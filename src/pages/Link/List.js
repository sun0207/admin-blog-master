...
class TableList extends PureComponent {
  constructor(props) {
    ...
    this.state = {
      visible: false,
      loading: false,
      searchType: '', // 1 :友情链接 2: 博主推荐 3: 在线工具 '' 代表所有链接
      keyword: '',
      type: '', // 1 :友情链接 2: 博主推荐 3: 在线工具 '' 代表所有链接
      url: '',
      icon: '',
      pageNum: 1,
      pageSize: 10,
      ...
      columns: [
        ...
        },
        {
          ...
          render: val => {
            if (val == 1) {
              return <Tag color="cyan">友情链接</Tag>;
            } else if (val == 2) {
              return <Tag color="orange">博主推荐</Tag>;
            } else {
              return <Tag color="magenta">在线工具</Tag>;
            }
          },
        },
        {
        ...
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          <Col md={24} sm={24}>
            ...
            >
              ...
              <Select.Option value="1">友情链接</Select.Option>
              <Select.Option value="2">博主推荐</Select.Option>
              <Select.Option value="3">在线工具</Select.Option>
            </Select>
