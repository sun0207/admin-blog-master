...
!(function(n) {
  ...
  var s = function(e, t) {
    ...
    t &&
      ...
      (this.opts = Ee.extend(!0, {}, Ee.extend({}, s.DEFAULTS, n, 'object' == typeof t && t)));
    var r = JSON.stringify(this.opts);
    (Ee.FE.OPTS_MAPPING[r] = Ee.FE.OPTS_MAPPING[r] || this.id),
      (this.sid = Ee.FE.OPTS_MAPPING[r]),
                  ...
                  if (1 === e.which || !e.which) {
                    ...
                    t && 'IMG' == t.tagName && Ee(t).trigger('mousedown'),
                      ...
                      'touchend' == e.type &&
                        ...
                        Ee(e.originalEvent.target).is('img') &&
                        setTimeout(
                          Ee.proxy(function() {
  ...
  (s.DEFAULTS = { initOnClick: !1, pluginsEnabled: null }),
    ...
    (s.prototype._init = function() {
      ...
      var t = Ee.proxy(function() {
          'TEXTAREA' != e && (this._original_html = this._original_html || this.$oel.html()),
            ...
            this.opts.iframe
              ? ((this.$iframe = Ee('<iframe src="about:blank" frameBorder="0">')),
                (this.$wp = Ee('<div></div>')),
                ...
                this.$iframe
                  .get(0)
                  .contentWindow.document.write('<html><head></head><body></body></html>'),
              ...
              : ((this.$el = Ee('<div></div>')),
                (this.el = this.$el.get(0)),
                (this.$wp = Ee('<div></div>').append(this.$el)),
                this.$box.html(this.$wp)),
        ...
        : 'TEXTAREA' == e
          ...
          : 'A' == e
            ...
            : 'IMG' == e
              ? i()
              : 'BUTTON' == e || 'INPUT' == e
                ? ((this.opts.editInPopup = !0), (this.opts.toolbarInline = !1), a())
                : t();
    }),
    (s.prototype.load = function(e) {
      for (var t in e)
        if (e.hasOwnProperty(t)) {
          ...
          if (
            ((this[t] = new e[t](this)),
            this[t]._init && (this[t]._init(), this.opts.initOnClick && 'core' == t))
          )
            return !1;
        }
    }),
    (s.prototype.destroy = function() {
      ...
      if (
        ...
        this.events.trigger('shared.destroy', undefined, !0),
        0 === this.shared.count)
      ) {
      ...
      if ('string' == typeof i) {
        ...
        return (
          this.each(function() {
            var e,
              t,
              n = Ee(this).data('froala.editor');
            if (!n)
              return console.warn(
                'Editor should be initialized before calling the ' + i + ' method.'
              );
            if (
              (0 < i.indexOf('.') && n[i.split('.')[0]]
                ? (n[i.split('.')[0]] && (e = n[i.split('.')[0]]), (t = i.split('.')[1]))
                : ((e = n), (t = i.split('.')[0])),
              !e[t])
            )
              return Ee.error('Method ' + i + ' does not exist in Froala Editor.');
    ...
    (Ee.FE.MD = 2),
    (Ee.FE.LG = 3);
  (Ee.FE.LinkRegExCommon = '[a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_.]{1,}'),
    (Ee.FE.LinkRegExEnd =
      "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;/~+#-\\'*-_{}]*)|())"),
    (Ee.FE.LinkRegExTLD =
      '((' + Ee.FE.LinkRegExCommon + ')(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))'),
    (Ee.FE.LinkRegExHTTP = '((ftp|http|https):\\/\\/' + Ee.FE.LinkRegExCommon + ')'),
    (Ee.FE.LinkRegExAuth =
      '((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@' + Ee.FE.LinkRegExCommon + ')'),
    (Ee.FE.LinkRegExWWW = '(www\\.' + Ee.FE.LinkRegExCommon + '\\.[a-z0-9-]{2,24})'),
    (Ee.FE.LinkRegEx =
      '(' +
      Ee.FE.LinkRegExTLD +
      '|' +
      ...
      ')' +
      Ee.FE.LinkRegExEnd),
    (Ee.FE.LinkProtocols = ['mailto', 'tel', 'sms', 'notes', 'data']),
    (Ee.FE.MAIL_REGEX = /.+@.+\..+/i),
    (Ee.FE.MODULES.helpers = function(a) {
      function e() {
        var e,
          t,
          n = {},
        ...
        if (0 < r) n.msie = !0;
          ...
          var i = navigator.userAgent.toLowerCase(),
            a =
              ...
              /(msie) ([\w.]+)/.exec(i) ||
              (i.indexOf('compatible') < 0 && /(mozilla)(?:.*? rv:([\w.]+)|)/.exec(i)) ||
              [],
            o = a[1] || '';
          a[2];
      ...
      return {
              ...
              function e(e, t) {
                ...
                e[t] = function(e) {
                  ...
                  if (e && e.match(s)) {
                    ...
                    return (
                      this.id ||
                        ((this.id = 'rootedQuerySelector_id_' + new Date().getTime()), (n = !0)),
        ...
        sanitizeURL: function(e) {
          return /^(https?:|ftps?:|)\/\//i.test(e)
            ...
            : /^([A-Za-z]:(\\){1,2}|[A-Za-z]:((\\){1,2}[^\\]+)+)(\\)?$/i.test(e)
              ? e
              : new RegExp('^(' + Ee.FE.LinkProtocols.join('|') + '):\\/\\/', 'i').test(e)
                ? e
        ...
        isURL: function(e) {
          return (
            ...
            ((e = String(e)
              ...
              .replace(/"/g, '%22')
              .replace(/ /g, '%20')),
            new RegExp('^' + Ee.FE.LinkRegExHTTP + Ee.FE.LinkRegExEnd + '$', 'gi').test(e))
          );
        },
        ...
        scrollTop: function() {
          return a.o_win.pageYOffset
            ? a.o_win.pageYOffset
            : a.o_doc.documentElement && a.o_doc.documentElement.scrollTop
              ? a.o_doc.documentElement.scrollTop
              : a.o_doc.body.scrollTop
                ? a.o_doc.body.scrollTop
                : 0;
        },
        scrollLeft: function() {
          return a.o_win.pageXOffset
            ? a.o_win.pageXOffset
            : a.o_doc.documentElement && a.o_doc.documentElement.scrollLeft
              ? a.o_doc.documentElement.scrollLeft
              : a.o_doc.body.scrollLeft
                ? a.o_doc.body.scrollLeft
                : 0;
        },
        isInViewPort: function(e) {
          ...
          return (
            (0 <= (t = { top: Math.round(t.top), bottom: Math.round(t.bottom) }).top &&
    ...
    (Ee.FE.MODULES.events = function(l) {
      ...
      function f(e, t, n, r, i) {
        ...
        (a = r),
          ...
          n
            ? e.on(t.split(' ').join('.ed' + s + ' ') + '.ed' + s, n, r)
            : e.on(t.split(' ').join('.ed' + s + ' ') + '.ed' + s, r),
          o.push([e, t.split(' ').join('.ed' + s + ' ') + '.ed' + s]);
      }
      function p(e) {
      ...
      function u(e, t, n) {
        if (!l.edit.isDisabled() || n) {
          ...
          return (
            !1 !== (i = l.$oel.triggerHandler('froalaEditor.' + e, Ee.merge([l], t || []))) && i
          );
        }
      }
      function h() {
      ...
      return {
          ...
          (l.shared.$_events = l.shared.$_events || []),
            ...
            d('mousedown', function() {
              for (var e = 0; e < Ee.FE.INSTANCES.length; e++)
                Ee.FE.INSTANCES[e] != l &&
                  Ee.FE.INSTANCES[e].popups &&
                  Ee.FE.INSTANCES[e].popups.areVisible() &&
                  Ee.FE.INSTANCES[e].$el.find('.fr-marker').remove();
            }),
                ...
                l.edit.isDisabled() || l.node.hasClass(n.get(0), 'fr-disabled')
                  ...
                  : ('mousedown' === t.type && 1 !== t.which) ||
                    ...
                    (l.helpers.isAndroid() || l.helpers.isWindowsPhone()) &&
                      0 === n.parents('.fr-dropdown-menu').length &&
                  ...
                  (function(e, t) {
                    ...
                    if (
                      ...
                      if ('touchmove' != e.type) {
                        ...
                        if (
                          (l.button.getButtons('.fr-selected', !0).removeClass('fr-selected'),
        ...
        chainTrigger: function(e, t, n) {
          if (!l.edit.isDisabled() || n) {
            ...
            return (
              void 0 !== (i = l.$oel.triggerHandler('froalaEditor.' + e, Ee.merge([l], [t]))) &&
                (t = i),
              t
            );
          }
      ...
      function l(e) {
        return (
          ...
          (e.nodeType == Node.ELEMENT_NODE &&
            0 <= Ee.FE.BLOCK_TAGS.indexOf(e.tagName.toLowerCase()))
        );
      }
      function d(e) {
        var t = {},
      ...
      return {
        ...
        isEmpty: function(e, t) {
          ...
          for (var r = !1, i = 0; i < n.length; i++) {
            ...
            if (
              !(
                (t && o.node.hasClass(a, 'fr-marker')) ||
                (a.nodeType == Node.TEXT_NODE && 0 === a.textContent.length)
              )
            ) {
              if (
                'BR' != a.tagName &&
                0 < (a.textContent || '').replace(/\u200B/gi, '').replace(/\n/g, '').length
              )
                return !1;
              if (r) return !1;
              'BR' == a.tagName && (r = !0);
          ...
          return !(
            e.querySelectorAll(Ee.FE.VOID_ELEMENTS.join(',')).length -
              e.querySelectorAll('br').length ||
            e.querySelector(
              o.opts.htmlAllowedEmptyTags.join(':not(.fr-marker),') + ':not(.fr-marker)'
            ) ||
            1 < e.querySelectorAll(Ee.FE.BLOCK_TAGS.join(',')).length ||
            e.querySelector(o.opts.htmlDoNotWrapTags.join(':not(.fr-marker),') + ':not(.fr-marker)')
          );
        },
        blockParent: function(e) {
          for (
            ...
            e &&
            e.parentNode !== o.el &&
            (!e.parentNode || !o.node.hasClass(e.parentNode, 'fr-inner'));
        ...
        deepestParent: function(e, t, n) {
          if (
            ...
            0 <= t.indexOf(e.parentNode) ||
              (e.parentNode && o.node.hasClass(e.parentNode, 'fr-inner')) ||
              (e.parentNode && 0 <= Ee.FE.SIMPLE_ENTER_TAGS.indexOf(e.parentNode.tagName) && n))
          )
            return null;
          for (
            ;
            ...
            e.parentNode &&
            !o.node.hasClass(e.parentNode, 'fr-inner') &&
            (Ee.FE.SIMPLE_ENTER_TAGS.indexOf(e.parentNode.tagName) < 0 || !n) &&
        ...
        isVoid: function(e) {
          return (
            e &&
            e.nodeType == Node.ELEMENT_NODE &&
            0 <= Ee.FE.VOID_ELEMENTS.indexOf((e.tagName || '').toLowerCase())
          );
        },
        hasFocus: function(e) {
          return (
            e === o.doc.activeElement &&
            (!o.doc.hasFocus || o.doc.hasFocus()) &&
            !!(n(e) || e.type || e.href || ~e.tabIndex)
          );
        },
    ...
    (Ee.FE.END_MARKER =
      ...
      Ee.FE.INVISIBLE_SPACE +
      '</span>'),
    (Ee.FE.MARKERS = Ee.FE.START_MARKER + Ee.FE.END_MARKER),
    (Ee.FE.MODULES.markers = function(d) {
      function l() {
        if (!d.$wp) return null;
        try {
          ...
          if (
            ...
            t.textContent !==
              Ee('<span>')
                .html(Ee.FE.INVISIBLE_SPACE)
                .text()
          )
            return (
              d.selection.setAtStart(d.el),
              d.$el
                .find('.fr-marker:first')
                .replaceWith(
                  '<span class="fr-single-marker" style="display: none; line-height: 0;">' +
                    Ee.FE.INVISIBLE_SPACE +
                    '</span>'
                ),
              d.$el.find('.fr-marker').remove(),
              d.$el
                .find('.fr-single-marker')
                .removeClass('fr-single-marker')
                .addClass('fr-marker')
                .get(0)
            );
          ...
          if ((n.insertNode(i), (i = d.$el.find('span.fr-marker').get(0)))) {
            for (
              var a = i.nextSibling;
              a && a.nodeType === Node.TEXT_NODE && 0 === a.textContent.length;
        ...
        place: function(e, t, n) {
          ...
          try {
            ...
            if (
              ...
              for (
                a = (r = d.$el.find('span.fr-marker[data-type="true"][data-id="' + n + '"]').get(0))
                  .nextSibling;
                a && a.nodeType === Node.TEXT_NODE && 0 === a.textContent.length;
            ...
            if (!1 === t && !e.collapsed) {
              if (
                (a = (r = d.$el
                  .find('span.fr-marker[data-type="false"][data-id="' + n + '"]')
                ...
                for (
                  i = [a];
                  (a = i[i.length - 1]),
                    (i = d.node.contents(a))[i.length - 1] && d.node.isBlock(i[i.length - 1]);

                );
                Ee(a).append(Ee(r));
              }
              ((r.parentNode && 0 <= ['TD', 'TH'].indexOf(r.parentNode.tagName)) ||
                (!r.previousSibling && d.node.isBlock(r.parentElement))) &&
                r.parentNode.previousSibling &&
                !r.previousSibling &&
                Ee(r.parentNode.previousSibling).append(r);
            }
          ...
          if ((t || ((t = d.node.blockParent(e)) && 'LI' != t.tagName && (t = null)), t))
            if (d.node.isBlock(t) && d.node.isEmpty(t))
              ...
              d.node.isEmpty(t.parentNode)
                ? Ee(t).replaceWith('<span class="fr-marker"></span>')
                : Ee(t).append('<span class="fr-marker"></span>');
            else if (d.cursor.isAtStart(e, t))
              Ee(t).before('<span class="fr-marker"></span>'), Ee(e).remove();
            else if (d.cursor.isAtEnd(e, t))
              Ee(t).after('<span class="fr-marker"></span>'), Ee(e).remove();
            else {
              for (
                var n = e, r = '', i = '';
                (n = n.parentNode),
                  (r += d.node.closeTagString(n)),
                  (i = d.node.openTagString(n) + i),
                  n != t;
          ...
          if (
            ('undefined' != typeof d.doc.caretPositionFromPoint
              ? ((t = d.doc.caretPositionFromPoint(n, r)),
                (i = d.doc.createRange()).setStart(t.offsetNode, t.offset),
                i.setEnd(t.offsetNode, t.offset))
              : 'undefined' != typeof d.doc.caretRangeFromPoint &&
                ((t = d.doc.caretRangeFromPoint(n, r)),
                (i = d.doc.createRange()).setStart(t.startContainer, t.startOffset),
                i.setEnd(t.startContainer, t.startOffset)),
            null !== i && 'undefined' != typeof d.win.getSelection)
          ) {
    ...
    (Ee.FE.MODULES.selection = function(T) {
      function s() {
        ...
        return (
          T.win.getSelection
            ? (e = T.win.getSelection())
            : T.doc.getSelection
              ? (e = T.doc.getSelection())
              : T.doc.selection && (e = T.doc.selection.createRange().text),
          e.toString()
        );
      }
      function A() {
        return T.win.getSelection
          ? T.win.getSelection()
          : T.doc.getSelection
            ? T.doc.getSelection()
            : T.doc.selection.createRange();
      }
      function c(e) {
        var t = A(),
          n = [];
          ...
          for (t = 0; t < n.length; t++)
            if (n[t].startContainer !== T.doc || T.browser.msie) {
              ...
              if (
                ((void 0 !== a && a) ||
                  !i ||
                  (Ee('.fr-marker').remove(), T.selection.setAtEnd(T.el)),
                T.el.normalize(),
                T.browser.safari && !i)
              )
                try {
      ...
      function R() {
        ...
        for (e = 0; e < t.length; e++) {
          ...
          if (0 < o.length) {
            ...
            try {
              for (
                var l, d = !1, c = i.nextSibling;
                c && c.nodeType == Node.TEXT_NODE && 0 === c.textContent.length;

              )
                (c = (l = c).nextSibling), Ee(l).remove();
              for (
                var f, p, u = o.nextSibling;
                u && u.nodeType == Node.TEXT_NODE && 0 === u.textContent.length;

              )
                (u = (l = u).nextSibling), Ee(l).remove();
              if (i.nextSibling == o || o.nextSibling == i) {
                for (
                  var h = i.nextSibling == o ? i : o, g = h == i ? o : i, m = h.previousSibling;
                  m && m.nodeType == Node.TEXT_NODE && 0 === m.length;
                ...
                if (m && m.nodeType == Node.TEXT_NODE)
                  for (; m && m.previousSibling && m.previousSibling.nodeType == Node.TEXT_NODE; )
                    (m.previousSibling.textContent = m.previousSibling.textContent + m.textContent),
                      (m = m.previousSibling),
                ...
                if (v && v.nodeType == Node.TEXT_NODE)
                  for (; v && v.nextSibling && v.nextSibling.nodeType == Node.TEXT_NODE; )
                    (v.nextSibling.textContent = v.textContent + v.nextSibling.textContent),
                      (v = v.nextSibling),
                      Ee(v.previousSibling).remove();
                if (
                  (m && (T.node.isVoid(m) || T.node.isBlock(m)) && (m = null),
                  v && (T.node.isVoid(v) || T.node.isBlock(v)) && (v = null),
                  m && v && m.nodeType == Node.TEXT_NODE && v.nodeType == Node.TEXT_NODE)
                ) {
                  ...
                  !m && v && v.nodeType == Node.TEXT_NODE
                    ? (Ee(i).remove(),
                      Ee(o).remove(),
                      T.opts.htmlUntouched || T.spaces.normalize(v),
                      (s = Ee(T.doc.createTextNode('\u200b'))),
                      Ee(v).before(s),
                      a.setStart(v, 0),
                      a.setEnd(v, 0),
                      (d = !0))
                    : !v &&
                      ...
                      (s = Ee(T.doc.createTextNode('\u200b'))),
                      Ee(m).after(s),
                      a.setStart(m, m.textContent.length),
                      a.setEnd(m, m.textContent.length),
                      (d = !0));
              }
              if (!d)
                (T.browser.chrome || T.browser.edge) && i.nextSibling == o
                  ? ((f = y(o, a, !0) || a.setStartAfter(o)),
                    (p = y(i, a, !1) || a.setEndBefore(i)))
                  : (i.previousSibling == o && (o = (i = o).nextSibling),
                    (o.nextSibling && 'BR' === o.nextSibling.tagName) ||
                      (!o.nextSibling && T.node.isBlock(i.previousSibling)) ||
                      (i.previousSibling && 'BR' == i.previousSibling.tagName) ||
                      ((i.style.display = 'inline'),
                      (o.style.display = 'inline'),
                      (s = Ee(T.doc.createTextNode('\u200b')))),
                    (f = y(i, a, !0) || (Ee(i).before(s) && a.setStartBefore(i))),
                    (p = y(o, a, !1) || (Ee(o).after(s) && a.setEndAfter(o)))),
                  'function' == typeof f && f(),
                  'function' == typeof p && p();
            } catch (b) {
      ...
      function y(e, t, n) {
        var r,
          i = e.previousSibling,
          a = e.nextSibling;
        return i && a && i.nodeType == Node.TEXT_NODE && a.nodeType == Node.TEXT_NODE
          ? ((r = i.textContent.length),
            n
              ? ((a.textContent = i.textContent + a.textContent),
                Ee(i).remove(),
                Ee(e).remove(),
              ...
              : ((i.textContent = i.textContent + a.textContent),
                Ee(a).remove(),
                Ee(e).remove(),
      ...
      function i(e) {
        ...
        if (T.win.getSelection) {
          ...
          a.rangeCount &&
            ((n = (t = a.getRangeAt(0)).cloneRange()).selectNodeContents(e),
          ...
          T.doc.selection &&
            ...
            ((n = (t = T.doc.selection.createRange()).duplicate()).moveToElementText(e),
      ...
      function _(e, t) {
        ...
        for (var r = T.node.contents(e), i = 0; i < r.length; i++)
          r[i].nodeType != Node.ELEMENT_NODE
            ? Ee(r[i]).remove()
            : (_(r[i], 0 === i), 0 === i && (t = !1));
        e.nodeType == Node.TEXT_NODE
          ? Ee(e).replaceWith('<span data-first="true" data-text="true"></span>')
          : t && Ee(e).attr('data-first', !0);
      }
      function x() {
      ...
      function r(e, t) {
        ...
        for (
          var n = e.firstChild;
          n && (T.node.isBlock(n) || (t && !T.node.isVoid(n) && n.nodeType == Node.ELEMENT_NODE));
      ...
      function a(e, t) {
        ...
        for (
          r.setAttribute('id', 'fr-sel-markers'), r.innerHTML = Ee.FE.MARKERS;
          e.parentNode &&
          T.opts.htmlAllowedEmptyTags &&
          0 <= T.opts.htmlAllowedEmptyTags.indexOf(e.tagName.toLowerCase());
      ...
      return {
          ...
          try {
            if (e.rangeCount) {
              ...
              if (r.nodeType == Node.ELEMENT_NODE) {
                ...
                Ee(r.childNodes[n.endOffset]).text() === s()
                  ? ((r = r.childNodes[n.endOffset]), (i = !0))
                  : !n.collapsed &&
                    r.previousSibling &&
                  ...
                  !i &&
                    0 < r.childNodes.length &&
                    Ee(r.childNodes[r.childNodes.length - 1]).text() === s() &&
                    ['BR', 'IMG', 'HR'].indexOf(r.childNodes[r.childNodes.length - 1].tagName) <
                      0 &&
        ...
        isFull: function() {
          ...
          for (e = 0; e < t.length; e++)
            t[e].nextSibling &&
              (t[e].innerHTML =
                '<span class="fr-mk">' + Ee.FE.INVISIBLE_SPACE + '</span>' + t[e].innerHTML);
          var n = !1,
            r = i(T.el);
          for (
            r.atStart && r.atEnd && (n = !0), t = T.el.querySelectorAll('.fr-mk'), e = 0;
            e < t.length;
            e++
          )
        ...
        remove: function() {
          ...
          for (t = 0; t < i.length; t++)
            for (
              ...
              !(
                n(a) ||
                T.node.isBlock(a.parentNode) ||
                T.$el.is(a.parentNode) ||
                T.node.hasClass(a.parentNode, 'fr-inner')
              );
          ...
          for (t = 0; t < o.length; t++) {
            for (
              ...
              !(
                r(s) ||
                T.node.isBlock(s.parentNode) ||
                T.$el.is(s.parentNode) ||
                T.node.hasClass(s.parentNode, 'fr-inner')
              );
            ...
            s.parentNode &&
              T.node.isBlock(s.parentNode) &&
              T.node.isEmpty(s.parentNode) &&
              !T.$el.is(s.parentNode) &&
              !T.node.hasClass(s.parentNode, 'fr-inner') &&
              T.opts.keepFormatOnDelete &&
              Ee(s.parentNode).after(s);
          }
          if (
            (function() {
            ...
            !(function e(t, n) {
              ...
              for (var i = 0; i < r.length; i++) {
                ...
                T.node.hasClass(a, 'fr-marker')
                  ? (n = (n + 1) % 2)
                  : n
                    ? 0 < Ee(a).find('.fr-marker').length
                      ? (n = e(Ee(a), n))
                      : ['TD', 'TH'].indexOf(a.tagName) < 0 && !T.node.hasClass(a, 'fr-inner')
                        ? !T.opts.keepFormatOnDelete ||
                          0 < T.$el.find('[data-first]').length ||
                          T.node.isVoid(a)
                          ? Ee(a).remove()
                          : _(a)
                        : T.node.hasClass(a, 'fr-inner')
                          ? 0 === Ee(a).find('.fr-inner').length
                            ? Ee(a).html('<br>')
                            : Ee(a)
                                .find('.fr-inner')
                                .filter(x)
                                .html('<br>')
                          : (Ee(a).empty(), Ee(a).attr('data-del-cell', !0))
                    : 0 < Ee(a).find('.fr-marker').length && (n = e(Ee(a), n));
              }
              return n;
            })(T.$el, 0);
            ...
            if (l.length)
              ...
              for (
                T.$el
                  ...
                  .filter(function() {
                    return (
                      0 < Ee(this).find('[data-del-cell]').length &&
                      Ee(this).find('[data-del-cell]').length == Ee(this).find('td, th').length
                    );
                  })
                  .remove(),
                ...
                var d = i[t],
                  c = d.nextSibling,
                  f = T.$el
                    .find('.fr-marker[data-type="false"][data-id="' + Ee(d).data('id') + '"]')
                    .get(0);
                if (f) {
                  if (d && (!c || c != f)) {
                    ...
                    if (
                      ...
                      u && 0 <= ['UL', 'OL'].indexOf(u.tagName) && (g = !(u = null)),
                      Ee(d).after(f),
                      p != u)
                    )
                      if (null != p || h)
                        if (null != u || g || 0 !== Ee(p).parentsUntil(T.$el, 'table').length)
                          p &&
                            u &&
                            0 === Ee(p).parentsUntil(T.$el, 'table').length &&
                            0 === Ee(u).parentsUntil(T.$el, 'table').length &&
                            0 === Ee(p).find(u).length &&
                            0 === Ee(u).find(p).length &&
                            (Ee(p).append(Ee(u).html()), Ee(u).remove());
                        else {
                        ...
                        v
                          ? (Ee(v).after(Ee(u).html()), Ee(u).remove())
                          : 0 === Ee(u).parentsUntil(T.$el, 'table').length &&
                            (Ee(d)
                              .next()
                              .after(Ee(u).html()),
          ...
          T.$el.find('li:empty').remove(),
            ...
            T.opts.htmlUntouched ||
              (T.clean.lists(), T.$el.find('li:empty').append('<br>'), T.spaces.normalize());
          ...
          void 0 !== E &&
            ...
            T.node.isElement(E.parentNode) &&
            T.node.isElement(b.parentNode) &&
            T.$el.append('<br>'),
            R();
        },
        blocks: function() {
          ...
          if (p() && n.rangeCount) {
            ...
            for (e = 0; e < r.length; e++) {
              ...
              (T.node.isBlock(o) || T.node.hasClass(o, 'fr-inner')) &&
                t.indexOf(o) < 0 &&
                t.push(o),
                (i = T.node.blockParent(o)) && t.indexOf(i) < 0 && t.push(i);
              for (var l = [], d = o; d !== s && d !== T.el; )
                l.indexOf(d) < 0 && d.children && d.children.length
                  ? (l.push(d), (d = d.children[0]))
                  : d.nextSibling
                    ? (d = d.nextSibling)
                    : d.parentNode && ((d = d.parentNode), l.push(d)),
                  T.node.isBlock(d) &&
                    l.indexOf(d) < 0 &&
                    t.indexOf(d) < 0 &&
                    (d !== s || 0 < a.endOffset) &&
        ...
        setBefore: function(e, t) {
          ...
          return n
            ? (T.node.isBlock(n)
                ? a(n)
                : 'BR' == n.tagName
                  ? Ee(n).before(Ee.FE.MARKERS)
                  : Ee(n).after(Ee.FE.MARKERS),
              !0)
            : !!t && (T.node.isBlock(e) ? r(e) : Ee(e).before(Ee.FE.MARKERS), !0);
        },
        setAfter: function(e, t) {
          ...
          for (
            ...
            n = n.nextSibling;
          return n
            ? (T.node.isBlock(n) ? r(n) : Ee(n).before(Ee.FE.MARKERS), !0)
            : !!t && (T.node.isBlock(e) ? a(e) : Ee(e).after(Ee.FE.MARKERS), !0);
        },
        rangeElement: f,
      };
    }),
    ...
    (Ee.FE.HTML5Map = { B: 'STRONG', I: 'EM', STRIKE: 'S' }),
    (Ee.FE.MODULES.clean = function(f) {
      ...
      function i(e) {
        ...
        for (t = 0; t < n.length; t++)
          n[t].nodeType != Node.ELEMENT_NODE || f.node.isVoid(n[t])
            ...
            : n[t].textContent.replace(/\u200b/g, '').length != n[t].textContent.length && i(n[t]);
        if (
          e.nodeType == Node.ELEMENT_NODE &&
          !f.node.isVoid(e) &&
          (e.normalize(),
      ...
      function l(e) {
        ...
        for (t in e)
          if (e.hasOwnProperty(t)) {
            var n = t.match(h),
              r = null;
            'style' == t && f.opts.htmlAllowedStyleProps.length && (r = e[t].match(g)),
      ...
      function c(e, t, n) {
        ...
        var r = (e = e
          ...
          i = null;
        f.opts.fullPage &&
          ((r = f.html.extractNode(e, 'body') || (0 <= e.indexOf('<body') ? '' : e)),
          n && (i = f.html.extractNode(e, 'head') || '')),
          (r = d(r, t)),
          i && (i = d(i, t));
          ...
          if (f.opts.fullPage) {
            ...
            return (
              ...
              r +
                ...
                i +
                '><head' +
                l(f.html.extractNodeAttrs(n, 'head')) +
                '>' +
                t +
                '</head><body' +
                l(f.html.extractNodeAttrs(n, 'body')) +
                '>' +
                e +
                '</body></html>'
            );
        ...
        return a
          ...
          .replace(/\[FROALA\.EDITOR\.NOSCRIPT ([\d]*)\]/gi, function(e, t) {
            return 0 <= f.opts.htmlRemoveTags.indexOf('noscript')
              ? ''
              : o[parseInt(t, 10)].replace(/\&lt;/g, '<').replace(/\&gt;/g, '>');
          })
      ...
      function E(e) {
        ...
        !(function(e) {
          ...
          if (
            ('PRE' == e.tagName &&
              0 <= (n = (t = e).innerHTML).indexOf('\n') &&
              (t.innerHTML = n.replace(/\n/g, '<br>')),
            e.nodeType == Node.ELEMENT_NODE &&
              (e.getAttribute('data-fr-src') &&
                0 !== e.getAttribute('data-fr-src').indexOf('blob:') &&
                e.setAttribute(
                  'data-fr-src',
                  f.helpers.sanitizeURL(v(e.getAttribute('data-fr-src')))
                ),
              e.getAttribute('href') &&
                e.setAttribute('href', f.helpers.sanitizeURL(v(e.getAttribute('href')))),
              e.getAttribute('src') &&
                e.setAttribute('src', f.helpers.sanitizeURL(v(e.getAttribute('src')))),
              e.getAttribute('data') &&
                e.setAttribute('data', f.helpers.sanitizeURL(v(e.getAttribute('data')))),
              0 <= ['TABLE', 'TBODY', 'TFOOT', 'TR'].indexOf(e.tagName) &&
                (e.innerHTML = e.innerHTML.trim())),
            !f.opts.pasteAllowLocalImages &&
              e.nodeType == Node.ELEMENT_NODE &&
              'IMG' == e.tagName &&
              e.getAttribute('data-fr-src') &&
              0 === e.getAttribute('data-fr-src').indexOf('file://'))
          )
            return e.parentNode.removeChild(e);
          if (
            e.nodeType == Node.ELEMENT_NODE &&
            Ee.FE.HTML5Map[e.tagName] &&
            '' === f.node.attributes(e)
          ) {
              ...
              if (a)
                for (var o = a.length - 1; 0 <= o; o--) {
                  ...
                  'style' == s.nodeName &&
                    ...
                    l && d
                      ? (s.value = m(d.join(';')))
                      : (l && ('style' != s.nodeName || d)) || e.removeAttribute(s.nodeName);
                }
            }
      ...
      return {
        _init: function() {
          f.opts.fullPage &&
            Ee.merge(f.opts.htmlAllowedTags, [
              'head',
              'title',
              'style',
              'link',
        ...
        html: function(e, t, n, r) {
          ...
          return (
            o.push('data-fr-.*'),
            o.push('fr-.*'),
            (p = new RegExp('^' + a.join('$|^') + '$', 'gi')),
            (h = new RegExp('^' + o.join('$|^') + '$', 'gi')),
            (u = new RegExp('^' + f.opts.htmlRemoveTags.join('$|^') + '$', 'gi')),
            (g = f.opts.htmlAllowedStyleProps.length
              ? new RegExp(
                  '((^|;|\\s)' +
                    f.opts.htmlAllowedStyleProps.join(':.+?(?=;|$))|((^|;|\\s)') +
                    ':.+?(?=(;)|$))',
                  'gi'
                )
              : null),
          ...
          !(function() {
            for (var e = f.el.querySelectorAll('tr'), t = 0; t < e.length; t++) {
              ...
              if (!1 !== r && 0 !== n.length) {
                ...
                var o = a;
                'THEAD' != o.tagName &&
                  ((o = f.doc.createElement('THEAD')), a.insertBefore(o, a.firstChild)),
                  o.appendChild(e[t]);
              }
            }
          })();
        ...
        lists: function() {
          !(function() {
            ...
            (function() {
              for (var e = f.el.querySelectorAll('ol + ol, ul + ul'), t = 0; t < e.length; t++) {
                ...
                if (
                  ...
                  f.node.openTagString(n) == f.node.openTagString(n.previousSibling)
                ) {
            ...
            (function() {
              for (var e = f.el.querySelectorAll('ul, ol'), t = 0; t < e.length; t++)
                for (var n = f.node.contents(e[t]), r = null, i = n.length - 1; 0 <= i; i--)
                  'LI' != n[i].tagName && 'UL' != n[i].tagName && 'OL' != n[i].tagName
                    ? (r || (r = Ee('<li>')).insertBefore(n[i]), r.prepend(n[i]))
                    : (r = null);
            })(),
            (function() {
              var e, t, n;
            ...
            (function() {
              for (
                var e = f.el.querySelectorAll('ul > ul, ol > ol, ul > ol, ol > ul'), t = 0;
                t < e.length;
                t++
              ) {
                var n = e[t],
        ...
        if (!l.html.isPreformatted(a)) {
          t &&
            ...
            (r && 'BR' !== r.tagName && !l.node.isBlock(r)) ||
              !(l.node.isBlock(a) || (l.node.isLink(a) && !a.nextSibling) || l.node.isElement(a)) ||
              (i = i.replace(/[\f\n\r\t\v ]{1,}$/g, '')),
            (n && 'BR' !== n.tagName && !l.node.isBlock(n)) ||
              !(
                l.node.isBlock(a) ||
                (l.node.isLink(a) && !a.previousSibling) ||
                l.node.isElement(a)
              ) ||
              (i = i.replace(/^[\f\n\r\t\v ]{1,}/g, '')),
            (l.node.isBlock(r) || l.node.isBlock(n)) && (i = i.replace(/^[\f\n\r\t\v ]{1,}/g, '')),
            ' ' === i &&
              ((n && l.node.isVoid(n)) || (r && l.node.isVoid(r))) &&
              !((n && r && l.node.isVoid(n)) || (r && n && l.node.isVoid(r))) &&
              (i = '')),
            ((!n && l.node.isBlock(r)) || (!r && l.node.isBlock(n))) &&
              l.node.isBlock(a) &&
              a !== l.el &&
              (i = i.replace(/^[\f\n\r\t\v ]{1,}/g, '')),
          ...
          for (var o = '', s = 0; s < i.length; s++)
            32 != i.charCodeAt(s) ||
            (0 !== s && 32 != o.charCodeAt(s - 1)) ||
            (n && r && l.node.isVoid(n)) ||
            (n && r && l.node.isVoid(r))
              ? (o += i[s])
              : (o += Ee.FE.UNICODE_NBSP);
          (!r ||
            (r && l.node.isBlock(r)) ||
            (r &&
              r.nodeType == Node.ELEMENT_NODE &&
            ...
            (l.node.isVoid(n) || (o = o.replace(/ $/, Ee.FE.UNICODE_NBSP))),
            !n ||
              l.node.isVoid(n) ||
              l.node.isBlock(n) ||
              1 !== (o = o.replace(/^\u00A0([^ $])/, ' $1')).length ||
              160 !== o.charCodeAt(0) ||
              !r ||
              l.node.isVoid(r) ||
              l.node.isBlock(r) ||
                ...
                l.node.filter(function(e) {
                  ...
                  return (
                    null !=
                      e.textContent.match(
                        /([ \u00A0\f\n\r\t\v]{2,})|(^[ \u00A0\f\n\r\t\v]{1,})|([ \u00A0\f\n\r\t\v]{1,}$)/g
                      ) && !l.node.hasClass(e.parentNode, 'fr-marker')
                  );
                }),
                !1
              );
      ...
      return {
        ...
        normalizeAroundCursor: function() {
          for (var e = [], t = l.el.querySelectorAll('.fr-marker'), n = 0; n < t.length; n++) {
            for (
              var r = null,
                i = l.node.blockParent(t[n]),
                a = (r = i || t[n]).nextSibling,
                o = r.previousSibling;
              a && 'BR' == a.tagName;
    ...
    (Ee.FE.UNICODE_NBSP = String.fromCharCode(160)),
    (Ee.FE.VOID_ELEMENTS = [
      'area',
      'base',
      'br',
    ...
    (Ee.FE.MODULES.html = function(w) {
      function c() {
        return w.opts.enter == Ee.FE.ENTER_P
          ? 'p'
          : w.opts.enter == Ee.FE.ENTER_DIV
            ? 'div'
            : w.opts.enter == Ee.FE.ENTER_BR
              ? null
              : void 0;
      }
      function s(e, t) {
        return (
          !(!e || e === w.el) &&
          (t
            ? -1 != ['PRE', 'SCRIPT', 'STYLE'].indexOf(e.tagName) || s(e.parentNode, t)
        ...
        if (e) {
          ...
          for (t = 0; t < i.length; t++) {
            ...
            if (a) {
              var o = a.nextSibling,
                s = a.previousSibling;
              a && r.indexOf(a) < 0 && w.node.isBlock(a) && r.push(a),
                s && w.node.isBlock(s) && r.indexOf(s) < 0 && r.push(s),
                o && w.node.isBlock(o) && r.indexOf(o) < 0 && r.push(o);
            }
          }
        } else r = w.el.querySelectorAll(p());
        var l = p();
        for (
          l += ',' + Ee.FE.VOID_ELEMENTS.join(','),
            l += ', .fr-inner',
            l += ',' + w.opts.htmlAllowedEmptyTags.join(':not(.fr-marker),') + ':not(.fr-marker)',
            t = r.length - 1;
          0 <= t;
          t--
        )
          if (
            !(
              (r[t].textContent && 0 < r[t].textContent.replace(/\u200B|\n/g, '').length) ||
              0 < r[t].querySelectorAll(l).length
            )
          ) {
            for (var d = w.node.contents(r[t]), c = !1, f = 0; f < d.length; f++)
              if (
                d[f].nodeType != Node.COMMENT_NODE &&
                d[f].textContent &&
                0 < d[f].textContent.replace(/\u200B|\n/g, '').length
              ) {
                c = !0;
                break;
              }
      ...
      function e(e) {
        ...
        (r = Ee.merge(r, w.opts.htmlAllowedEmptyTags)),
        ...
        do {
          ...
          for (var i = 0; i < t.length; i++)
            (0 !== t[i].attributes.length && void 0 === t[i].getAttribute('href')) ||
              (t[i].parentNode.removeChild(t[i]), (n = !0));
          t = w.el.querySelectorAll('*:empty:not(' + r.join('):not(') + '):not(.fr-marker)');
        } while (t.length && n);
      }
      function o(e, t) {
        ...
        if ((t && (n = 'div'), n)) {
          for (
            var r = w.doc.createDocumentFragment(), i = null, a = !1, o = e.firstChild, s = !1;
            o;
            ...
            if (
              ...
              (w.node.isBlock(o) ||
                (0 <= w.opts.htmlDoNotWrapTags.indexOf(o.tagName.toLowerCase()) &&
                  !w.node.hasClass(o, 'fr-marker')))
            )
              ...
              null == i
                ? ((i = w.doc.createElement(n)),
                  (s = !0),
                  t && (i.setAttribute('class', 'fr-temp-div'), i.setAttribute('data-empty', !0)),
                  i.appendChild(o.cloneNode(!0)),
                  r.appendChild(i))
                : !1 === a &&
                  (i.appendChild(w.doc.createElement('br')),
                  t && (i.setAttribute('class', 'fr-temp-div'), i.setAttribute('data-empty', !0))),
                (i = null);
            else {
              var d = o.textContent;
              ...
              0 < d.replace(/\n/g, '').replace(/(^ *)|( *$)/g, '').length ||
              (d.replace(/(^ *)|( *$)/g, '').length && d.indexOf('\n') < 0)
                ? (null == i &&
                    ((i = w.doc.createElement(n)),
                    (s = !0),
                    t && i.setAttribute('class', 'fr-temp-div'),
                    r.appendChild(i),
                    (a = !1)),
                  i.appendChild(o.cloneNode(!0)),
                  a ||
                    w.node.hasClass(o, 'fr-marker') ||
                    (o.nodeType == Node.TEXT_NODE && 0 === d.replace(/ /g, '').length) ||
                    (a = !0))
                : (s = !0);
            }
            o = l;
      ...
      function t(e, t, n, r, i) {
        ...
        o(w.el, e),
          ...
          i && l(w.el.querySelectorAll('li'), e),
          a != w.$wp.scrollTop() && w.$wp.scrollTop(a);
      }
      function n(e) {
        if ((void 0 === e && (e = w.el), e && 0 <= ['SCRIPT', 'STYLE', 'PRE'].indexOf(e.tagName)))
          return !1;
        for (
          ...
          if (!s(n.parentNode, !0)) {
            ...
            if (r) {
              var a = n.previousSibling,
                o = n.nextSibling;
              a && o && ' ' == i
                ? (i = w.node.isBlock(a) && w.node.isBlock(o) ? '' : ' ')
                : (a || (i = i.replace(/^ */, '')), o || (i = i.replace(/ *$/, '')));
            }
            n.textContent = i;
          }
        }
      ...
      function d(e) {
        ...
        if (
          ...
          for (
            ...
            n &&
            ((n.nodeType == Node.TEXT_NODE && 0 === n.textContent.replace(/\n|\r/g, '').length) ||
          ...
          n &&
            ...
            ((w.el == t && !r && w.opts.enter == Ee.FE.ENTER_BR && w.browser.msie) ||
        ...
        w.node.isEmpty(w.el) &&
          (null != c()
            ? w.el.querySelector(p()) ||
              w.el.querySelector(
                w.opts.htmlDoNotWrapTags.join(':not(.fr-marker),') + ':not(.fr-marker)'
              ) ||
              (w.core.hasFocus()
                ? (w.$el.html('<' + c() + '>' + Ee.FE.MARKERS + '<br/></' + c() + '>'),
                  w.selection.restore())
                : w.$el.html('<' + c() + '><br/></' + c() + '>'))
            : w.el.querySelector('*:not(.fr-marker):not(br)') ||
              (w.core.hasFocus()
                ? (w.$el.html(Ee.FE.MARKERS + '<br/>'), w.selection.restore())
                : w.$el.html('<br/>')));
      }
      function h(e, t) {
      ...
      return {
        ...
        fillEmptyBlocks: function(e) {
          var t = a(e);
          w.node.isEmpty(w.el) && w.opts.enter === Ee.FE.ENTER_BR && t.push(w.el);
          for (var n = 0; n < t.length; n++) {
            var r = t[n];
            'false' === r.getAttribute('contenteditable') ||
              r.querySelector(
                w.opts.htmlAllowedEmptyTags.join(':not(.fr-marker),') + ':not(.fr-marker)'
              ) ||
              w.node.isVoid(r) ||
              ('TABLE' != r.tagName &&
                'TBODY' != r.tagName &&
          ...
          if (w.browser.msie && w.opts.enter == Ee.FE.ENTER_BR) {
        ...
        set: function(e) {
          var t,
            n,
            r,
            i = w.clean.html((e || '').trim(), [], [], w.opts.fullPage);
          if (w.opts.fullPage) {
            ...
            v(w.$el, d + '\n' + a),
              ...
              w.iframe_document.doctype.parentNode.replaceChild(
                ...
                (n = w.iframe_document),
                (r = t.match(/<!DOCTYPE ?([^ ]*) ?([^ ]*) ?"?([^"]*)"? ?"?([^"]*)"?>/i))
                  ? n.implementation.createDocumentType(r[1], r[3], r[4])
                  : n.implementation.createDocumentType('html')),
        ...
        get: function(e, t) {
                ...
                for (var p = 0, u = c.length; p < u; p++)
                  if (c[p].selectorText && 0 < c[p].style.cssText.length) {
                    ...
                    for (i = 0; i < h.length; i++) {
                      !h[i].getAttribute('fr-original-style') && h[i].getAttribute('style')
                        ? (h[i].setAttribute('fr-original-style', h[i].getAttribute('style')),
                          a.push(h[i]))
                        : h[i].getAttribute('fr-original-style') ||
                          (h[i].setAttribute('fr-original-style', ''), a.push(h[i])),
                        o[h[i]] || (o[h[i]] = {});
                      for (
                        var m = 1e3 * f + I(c[p].selectorText),
                          v = c[p].style.cssText.split(';'),
                          E = 0;
                        E < v.length;
                        E++
                      ) {
                        ...
                        if (
                          ...
                          (o[h[i]][b] ||
                            ((o[h[i]][b] = 0) <=
                              (h[i].getAttribute('fr-original-style') || '').indexOf(b + ':') &&
                              (o[h[i]][b] = 1e4)),
                          m >= o[h[i]][b] && ((o[h[i]][b] = m), v[E].trim().length))
                        ) {
            ...
            for (r = 0; r < a.length; r++)
              if (
                (a[r].getAttribute('class') &&
                  (a[r].setAttribute('fr-original-class', a[r].getAttribute('class')),
                  a[r].removeAttribute('class')),
                0 < (a[r].getAttribute('fr-original-style') || '').trim().length)
              ) {
          ...
          if (w.node.isEmpty(w.el))
            w.opts.fullPage &&
              ((n = O(w.iframe_document)),
              (n +=
                '<html' +
                w.node.attributes(w.$html.get(0)) +
                '>' +
            ...
            (w.opts.heightMin = null),
              ...
              w.size.refresh(),
              (n += '<html' + w.node.attributes(w.$html.get(0)) + '>' + w.$html.html() + '</html>'),
              (w.opts.heightMin = y),
              (w.opts.height = L),
              (w.opts.heightMax = _),
              w.size.refresh(),
          ...
          if (!w.opts.useClasses && !t)
            for (r = 0; r < a.length; r++)
              a[r].getAttribute('fr-original-class') &&
                (a[r].setAttribute('class', a[r].getAttribute('fr-original-class')),
                a[r].removeAttribute('fr-original-class')),
                null != a[r].getAttribute('fr-original-style') &&
                void 0 !== a[r].getAttribute('fr-original-style')
                  ? (0 !== a[r].getAttribute('fr-original-style').length
                      ? a[r].setAttribute('style', a[r].getAttribute('fr-original-style'))
                      : a[r].removeAttribute('style'),
                    a[r].removeAttribute('fr-original-style'))
                  : a[r].removeAttribute('style');
          w.opts.fullPage &&
            (n = (n = (n = (n = (n = (n = (n = (n = n.replace(
              /<style data-fr-style="true">(?:[\w\W]*?)<\/style>/g,
              ''
            )).replace(/<link([^>]*)data-fr-style="true"([^>]*)>/g, '')).replace(
            ...
            n = function(e, t) {
              for (
                ...
                t &&
                  ...
                  Ee(e).wrapInner(w.node.openTagString(t) + w.node.closeTagString(t)),
                  (t = t.parentNode);
          ...
          if ('undefined' != typeof w.win.getSelection) {
            w.browser.mozilla &&
              ...
              1 < w.$el.find('.fr-marker[data-type="false"]').length &&
                (w.$el.find('.fr-marker[data-type="false"][data-id="0"]').remove(),
            ...
            for (var i = w.selection.ranges(), a = 0; a < i.length; a++) {
              ...
              o.appendChild(i[a].cloneContents()),
                n(
                  ...
                  (t = null),
                  w.win.getSelection
                    ? (e = w.win.getSelection()) &&
                      e.rangeCount &&
                      (t = e.getRangeAt(0).commonAncestorContainer).nodeType != Node.ELEMENT_NODE &&
                      (t = t.parentNode)
                    : (e = w.doc.selection) &&
                      'Control' != e.type &&
                      (t = e.createRange().parentElement()),
                  null != t && (0 <= Ee.inArray(w.el, Ee(t).parents()) || t == w.el) ? t : null)
                ),
                0 < Ee(o).find('.fr-element').length && (o = w.el),
                (r += o.innerHTML);
            }
          } else
            'undefined' != typeof w.doc.selection &&
              'Text' == w.doc.selection.type &&
              (r = w.doc.selection.createRange().htmlText);
          return r;
        },
        insert: function(e, t, n) {
          ...
          if (
            ...
            e.indexOf('class="fr-marker"') < 0 &&
              ((i = r),
              ((a = w.doc.createElement('div')).innerHTML = i),
              w.selection.setAtEnd(a, !0),
              (r = a.innerHTML)),
                ...
                if (
                  (s &&
                    ...
                    (r = (function(e) {
                      ...
                      t.innerHTML = e;
                      for (
                        var n = t.querySelectorAll(':scope > ' + w.html.defaultTag()),
                          r = n.length - 1;
                        0 <= r;
                        r--
                      ) {
                        var i = n[r];
                        w.node.isBlock(i.previousSibling) ||
                          (i.previousSibling &&
                            !w.node.isEmpty(i) &&
                            Ee('<br>').insertAfter(i.previousSibling),
                          (i.outerHTML = i.innerHTML));
                      }
                      return t.innerHTML;
                    })(r)),
        ...
        unwrap: function() {
          w.$el.find('div.fr-temp-div').each(function() {
            this.previousSibling &&
              ...
              Ee(this).before('<br>'),
              Ee(this).attr('data-empty') ||
              !this.nextSibling ||
              (w.node.isBlock(this.nextSibling) && !Ee(this.nextSibling).hasClass('fr-temp-div'))
                ? Ee(this).replaceWith(Ee(this).html())
                : Ee(this).replaceWith(Ee(this).html() + '<br>');
          }),
            w.$el
              .find('.fr-temp-div')
    ...
    Ee.extend(Ee.FE.DEFAULTS, { height: null, heightMax: null, heightMin: null, width: null }),
    (Ee.FE.MODULES.size = function(e) {
      ...
      function n() {
        e.opts.heightMin ? e.$el.css('minHeight', e.opts.heightMin) : e.$el.css('minHeight', ''),
          e.opts.heightMax
            ? (e.$wp.css('maxHeight', e.opts.heightMax), e.$wp.css('overflow', 'auto'))
            : (e.$wp.css('maxHeight', ''), e.$wp.css('overflow', '')),
          e.opts.height
            ? (e.$wp.height(e.opts.height),
    ...
    Ee.extend(Ee.FE.DEFAULTS, { language: null }),
    (Ee.FE.LANGUAGE = {}),
    ...
    Ee.extend(Ee.FE.DEFAULTS, { placeholderText: 'Type something' }),
    (Ee.FE.MODULES.placeholder = function(f) {
      function e() {
        f.$placeholder ||
          ((f.$placeholder = Ee('<span class="fr-placeholder"></span>')),
        ...
        if (s.length && s[0].nodeType == Node.ELEMENT_NODE) {
          ...
          (!f.opts.toolbarInline || 0 < f.$el.prev().length) &&
            ...
            (i = f.helpers.getPX(d.css('padding-top'))),
            (n = f.helpers.getPX(d.css('margin-left'))),
            (r = f.helpers.getPX(d.css('margin-right'))),
            (a = f.helpers.getPX(d.css('padding-left'))),
            (o = f.helpers.getPX(d.css('padding-right')))),
        ...
        if (
          ...
          (f.opts.heightMin = f.$placeholder.outerHeight() + (f.$tb ? f.$tb.height() : 0)),
            f.size.refresh(),
            (f.opts.heightMin = c);
        }
      }
        ...
        on: function() {
          t.$wp
            ? (t.$el.attr('contenteditable', !0),
              ...
              t.$tb && t.$tb.removeClass('fr-disabled').removeAttr('aria-disabled'),
              e())
          ...
          t.events.disableBlur(),
            t.$wp
              ? (t.$el.attr('contenteditable', !1),
                ...
                t.$tb && t.$tb.addClass('fr-disabled').attr('aria-disabled', !0))
    ...
    (Ee.FE.MODULES.core = function(d) {
      ...
      function t() {
        ...
        'auto' != d.opts.direction &&
          d.$box.removeClass('fr-ltr fr-rtl').addClass('fr-' + d.opts.direction),
      ...
      return {
        _init: function() {
          if (
            ...
            t(),
              ...
              d.helpers.isMobile() &&
                (d.$el.attr('autocomplete', d.opts.spellcheck ? 'on' : 'off'),
                d.$el.attr('autocorrect', d.opts.spellcheck ? 'on' : 'off'),
                d.$el.attr('autocapitalize', d.opts.spellcheck ? 'on' : 'off')),
          ...
          'TEXTAREA' == d.$oel.get(0).tagName && d.$oel.val(e),
            ...
            d.$wp &&
              ('TEXTAREA' == d.$oel.get(0).tagName
                ...
                : (d.$wp.replaceWith(e),
                  d.$el.html(''),
                  d.$box.removeClass('fr-view fr-ltr fr-box ' + (d.opts.editorClass || '')),
                  d.opts.theme && d.$box.addClass(d.opts.theme + '-theme'))),
            (this.$wp = null),
            (this.$el = null),
            (this.el = null),
        ...
        getXHR: function(e, t) {
          ...
          d.opts.requestWithCredentials && (n.withCredentials = !0),
          d.opts.requestHeaders))
            d.opts.requestHeaders.hasOwnProperty(r) &&
              n.setRequestHeader(r, d.opts.requestHeaders[r]);
          return n;
        },
        injectStyle: function(e) {
          if (d.opts.iframe) {
            ...
            for (
              var t = Ee('<style data-fr-style="true">' + e + '</style>').appendTo(d.$head)[0]
                  .sheet,
                n = 0;
              n < c.length;
              n++
              ...
              for (
                var r = t.insertRule(c[n].selector + '{}', t.cssRules.length), i = 0;
                i < c[n].style.length;
                i++
              ) {
                var a = c[n].style[i],
                  o = c[n].style[a];
                d.browser.safari && 'content' === a && (o = '"' + o + '"'),
                  (t.cssRules[r].style[a] = o);
              }
            for (var s = 0; s < d.opts.iframeStyleFiles.length; s++) {
              var l = Ee(
                '<link data-fr-style="true" rel="stylesheet" href="' +
                  d.opts.iframeStyleFiles[s] +
                  '">'
              );
        ...
        hasFocus: function() {
          return d.browser.mozilla && d.helpers.isMobile()
            ? d.selection.inEditor()
            : d.node.hasFocus(d.el) || 0 < d.$el.find('*:focus').length;
        },
      ...
      return {
        _startEnter: function(e) {
          ...
          if (g.node.isEmpty(n, !0) && r) {
            ...
            for (
              d =
                l.parentNode && 'LI' == l.parentNode.tagName
                  ? s + '<li>' + Ee.FE.MARKERS + '<br>' + o
                  : a
                    ? s + '<' + a + '>' + Ee.FE.MARKERS + '<br></' + a + '>' + o
                    : s + Ee.FE.MARKERS + '<br>' + o;
            ...
            (t = v(n)).parentNode && 'LI' == t.parentNode.tagName
              ? r
                ? Ee(t.parentNode).before(g.node.openTagString(n) + Ee.FE.MARKERS + '<br></li>')
                : Ee(t.parentNode).after(g.node.openTagString(n) + Ee.FE.MARKERS + '<br></li>')
              : a
                ? Ee(t).before('<' + a + '>' + Ee.FE.MARKERS + '<br></' + a + '>')
                : Ee(t).before(Ee.FE.MARKERS + '<br>'),
              Ee(n).remove();
        },
        _middleEnter: function(e) {
          for (var t = m(e), n = '', r = e, i = '', a = ''; r != t; ) {
            var o =
              'A' == (r = r.parentNode).tagName && g.cursor.isAtEnd(e, r) ? 'fr-to-remove' : '';
            (i =
          ...
          (n =
            a + n + i + Ee.FE.MARKERS + (g.opts.keepFormatOnDelete ? Ee.FE.INVISIBLE_SPACE : '')),
            Ee(e).replaceWith('<span id="fr-break"></span>');
        ...
        _endEnter: function(e) {
          for (var t = m(e), n = Ee.FE.MARKERS, r = '', i = e, a = !1; i != t; ) {
            var o =
              'A' == (i = i.parentNode).tagName && g.cursor.isAtEnd(e, i) ? 'fr-to-remove' : '';
          ...
          if (n) {
            ...
            r.length && 'BR' == r[r.length - 1].tagName && Ee(r[r.length - 1]).remove(),
              Ee(t)
                ...
                .each(function() {
                  this.parentNode == t &&
                    Ee(this).replaceWith(Ee(this).html() + (g.node.isEmpty(this) ? '' : '<br>'));
                });
              ...
              g.node.isBlock(s)
                ? (Ee(t)
                    ...
                    .each(function() {
                      this.parentNode == t &&
                        Ee(this).replaceWith(
                          Ee(this).html() + (g.node.isEmpty(this) ? '' : '<br>')
                        );
                    }),
                  Ee(s).append(Ee(t).html()))
                : Ee(o).before(Ee(t).html());
            } else {
              var l = g.html.defaultTag();
              l && 0 === Ee(t).find(g.html.blockTagsQuery()).length
                ? Ee(o).before('<' + l + '>' + Ee(t).html() + '</' + l + '>')
                : Ee(o).before(Ee(t).html());
            }
        ...
        _del: function(e) {
          var t,
            ...
            r = n.nextSibling;
          if (r) {
            (t = g.node.contents(r)).length && 'BR' == t[0].tagName && Ee(t[0]).remove(),
              Ee(r)
                .find(g.html.blockTagsQuery())
                .not('ol, ul, table')
                .each(function() {
            ...
            if (((s = s.nextSibling), g.node.isBlock(s)))
              Ee.FE.NO_DELETE_TAGS.indexOf(s.tagName) < 0 &&
                (Ee(e).replaceWith(Ee.FE.MARKERS),
                (t = g.node.contents(n)).length &&
                  'BR' == t[t.length - 1].tagName &&
                  Ee(t[t.length - 1]).remove(),
                Ee(n).append(Ee(s).html()),
                Ee(s).remove());
            else
              for (
                (t = g.node.contents(n)).length &&
    ...
    (Ee.FE.NO_DELETE_TAGS = ['TH', 'TD', 'TR', 'TABLE', 'FORM']),
    (Ee.FE.SIMPLE_ENTER_TAGS = ['TH', 'TD', 'LI', 'DL', 'DT', 'FORM']),
    (Ee.FE.MODULES.cursor = function(u) {
      function a(e) {
        return (
          !!e &&
          (!!u.node.isBlock(e) ||
            ...
            0 === e.nextSibling.textContent.replace(/\u200b/g, '').length
              ...
              : !(
                  e.nextSibling &&
                  (!e.previousSibling || 'BR' != e.nextSibling.tagName || e.nextSibling.nextSibling)
                ) && a(e.parentNode)))
        );
      }
      function o(e) {
        return (
          ...
          (!!u.node.isBlock(e) ||
            ...
            0 === e.previousSibling.textContent.replace(/\u200b/g, '').length
              ? o(e.previousSibling)
              : !e.previousSibling &&
                (!(e.previousSibling || !u.node.hasClass(e.parentNode, 'fr-inner')) ||
                  o(e.parentNode))))
        );
      }
      function h(e, t) {
        return (
          ...
          (e != u.$wp.get(0) &&
            ...
            e.previousSibling.nodeType == Node.TEXT_NODE &&
            0 === e.previousSibling.textContent.replace(/\u200b/g, '').length
              ? h(e.previousSibling, t)
              : !e.previousSibling && (e.parentNode == t || h(e.parentNode, t))))
        );
      }
      function g(e, t) {
        return (
      ...
      function s(e) {
        return (
          0 < Ee(e).parentsUntil(u.$el, 'LI').length &&
          0 === Ee(e).parentsUntil('LI', 'TABLE').length
        );
      }
      function d(e, t) {
        var n = new RegExp(
      ...
      function c(e) {
        ...
        if (((n = n.previousSibling), !u.node.isBlock(n) && u.node.isEditable(n))) {
          ...
          if (n.nodeType == Node.TEXT_NODE) {
            ...
            if (r.length && '\n' === r[r.length - 1])
              return (
                (n.textContent = r.substring(0, i - 2)),
            ...
            if (u.opts.tabSpaces && r.length >= u.opts.tabSpaces)
              0 ===
                r
                  ...
                  .replace(/ /g, '')
                  .replace(new RegExp(Ee.FE.UNICODE_NBSP, 'g'), '').length &&
                (i = r.length - u.opts.tabSpaces + 1);
            (n.textContent = r.substring(0, i - d(r))),
              u.opts.htmlUntouched &&
                ...
                (n.textContent =
                  n.textContent.substring(0, n.textContent.length - 1) + Ee.FE.UNICODE_NBSP);
            var a = r.length != n.textContent.length;
            if (0 === n.textContent.length)
              if (a && u.opts.keepFormatOnDelete)
                Ee(n).after(Ee.FE.INVISIBLE_SPACE + Ee.FE.MARKERS);
              else if (0 !== r.length && u.node.isBlock(n.parentNode)) Ee(n).after(Ee.FE.MARKERS);
              else if (
                ((2 != n.parentNode.childNodes.length || n.parentNode != e.parentNode) &&
                ...
                for (
                  ...
                  Ee.FE.NO_DELETE_TAGS.indexOf(n.parentNode.tagName) < 0;
            ...
            u.node.isDeletable(n)
              ? (Ee(n).after(Ee.FE.MARKERS), Ee(n).remove())
              : e.nextSibling &&
                'BR' == e.nextSibling.tagName &&
                u.node.isVoid(n) &&
                'BR' != n.tagName
                ? (Ee(e.nextSibling).remove(), Ee(e).replaceWith(Ee.FE.MARKERS))
                : !1 !== u.events.trigger('node.remove', [Ee(n)]) &&
                  (Ee(n).after(Ee.FE.MARKERS), Ee(n).remove());
        } else if (
          Ee.FE.NO_DELETE_TAGS.indexOf(n.tagName) < 0 &&
          ...
          if (u.node.isDeletable(n)) Ee(e).replaceWith(Ee.FE.MARKERS), Ee(n).remove();
            ...
            Ee(n).remove(), Ee(e).replaceWith(Ee.FE.MARKERS);
          else {
            for (
              u.node.isList(n) &&
                (n = Ee(n)
      ...
      function l(e) {
        ...
        if (null !== n) {
          ...
          if (
            ...
            (u.node.isEditable(n) || u.node.isDeletable(n)) &&
            a &&
            Ee.FE.NO_DELETE_TAGS.indexOf(a.tagName) < 0
          )
            if (u.node.isDeletable(a)) Ee(a).remove(), Ee(e).replaceWith(Ee.FE.MARKERS);
              ...
              if (u.node.isList(a))
                if (u.node.isEmpty(n, !0))
                  Ee(n).remove(),
                    Ee(a)
                      .find('li:first')
                      .prepend(Ee.FE.MARKERS);
                else {
                  var o = Ee(a).find('li:first');
                  'BLOCKQUOTE' == n.tagName &&
                    (i = u.node.contents(n)).length &&
                    u.node.isBlock(i[i.length - 1]) &&
                    (n = i[i.length - 1]),
                    0 === o.find('ul, ol').length &&
                      (Ee(e).replaceWith(Ee.FE.MARKERS),
                      o
                        .find(u.html.blockTagsQuery())
                        .not('ol, ul, table')
                        .each(function() {
                          this.parentNode == o.get(0) &&
                            Ee(this).replaceWith(
                              Ee(this).html() + (u.node.isEmpty(this) ? '' : '<br>')
                            );
                        }),
                      Ee(n).append(u.node.contents(o.get(0))),
                      o.remove(),
                      0 === Ee(a).find('li').length && Ee(a).remove());
                }
              else {
                if (
                  ((i = u.node.contents(a)).length && 'BR' == i[0].tagName && Ee(i[0]).remove(),
              ...
              for (
                Ee(e).replaceWith(Ee.FE.MARKERS);
                a && 'BR' !== a.tagName && !u.node.isBlock(a) && u.node.isEditable(a);
      ...
      function n(e) {
        ...
        if ('BR' == (n = n.nextSibling).tagName && u.node.isEditable(n))
          if (n.nextSibling) {
            if (u.node.isBlock(n.nextSibling) && u.node.isEditable(n.nextSibling)) {
              if (!(Ee.FE.NO_DELETE_TAGS.indexOf(n.nextSibling.tagName) < 0))
                return void Ee(n).remove();
              ...
              u.node.deepestParent(n) &&
                ((!u.node.isEmpty(u.node.blockParent(n)) ||
                  (u.node.blockParent(n).nextSibling &&
                    Ee.FE.NO_DELETE_TAGS.indexOf(u.node.blockParent(n).nextSibling.tagName)) < 0) &&
                  Ee(n).remove(),
                l(e));
            return;
          }
        if (!u.node.isBlock(n) && u.node.isEditable(n)) {
          ...
          n.nodeType == Node.TEXT_NODE
            ...
            : u.node.isDeletable(n)
              ? (Ee(n).before(Ee.FE.MARKERS), Ee(n).remove())
              : !1 !== u.events.trigger('node.remove', [Ee(n)]) &&
                (Ee(n).before(Ee.FE.MARKERS), Ee(n).remove()),
            Ee(e).remove();
        } else if (
          ...
          if (u.node.isDeletable(n)) Ee(e).replaceWith(Ee.FE.MARKERS), Ee(n).remove();
            ...
            ((t = u.node.contents(n)) && t.length && 'BR' == t[0].tagName && Ee(t[0]).remove(),
      ...
      function p(e, t, n) {
        ...
        if (i && 'BLOCKQUOTE' == i.tagName)
          return (
            g(e, i)
              ? ((r = u.html.defaultTag()),
                t
                  ? Ee(e).replaceWith('<br>' + Ee.FE.MARKERS)
                  : r
                    ? Ee(i).after('<' + r + '>' + Ee.FE.MARKERS + '<br></' + r + '>')
                    : Ee(i).after(Ee.FE.MARKERS + '<br>'),
                Ee(e).remove())
              : m(e, t, n),
            !1
          );
        if (null == i)
          (r = u.html.defaultTag()) && u.node.isElement(e.parentNode)
            ? Ee(e).replaceWith('<' + r + '>' + Ee.FE.MARKERS + '<br></' + r + '>')
            : !e.previousSibling || Ee(e.previousSibling).is('br') || e.nextSibling
              ? Ee(e).replaceWith('<br>' + Ee.FE.MARKERS)
              : Ee(e).replaceWith('<br>' + Ee.FE.MARKERS + '<br>');
        else {
          var a = e,
            o = '';
          'PRE' != i.tagName || e.nextSibling || (t = !0),
          ...
          (r = u.html.defaultTag()) &&
            ...
            ((c = '<' + r + '>'),
            (f = '</' + r + '>'),
            i.tagName == r.toUpperCase() &&
              (c = u.node.openTagString(
                Ee(i)
                  .clone()
                  .removeAttr('id')
                  .get(0)
          ...
          (o =
            ...
            o +
            d +
            (e.parentNode == i && u.node.isBlock(i) ? '' : Ee.FE.INVISIBLE_SPACE) +
            Ee.FE.MARKERS),
            u.node.isBlock(i) &&
              !Ee(i)
                .find('*:last')
            ...
            Ee(e).remove(),
            (i.nextSibling && !u.node.isBlock(i.nextSibling)) ||
              u.node.isBlock(i) ||
              Ee(i).after('<br>'),
            (s = (s =
              !t && u.node.isBlock(i)
                ? u.node.openTagString(i) + Ee(i).html() + f
                : u.node.openTagString(i) + Ee(i).html() + u.node.closeTagString(i)).replace(
              /<span id="fr-break"><\/span>/g,
              o
            )),
            Ee(i).replaceWith(s);
      ...
      function m(e, t, n) {
        ...
        if (null == r)
          u.html.defaultTag() && e.parentNode === u.el
            ...
            : ((e.nextSibling && !u.node.isBlock(e.nextSibling)) || Ee(e).after('<br>'),
              Ee(e).replaceWith('<br>' + Ee.FE.MARKERS));
        else {
          var i = e,
            a = '';
          ...
          do {
            ...
            if (
              ...
              'BLOCKQUOTE' == r.tagName &&
                ...
                0 < Ee(l).find(e).length &&
                Ee(l).after(e),
              'BLOCKQUOTE' != r.tagName || (!g(e, i) && !h(e, i)))
            )
          ...
          if ('BLOCKQUOTE' == r.tagName)
            if (
              (e.previousSibling &&
                ...
                e.nextSibling &&
                'BR' == e.nextSibling.tagName &&
                (Ee(e.nextSibling).after(e),
                e.nextSibling && 'BR' == e.nextSibling.tagName && Ee(e.nextSibling).remove()),
              t)
            )
              a = o + a + Ee.FE.MARKERS + s;
            else {
        ...
        enter: function(t) {
          ...
          for (var r = n.parentNode; r && !u.node.isElement(r); ) {
            if ('false' === r.getAttribute('contenteditable'))
              return Ee(n).replaceWith(Ee.FE.MARKERS), u.selection.restore(), !1;
            if ('true' === r.getAttribute('contenteditable')) break;
            r = r.parentNode;
          }
          u.el.normalize();
          var i = !1;
          0 < Ee(n).parentsUntil(u.$el, 'BLOCKQUOTE').length && (i = !0),
            Ee(n).parentsUntil(u.$el, 'TD, TH').length && (i = !1),
            a(n)
              ? !s(n) || t || i
                ? p(n, t, i)
                      ...
                      if (a && 'BLOCKQUOTE' == a.tagName)
                        if (h(t, a)) {
                          if (!n)
                            return (
                              (i = u.html.defaultTag())
                                ? Ee(a).before('<' + i + '>' + Ee.FE.MARKERS + '<br></' + i + '>')
                                : Ee(a).before(Ee.FE.MARKERS + '<br>'),
                              Ee(t).remove(),
                              !1
                            );
                        } else g(t, a) ? p(t, n, !0) : m(t, n, !0);
                      if (null == a)
                        (i = u.html.defaultTag()) && u.node.isElement(t.parentNode)
                          ? Ee(t).replaceWith('<' + i + '>' + Ee.FE.MARKERS + '<br></' + i + '>')
                          : Ee(t).replaceWith('<br>' + Ee.FE.MARKERS);
                      else {
                        if (u.node.isBlock(a))
                          if (('PRE' == a.tagName && (n = !0), n))
                            Ee(t).remove(), Ee(a).prepend('<br>' + Ee.FE.MARKERS);
                          else {
                            if (u.node.isEmpty(a, !0)) return p(t, n, r);
                            if (u.opts.keepFormatOnDelete) {
                              for (
                                var o = t, s = Ee.FE.INVISIBLE_SPACE;
                                o != a && !u.node.isElement(o);
            ...
            u.$el.find('.fr-to-remove').each(function() {
              for (var e = u.node.contents(this), t = 0; t < e.length; t++)
                e[t].nodeType == Node.TEXT_NODE &&
                  (e[t].textContent = e[t].textContent.replace(/\u200B/g, ''));
              Ee(this).replaceWith(this.innerHTML);
            }),
            u.html.fillEmptyBlocks(!0),
            u.opts.htmlUntouched ||
              (u.html.cleanEmptyTags(), u.clean.lists(), u.spaces.normalizeAroundCursor()),
            u.selection.restore();
        },
        backspace: function() {
          var e = !1,
          ...
          for (var n = t.parentNode; n && !u.node.isElement(n); ) {
            if ('false' === n.getAttribute('contenteditable'))
              return Ee(t).replaceWith(Ee.FE.MARKERS), u.selection.restore(), !1;
          ...
          if (r) {
            ...
            i &&
              i.length &&
              8203 == i.charCodeAt(i.length - 1) &&
              (1 == i.length
                ? Ee(r).remove()
                : (r.textContent = r.textContent.substr(0, i.length - d(i))));
          }
          return (
            a(t)
              ? s(t) &&
                ...
                ? s(t) &&
                  ...
                  : (function(e) {
                      for (
                        ...
                        !u.node.hasClass(n.parentElement, 'fr-inner') &&
                        Ee.FE.SIMPLE_ENTER_TAGS.indexOf(n.parentElement.tagName) < 0;

                      )
                        n = n.parentElement;
                      if (n && 'BLOCKQUOTE' == n.tagName) {
                        var i = u.node.deepestParent(e, [
                          Ee(e)
                            .parentsUntil(u.$el, 'BLOCKQUOTE')
                            .get(0),
                        ]);
                        ...
                        if (u.node.isBlock(n) && u.node.isEditable(n))
                          if (o && Ee.FE.NO_DELETE_TAGS.indexOf(o.tagName) < 0) {
                            if (u.node.isDeletable(o))
                              Ee(o).remove(), Ee(e).replaceWith(Ee.FE.MARKERS);
                            else if (u.node.isEditable(o))
                              if (u.node.isBlock(o))
                                if (u.node.isEmpty(o) && !u.node.isList(o))
                                  Ee(o).remove(),
                                    Ee(e).after(
                                      u.opts.keepFormatOnDelete ? Ee.FE.INVISIBLE_SPACE : ''
                                    );
                                else {
                                  if (
                                    (u.node.isList(o) &&
                                    ...
                                    (a = u.node.contents(o)).length &&
                                      'BR' == a[a.length - 1].tagName &&
                                      Ee(a[a.length - 1]).remove(),
                                    'BLOCKQUOTE' == o.tagName && 'BLOCKQUOTE' != n.tagName)
                                  )
                                    for (
                                      a = u.node.contents(o);
                                      a.length && u.node.isBlock(a[a.length - 1]);
                                  ...
                                  if (u.node.isEmpty(n))
                                    Ee(e).remove(), u.selection.setAtEnd(o, !0);
                                  else {
                                    Ee(e).replaceWith(Ee.FE.MARKERS);
                                    var s = o.childNodes;
                                    u.node.isBlock(s[s.length - 1])
                                      ? Ee(s[s.length - 1]).append(r.innerHTML)
                                      : Ee(o).append(r.innerHTML);
                                  }
                                  Ee(r).remove(), u.node.isEmpty(n) && Ee(n).remove();
                                }
                              else
                                Ee(e).replaceWith(Ee.FE.MARKERS),
                                  'BLOCKQUOTE' == n.tagName && o.nodeType == Node.ELEMENT_NODE
                                    ? Ee(o).remove()
                                    : (Ee(o).after(u.node.isEmpty(n) ? '' : Ee(n).html()),
                                      Ee(n).remove(),
                                      'BR' == o.tagName && Ee(o).remove());
                          } else
                            o ||
                              (n &&
                                'BLOCKQUOTE' === n.tagName &&
    ...
    Ee.extend(Ee.FE.DEFAULTS, { enter: Ee.FE.ENTER_P, multiLine: !0, tabSpaces: 0 }),
    (Ee.FE.MODULES.keys = function(l) {
      ...
      function e() {
        if (l.browser.mozilla && l.selection.isCollapsed() && !c) {
          ...
          t &&
            ...
            (l.selection.save(), l.spaces.normalize(), l.selection.restore());
        }
      }
      function t() {
        l.selection.isFull() &&
          setTimeout(function() {
            ...
            e
              ? l.$el.html('<' + e + '>' + Ee.FE.MARKERS + '<br/></' + e + '>')
              : l.$el.html(Ee.FE.MARKERS + '<br/>'),
              l.selection.restore(),
      ...
      function o(e) {
        ...
        if (
          ((!(h(e) || (e.shiftKey && (33 === n || 34 === n || 35 === n || 36 === n))) &&
            l.selection.isFull() &&
            !l.opts.keepFormatOnDelete &&
        ...
        n == Ee.FE.KEYCODE.ENTER
          ? e.shiftKey
            ? ((a = e).preventDefault(),
              a.stopPropagation(),
              l.opts.multiLine &&
                (l.selection.isCollapsed() || l.selection.remove(), l.cursor.enter(!0)))
            : ((i = e),
              l.opts.multiLine
                ? (l.helpers.isIOS() || (i.preventDefault(), i.stopPropagation()),
                  l.selection.isCollapsed() || l.selection.remove(),
                  l.cursor.enter())
                : (i.preventDefault(), i.stopPropagation()))
          : n === Ee.FE.KEYCODE.BACKSPACE && (e.metaKey || e.ctrlKey)
            ? setTimeout(function() {
                l.events.disableBlur(), l.events.focus();
              }, 0)
            : n != Ee.FE.KEYCODE.BACKSPACE || h(e) || e.altKey
              ? n != Ee.FE.KEYCODE.DELETE || h(e) || e.altKey || e.shiftKey
                ? n == Ee.FE.KEYCODE.SPACE
                  ? (function(e) {
                      var t = l.selection.element();
                ...
                : l.placeholder.isVisible()
                  ...
                  : ((r = e).preventDefault(),
                    r.stopPropagation(),
                    '' === l.selection.text() ? l.cursor.del() : l.selection.remove(),
                    l.placeholder.refresh())
              : l.placeholder.isVisible()
                ? (l.opts.keepFormatOnDelete || f(), e.preventDefault(), e.stopPropagation())
                : (function(e) {
      ...
      function s() {
        ...
        l.opts.height || l.opts.heightMax
          ? ((e = l.position.getBoundingRect().top),
            ...
            e > l.$wp.offset().top - l.helpers.scrollTop() + l.$wp.height() - 20 &&
              l.$wp.scrollTop(
                e +
                  l.$wp.scrollTop() -
                  (l.$wp.height() + l.$wp.offset().top) +
                  l.helpers.scrollTop() +
                  20
              ))
          : ((e = l.position.getBoundingRect().top),
            ...
            l.opts.iframe && ((e += l.$iframe.offset().top), (e -= l.helpers.scrollTop())),
            (e += l.opts.toolbarStickyOffset) > l.o_win.innerHeight - 20 &&
              Ee(l.o_win).scrollTop(e + l.helpers.scrollTop() - l.o_win.innerHeight + 20),
            (e = l.position.getBoundingRect().top),
            l.opts.toolbarBottom || (e -= l.opts.toolbarStickyOffset),
            l.opts.iframe && ((e += l.$iframe.offset().top), (e -= l.helpers.scrollTop())),
            e < l.$tb.height() + 20 &&
              Ee(l.o_win).scrollTop(e + l.helpers.scrollTop() - l.$tb.height() - 20));
      }
      function p() {
        var e,
      ...
      function u(e) {
        ...
        if (c) return !1;
        if (
          (e && l.helpers.isIOS() && e.which == Ee.FE.KEYCODE.ENTER && l.doc.execCommand('undo'),
          !l.selection.isCollapsed())
        )
          return !0;
        ...
        if (
          e &&
          !l.helpers.isIOS() &&
          (e.which == Ee.FE.KEYCODE.ENTER ||
            e.which == Ee.FE.KEYCODE.BACKSPACE ||
            (37 <= e.which && e.which <= 40 && !l.browser.msie))
        )
          try {
            s();
          } catch (n) {}
      ...
      function v(e) {
        ...
        if (
          ...
          (37 <= t && t <= 40) ||
          (!m(t) &&
            t != Ee.FE.KEYCODE.DELETE &&
            t != Ee.FE.KEYCODE.BACKSPACE &&
            t != Ee.FE.KEYCODE.ENTER &&
            t != Ee.FE.KEYCODE.IME)
        )
          return !0;
      ...
      function E(e) {
        ...
        r && n
          ? (l.undo.saveStep(r), (r = null))
          : (void 0 !== t && 0 !== t) || r || n || l.undo.saveStep();
      }
      function b(e) {
          ...
          return (
            ...
            (e.childNodes &&
              ...
              ('false' == e.childNodes[0].getAttribute('contenteditable') ||
                l.node.hasClass(e.childNodes[0], 'fr-img-caption')))
          );
        } catch (t) {
          return !1;
        }
      ...
      function T(e) {
        ...
        return (
          ...
          (0 === t.length ||
            void (l.$el.outerHeight() - e.offsetY <= 10
              ? b(t[t.length - 1]) &&
                (n
                  ? l.$el.append('<' + n + '>' + Ee.FE.MARKERS + '<br></' + n + '>')
                  : l.$el.append(Ee.FE.MARKERS + '<br>'),
                l.selection.restore(),
                s())
              : e.offsetY <= 10 &&
                b(t[0]) &&
                (n
                  ? l.$el.prepend('<' + n + '>' + Ee.FE.MARKERS + '<br></' + n + '>')
                  : l.$el.prepend(Ee.FE.MARKERS + '<br>'),
                l.selection.restore(),
                s())))
        );
      }
      ...
      return {
        _init: function() {
          l.events.on('keydown', v),
            ...
            l.events.on('keyup', u),
            l.events.on('destroy', A),
            l.events.on('html.inserted', u),
            l.events.on('cut', t),
            l.opts.multiLine && l.events.on('click', T);
        },
        ctrlKey: h,
        isCharacter: m,
        isArrow: g,
    ...
    (Ee.FE.MODULES.accessibility = function(f) {
      ...
      function v() {
        f.shared.$f_el && (f.events.disableBlur(), f.shared.$f_el.blur(), (f.shared.$f_el = null)),
          !1 !== f.events.trigger('toolbar.focusEditor') &&
            (f.events.disableBlur(), f.browser.msie || f.$el.focus(), f.events.focus());
      }
      function r(r) {
        r &&
          r.length &&
          (f.events.$on(
            ...
            'keydown',
            function(e) {
              if (!Ee(e.target).is('a.fr-command, button.fr-command, .fr-group span.fr-command'))
                return !0;
      ...
      return {
            ...
            (c = f.popups.get(d)),
            {
              _tiKeydown: function(e) {
                ...
                if (Ee.FE.KEYCODE.TAB == n) {
                  ...
                  if (0 <= o && o < a.length)
                    return t.events.disableBlur(), Ee(a[o]).focus(), e.stopPropagation(), !1;
                  var s = c.find('.fr-buttons');
                  if (s.length && p(s, !!e.shiftKey)) return e.stopPropagation(), !1;
                  if (u(i)) return e.stopPropagation(), !1;
                } else {
                  if (Ee.FE.KEYCODE.ENTER != n || !e.target || 'TEXTAREA' === e.target.tagName)
                    return Ee.FE.KEYCODE.ESC == n
                      ? (e.preventDefault(),
                        e.stopPropagation(),
                        ...
                        t.popups.isVisible(d) && c.find('.fr-back:visible').length
                          ? (t.opts.toolbarInline && (t.events.disableBlur(), t.events.focus()),
                            t.button.exec(c.find('.fr-back:visible:first')),
                            E(c))
                          : t.popups.isVisible(d) && c.find('.fr-dismiss:visible').length
                            ...
                            : (t.popups.hide(d),
                              ...
                              E(c)),
                        !1)
                      : Ee.FE.KEYCODE.SPACE == n && (r.is('.fr-submit') || r.is('.fr-dismiss'))
                        ? (e.preventDefault(),
                          e.stopPropagation(),
                          t.events.disableBlur(),
                          t.button.exec(r),
                        ...
                        : t.keys.isBrowserAction(e)
                          ...
                          : r.is('input[type=text], textarea')
                            ? void e.stopPropagation()
                            : Ee.FE.KEYCODE.SPACE == n &&
                              (r.is('.fr-link-attr') || r.is('input[type=file]'))
                              ? void e.stopPropagation()
                              : (e.stopPropagation(), e.preventDefault(), !1);
                  var l = null;
                  0 < c.find('.fr-submit:visible').length
                    ? (l = c.find('.fr-submit:visible:first'))
                    : c.find('.fr-dismiss:visible').length &&
                      (l = c.find('.fr-dismiss:visible:first')),
                    l &&
                      (e.preventDefault(),
                      e.stopPropagation(),
                      t.events.disableBlur(),
        ...
        focusPopup: function(r) {
          ...
          i.data('mouseenter-event-set') ||
            f.browser.msie ||
            (f.events.$on(i, 'mouseenter', '[tabIndex]', function(e) {
              var t = r.data('instance') || f;
              if (!a) return e.stopPropagation(), void e.preventDefault();
              var n = i.find(':focus:first');
              n.length &&
                !n.is('input, button, textarea, select') &&
                (t.events.disableBlur(), n.blur(), t.events.disableBlur(), t.events.focus());
            }),
        ...
        exec: function(e, t) {
          var n = -1 != navigator.userAgent.indexOf('Mac OS X') ? e.metaKey : e.ctrlKey,
            ...
            i = !1;
          return (
            r != Ee.FE.KEYCODE.TAB || n || e.shiftKey || e.altKey
              ? r != Ee.FE.KEYCODE.ARROW_RIGHT || n || e.shiftKey || e.altKey
                ? r != Ee.FE.KEYCODE.TAB || n || !e.shiftKey || e.altKey
                  ? r != Ee.FE.KEYCODE.ARROW_LEFT || n || e.shiftKey || e.altKey
                    ? r != Ee.FE.KEYCODE.ARROW_UP || n || e.shiftKey || e.altKey
                      ? r != Ee.FE.KEYCODE.ARROW_DOWN || n || e.shiftKey || e.altKey
                        ? (r != Ee.FE.KEYCODE.ENTER && r != Ee.FE.KEYCODE.SPACE) ||
                          n ||
                          e.shiftKey ||
                          e.altKey
                          ? r != Ee.FE.KEYCODE.ESC || n || e.shiftKey || e.altKey
                            ? r != Ee.FE.KEYCODE.F10 || n || e.shiftKey || !e.altKey || (i = l())
                            : (i = (function(e) {
                                if (f.shared.$f_el) {
                                  var t = d();
                                  return (
                                      ...
                                      : e.parent().find('.fr-back:visible').length
                                        ...
                                        : f.shared.$f_el.is('button, .fr-group span') &&
                                          (e.parent().is('.fr-popup')
                                            ? (f.accessibility.restoreSelection(),
                                              (f.shared.$f_el = null),
                                              !1 !== f.events.trigger('toolbar.esc') &&
                          ...
                          : (i = m())
                        : (i =
                            f.shared.$f_el && f.shared.$f_el.is('.fr-dropdown:not(.fr-active)')
                              ? m()
                              : g(!0))
                      : (i = g())
                    : (i = h(t))
        ...
        restoreSelection: function() {
          f.$el.find('.fr-marker').length &&
            (f.events.disableBlur(), f.selection.restore(), f.events.enableBlur());
        },
      };
    }),
    (Ee.FE.MODULES.format = function(g) {
      ...
      function m(e, t, n) {
        if (e) {
          ...
          if (e) {
            ...
            for (
              var r = Ee(l(t, n)).insertBefore(e), i = e;
              i &&
              !Ee(i).is('.fr-marker') &&
              0 === Ee(i).find('.fr-marker').length &&
              'UL' != i.tagName &&
              'OL' != i.tagName;
            ...
            if (i)
              (Ee(i).find('.fr-marker').length || 'UL' == i.tagName || 'OL' == i.tagName) &&
                m(i.firstChild, t, n);
            else {
      ...
      function n(e, t) {
        ...
        if ((void 0 === t && (t = {}), t.style && delete t.style, g.selection.isCollapsed())) {
          g.markers.insert(),
            g.$el
              .find('.fr-marker')
              .replaceWith(l(e, t) + Ee.FE.INVISIBLE_SPACE + Ee.FE.MARKERS + ('</' + e + '>')),
            g.selection.restore();
        } else {
          var r;
          g.selection.save(),
          ...
          for (n = 0; n < i.length; n++) {
            var a = Ee(i[n]);
            !0 === a.data('type')
              ? p(a.get(0).nextSibling, f(e, t)) && a.next().prepend(a)
              : p(a.get(0).previousSibling, f(e, t)) && a.prev().append(a);
          }
          g.selection.restore();
        }
      }
      function v(e, t, n, r) {
        ...
        if (e.parents(t).length || void 0 === t) {
          ...
          for (
            ;
            !g.node.isBlock(s.parent().get(0)) &&
            (void 0 === t || (void 0 !== t && !p(s.get(0), f(t, n))));

          )
            (a += g.node.closeTagString(s.get(0))),
          ...
          var d = s
            ...
            .replace(
              /<span id="mark"><\/span>/,
              a + g.node.closeTagString(s.get(0)) + o + l + a + g.node.openTagString(s.get(0)) + o
            );
          return (
            s.replaceWith(g.node.openTagString(s.get(0)) + d + g.node.closeTagString(s.get(0))), !0
          );
        }
        return !1;
      }
      function r(t, n) {
            ...
            if (
              (s.attr('data-cloned') ||
                ...
                ((l = s
                  ...
                  .addClass('fr-clone')),
                !0 === s.data('type')
                  ? s.attr('data-cloned', !0).after(l)
                  : s.attr('data-cloned', !0).before(l)),
              v(s, t, n, r))
            ) {
              i = !0;
              break;
        ...
        !(function e(t, n, r, i) {
            ...
            if (g.node.hasClass(s, 'fr-marker')) n = (n + 1) % 2;
              ...
              if (0 < Ee(s).find('.fr-marker').length) n = e(Ee(s), n, r, i);
                ...
                for (var l = Ee(s).find(r || '*:not(br)'), d = l.length - 1; 0 <= d; d--) {
                  var c = l[d];
                  g.node.isBlock(c) || g.node.isVoid(c) || (void 0 !== r && !p(c, f(r, i)))
                    ? g.node.isBlock(c) &&
                      void 0 === r &&
                      'TABLE' != s.tagName &&
                      g.node.clearAttributes(c)
                    : g.node.hasClass(c, 'fr-clone') || (c.outerHTML = c.innerHTML);
                }
                (void 0 === r && s.nodeType == Node.ELEMENT_NODE && !g.node.isVoid(s)) ||
                p(s, f(r, i))
                  ? g.node.isBlock(s)
                    ? void 0 === r &&
                      ...
                      g.node.isBlock(s) &&
                      'TABLE' != s.tagName &&
                      g.node.clearAttributes(s)
                    : g.node.hasClass(s, 'fr-clone') || (s.outerHTML = s.innerHTML)
                  : void 0 === r &&
                    s.nodeType == Node.ELEMENT_NODE &&
                    g.node.isBlock(s) &&
                    'TABLE' != s.tagName &&
          ...
          r &&
            g.$el
              .find('.fr-marker')
              .before(Ee.FE.INVISIBLE_SPACE)
              .after(Ee.FE.INVISIBLE_SPACE),
      ...
      function t(e, t) {
        ...
        if (g.selection.isCollapsed()) {
              ...
              (d['style*'] = e + ':'),
                ...
                t
                  ? ((s = Ee(
                    ...
                    r.replaceWith(s))
                  : r.replaceWith(Ee.FE.INVISIBLE_SPACE + Ee.FE.MARKERS);
            }
            g.html.cleanEmptyTags();
          } else
            g.node.isEmpty(l.get(0)) && l.is('span')
              ? (r.replaceWith(Ee.FE.MARKERS), l.css(e, t))
              : ((s = Ee(
                  '<span style="' +
                    e +
                    ': ' +
          ...
          if (
            (g.selection.save(),
            null == t || ('color' == e && 0 < g.$el.find('.fr-marker').parents('u, a').length))
          ) {
            ...
            for (n = 0; n < c.length; n++)
              if (!0 === (r = Ee(c[n])).data('type'))
                for (
                  ;
                  g.node.isFirstSibling(r.get(0)) &&
                  !r.parent().is(g.$el) &&
                  !g.node.isElement(r.parent().get(0)) &&
                  !g.node.isBlock(r.parent().get(0));
          ...
          for (
            t && (p.style = e + ': ' + t + ';'),
              m(f, 'span', p),
              g.$el.find('.fr-marker + .fr-unprocessed').each(function() {
              ...
              (t || '').match(/\dem$/) &&
                g.$el.find('span.fr-unprocessed').removeClass('fr-unprocessed');
            0 < g.$el.find('span.fr-unprocessed').length;

          ) {
            if (
              ((s = g.$el.find('span.fr-unprocessed:first').removeClass('fr-unprocessed'))
                .parent()
                .get(0)
                .normalize(),
        ...
        !(function() {
          ...
          for (e = 0; e < t.length; e++) {
            var n = Ee(t[e]),
              r = Ee(t[e]).prev();
            n.get(0).previousSibling == r.get(0) &&
              g.node.openTagString(n.get(0)) == g.node.openTagString(r.get(0)) &&
              (n.prepend(r.html()), r.remove());
          }
          g.$el.find('span[style] span[style]').each(function() {
            if (
              ...
              0 <= e.attr('style').indexOf('background-color') &&
                (Ee(this).attr('style', Ee(this).attr('style') + ';' + e.attr('style')),
                v(Ee(this), 'span[style]', {}, !1));
            }
          }),
            g.el.normalize(),
            g.selection.restore();
      ...
      function E(e, t, n) {
        ...
        if ((o = o.not(s)).length) {
          for (
            ...
            (p = p.parentNode),
              Ee(p).addClass('fr-split'),
              (l += g.node.closeTagString(p)),
              (d =
                g.node.openTagString(
                  Ee(p)
                    .clone()
      ...
      function i(e, t) {
        ...
        var a = r;
        for (
          a && a.nodeType != Node.ELEMENT_NODE && (a = a.parentNode);
          a && a.nodeType == Node.ELEMENT_NODE && a != g.el && !p(a, f(e, t));
    ...
    Ee.extend(Ee.FE.DEFAULTS, { indentMargin: 20 }),
    (Ee.FE.COMMANDS = {
      bold: {
        title: 'Bold',
        toggle: !0,
    ...
    (Ee.FE.MODULES.commands = function(o) {
      function i(e) {
        return (
          o.html.defaultTag() &&
            (e = '<' + o.html.defaultTag() + '>' + e + '</' + o.html.defaultTag() + '>'),
          e
        );
      }
      var a = {
        ...
        insertHR: function() {
          ...
          n.prev().is('hr')
            ? (t = o.selection.setAfter(n.get(0), !1))
            : n.next().is('hr')
              ? (t = o.selection.setBefore(n.get(0), !1))
              : o.selection.setAfter(n.get(0), !1) || o.selection.setBefore(n.get(0), !1),
      ...
      function t(e, t) {
        if (!1 !== o.events.trigger('commands.before', Ee.merge([e], t || []))) {
          var n = (Ee.FE.COMMANDS[e] && Ee.FE.COMMANDS[e].callback) || a[e],
            ...
            i = !1;
          Ee.FE.COMMANDS[e] &&
            ('undefined' != typeof Ee.FE.COMMANDS[e].focus && (r = Ee.FE.COMMANDS[e].focus),
            'undefined' != typeof Ee.FE.COMMANDS[e].accessibilityFocus &&
              (i = Ee.FE.COMMANDS[e].accessibilityFocus)),
            ((!o.core.hasFocus() && r && !o.popups.areVisible()) ||
              (!o.core.hasFocus() && i && o.accessibility.hasFocus())) &&
              o.events.focus(!0),
            Ee.FE.COMMANDS[e] &&
              !1 !== Ee.FE.COMMANDS[e].undo &&
              (o.$el.find('.fr-marker').length && (o.events.disableBlur(), o.selection.restore()),
              o.undo.saveStep()),
      ...
      function n(e) {
        ...
        for (var t = o.selection.blocks(), n = 0; n < t.length; n++)
          if ('LI' != t[n].tagName && 'LI' != t[n].parentNode.tagName) {
            var r = Ee(t[n]),
              i =
                'rtl' == o.opts.direction || 'rtl' == r.css('direction')
                  ? 'margin-right'
                  : 'margin-left',
        ...
        _init: function() {
          o.events.on('keydown', function(e) {
              ...
              if (t && 'HR' == t.tagName)
                if (e.which == Ee.FE.KEYCODE.ARROW_LEFT || e.which == Ee.FE.KEYCODE.ARROW_UP) {
                  if (t.previousSibling)
                    return (
                      o.node.isBlock(t.previousSibling)
                        ? o.selection.setAtEnd(t.previousSibling)
                        : Ee(t).before(Ee.FE.MARKERS),
                      o.selection.restore(),
                      !1
                    );
                } else if (
                  (e.which == Ee.FE.KEYCODE.ARROW_RIGHT || e.which == Ee.FE.KEYCODE.ARROW_DOWN) &&
                  t.nextSibling
                )
                  return (
                    o.node.isBlock(t.nextSibling)
                      ? o.selection.setAtStart(t.nextSibling)
                      : Ee(t).after(Ee.FE.MARKERS),
                    o.selection.restore(),
                    !1
                  );
            }),
            ...
            o.events.on('mouseup', function() {
              ...
              e == o.selection.endElement() &&
                e &&
                'HR' == e.tagName &&
                (e.nextSibling &&
                  (o.node.isBlock(e.nextSibling)
                    ? o.selection.setAtStart(e.nextSibling)
                    : Ee(e).after(Ee.FE.MARKERS)),
                o.selection.restore());
            });
        },
      });
    ...
    (Ee.FE.MODULES.data = function(p) {
      var u =
        ...
        h = (function() {
          for (
            var e = 0, t = document.domain, n = t.split('.'), r = '_gd' + new Date().getTime();
            e < n.length - 1 && -1 == document.cookie.indexOf(r + '=' + r);

          )
            (t = n.slice(-1 - ++e).join('.')),
              (document.cookie = r + '=' + r + ';domain=' + t + ';');
          return (
            (document.cookie = r + '=;expires=Thu, 01 Jan 1970 00:00:01 GMT;domain=' + t + ';'),
            (t || '').replace(/(^\.*)|(\.*$)/g, '')
          );
        })();
      function g(e) {
        ...
        E = g(function(e) {
          ...
          for (
            var t = '',
              n = g('charCodeAt'),
              r = g('fromCharCode'),
              i = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789'.indexOf(e[0]),
              a = 1;
            a < e.length - 2;
            a++
          ) {
      ...
      function b(e) {
        return e && 'block' !== e.css('display')
          ? (e.remove(), !0)
          : e && 0 === p.helpers.getPX(e.css('height'))
            ? (e.remove(), !0)
            : !(
                !e ||
                ('absolute' !== e.css('position') && 'fixed' !== e.css('position')) ||
                (e.remove(), 0)
              );
      }
      function T(e) {
      ...
      function A() {
        if (
          ...
          return !1;
        p.$wp.prepend(E(g(E(u)))),
          (m = p.$wp.find('> div:first')),
          (v = m.find('> a')),
          'rtl' == p.opts.direction &&
            m
              .css('left', 'auto')
              .css('right', 0)
              .attr('direction', 'rtl'),
      ...
      return {
        _init: function() {
          ...
          e = p.opts.key || e || [''];
          var t = E(
            g('ziRA1E3B9pA5B-11D-11xg1A3ZB5D1D4B-11ED2EG2pdeoC1clIH4wB-22yQD5uF4YE3E3A9==')
          );
          'string' == typeof e && (e = [e]);
          for (var n, r, i, a = !(p.ul = !0), o = 0, s = 0; s < e.length; s++) {
            var l = ((r = e[s]),
              3 === (i = (E(r) || '').split('|')).length ? i : [null, null, E(r) || '']),
              d = l[2];
            if (
              d === E(g(E('mcVRDoB1BGILD7YFe1BTXBA7B6=='))) ||
              0 <= d.indexOf(h, d.length - h.length) ||
              C(h)
            ) {
              if (
                !(
                  (null === (n = l[1]) || new Date(n) < new Date(E('fA4B3E3C1I3H2C6C6C3E4=='))) &&
                  0 < (h || '').length
                ) ||
                C(h)
              ) {
          ...
          var c = new Image();
          !0 === p.ul && (A(), (c.src = a ? g(E(t)) + 'e=' + o : g(E(t)) + 'u')),
            !0 === p.ul &&
    ...
    (Ee.FE.MODULES.paste = function(R) {
      var y, o, i, L;
      function n(e, t) {
        try {
          R.win.localStorage.setItem('fr-copied-html', e),
            R.win.localStorage.setItem('fr-copied-text', t);
        } catch (n) {}
      }
      function e(e) {
      ...
      function t(e) {
        ...
        if (a) return !1;
        if (
          (e.originalEvent && (e = e.originalEvent), !1 === R.events.trigger('paste.before', [e]))
        )
          return e.preventDefault(), !1;
        if ((R.$win.scrollTop(), e && e.clipboardData && e.clipboardData.getData)) {
          var t = '',
            n = e.clipboardData.types;
          if (R.helpers.isArray(n)) for (var r = 0; r < n.length; r++) t += n[r] + ';';
          else t = n;
          if (
            ((y = ''),
            /text\/rtf/.test(t) && (o = e.clipboardData.getData('text/rtf')),
            /text\/html/.test(t) && !R.browser.safari
              ? (y = e.clipboardData.getData('text/html'))
              : /text\/rtf/.test(t) && R.browser.safari
                ? (y = o)
                : /public.rtf/.test(t) &&
                  R.browser.safari &&
                  (y = e.clipboardData.getData('text/rtf')),
            '' !== y)
          )
        ...
        return (
          (function() {
            R.selection.save(),
              ...
              (y = null),
              i
                ? (i.html(''), R.browser.edge && R.opts.iframe && R.$el.append(i))
                : ((i = Ee(
                  ...
                  R.browser.webkit || R.browser.mozilla
                    ? (i.css('top', R.$sc.scrollTop()), R.$el.after(i))
                    : R.browser.edge && R.opts.iframe
                      ? R.$el.append(i)
                      : R.$box.after(i),
      ...
      function r(e) {
        if (
          (e.originalEvent && (e = e.originalEvent), e && e.dataTransfer && e.dataTransfer.getData)
        ) {
          var t = '',
          ...
          if (
            ((y = ''),
            /text\/rtf/.test(t) && (o = e.dataTransfer.getData('text/rtf')),
            /text\/html/.test(t)
              ? (y = e.dataTransfer.getData('text/html'))
              : /text\/rtf/.test(t) && R.browser.safari
                ? (y = o)
                : /text\/plain/.test(t) &&
            ...
            if (
              ...
              return (
                Ee(a).replaceWith(Ee.FE.MARKERS),
                R.selection.restore(),
                s(),
      ...
      function s() {
        R.opts.iframe && R.$el.attr('contenteditable', 'true'),
          R.browser.edge && R.opts.iframe && R.$box.after(i),
          L || (R.keys.forceUndo(), (L = R.snapshot.get())),
          y || ((y = i.get(0).innerHTML), R.selection.restore(), R.events.enableBlur());
        var e = y.match(
        ...
        t && 'string' == typeof t && (y = t),
          (!e || (e && !1 !== R.events.trigger('paste.wordPaste', [y]))) && l(y, e);
      }
      function _(e) {
        for (var t = '', n = 0; n++ < e; ) t += '&nbsp;';
        return t;
      ...
      function l(r, e, t) {
        ...
        var d = !1;
        0 <= r.indexOf('id="docs-internal-guid') &&
          ((r = r.replace(
        ...
        if (!e)
          if (
            ...
            c && (r = R.win.localStorage.getItem('fr-copied-html')),
            f && ((c = !0), (r = R.win.localStorage.getItem('fr-dragged-content-html'))),
            c)
          )
            r = R.clean.html(r, R.opts.pasteDeniedTags, R.opts.pasteDeniedAttrs);
          else {
            var p = R.opts.htmlAllowedStyleProps;
            (R.opts.htmlAllowedStyleProps = R.opts.pasteAllowedStyleProps),
              (R.opts.htmlAllowComments = !1),
              (r = (r = (r = r.replace(
                /<span class="Apple-tab-span">\s*<\/span>/g,
                _(R.opts.tabSpaces || 4)
              )).replace(
                /<span class="Apple-tab-span" style="white-space:pre">(\t*)<\/span>/g,
                function(e, t) {
                  return _(t.length * (R.opts.tabSpaces || 4));
                }
              )).replace(/\t/g, _(R.opts.tabSpaces || 4))),
              (r = R.clean.html(r, R.opts.pasteDeniedTags, R.opts.pasteDeniedAttrs)),
              (R.opts.htmlAllowedStyleProps = p),
              (R.opts.htmlAllowComments = !0),
              (r = (r = (r = x(r)).replace(/\r/g, '')).replace(/^ */g, '').replace(/ *$/g, ''));
          }
        !e ||
          (R.wordPaste && t) ||
          ...
          (r = x(
            (r = (function(e) {
              ...
              e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = e.replace(
                ...
                '<span><span'
              )).replace(/<!--\[if \!supportLists\]-->([\s\S]*?)<!--\[endif\]-->/gi, '')).replace(
              ...
              (e = (e = e.replace(/<lilevel([^1])([^>]*)>/gi, '<li data-indent="true"$2>')).replace(
                /<lilevel1([^>]*)>/gi,
                '<li$1>'
              )),
                (e = (e = (e = R.clean.html(
                  e,
                  R.opts.pasteDeniedTags,
                  R.opts.pasteDeniedAttrs
                )).replace(/<a>(.[^<]+)<\/a>/gi, '$1')).replace(/<br> */g, '<br>'));
          ...
          R.opts.pastePlain &&
            ...
            (r = (function(e) {
              ...
              var a = function(e) {
                for (var t = R.node.contents(e), n = 0; n < t.length; n++)
                  t[n].nodeType != Node.TEXT_NODE && t[n].nodeType != Node.ELEMENT_NODE
        ...
        if (('string' == typeof u && (r = u), '' !== r)) {
          ...
          0 <= (h.innerHTML = r).indexOf('<body>')
            ? (R.html.cleanBlankSpaces(h), R.spaces.normalize(h, !0))
            : R.spaces.normalize(h);
          ...
          var b = R.selection.element(),
            T = !1;
          if ((b && Ee(b).parentsUntil(R.el, 'ul, ol').length && (T = !0), T)) {
            var A = h.children;
            1 == A.length &&
              0 <= ['OL', 'UL'].indexOf(A[0].tagName) &&
          ...
          if (R.opts.enter == Ee.FE.ENTER_BR)
            for (n = (i = h.querySelectorAll('p, div')).length - 1; 0 <= n; n--)
              0 === (a = i[n]).attributes.length &&
                (a.outerHTML = a.innerHTML + (a.nextSibling && !R.node.isEmpty(a) ? '<br>' : ''));
          else if (R.opts.enter == Ee.FE.ENTER_DIV)
            for (n = (i = h.getElementsByTagName('p')).length - 1; 0 <= n; n--)
              0 === (a = i[n]).attributes.length &&
                (a.outerHTML = '<div>' + a.innerHTML + '</div>');
          else
            R.opts.enter == Ee.FE.ENTER_P &&
              1 == h.childNodes.length &&
              'P' == h.childNodes[0].tagName &&
              0 === h.childNodes[0].attributes.length &&
              (h.childNodes[0].outerHTML = h.childNodes[0].innerHTML);
          (r = h.innerHTML),
            c &&
              (r = (function(e) {
                var t,
                  n = R.o_doc.createElement('div');
                n.innerHTML = e;
                var r = n.querySelectorAll(
                  '*:empty:not(td):not(th):not(tr):not(iframe):not(svg):not(' +
                    Ee.FE.VOID_ELEMENTS.join('):not(') +
                    '):not(' +
                    R.opts.htmlAllowedEmptyTags.join('):not(') +
                    ')'
                );
                for (; r.length; ) {
      ...
      function x(e) {
        ...
        for (
          ...
          var i = r[r.length - 1];
          if (R.html.defaultTag() && 'div' != R.html.defaultTag())
            i.querySelector(R.html.blockTagsQuery())
              ? (i.outerHTML = i.innerHTML)
              : (i.outerHTML =
                  '<' + R.html.defaultTag() + '>' + i.innerHTML + '</' + R.html.defaultTag() + '>');
          else {
            var a = i.querySelectorAll('*');
            !a.length || ('BR' !== a[a.length - 1].tagName && 0 === i.innerText.length)
              ? (i.outerHTML = i.innerHTML + (i.nextSibling ? '<br>' : ''))
              : !a.length || 'BR' !== a[a.length - 1].tagName || a[a.length - 1].nextSibling
                ? (i.outerHTML = i.innerHTML + (i.nextSibling ? '<br>' : ''))
                : (i.outerHTML = i.innerHTML);
          }
          r = d(
      ...
      function c(e) {
        if (
          ...
          try {
            R.win.localStorage.setItem(
              'fr-dragged-content-html',
              e.originalEvent.dataTransfer.getData('text/html')
            ),
              R.win.localStorage.setItem(
                'fr-dragged-content-text',
                e.originalEvent.dataTransfer.getData('text/plain')
              );
          } catch (t) {}
      }
      function f() {
        R.el.removeEventListener('copy', e),
          R.el.removeEventListener('cut', e),
          R.el.removeEventListener('paste', t);
      }
      return {
        _init: function() {
          R.el.addEventListener('copy', e),
            R.el.addEventListener('cut', e),
            R.el.addEventListener('paste', t, { capture: !0 }),
            R.events.on('drop', r),
            R.browser.msie &&
              R.browser.version < 11 &&
              (R.events.on(
                'mouseup',
                function(e) {
                  2 == e.button &&
              ...
              R.events.on('beforepaste', t)),
            R.events.on('dragstart', c, !0),
            R.events.on('destroy', f);
        },
        cleanEmptyTagsAndDivs: x,
    ...
    Ee.extend(Ee.FE.DEFAULTS, { shortcutsEnabled: [], shortcutsHint: !0 }),
    (Ee.FE.SHORTCUTS_MAP = {}),
    ...
    Ee.FE.RegisterShortcut(Ee.FE.KEYCODE.E, 'show', null, 'E', !1, !1),
    Ee.FE.RegisterShortcut(Ee.FE.KEYCODE.B, 'bold', null, 'B', !1, !1),
    Ee.FE.RegisterShortcut(Ee.FE.KEYCODE.I, 'italic', null, 'I', !1, !1),
    Ee.FE.RegisterShortcut(Ee.FE.KEYCODE.U, 'underline', null, 'U', !1, !1),
    Ee.FE.RegisterShortcut(Ee.FE.KEYCODE.S, 'strikeThrough', null, 'S', !1, !1),
    Ee.FE.RegisterShortcut(Ee.FE.KEYCODE.CLOSE_SQUARE_BRACKET, 'indent', null, ']', !1, !1),
    Ee.FE.RegisterShortcut(Ee.FE.KEYCODE.OPEN_SQUARE_BRACKET, 'outdent', null, '[', !1, !1),
    Ee.FE.RegisterShortcut(Ee.FE.KEYCODE.Z, 'undo', null, 'Z', !1, !1),
    Ee.FE.RegisterShortcut(Ee.FE.KEYCODE.Z, 'redo', null, 'Z', !0, !1),
    Ee.FE.RegisterShortcut(Ee.FE.KEYCODE.Y, 'redo', null, 'Y', !1, !1),
    (Ee.FE.MODULES.shortcuts = function(s) {
      var r = null;
      var l = !1;
      function e(e) {
        ...
        if (n && Ee.FE.SHORTCUTS_MAP[r]) {
          ...
          if (i && 0 <= s.opts.shortcutsEnabled.indexOf(i)) {
            ...
            if (
              (i && !o
                ? (a = s.$tb.find('.fr-command[data-cmd="' + i + '"]'))
                : i &&
                  o &&
                  (a = s.$tb.find('.fr-command[data-cmd="' + i + '"][data-param1="' + o + '"]')),
              a.length)
            )
              return (
                e.preventDefault(),
            ...
            if (i && (s.commands[i] || (Ee.FE.COMMANDS[i] && Ee.FE.COMMANDS[i].callback)))
              return (
                e.preventDefault(),
                e.stopPropagation(),
      ...
      return {
        ...
        get: function(e) {
          ...
          if (!r)
            for (var t in ((r = {}), Ee.FE.SHORTCUTS_MAP))
              Ee.FE.SHORTCUTS_MAP.hasOwnProperty(t) &&
                0 <= s.opts.shortcutsEnabled.indexOf(Ee.FE.SHORTCUTS_MAP[t].cmd) &&
                (r[Ee.FE.SHORTCUTS_MAP[t].cmd + '.' + (Ee.FE.SHORTCUTS_MAP[t].val || '')] = {
          ...
          var n = r[e];
          return n
            ? (s.helpers.isMac() ? String.fromCharCode(8984) : s.language.translate('Ctrl') + '+') +
                (n.shift
                  ? s.helpers.isMac()
    ...
    (Ee.FE.MODULES.snapshot = function(l) {
      ...
      return {
        ...
        restore: function(e) {
          l.$el.html() != e.html &&
            (l.opts.htmlExecuteScripts ? l.$el.html(e.html) : (l.el.innerHTML = e.html));
        ...
        equal: function(e, t) {
          return (
            e.html == t.html &&
            (!l.core.hasFocus() || JSON.stringify(e.ranges) == JSON.stringify(t.ranges))
          );
        },
      };
    }),
    (Ee.FE.MODULES.undo = function(n) {
      function e(e) {
        var t = e.which;
        n.keys.ctrlKey(e) &&
          (90 == t && e.shiftKey && e.preventDefault(), 90 == t && e.preventDefault());
      }
      var t = null;
      function r() {
          ...
          void 0 === e
            ? ((e = n.snapshot.get()),
              (n.undo_stack[n.undo_index - 1] &&
                ...
                n.undo_stack.push(e),
                n.undo_index++,
                e.html != t && (n.events.trigger('contentChanged'), (t = e.html))))
            : (r(),
              0 < n.undo_index
    ...
    Ee.extend(Ee.FE.DEFAULTS, { iconsTemplate: 'font_awesome' }),
      ...
      return {
        create: function(n) {
          ...
          if (void 0 !== r) {
            ...
            t && t.apply && (t = t.apply(i)),
              r.FA5NAME || (r.FA5NAME = r.NAME),
              t &&
                (t = Ee.FE.ICON_TEMPLATES[t]) &&
        ...
        getTemplate: function(e) {
          ...
          return void 0 !== t
            ? (n = t.template || Ee.FE.ICON_DEFAULT_TEMPLATE || i.opts.iconsTemplate)
            : n;
        },
      };
    }),
    Ee.extend(Ee.FE.DEFAULTS, { tooltips: !0 }),
    (Ee.FE.MODULES.tooltip = function(i) {
      ...
      function a(e, t) {
        ...
        i.$tooltip ||
          (i.opts.tooltips &&
            ...
            (i.shared.$tooltip
              ...
              : ((i.shared.$tooltip = Ee('<div class="fr-tooltip"></div>')),
                (i.$tooltip = i.shared.$tooltip),
                i.opts.theme && i.$tooltip.addClass(i.opts.theme + '-theme'),
                Ee(i.o_doc)
                  .find('body:first')
                  .append(i.$tooltip)),
            i.events.on(
        ...
        n < 0 && (n = 0),
          n + i.$tooltip.outerWidth() > Ee(i.o_win).width() &&
            (n = Ee(i.o_win).width() - i.$tooltip.outerWidth()),
          void 0 === t && (t = i.opts.toolbarBottom),
          e.offset().top - Ee(window).scrollTop() + e.outerHeight() + 10 >= Ee(window).height() &&
            (t = !0);
            ...
            (i.events.$on(
              ...
              function(e) {
                i.node.hasClass(e.currentTarget, 'fr-disabled') ||
                  i.edit.isDisabled() ||
                  a(Ee(e.currentTarget), n);
              },
              !0
            ),
            i.events.$on(
              e,
              'mouseleave ' + i._mousedown + ' ' + i._mouseup,
              t,
              function() {
                r();
              },
    ...
    (Ee.FE.MODULES.button = function(u) {
      var o = [];
      (u.opts.toolbarInline || u.opts.toolbarContainer) &&
        (u.shared.buttons || (u.shared.buttons = []), (o = u.shared.buttons));
      var s = [];
      function l(e, t, n) {
      ...
      function t(e) {
        ...
        if (
          ...
          for (var n = 0; n < Ee.FE.INSTANCES.length; n++)
            Ee.FE.INSTANCES[n] != t &&
              Ee.FE.INSTANCES[n].popups &&
              Ee.FE.INSTANCES[n].popups.areVisible() &&
              Ee.FE.INSTANCES[n].$el.find('.fr-marker').remove();
          t.popups.hideAll();
        }
        u.node.hasClass(e.get(0), 'fr-dropdown')
          ? (function(e) {
              ...
              if (
                (i.helpers.isIOS() &&
                  !i.el.querySelector('.fr-marker') &&
                  (i.selection.save(), i.selection.clear(), i.selection.restore()),
                !n)
              ) {
                var a = e.data('cmd');
                t
                  ...
                  Ee.FE.COMMANDS[a] &&
                    Ee.FE.COMMANDS[a].refreshOnShow &&
                    Ee.FE.COMMANDS[a].refreshOnShow.apply(i, [e, t]),
                  t.css(
                    'left',
                    e.offset().left -
                      e.parent().offset().left -
                      ('rtl' == u.opts.direction ? t.width() - e.outerWidth() : 0)
                  ),
                ...
                t.removeClass('test-height'),
                  ...
                  t.offset().top + e.outerHeight() + o < Ee(u.o_doc).height()
                    ...
                    : t.css(
                        ...
                        e
                          .parents('.fr-popup, .fr-toolbar')
                          .first()
                          .height() - e.position().top
                      );
              }
              e.addClass('fr-blink').toggleClass('fr-active'),
                e.hasClass('fr-options') && e.prev().toggleClass('fr-expanded'),
                e.hasClass('fr-active')
                  ? (t.attr('aria-hidden', !1), e.attr('aria-expanded', !0))
                  : (t.attr('aria-hidden', !0), e.attr('aria-expanded', !1)),
                setTimeout(function() {
                  e.removeClass('fr-blink');
                }, 300),
                t.css('margin-left', ''),
                t.offset().left + t.outerWidth() > u.$sc.offset().left + u.$sc.width() &&
                  t.css(
                    'margin-left',
                    -(t.offset().left + t.outerWidth() - u.$sc.offset().left - u.$sc.width())
                  ),
                t.offset().left < u.$sc.offset().left &&
                  'rtl' == u.opts.direction &&
                  t.css('margin-left', u.$sc.offset().left),
                r
                  .removeClass('fr-active')
                  .attr('aria-expanded', !1)
                  .next()
                ...
                0 !== e.parents('.fr-popup').length ||
                  ...
                  (u.node.hasClass(e.get(0), 'fr-active')
                    ? u.$tb.css('zIndex', (u.opts.zIndex || 1) + 4)
                    : u.$tb.css('zIndex', ''));
              var s = t.find('a.fr-command.fr-active:first');
              u.helpers.isMobile() ||
                (s.length
                  ? u.accessibility.focusToolbarElement(s)
                  : u.accessibility.focusToolbarElement(e));
            })(e)
          : (r(e),
            Ee.FE.COMMANDS[e.data('cmd')] &&
              !1 !== Ee.FE.COMMANDS[e.data('cmd')].refreshAfterCallback &&
      ...
      function h(e, t, n) {
        ...
        if ('options' !== t.type)
          if (r) {
            var a =
              'function' == typeof t.defaultSelection ? t.defaultSelection(u) : t.defaultSelection;
            i =
              '<span style="width:' +
              (t.displaySelectionWidth || 100) +
              'px">' +
              u.language.translate(a || t.title) +
              '</span>';
          } else
            (i = u.icon.create(t.icon || e)),
              (i +=
                '<span class="fr-sr-only">' + (u.language.translate(t.title) || '') + '</span>');
        ...
        var d = e + '-' + u.id,
          ...
          f =
            ...
            ('dropdown' == t.type || 'options' == t.type
              ? ' aria-controls="' + c + '" aria-expanded="false" aria-haspopup="true"'
              : '') +
        ...
        if ('dropdown' == t.type || 'options' == t.type) {
          ...
          (p += (function(e, t) {
            ...
            if (t.html) 'function' == typeof t.html ? (n += t.html.call(u)) : (n += t.html);
              ...
              var r = t.options;
              for (var i in ('function' == typeof r && (r = r()),
        ...
        return (
          t.hasOptions &&
            t.hasOptions.apply(u) &&
            ((t.type = 'options'),
            (t.hasOptions = !1),
            (f = '<div class="fr-btn-wrap">' + f + h(e + 'Options', t, n) + '</div>')),
          f
        );
      }
      function e(i) {
        ...
        setTimeout(function() {
          for (var e = a.selection.inEditor() && a.core.hasFocus(), t = 0; t < i.length; t++) {
            ...
            0 === n.parents('.fr-popup').length
              ? e || (Ee.FE.COMMANDS[r] && Ee.FE.COMMANDS[r].forcedRefresh)
                ? a.button.refresh(n)
                : u.node.hasClass(n.get(0), 'fr-dropdown') ||
                  (n.removeClass('fr-active'), n.attr('aria-pressed') && n.attr('aria-pressed', !1))
              : n.parents('.fr-popup').is(':visible') && a.button.refresh(n);
          }
        }, 0);
      }
      function n() {
      ...
      return {
        _init: function() {
          u.opts.toolbarInline
            ...
            : (u.events.on('mouseup', m),
              u.events.on('keyup', m),
              u.events.on('blur', m),
              u.events.on('focus', m),
              u.events.on('contentChanged', m),
              u.helpers.isMobile() && u.events.$on(u.$doc, 'selectionchange', n)),
        ...
        buildList: function(e, t) {
          for (var n = '', r = 0; r < e.length; r++) {
            var i = e[r],
              a = Ee.FE.COMMANDS[i];
            (a && 'undefined' != typeof a.plugin && u.opts.pluginsEnabled.indexOf(a.plugin) < 0) ||
              (a
                ? (n += h(i, a, void 0 === t || 0 <= t.indexOf(i)))
                : '|' == i
                  ? (n +=
        ...
        bindCommands: function(t, e) {
          u.events.bindClick(t, '.fr-command:not(.fr-disabled)', a),
            u.events.$on(
              t,
              u._mousedown + ' ' + u._mouseup + ' ' + u._move,
              '.fr-dropdown-menu',
              f,
              !0
            ),
          ...
          var n = t.get(0).ownerDocument,
            ...
            i = function(e) {
              (!e ||
                (e.type == u._mouseup && e.target != Ee('html').get(0)) ||
                ('keydown' == e.type &&
                  ((u.keys.isCharacter(e.which) && !u.keys.ctrlKey(e)) ||
                    e.which == Ee.FE.KEYCODE.ESC))) &&
                c(t);
            };
          u.events.$on(Ee(r), u._mouseup + ' resize keydown', i, !0),
            u.opts.iframe && u.events.$on(u.$win, u._mouseup, i, !0),
            u.node.hasClass(t.get(0), 'fr-popup')
              ? Ee.merge(s, t.find('.fr-btn').toArray())
              : Ee.merge(o, t.find('.fr-btn').toArray()),
        ...
        refresh: function(e) {
          ...
          u.node.hasClass(e.get(0), 'fr-dropdown')
            ? (t = e.next())
            : (e.removeClass('fr-active'), e.attr('aria-pressed') && e.attr('aria-pressed', !1)),
            Ee.FE.COMMANDS[r] && Ee.FE.COMMANDS[r].refresh
              ? Ee.FE.COMMANDS[r].refresh.apply(n, [e, t])
              : u.refresh[r] && n.refresh[r](e, t);
        },
        bulkRefresh: n,
        exec: r,
        click: t,
    ...
    (Ee.FE.MODULES.modals = function(l) {
      ...
      return {
        ...
        create: function(n, e, t) {
          if (
            (l.shared.$overlay ||
              (l.shared.$overlay = Ee('<div class="fr-overlay">').appendTo('body:first')),
            (s = l.shared.$overlay),
            l.opts.theme && s.addClass(l.opts.theme + '-theme'),
            !d[n])
          ) {
            var r = ((i = e),
            (a = t),
            (o =
              ...
              (l.opts.theme ? ' ' + l.opts.theme + '-theme' : '') +
            ...
            (o +=
              ...
              '" class="fr-modal-close">&times;</span></div>'),
            (o += '<div tabIndex="-1" class="fr-modal-body">' + a + '</div>'),
            Ee((o += '</div></div>')));
            (d[n] = {
              $modal: r,
              ...
              l.events.$on(
                ...
                function(e) {
                  var t = e.which;
                  return t == Ee.FE.KEYCODE.ESC
                    ? (c(n), l.accessibility.focusModalButton(r), !1)
                    : !(
                        !Ee(e.target).is('input[type=text], textarea') &&
                        t != Ee.FE.KEYCODE.ARROW_UP &&
                        t != Ee.FE.KEYCODE.ARROW_DOWN &&
    ...
    (Ee.FE.POPUP_TEMPLATES = { 'text.edit': '[_EDIT_]' }),
    ...
    (Ee.FE.MODULES.popups = function(c) {
      ...
      function n(e) {
        ...
        (t = 'string' != typeof e ? e : f[e]) &&
          ...
          c.$tb &&
            (1 < c.opts.zIndex ? c.$tb.css('zIndex', c.opts.zIndex + 1) : c.$tb.css('zIndex', '')),
      ...
      function i(e, t) {
        ...
        return i
          ? ((n = Ee(
              '<div class="fr-popup' +
                (c.helpers.isMobile() ? ' fr-mobile' : ' fr-desktop') +
                (c.opts.toolbarInline ? ' fr-inline' : '') +
            ...
            1 < c.opts.zIndex &&
              (c.opts.editInPopup
                ? n.css('z-index', c.opts.zIndex + 2)
                : c.$tb.css('z-index', c.opts.zIndex + 2)),
            'auto' != c.opts.direction &&
              n.removeClass('fr-ltr fr-rtl').addClass('fr-' + c.opts.direction),
            n
              .find('input, textarea')
              .attr('dir', c.opts.direction)
              .attr('disabled', 'disabled'),
            (r = Ee('body:first')).append(n),
            n.data('container', r),
            (f[e] = n),
            c.button.bindCommands(n, !1),
            n)
          : ((n = Ee('<div class="fr-popup fr-empty"></div>')),
            (r = Ee('body:first')).append(n),
            n.data('container', r),
            (f[e] = n));
      }
        ...
        return {
          ...
          _inputBlur: function(e) {
            ...
            n.is('input:file') && n.closest('.fr-layer').removeClass('fr-input-focus'),
              document.activeElement != this &&
                Ee(this).is(':visible') &&
                (t.events.blurActive() && t.events.trigger('blur'), t.events.enableBlur());
          },
          _editorKeydown: function(e) {
            var t = i.data('instance') || c;
            t.keys.ctrlKey(e) ||
              e.which == Ee.FE.KEYCODE.ALT ||
              e.which == Ee.FE.KEYCODE.ESC ||
              (u(r) && i.find('.fr-back:visible').length
                ? t.button.exec(i.find('.fr-back:visible:first'))
                : e.which != Ee.FE.KEYCODE.ALT && t.popups.hide(r));
          },
          _preventFocus: function(e) {
            ...
            'mouseup' == e.type || Ee(n).is(':focus') || t.events.disableBlur(),
              'mouseup' != e.type ||
                Ee(n).hasClass('fr-command') ||
                0 < Ee(n).parents('.fr-command').length ||
                Ee(n).hasClass('fr-dropdown-content') ||
                c.button.hideActiveDropdowns(i),
              (c.browser.safari || c.browser.mozilla) &&
                'mousedown' == e.type &&
                Ee(n).is('input[type=file]') &&
                t.events.disableBlur();
          ...
          _editorMouseup: function() {
            i.is(':visible') &&
              a() &&
              0 <
                i.find('input:focus, textarea:focus, button:focus, select:focus').filter(':visible')
                  .length &&
              c.events.disableBlur();
          },
          _windowMouseup: function(e) {
            ...
            i.is(':visible') &&
              a() &&
              (e.stopPropagation(), t.markers.remove(), t.popups.hide(r), m());
          },
              ...
              if (t.popups.isVisible(r) && t.opts.toolbarInline)
                return (
                  ...
                  t.popups.isVisible(r) &&
                    (i.find('.fr-back:visible').length
                      ? (t.button.exec(i.find('.fr-back:visible:first')),
                        t.accessibility.focusPopupButton(i))
                      : i.find('.fr-dismiss:visible').length
                        ? t.button.exec(i.find('.fr-dismiss:visible:first'))
                        : (t.popups.hide(r),
              ...
              if (t.popups.isVisible(r))
                return (
                  i.find('.fr-back:visible').length
                    ...
                    : i.find('.fr-dismiss:visible').length
                      ? t.button.exec(i.find('.fr-dismiss:visible:first'))
                      : (t.popups.hide(r), t.accessibility.focusPopupButton(i)),
                  !1
                );
            }
          },
          _doPlaceholder: function() {
            0 === Ee(this).next().length &&
              Ee(this).attr('placeholder') &&
              Ee(this).after(
                '<label for="' +
                  Ee(this).attr('id') +
                  '">' +
      ...
      function o(e, t) {
        c.events.on('mouseup', e._editorMouseup, !0),
          ...
          c.$wp &&
            !c.helpers.isMobile() &&
            c.events.$on(c.$wp, 'scroll.popup' + t, e._repositionPopup),
      ...
      return (
        (c.shared.exit_flag = !1),
        {
          ...
          show: function(e, t, n, r) {
            if (
              (u(e) ||
                (h() && 0 < c.$el.find('.fr-marker').length
                  ? (c.events.disableBlur(), c.selection.restore())
                  : h() || (c.events.disableBlur(), c.events.focus(), c.events.enableBlur())),
              g([e]),
              !f[e])
            )
              return !1;
            ...
            (s = e),
              ...
              c.opts.toolbarInline &&
                ...
                (t =
                  c.$tb.offset().left +
                  c.$tb.outerWidth() / 2 +
                  (parseFloat(c.$tb.find('.fr-arrow').css('margin-left')) || 0) +
                  c.$tb.find('.fr-arrow').outerWidth() / 2),
              ...
              !c.opts.iframe ||
                r ||
                o ||
                (t && (t -= c.$iframe.offset().left), n && (n -= c.$iframe.offset().top)),
              d.is(c.$tb)
                ? c.$tb.css('zIndex', (c.opts.zIndex || 1) + 4)
                : f[e].css('zIndex', (c.opts.zIndex || 1) + 4),
              t && (t -= a / 2),
              c.opts.toolbarBottom &&
                d &&
                c.$tb &&
                d.get(0) == c.$tb.get(0) &&
                (f[e].addClass('fr-above'), n && (n -= f[e].outerHeight())),
    ...
    (Ee.FE.MODULES.position = function(E) {
      function i() {
        ...
        if ((0 === e.top && 0 === e.left && 0 === e.width) || 0 === e.height) {
          ...
          n.css('display', 'none'),
            ...
            (e.width = 0),
            (e.height = i),
            (e.top = r.top - (E.opts.iframe ? 0 : E.helpers.scrollTop())),
            (e.right = 1),
            (e.bottom = 1),
            (e.ok = !0),
      ...
      function a(e, t, n, r) {
        ...
        !i ||
          ('BODY' === i.get(0).tagName && 'static' == i.css('position')) ||
          (e && (e -= i.offset().left),
          t && (t -= i.offset().top),
          'BODY' != i.get(0).tagName
            ? (e && (e += i.get(0).scrollLeft), t && (t += i.get(0).scrollTop))
            : 'absolute' == i.css('position') &&
              (e && (e += i.position().left), t && (t += i.position().top))),
          E.opts.iframe &&
            i &&
            E.$tb &&
            i.get(0) != E.$tb.get(0) &&
            (e && (e += E.$iframe.offset().left), t && (t += E.$iframe.offset().top));
        var a,
          o,
          s,
          l,
          d = ((o = e),
          (s = (a = n).outerWidth(!0)),
          (l = a.parent().offset().left),
          a.parent().get(0) == E.$sc.get(0) && (l -= a.parent().position().left),
          l + o + s > E.$sc.get(0).clientWidth - 10 && (o = E.$sc.get(0).clientWidth - s - l - 10),
          o < 0 && (o = 10),
          o);
        if (e) {
          n.css('left', d);
          var c = n.data('fr-arrow');
          c || ((c = n.find('.fr-arrow')), n.data('fr-arrow', c)),
            c.data('margin-left') || c.data('margin-left', E.helpers.getPX(c.css('margin-left'))),
            c.css('margin-left', e - d + c.data('margin-left'));
        }
        t &&
          n.css(
            'top',
            (function(e, t, n) {
              ...
              if (!E.helpers.isMobile() && E.$tb && e.parent().get(0) != E.$tb.get(0)) {
                ...
                i + t + r > E.$sc.offset().top + o && 0 < e.parent().offset().top + a && 0 < a
                  ? a > E.$wp.scrollTop() && ((t = a), e.addClass('fr-above'))
      ...
      function n(e) {
        ...
        if (void 0 === r) {
          n.data('sticky-top', 0);
          var a = Ee(
            '<div class="fr-sticky-dummy" style="height: ' + n.outerHeight() + 'px;"></div>'
          );
          E.$box.prepend(a);
        ...
        if (E.core.hasFocus() || 0 < E.$tb.find('input:visible:focus').length) {
          var o = E.helpers.scrollTop(),
            s = Math.min(
              Math.max(o - E.$tb.parent().offset().top, 0),
              E.$tb.parent().outerHeight() - n.outerHeight()
            );
          s != r &&
            s != i &&
            (clearTimeout(n.data('sticky-timeout')),
            n.data('sticky-scheduled', s),
            n.outerHeight() < o - E.$tb.parent().offset().top && n.addClass('fr-opacity-0'),
            n.data(
              'sticky-timeout',
              setTimeout(function() {
                var e = E.helpers.scrollTop(),
                  t = Math.min(
                    Math.max(e - E.$tb.parent().offset().top, 0),
                    E.$tb.parent().outerHeight() - n.outerHeight()
                  );
                0 < t &&
                  'BODY' == E.$tb.parent().get(0).tagName &&
                  (t += E.$tb.parent().position().top),
                  t != r &&
            ...
            t ||
              (n.css('top', '0'),
              n.width(E.$tb.parent().width()),
              n.addClass('fr-sticky-on'),
              E.$box.addClass('fr-sticky-box'));
        } else
          clearTimeout(Ee(e).css('sticky-timeout')),
            n.css('top', '0'),
            n.css('position', ''),
            n.width(''),
            n.data('sticky-top', 0),
      ...
      function t(e) {
        if (e.offsetWidth) {
          var t,
            ...
            s = Ee(
              'body' == E.opts.scrollableContainer ? E.o_win : E.opts.scrollableContainer
            ).outerHeight(),
            l = 0,
            d = 0;
          'body' !== E.opts.scrollableContainer &&
            ((l = E.$sc.offset().top), (d = Ee(E.o_win).outerHeight() - l - s));
          ...
          var p = r.data('sticky-parent'),
            ...
            h = p.outerHeight();
          if (
            (r.data('sticky-offset') || void 0 !== a
              ? E.$box.find('.fr-sticky-dummy').css('height', i + 'px')
              : (r.data('sticky-offset', !0),
                r.after('<div class="fr-sticky-dummy" style="height: ' + i + 'px;"></div>')),
            !o)
          ) {
          ...
          var m =
              ...
              u < c + t &&
              c + t <= u + h - i &&
              (E.helpers.isInViewPort(E.$sc.get(0)) || 'body' == E.opts.scrollableContainer),
          ...
          m || v
            ? (r.css('width', p.get(0).getBoundingClientRect().width + 'px'),
              f ||
                ...
                r.css('top') &&
                  ('auto' != r.data('top')
                    ? r.css('top', E.helpers.getPX(r.data('top')) + l)
                    : r.data('top', 'auto')),
                r.css('bottom') &&
                  ('auto' != r.data('bottom')
                    ? r.css('bottom', E.helpers.getPX(r.data('bottom')) + d)
                    : r.css('bottom', 'auto'))))
            : E.node.hasClass(r.get(0), 'fr-sticky-off') ||
              (r.width(''),
              r.removeClass('fr-sticky-on'),
              r.addClass('fr-sticky-off'),
              r.css('top') && 'auto' != r.data('top') && o.top && r.css('top', 0),
              r.css('bottom') && 'auto' != r.data('bottom') && o.bottom && r.css('bottom', 0));
        }
      }
      function e() {
      ...
      return {
        _init: function() {
          !(function() {
            if (((E._stickyElements = []), E.helpers.isIOS())) {
              var t = function() {
                if (
                  (E.helpers.requestAnimationFrame()(t),
                  !1 !== E.events.trigger('position.refresh'))
                )
              ...
              'body' !== E.opts.scrollableContainer &&
                E.events.$on(Ee(E.opts.scrollableContainer), 'scroll', e, !0),
                E.events.$on(Ee(E.o_win), 'scroll', e, !0),
                E.events.$on(Ee(E.o_win), 'resize', e, !0),
                E.events.on('initialized', e),
                E.events.on('focus', e),
                E.events.$on(Ee(E.o_win), 'resize', 'textarea', e, !0);
        ...
        addSticky: function(e) {
          e.addClass('fr-sticky'),
            ...
            E._stickyElements.push(e.get(0));
        },
        refresh: e,
        at: a,
        getBoundingRect: i,
      ...
      return {
        ...
        outdent: function(e) {
          ...
          for (var t = i.selection.blocks(), n = 0; n < t.length; n++) {
            var r =
              'rtl' == i.opts.direction || 'rtl' == Ee(t[n]).css('direction')
                ? 'margin-right'
                : 'margin-left';
    ...
    Ee.extend(Ee.FE.DEFAULTS, { editInPopup: !1 }),
        ...
        n.events.$on(n.$el, n._mouseup, function() {
          setTimeout(function() {
            ...
            (t = n.popups.get('text.edit')),
              ...
              n.popups.show(
                'text.edit',
                n.$el.offset().left + n.$el.outerWidth() / 2,
                n.$el.offset().top + n.$el.outerHeight(),
                n.$el.outerHeight()
              );
          }, 10);
        });
    ...
    (Ee.FE.TOOLBAR_BUTTONS_MD = null),
    (Ee.FE.TOOLBAR_BUTTONS_SM = [
      'bold',
      'italic',
      'underline',
      '|',
    ...
    (Ee.FE.TOOLBAR_BUTTONS_XS = ['bold', 'italic', 'fontFamily', 'fontSize', '|', 'undo', 'redo']),
    (Ee.FE.MODULES.toolbar = function(i) {
      var r = [];
      function a(e, t) {
        for (var n = 0; n < t.length; n++)
      ...
      function e() {
        ...
        i.$tb.find('.fr-separator').remove(),
          i.$tb.find('> .fr-command, > div.fr-btn-wrap').addClass('fr-hidden');
        for (var t = 0; t < e.length; t++)
          if ('|' == e[t] || '-' == e[t]) i.$tb.append(i.button.buildList([e[t]]));
            ...
            i.node.hasClass(n.next().get(0), 'fr-dropdown-menu') && (r = n.next()),
              i.node.hasClass(n.next().get(0), 'fr-options') && (n = n.parent()),
      ...
      function t(e, t) {
        setTimeout(function() {
          if (
            (!e || e.which != Ee.FE.KEYCODE.ESC) &&
            i.selection.inEditor() &&
            i.core.hasFocus() &&
            !i.popups.areVisible() &&
            (i.opts.toolbarVisibleWithoutSelection ||
              (!i.selection.isCollapsed() && !i.keys.isIME()) ||
              t)
          ) {
            ...
            i.$tb.show(),
              ...
              1 < i.opts.zIndex
                ? i.$tb.css('z-index', i.opts.zIndex + 1)
                : i.$tb.css('z-index', null);
          }
        }, 0);
      }
      function n(e) {
        return (
          (!e || 'blur' !== e.type || document.activeElement !== i.el) &&
          (!(!e || 'keydown' !== e.type || !i.keys.ctrlKey(e)) ||
            (!!i.button
              .getButtons('.fr-dropdown.fr-active')
              .next()
              .find(i.o_doc.activeElement).length ||
              void (!1 !== i.events.trigger('toolbar.hide') && i.$tb.hide())))
        );
      }
      (r[Ee.FE.XS] =
        i.opts.toolbarButtonsXS ||
        i.opts.toolbarButtons ||
        Ee.FE.TOOLBAR_BUTTONS_XS ||
        Ee.FE.TOOLBAR_BUTTONS ||
        []),
        (r[Ee.FE.SM] =
          i.opts.toolbarButtonsSM ||
          i.opts.toolbarButtons ||
          Ee.FE.TOOLBAR_BUTTONS_SM ||
          Ee.FE.TOOLBAR_BUTTONS ||
          []),
        (r[Ee.FE.MD] =
          i.opts.toolbarButtonsMD ||
          i.opts.toolbarButtons ||
          Ee.FE.TOOLBAR_BUTTONS_MD ||
          Ee.FE.TOOLBAR_BUTTONS ||
          []),
      ...
      function d() {
        i.events.on('window.mousedown', n),
          ...
          i.helpers.isMobile()
            ? i.helpers.isIOS() ||
              (i.events.on('window.touchend', t), i.browser.mozilla && setInterval(t, 200))
            : i.events.on('window.keyup', l),
          ...
          i.events.$on(i.$sc, 'scroll.toolbar', t),
          i.events.on('commands.after', t),
          i.helpers.isMobile() &&
            (i.events.$on(i.$doc, 'selectionchange', l),
            i.events.$on(i.$doc, 'orientationchange', t));
      }
      function c() {
        i.$tb
          .html('')
      ...
      function p() {
        i.opts.theme && i.$tb.addClass(i.opts.theme + '-theme'),
          ...
          'auto' != i.opts.direction &&
            i.$tb.removeClass('fr-ltr fr-rtl').addClass('fr-' + i.opts.direction),
          i.helpers.isMobile() ? i.$tb.addClass('fr-mobile') : i.$tb.addClass('fr-desktop'),
          i.opts.toolbarContainer
            ? (i.opts.toolbarInline && (d(), n()),
              i.opts.toolbarBottom ? i.$tb.addClass('fr-bottom') : i.$tb.addClass('fr-top'))
            : i.opts.toolbarInline
              ? (i.$sc.append(i.$tb),
                i.$tb.data('container', i.$sc),
                i.$tb.addClass('fr-inline'),
                i.$tb.prepend('<span class="fr-arrow"></span>'),
                d(),
                (i.opts.toolbarBottom = !1))
              : (i.opts.toolbarBottom && !i.helpers.isIOS()
                  ? (i.$box.append(i.$tb),
                    i.$tb.addClass('fr-bottom'),
                    i.$box.addClass('fr-bottom'))
                  : ((i.opts.toolbarBottom = !1),
                    i.$box.prepend(i.$tb),
                    i.$tb.addClass('fr-top'),
                    i.$box.addClass('fr-top')),
                i.$tb.addClass('fr-basic'),
                i.opts.toolbarSticky &&
                  (i.opts.toolbarStickyOffset &&
                    (i.opts.toolbarBottom
                      ? i.$tb.css('bottom', i.opts.toolbarStickyOffset)
                      : i.$tb.css('top', i.opts.toolbarStickyOffset)),
                  i.position.addSticky(i.$tb))),
          (function() {
            var e = Ee.merge([], o());
      ...
      return {
        _init: function() {
          ...
          i.opts.toolbarContainer
            ? (i.shared.$tb
                ? ((i.$tb = i.shared.$tb), i.opts.toolbarInline && d())
                : ((i.shared.$tb = Ee('<div class="fr-toolbar"></div>')),
                  (i.$tb = i.shared.$tb),
                  Ee(i.opts.toolbarContainer).append(i.$tb),
                  p(),
                  i.$tb.data('instance', i)),
              i.opts.toolbarInline ? i.$box.addClass('fr-inline') : i.$box.addClass('fr-basic'),
              i.events.on(
                'focus',
                function() {
                  i.$tb.data('instance', i);
              ...
              (i.opts.toolbarInline = !1))
            : i.opts.toolbarInline
              ? (i.$box.addClass('fr-inline'),
                i.shared.$tb
                  ? ((i.$tb = i.shared.$tb), d())
                  : ((i.shared.$tb = Ee('<div class="fr-toolbar"></div>')),
                    (i.$tb = i.shared.$tb),
                    p()))
              : (i.$box.addClass('fr-basic'),
                (i.$tb = Ee('<div class="fr-toolbar"></div>')),
                p(),
                i.$tb.data('instance', i)),
            i.events.on('destroy', f, !0),
            i.events.on(
              i.opts.toolbarInline || i.opts.toolbarContainer ? 'shared.destroy' : 'destroy',
              c,
              !0
            );
        },
    ...
    (Ee.FE.PLUGINS.align = function(i) {
      return {
        ...
        refreshForToolbar: function(e) {
          ...
          if (t.length) {
            var n = i.helpers.getAlignment(Ee(t[0]));
            'align' + (n = n.charAt(0).toUpperCase() + n.slice(1)) == e.attr('data-cmd') &&
              e.addClass('fr-active');
          }
        },
      };
    }),
    Ee.FE.DefineIcon('align', { NAME: 'align-left' }),
    Ee.FE.DefineIcon('align-left', { NAME: 'align-left' }),
    Ee.FE.DefineIcon('align-right', { NAME: 'align-right' }),
    Ee.FE.DefineIcon('align-center', { NAME: 'align-center' }),
    Ee.FE.DefineIcon('align-justify', { NAME: 'align-justify' }),
    ...
    Ee.extend(Ee.FE.DEFAULTS, { charCounterMax: -1, charCounterCount: !0 }),
    (Ee.FE.PLUGINS.charCounter = function(n) {
      ...
      function e(e) {
        ...
        var t = e.which;
        return (
          !((!n.keys.ctrlKey(e) && n.keys.isCharacter(t)) || t === Ee.FE.KEYCODE.IME) ||
          (e.preventDefault(), e.stopPropagation(), n.events.trigger('charCounter.exceeded'), !1)
        );
      }
      function t(e) {
      ...
      function a() {
        if (n.opts.charCounterCount) {
          ...
          0 <= t &&
            ('rtl' == n.opts.direction ? r.css('margin-left', t) : r.css('margin-right', t));
        }
      }
      return {
        _init: function() {
          return (
            ...
            ((r = Ee('<span class="fr-counter"></span>')).css(
              'bottom',
              n.$wp.css('border-bottom-width')
            ),
            n.$box.append(r),
            ...
            n.events.on('charCounter.update', a),
            n.events.trigger('charCounter.update'),
    ...
    (Ee.FE.PLUGINS.codeBeautifier = function() {
      ...
      function x(r, e) {
        ...
        for (
          ...
          if ('/' === c && '*' === g()) {
            ...
            $ || '{' === k || x.trim(), x.singleSpace(), N.push(b()), x.newLine();
          else if ('@' === c) {
            ...
            '#' === c && '{' === g()
              ? (x.preserveSingleSpace(), N.push(m('}')))
              : '{' === c
                ? '}' === g(!0)
                  ? (v(),
                    h(),
                    ...
                    ? (v(),
                      (!w && !I) || T('&') || A()
                        ? ':' === g()
                          ? (h(), N.push('::'))
                          : N.push(':')
                        : ((O = !0), N.push(':'), x.singleSpace()))
                    : '"' === c || "'" === c
                      ? (x.preserveSingleSpace(), N.push(m(c)))
                      : ';' === c
                        ? ((O = !1), N.push(c), x.newLine())
                        : '(' === c
                          ? T('url')
                            ? (N.push(c),
                              v(),
                              h() && (')' !== c && '"' !== c && "'" !== c ? N.push(m(')')) : p--))
                            : (u++, x.preserveSingleSpace(), N.push(c), v())
                          : ')' === c
                            ? (N.push(c), u--)
                            : ',' === c
                              ? (N.push(c), v(), o && !O && u < 1 ? x.newLine() : x.singleSpace())
                              : (']' === c ||
                                  ('[' === c
      ...
      (e = Y),
        ...
        (e.isIdentifierStart = function(e) {
          return e < 65
            ? 36 === e || 64 === e
            : e < 91 ||
                (e < 97 ? 95 === e : e < 123 || (170 <= e && n.test(String.fromCharCode(e))));
        }),
        (e.isIdentifierChar = function(e) {
          return e < 48
            ...
            : e < 58 ||
                (!(e < 65) &&
                  (e < 91 ||
                    (e < 97 ? 95 === e : e < 123 || (170 <= e && r.test(String.fromCharCode(e))))));
        });
      var k = {
      ...
      function i(r, e) {
        ...
        function v(e, t) {
          ...
          return (
            e &&
              ...
              !o.just_added_newline() && e.line_indent_level > n && (n = e.line_indent_level)),
            {
              mode: t,
              parent: e,
          ...
          u = {
            TK_START_EXPR: function() {
              ...
              if ('[' === s.text) {
                ...
                (e = k.ArrayLiteral),
                  L(f.mode) &&
                    (('[' !== f.last_text && (',' !== f.last_text || (']' !== d && '}' !== d))) ||
                      h.keep_array_indentation ||
                      A());
              } else
                'TK_RESERVED' === l && 'for' === f.last_text
                  ? (e = k.ForInitializer)
                  : 'TK_RESERVED' === l && G(f.last_text, ['if', 'while']) && (e = k.Conditional);
              ';' === f.last_text || 'TK_START_BLOCK' === l
                ? A()
                : 'TK_END_EXPR' === l ||
                  'TK_START_EXPR' === l ||
                  'TK_END_BLOCK' === l ||
                  '.' === f.last_text
                  ? T(s.wanted_newline)
                  : ('TK_RESERVED' === l && '(' === s.text) ||
                    'TK_WORD' === l ||
                    'TK_OPERATOR' === l
                    ? ('TK_RESERVED' === l &&
                        ('function' === f.last_word || 'typeof' === f.last_word)) ||
                      ('*' === f.last_text && 'function' === d)
                      ? h.space_after_anon_function && (o.space_before_token = !0)
                      : 'TK_RESERVED' !== l ||
                        (!G(f.last_text, a.line_starters) && 'catch' !== f.last_text) ||
                        (h.space_before_conditional && (o.space_before_token = !0))
                    : (o.space_before_token = !0);
              '(' === s.text &&
                'TK_RESERVED' === l &&
                'await' === f.last_word &&
            ...
            TK_END_EXPR: function() {
              ...
              h.space_in_paren &&
                ('TK_START_EXPR' !== l || h.space_in_empty_paren
                  ? (o.space_before_token = !0)
                  : (o.trim(), (o.space_before_token = !1)));
              ']' === s.text && h.keep_array_indentation ? (S(), x()) : (x(), S());
              o.remove_redundant_indentation(p),
                f.do_while &&
                  p.mode === k.Conditional &&
                  ((p.mode = k.Expression), (f.do_block = !1), (f.do_while = !1));
            },
            TK_START_BLOCK: function() {
              var e = I(1),
                t = I(2);
              t &&
              ((':' === t.text && G(e.type, ['TK_STRING', 'TK_WORD', 'TK_RESERVED'])) ||
                (G(e.text, ['get', 'set']) && G(t.type, ['TK_WORD', 'TK_RESERVED'])))
                ? G(d, ['class', 'interface'])
                  ? y(k.BlockStatement)
                  : y(k.ObjectLiteral)
                : y(k.BlockStatement);
              var n =
                ...
                'TK_END_EXPR' === l;
              'expand' === h.brace_style || ('none' === h.brace_style && s.wanted_newline)
                ? 'TK_OPERATOR' !== l &&
                  (n ||
                    'TK_EQUALS' === l ||
                    ('TK_RESERVED' === l && O(f.last_text) && 'else' !== f.last_text))
                  ? (o.space_before_token = !0)
                  : A(!1, !0)
                : 'TK_OPERATOR' !== l && 'TK_START_EXPR' !== l
                  ? 'TK_START_BLOCK' === l
                    ? A()
                    : (o.space_before_token = !0)
                  : L(p.mode) &&
                    ',' === f.last_text &&
                    ('}' === d ? (o.space_before_token = !0) : A());
              S(), R();
            },
              ...
              'expand' === h.brace_style
                ...
                : e ||
                  (L(f.mode) && h.keep_array_indentation
                    ? ((h.keep_array_indentation = !1), A(), (h.keep_array_indentation = !0))
                    : A());
              x(), S();
            },
            TK_WORD: D,
            ...
            TK_OPERATOR: function() {
              ...
              G(s.text, ['--', '++', '!', '~']) ||
              (G(s.text, ['-', '+']) &&
                (G(l, ['TK_START_BLOCK', 'TK_START_EXPR', 'TK_EQUALS', 'TK_OPERATOR']) ||
                  G(f.last_text, a.line_starters) ||
                  ',' === f.last_text))
                ? ((t = e = !1),
                  !s.wanted_newline || ('--' !== s.text && '++' !== s.text) || A(!1, !0),
                  ';' === f.last_text && _(f.mode) && (e = !0),
                  'TK_RESERVED' === l
                    ? (e = !0)
                    : 'TK_END_EXPR' === l
                      ? (e = !(']' === f.last_text && ('--' === s.text || '++' === s.text)))
                      : 'TK_OPERATOR' === l &&
                        ((e =
                          G(s.text, ['--', '-', '++', '+']) &&
                          G(f.last_text, ['--', '-', '++', '+'])),
                        G(s.text, ['+', '-']) && G(f.last_text, ['--', '++']) && (t = !0)),
                  (f.mode !== k.BlockStatement && f.mode !== k.Statement) ||
                    ('{' !== f.last_text && ';' !== f.last_text) ||
                    A())
                : ':' === s.text
                  ? 0 === f.ternary_depth
                    ? (e = !1)
            ...
            TK_COMMA: function() {
              if (f.declaration_statement)
                return (
                  _(f.parent.mode) && (f.declaration_assignment = !1),
                  S(),
                  void (f.declaration_assignment
                    ? A((f.declaration_assignment = !1), !0)
                    : ((o.space_before_token = !0), h.comma_first && T()))
                );
              S(),
                f.mode === k.ObjectLiteral ||
                (f.mode === k.Statement && f.parent.mode === k.ObjectLiteral)
                  ? (f.mode === k.Statement && x(), A())
                  : ((o.space_before_token = !0), h.comma_first && T());
            },
            TK_BLOCK_COMMENT: function() {
              if (o.raw)
                return (
                  ...
                  void (
                    s.directives &&
                    'end' === s.directives.preserve &&
                    (h.test_output_raw || (o.raw = !1))
                  )
                );
              if (s.directives)
                return (
                  A(!1, !0), S(), 'start' === s.directives.preserve && (o.raw = !0), void A(!1, !0)
                );
            ...
            TK_DOT: function() {
              w();
              'TK_RESERVED' === l && O(f.last_text)
                ? (o.space_before_token = !0)
                : T(')' === f.last_text && h.break_chained_methods);
              S();
            },
            TK_UNKNOWN: function() {
            ...
            (e = e || {}).braces_on_own_line !== undefined &&
              (h.brace_style = e.braces_on_own_line ? 'expand' : 'collapse'),
            ...
            h.break_chained_methods =
              e.break_chained_methods !== undefined && e.break_chained_methods,
            h.max_preserve_newlines =
              e.max_preserve_newlines === undefined ? 0 : parseInt(e.max_preserve_newlines, 10),
            ...
            h.space_after_anon_function =
              e.space_after_anon_function !== undefined && e.space_after_anon_function,
            h.keep_array_indentation =
              e.keep_array_indentation !== undefined && e.keep_array_indentation,
            h.space_before_conditional =
              e.space_before_conditional === undefined || e.space_before_conditional,
            h.unescape_strings = e.unescape_strings !== undefined && e.unescape_strings,
            h.wrap_line_length =
              e.wrap_line_length === undefined ? 0 : parseInt(e.wrap_line_length, 10),
        ...
        function b(e) {
          var t = e.newlines;
          if (h.keep_array_indentation && L(f.mode)) for (n = 0; n < t; n += 1) A(0 < n);
          else if (
            (h.max_preserve_newlines &&
        ...
        function T(e) {
          if (((e = e !== undefined && e), !o.just_added_newline()))
            if ((h.preserve_newlines && s.wanted_newline) || e) A(!1, !0);
              ...
              o.current_line.get_character_count() +
                s.text.length +
                (o.space_before_token ? 1 : 0) >=
        ...
        function C() {
          o.just_added_newline() &&
            (h.keep_array_indentation && L(f.mode) && s.wanted_newline
              ? (o.current_line.push(s.whitespace_before), (o.space_before_token = !1))
              : o.set_indent(f.indentation_level) && (f.line_indent_level = f.indentation_level));
        }
        function S(e) {
          o.raw
            ? o.add_raw_token(s)
            : (h.comma_first &&
                'TK_COMMA' === l &&
                o.just_added_newline() &&
                ',' === o.previous_line.last() &&
                (o.previous_line.pop(), C(), o.add_token(','), (o.space_before_token = !0)),
              (e = e || s.text),
              C(),
              o.add_token(e));
        }
        ...
        function x() {
          0 < t.length &&
            ((p = f), (f = t.pop()), p.mode === k.Statement && o.remove_redundant_indentation(p));
        }
        function N() {
          return (
            f.parent.mode === k.ObjectLiteral &&
            f.mode === k.Statement &&
            ((':' === f.last_text && 0 === f.ternary_depth) ||
              ('TK_RESERVED' === l && G(f.last_text, ['get', 'set'])))
          );
        }
        function w() {
          return (
            !!(
              ('TK_RESERVED' === l &&
                G(f.last_text, ['var', 'let', 'const']) &&
                'TK_WORD' === s.type) ||
              ('TK_RESERVED' === l && 'do' === f.last_text) ||
              ('TK_RESERVED' === l && 'return' === f.last_text && !s.wanted_newline) ||
              ('TK_RESERVED' === l &&
                'else' === f.last_text &&
                ('TK_RESERVED' !== s.type || 'if' !== s.text)) ||
              ('TK_END_EXPR' === l && (p.mode === k.ForInitializer || p.mode === k.Conditional)) ||
              ('TK_WORD' === l &&
                f.mode === k.BlockStatement &&
                !f.in_case &&
                '--' !== s.text &&
                '++' !== s.text &&
                'function' !== d &&
            ...
            N() || T('TK_RESERVED' === s.type && G(s.text, ['do', 'for', 'if', 'while'])),
            !0)
          );
        }
        function O(e) {
        ...
        function D() {
          ('TK_RESERVED' === s.type &&
            ...
            G(s.text, ['set', 'get']) &&
            (s.type = 'TK_WORD'),
          'TK_RESERVED' === s.type && f.mode === k.ObjectLiteral) &&
            (':' == I(1).text && (s.type = 'TK_WORD'));
          if (
            (w() ||
              !s.wanted_newline ||
              _(f.mode) ||
              ('TK_OPERATOR' === l && '--' !== f.last_text && '++' !== f.last_text) ||
              'TK_EQUALS' === l ||
              (!h.preserve_newlines &&
                'TK_RESERVED' === l &&
                G(f.last_text, ['var', 'let', 'const', 'set', 'get'])) ||
              A(),
          ...
          if (
            'TK_RESERVED' === s.type &&
            ('case' === s.text || ('default' === s.text && f.in_case_statement))
          )
            return (
              A(),
              (f.case_body || h.jslint_happy) &&
                (0 < f.indentation_level &&
                  (!f.parent || f.indentation_level > f.parent.indentation_level) &&
                  (f.indentation_level -= 1),
                (f.case_body = !1)),
              S(),
              (f.in_case = !0),
          ...
          if (
            ('TK_RESERVED' === s.type &&
              'function' === s.text &&
              ((G(f.last_text, ['}', ';']) ||
                (o.just_added_newline() && !G(f.last_text, ['[', '{', ':', '=', ',']))) &&
                (o.just_added_blankline() || s.comments_before.length || (A(), A(!0))),
              'TK_RESERVED' === l || 'TK_WORD' === l
                ? 'TK_RESERVED' === l &&
                  G(f.last_text, ['get', 'set', 'new', 'return', 'export', 'async'])
                  ? (o.space_before_token = !0)
                  : 'TK_RESERVED' === l && 'default' === f.last_text && 'export' === d
                    ? (o.space_before_token = !0)
                    : A()
                : 'TK_OPERATOR' === l || '=' === f.last_text
                  ? (o.space_before_token = !0)
                  : (f.multiline_frame || (!_(f.mode) && !L(f.mode))) && A()),
            ('TK_COMMA' !== l &&
              'TK_START_EXPR' !== l &&
              'TK_EQUALS' !== l &&
              'TK_OPERATOR' !== l) ||
              N() ||
              T(),
            'TK_RESERVED' === s.type && G(s.text, ['function', 'get', 'set']))
          )
          ...
          'TK_END_BLOCK' === l
            ? 'TK_RESERVED' === s.type && G(s.text, ['else', 'catch', 'finally'])
              ? 'expand' === h.brace_style ||
                ...
                ('none' === h.brace_style && s.wanted_newline)
                ? (n = 'NEWLINE')
                : ((n = 'SPACE'), (o.space_before_token = !0))
              : (n = 'NEWLINE')
            : 'TK_SEMICOLON' === l && f.mode === k.BlockStatement
              ? (n = 'NEWLINE')
              : 'TK_SEMICOLON' === l && _(f.mode)
                ? (n = 'SPACE')
                : 'TK_STRING' === l
                  ? (n = 'NEWLINE')
                  : 'TK_RESERVED' === l ||
                    ...
                    : 'TK_START_BLOCK' === l
                      ? (n = 'NEWLINE')
                      : 'TK_END_EXPR' === l && ((o.space_before_token = !0), (n = 'NEWLINE')),
          'TK_RESERVED' === s.type &&
            G(s.text, a.line_starters) &&
            ')' !== f.last_text &&
            (n = 'else' === f.last_text || 'export' === f.last_text ? 'SPACE' : 'NEWLINE'),
          'TK_RESERVED' === s.type && G(s.text, ['else', 'catch', 'finally']))
            ? 'TK_END_BLOCK' !== l ||
              'expand' === h.brace_style ||
              'end-expand' === h.brace_style ||
              ('none' === h.brace_style && s.wanted_newline)
              ? A()
              : (o.trim(!0), '}' !== o.current_line.last() && A(), (o.space_before_token = !0))
            : 'NEWLINE' === n
              ? 'TK_RESERVED' === l && O(f.last_text)
                ? (o.space_before_token = !0)
                : 'TK_END_EXPR' !== l
                  ? ('TK_START_EXPR' === l &&
                      'TK_RESERVED' === s.type &&
                      G(s.text, ['var', 'let', 'const'])) ||
                    ':' === f.last_text ||
                    ('TK_RESERVED' === s.type && 'if' === s.text && 'else' === f.last_text
                      ? (o.space_before_token = !0)
                      : A())
                  : 'TK_RESERVED' === s.type &&
                    G(s.text, a.line_starters) &&
                    ')' !== f.last_text &&
                    A()
              : f.multiline_frame && L(f.mode) && ',' === f.last_text && '}' === d
                ? A()
                : 'SPACE' === n && (o.space_before_token = !0);
          S(),
            (f.last_word = s.text),
        ...
        (l = 'TK_START_BLOCK'),
          (d = ''),
          ((o = new F(c, m)).raw = h.test_output_raw),
          (t = []),
          y(k.BlockStatement),
        ...
        (this.baseIndentString = n),
          ...
          (this.add_new_line = function(e) {
            return (
              ...
              (!(!e && this.just_added_newline()) && (this.raw || this.add_outputline(), !0))
            );
          }),
          ...
          (this.trim = function(e) {
            for (
              e = e !== undefined && e, this.current_line.trim(t, n);
      ...
      function M(y, L, e) {
        ...
        function o() {
          ...
          if ((n.length && (D = n.join('')), x.test(r))) {
            var i = !0,
              ...
              o = x;
            for (
              '0' === r && M < $ && /[Xxo]/.test(y.charAt(M))
                ? ((a = i = !1),
                  (r += y.charAt(M)),
                  (M += 1),
                  (o = /[o]/.test(y.charAt(M)) ? N : w))
                : ((r = ''), (M -= 1));
              M < $ && o.test(y.charAt(M));
              ...
              (r += y.charAt(M)),
                ...
                a &&
                  ...
                  /[Ee]/.test(y.charAt(M)) &&
                  ((r += y.charAt(M)),
                  (M += 1) < $ && /[+-]/.test(y.charAt(M)) && ((r += y.charAt(M)), (M += 1)),
                  (i = a = !1));
            return [r, 'TK_WORD'];
          }
          if (Y.isIdentifierStart(y.charCodeAt(M - 1))) {
            ...
            return 'TK_DOT' === t.type ||
              ('TK_RESERVED' === t.type && G(t.text, ['set', 'get'])) ||
              !G(r, B)
              ? [r, 'TK_WORD']
              : 'in' === r
                ? [r, 'TK_OPERATOR']
          ...
          if ('/' === r) {
            ...
            if ('*' === y.charAt(M)) {
              ...
              return (
                d &&
                  'start' === d.ignore &&
                  ((W.lastIndex = M), (s += (l = W.exec(y))[0]), (M += l[0].length)),
          ...
          if (
            ...
            (('/' === r ||
              ...
              (('TK_RESERVED' === t.type &&
                G(t.text, ['return', 'case', 'throw', 'else', 'do', 'typeof', 'yield'])) ||
                ('TK_END_EXPR' === t.type &&
                  ')' === t.text &&
                  t.parent &&
                  'TK_RESERVED' === t.parent.type &&
                  G(t.parent.text, ['if', 'while', 'for'])) ||
                G(t.type, [
                  'TK_COMMENT',
                  'TK_START_EXPR',
                  'TK_START_BLOCK',
            ...
            if (((e = r), '/' === c))
              for (
                var u = !1;
                M < $ && (f || u || y.charAt(M) !== c) && !Y.newline.test(y.charAt(M));
              ...
              for (
                ;
                M < $ && (f || (y.charAt(M) !== c && ('`' === c || !Y.newline.test(y.charAt(M)))));

              )
                (f || '`' === c) && Y.newline.test(y.charAt(M))
                  ? ('\r' === y.charAt(M) && '\n' === y.charAt(M + 1) && (M += 1), (e += '\n'))
                  : (e += y.charAt(M)),
                  f
                    ? (('x' !== y.charAt(M) && 'u' !== y.charAt(M)) || (p = !0), (f = !1))
                    : (f = '\\' === y.charAt(M)),
                  (M += 1);
            if (
              (p &&
          ...
          if ('#' === r) {
            ...
            if (M < $ && x.test(y.charAt(M))) {
              ...
              return (
                '#' === r ||
                  ('[' === y.charAt(M) && ']' === y.charAt(M + 1)
                    ? ((S += '[]'), (M += 2))
                    : '{' === y.charAt(M) && '}' === y.charAt(M + 1) && ((S += '{}'), (M += 2))),
                [S, 'TK_WORD']
              );
            }
          }
          if ('<' === r && ('?' === y.charAt(M) || '%' === y.charAt(M))) {
            ...
            if (R)
              return (
                (r = R[0]), (M += r.length - 1), [(r = r.replace(Y.lineBreak, '\n')), 'TK_STRING']
              );
          }
        ...
        this.tokenize = function() {
          ...
          for (var r = null, i = [], a = []; !t || 'TK_EOF' !== t.type; ) {
            for (
              n = o(), e = new X(n[1], n[0], I, D);
              'TK_COMMENT' === e.type || 'TK_BLOCK_COMMENT' === e.type || 'TK_UNKNOWN' === e.type;

            )
              'TK_BLOCK_COMMENT' === e.type && (e.directives = n[2]),
                a.push(e),
                (n = o()),
                (e = new X(n[1], n[0], I, D));
            a.length && ((e.comments_before = a), (a = [])),
              'TK_START_BLOCK' === e.type || 'TK_START_EXPR' === e.type
                ? ((e.parent = t), i.push(r), (r = e))
                : ('TK_END_BLOCK' === e.type || 'TK_END_EXPR' === e.type) &&
                  r &&
                  ((']' === e.text && '[' === r.text) ||
                    (')' === e.text && '(' === r.text) ||
                    ('}' === e.text && '{' === r.text)) &&
                  ((e.parent = r.parent), (r = i.pop())),
              F.push(e),
              (t = e);
          }
          return F;
        ...
        run: function(e, t) {
          ...
          for (
            ((t = t || {}).wrap_line_length !== undefined &&
              ...
              r = t.indent_inner_html !== undefined && t.indent_inner_html,
              i = t.indent_size === undefined ? 4 : parseInt(t.indent_size, 10),
              ...
              d = l
                ...
                : 0,
              E = t.indent_handlebars !== undefined && t.indent_handlebars,
              b = t.wrap_attributes === undefined ? 'auto' : t.wrap_attributes,
              T =
                t.wrap_attributes_indent_size === undefined
                  ? i
                  : parseInt(t.wrap_attributes_indent_size, 10) || i,
              c = t.end_with_newline !== undefined && t.end_with_newline,
              f = Array.isArray(t.extra_liners)
                ? t.extra_liners.concat()
                : 'string' == typeof t.extra_liners
                  ? t.extra_liners.split(',')
                  : 'head,body,/html'.split(','),
              t.indent_with_tabs && ((m = '\t'), (i = 1)),
              (n = new function() {
                return (
                  (this.pos = 0),
                  (this.token = ''),
                  ...
                  (this.space_or_wrap = function(e) {
                    this.line_char_count >= this.wrap_line_length
                      ? (this.print_newline(!1, e), this.print_indentation(e))
                      : (this.line_char_count++, e.push(' '));
                  }),
                  ...
                  (this.get_contents_to = function(e) {
                    ...
                    return (
                      this.pos < i && ((t = this.input.substring(this.pos, i)), (this.pos = i)), t
                    );
                  }),
                  ...
                  (this.get_tag = function(e) {
                    ...
                    return (
                      '/' == h.charAt(h.length - 2) ||
                      this.Utils.in_array(g, this.Utils.single_token)
                        ...
                        : E && '{' == h[0] && 'else' == g
                          ...
                          : this.is_unformatted(g, v)
                            ...
                            : 'script' == g &&
                              ...
                              : 'style' == g &&
                                (-1 == h.search('type') ||
                                  (-1 < h.search('type') && -1 < h.search('text/css')))
                                ...
                                : '!' == g.charAt(0)
                                  ...
                                  : e ||
                                    ('/' == g.charAt(0)
                                      ...
                                      : (this.record_tag(g),
                                        'html' != g.toLowerCase() && (this.indent_content = !0),
                                        (this.tag_type = 'START')),
                  ...
                  (this.get_comment = function(e) {
                    ...
                    for (
                      ...
                      ((t += i)[t.length - 1] != n[n.length - 1] || -1 == t.indexOf(n));
                    ...
                    do {
                      ...
                      (r += n),
                        ...
                        E &&
                          ...
                          r.length &&
                          '{' == r[r.length - 2] &&
                          (i = (r += this.get_unformatted('}}')).length);
                  ...
                  (this.get_full_indent = function(e) {
                    return (e = this.indent_level + e || 0) < 1
                      ? ''
                      : new Array(e + 1).join(this.indent_string);
                  }),
              ...
              case 'TK_TAG_END':
                if ('TK_CONTENT' == n.last_token && '' === n.last_text) {
                  var u = n.token_text.match(/\w+/)[0],
                    h = null;
                  n.output.length &&
                    (h = n.output[n.output.length - 1].match(/(?:<|{{#)\/?\s*(\w+)/)),
                    (null == h || (h[1] != u && !n.Utils.in_array(h[1], v))) &&
                      n.print_newline(!1, n.output);
                }
                ...
                if ('' !== n.token_text) {
                  ...
                  'TK_SCRIPT' == n.token_type ? (A = N) : 'TK_STYLE' == n.token_type && (A = x),
                    'keep' == t.indent_scripts
                      ? (S = 0)
                      : 'separate' == t.indent_scripts && (S = -n.indent_level);
    ...
    (Ee.FE.PLUGINS.codeView = function(l) {
        ...
        f() &&
          ...
          l.opts.heightMin || l.opts.height
            ? l.$box
                ...
                .css('min-height', l.opts.heightMin || l.opts.height)
      ...
      function i(e) {
        d ||
              ...
              l.$box.hasClass('fr-basic') ||
                ((h = Ee(
                  '<a data-cmd="html" title="Code View" class="fr-command fr-btn html-switch' +
                    (l.helpers.isMobile() ? '' : ' fr-desktop') +
                    '" role="button" tabIndex="-1"><i class="fa fa-code"></i></button>'
                )),
                l.$box.append(h),
                l.events.bindClick(l.$box, 'a.html-switch', function() {
                  l.events.trigger('commands.before', ['html']),
                    E(!1),
                    l.events.trigger('commands.after', ['html']);
                }));
            var e = function() {
              return !f();
            };
          ...
          !c && l.opts.codeMirror
            ? ((c = l.opts.codeMirror.fromTextArea(d.get(0), l.opts.codeMirrorOptions)).on(
                'blur',
                m
              ),
              c.on('focus', v))
        ...
        var n,
          ...
          i = !1;
        if (
          (l.core.hasFocus() && ((i = !0), l.events.disableBlur(), l.$el.blur()),
          (t = (t = t.replace(/<span class="fr-tmp fr-sm">F<\/span>/, 'FROALA-SM')).replace(
            /<span class="fr-tmp fr-em">F<\/span>/,
            'FROALA-EM'
          )),
          l.codeBeautifier && (t = l.codeBeautifier.run(t, l.opts.codeBeautifierOptions)),
          c)
        ) {
          (n = t.indexOf('FROALA-SM')), (r = t.indexOf('FROALA-EM')) < n ? (n = r) : (r -= 9);
          var a =
              (t = t.replace(/FROALA-SM/g, '').replace(/FROALA-EM/g, '')).substring(0, n).length -
          ...
          (n =
            ...
            l.opts.heightMin &&
              l.$box.find('.CodeMirror-scroll').css('min-height', l.opts.heightMin),
            c.setValue(t),
            (g = !i),
            c.focus(),
            (g = !0),
            c.setSelection({ line: a, ch: n }, { line: o, ch: r }),
            c.refresh(),
            c.clearHistory();
        } else {
    ...
    Ee.FE.DefineIcon('html', { NAME: 'code' }),
  ...
  if (
    ((Ee.FE.PLUGINS.colors = function(g) {
      ...
      function a(e) {
        for (
          var t = 'text' == e ? g.opts.colorsText : g.opts.colorsBackground,
            n =
              '<div class="fr-color-set fr-' +
              e +
              '-color' +
              (g.opts.colorsDefaultTab == e ||
              ('text' != g.opts.colorsDefaultTab &&
                'background' != g.opts.colorsDefaultTab &&
                'text' == e)
                ? ' fr-selected-set'
                : '') +
              '">',
          ...
          0 !== r && r % g.opts.colorsStep == 0 && (n += '<br>'),
            'REMOVE' != t[r]
              ? (n +=
      ...
      function r(e) {
        'REMOVE' != e
          ? g.format.applyStyle('background-color', g.helpers.HEXtoRGB(e))
          : g.format.removeStyle('background-color'),
          t();
      }
      function i(e) {
        'REMOVE' != e
          ? g.format.applyStyle('color', g.helpers.HEXtoRGB(e))
      ...
      return {
        showColorsPopup: function() {
          ...
          if (
            (t ||
              (t = (function() {
                ...
                g.opts.toolbarInline &&
                  ...
                  (t += g.button.buildList(g.opts.colorsButtons)),
                  (t += ((e = '<div class="fr-colors-tabs fr-group">'),
                  (e +=
                    '<span class="fr-colors-tab ' +
                    ('background' == g.opts.colorsDefaultTab ? '' : 'fr-selected-tab ') +
                    'fr-command" tabIndex="-1" role="button" aria-pressed="' +
                    ('background' != g.opts.colorsDefaultTab) +
                    '" data-param1="text" data-cmd="colorChangeSet" title="' +
                    g.language.translate('Text') +
                    '">' +
                    g.language.translate('Text') +
                    '</span>'),
                  (e +=
                    ...
                    g.language.translate('Background') +
                    '">' +
                    g.language.translate('Background') +
                    '</span>') + '</div></div>'));
                var n = '';
                  ...
                  g.events.on(
                    ...
                    function(e) {
                      ...
                      if (Ee.FE.KEYCODE.TAB == n) {
                        ...
                        Ee.FE.KEYCODE.ARROW_UP == n ||
                        Ee.FE.KEYCODE.ARROW_DOWN == n ||
                        Ee.FE.KEYCODE.ARROW_LEFT == n ||
                        Ee.FE.KEYCODE.ARROW_RIGHT == n
                      ) {
                        if (t.is('span.fr-select-color')) {
                          ...
                          Ee.FE.KEYCODE.ARROW_UP == n
                            ...
                            : Ee.FE.KEYCODE.ARROW_DOWN == n
                              ...
                              : Ee.FE.KEYCODE.ARROW_LEFT == n
                                ? (f = (((f - 1) % p) + p) % p)
                                : Ee.FE.KEYCODE.ARROW_RIGHT == n && (f = (f + 1) % p);
                          var u = Ee(a.get(f));
            ...
            if (
              (g.popups.setContainer('colors.picker', g.$tb),
              l.map(function(e) {
                !(function(e) {
                  var t,
                  ...
                  for (
                    i.find('.fr-selected-color').remove(),
                      i.removeClass('fr-active-item'),
                      i.not('[data-param1="REMOVE"]').attr('aria-selected', !1);
                    r.get(0) != g.el;
        ...
        changeSet: function(e, t) {
          e.hasClass('fr-selected-tab') ||
            (e
              .siblings()
              .removeClass('fr-selected-tab')
              .attr('aria-pressed', !1),
            e.addClass('fr-selected-tab').attr('aria-pressed', !0),
            e
              .parents('.fr-popup')
              .find('.fr-color-set')
    ...
    Ee.FE.DefineIcon('colors', { NAME: 'tint' }),
    ...
    Ee.FE.RegisterCommand('colorChangeSet', {
      ...
      callback: function(e, t) {
        var n = this.popups
          .get('colors.picker')
          .find('.fr-command[data-cmd="' + e + '"][data-param1="' + t + '"]');
        this.colors.changeSet(n, t);
      },
    }),
    Ee.FE.DefineIcon('colorsBack', { NAME: 'arrow-left' }),
    ...
    Ee.FE.DefineIcon('remove', { NAME: 'eraser' }),
    Ee.extend(Ee.FE.DEFAULTS, { dragInline: !0 }),
    (Ee.FE.PLUGINS.draggable = function(d) {
            ...
            : (e.preventDefault(),
              (function(e) {
                ...
                if (!c(t)) {
                  for (
                    var n = 0, r = t;
                    !c(r) && r == t && 0 < e.originalEvent.pageY - d.win.pageYOffset - n;

                  )
                    n++,
                      (r = d.doc.elementFromPoint(
                        e.originalEvent.pageX - d.win.pageXOffset,
                        e.originalEvent.pageY - d.win.pageYOffset - n
                      ));
                  ...
                  for (
                    ...
                    !c(a) &&
                    a == t &&
                    e.originalEvent.pageY - d.win.pageYOffset + i < Ee(d.doc).height();

                  )
                    i++,
                      (a = d.doc.elementFromPoint(
                        e.originalEvent.pageX - d.win.pageXOffset,
                        e.originalEvent.pageY - d.win.pageYOffset + i
                      ));
                  (!c(a) || (p && 0 === d.$el.find(a).length && a != p.get(0))) && (a = null),
                ...
                if (
                  ...
                  t &&
                    0 <= ['TD', 'TH', 'TR', 'THEAD', 'TBODY'].indexOf(t.tagName) &&
                    (t = Ee(t)
                      .parents('table')
                      .get(0)),
                  t &&
                    ...
                    (t = Ee(t)
                      .parents('UL, OL')
                      .get(0)),
                  t && !Ee(t).hasClass('fr-drag-helper'))
                ) {
                  var o;
                  p ||
                    (Ee.FE.$draggable_helper ||
                      (Ee.FE.$draggable_helper = Ee('<div class="fr-drag-helper"></div>')),
                    (p = Ee.FE.$draggable_helper),
                    d.events.on(
                      'shared.destroy',
                      function() {
                        p
                  ...
                  o || 0 !== s.next().length
                    ? (o || (s = s.next()),
                      ('before' == p.data('fr-position') && s.is(p.data('fr-tag'))) ||
                        (0 < s.prev().length &&
                          (l = parseFloat(s.prev().css('margin-bottom')) || 0),
                        (l = Math.max(l, parseFloat(s.css('margin-top')) || 0)),
                        f(
                          s.offset().top - l / 2 - d.$box.offset().top,
                          s.offset().left - d.win.pageXOffset - d.$box.offset().left,
                          s.width()
                        ),
                    ...
                    : ('after' == p.data('fr-position') && s.is(p.data('fr-tag'))) ||
                      ...
                      f(
                        s.offset().top + Ee(t).height() + l / 2 - d.$box.offset().top,
                        s.offset().left - d.win.pageXOffset - d.$box.offset().left,
                        s.width()
                      ),
      ...
      function r(e) {
        ...
        p && p.hasClass('fr-visible') && d.$box.find(p).length
          ? i(e)
      ...
      function i(e) {
        ...
        if (t.length) {
          if (
            ...
            p.data('fr-tag')[p.data('fr-position')]('<span class="fr-marker"></span>'),
              p.removeClass('fr-visible');
          else if (!1 === d.markers.insertAtPoint(e.originalEvent)) return !1;
          if (
            (t.removeClass('fr-dragging'),
            !1 === (t = d.events.chainTrigger('element.beforeDrop', t)))
          )
            return !1;
          var i = t;
          if (
            (t.parent().is('A') && 1 == t.parent().get(0).childNodes.length && (i = t.parent()),
            d.core.isEmpty())
          )
            d.events.focus();
          ...
          if ((n == d || d.undo.canDo() || d.undo.saveStep(), d.core.isEmpty())) d.$el.html(i);
            ...
            0 === i.find(a).length
              ? Ee(a).replaceWith(i)
              : 0 === t.find(a).length && Ee(a).replaceWith(t),
    ...
    Ee.extend(Ee.FE.POPUP_TEMPLATES, { emoticons: '[_BUTTONS_][_EMOTICONS_]' }),
    Ee.extend(Ee.FE.DEFAULTS, {
      emoticonsStep: 8,
      emoticonsSet: [
    ...
    (Ee.FE.PLUGINS.emoticons = function(m) {
      ...
      return {
        _init: function() {
          var e = function() {
            for (
              var e = m.el.querySelectorAll('.fr-emoticon:not(.fr-deletable)'), t = 0;
              t < e.length;
              t++
            )
            ...
            m.events.on('keydown', function(e) {
              if (m.keys.isCharacter(e.which) && m.selection.inEditor()) {
                ...
                m.node.hasClass(n, 'fr-emoticon-img') &&
                  n &&
                  (0 === t.startOffset && m.selection.element() === n
                    ? Ee(n).before(Ee.FE.MARKERS + Ee.FE.INVISIBLE_SPACE)
                    : Ee(n).after(Ee.FE.INVISIBLE_SPACE + Ee.FE.MARKERS),
                  m.selection.restore());
              }
            }),
          ...
          n
            ? (0 === r.startOffset && m.selection.element() === n
                ...
                : 0 < r.startOffset &&
                  ...
                  r.commonAncestorContainer.parentNode.classList.contains('fr-emoticon') &&
                  Ee(n).after(Ee.FE.INVISIBLE_SPACE + Ee.FE.MARKERS),
              m.selection.restore(),
              m.html.insert(
              ...
              (t = (function() {
                ...
                m.opts.toolbarInline &&
                  ...
                  (e =
                    ...
                    m.button.buildList(m.opts.emoticonsButtons) +
                    '</div>');
                var g,
                  t = {
                    buttons: e,
                    emoticons: (function() {
                      for (
                        var e = '<div style="text-align: center">', t = 0;
                        t < m.opts.emoticonsSet.length;
                        t++
                      )
                        0 !== t && t % m.opts.emoticonsStep == 0 && (e += '<br>'),
                          (e +=
                            '<span class="fr-command fr-emoticon" tabIndex="-1" data-cmd="insertEmoticon" title="' +
                            m.language.translate(m.opts.emoticonsSet[t].desc) +
                            '" role="button" data-param1="' +
                            m.opts.emoticonsSet[t].code +
                            '">' +
                            (m.opts.emoticonsUseImage
                              ? '<img src="https://cdnjs.cloudflare.com/ajax/libs/emojione/2.0.1/assets/svg/' +
                                m.opts.emoticonsSet[t].code +
                                '.svg"/>'
                              : '&#x' + m.opts.emoticonsSet[t].code + ';') +
                            '<span class="fr-sr-only">' +
                            m.language.translate(m.opts.emoticonsSet[t].desc) +
                            '&nbsp;&nbsp;&nbsp;</span></span>');
                      return (
                  ...
                  m.events.on(
                    ...
                    function(e) {
                      ...
                      if (Ee.FE.KEYCODE.TAB == a) {
                        if (
                          (t.is('span.fr-emoticon') && e.shiftKey) ||
                          (t.is('a') && !e.shiftKey)
                        ) {
                        ...
                        if (!1 !== n) {
                          var s = g.find(
                            'span.fr-emoticon:focus:first, span.fr-emoticon:visible:first, a'
                          );
                          t.is('span.fr-emoticon') && (s = s.not('span.fr-emoticon:not(:focus)')),
                            (r = s.index(t)),
                            (r = e.shiftKey
                              ? (((r - 1) % s.length) + s.length) % s.length
                              : (r + 1) % s.length),
                            (i = s.get(r)),
                        ...
                        Ee.FE.KEYCODE.ARROW_UP == a ||
                        Ee.FE.KEYCODE.ARROW_DOWN == a ||
                        Ee.FE.KEYCODE.ARROW_LEFT == a ||
                        Ee.FE.KEYCODE.ARROW_RIGHT == a
                      ) {
                        if (t.is('span.fr-emoticon')) {
                          ...
                          Ee.FE.KEYCODE.ARROW_UP == a
                            ...
                            : Ee.FE.KEYCODE.ARROW_DOWN == a
                              ...
                              : Ee.FE.KEYCODE.ARROW_LEFT == a
                                ? (u = (((u - 1) % h) + h) % h)
                                : Ee.FE.KEYCODE.ARROW_RIGHT == a && (u = (u + 1) % h),
                            (i = Ee(l.get(u))),
                            m.events.disableBlur(),
                            i.focus(),
                            (n = !1);
                        ...
                        Ee.FE.KEYCODE.ENTER == a &&
                          (t.is('a') ? t[0].click() : m.button.exec(t), (n = !1));
    ...
    Ee.FE.DefineIcon('emoticons', { NAME: 'smile-o', FA5NAME: 'smile' }),
      ...
      callback: function(e, t) {
        this.emoticons.insert(
          ...
          this.opts.emoticonsUseImage
            ? 'https://cdnjs.cloudflare.com/ajax/libs/emojione/2.0.1/assets/svg/' + t + '.svg'
            : null
        ),
          this.emoticons.hideEmoticonsPopup();
      },
    }),
    Ee.FE.DefineIcon('emoticonsBack', { NAME: 'arrow-left' }),
    ...
    (Ee.FE.PLUGINS.file = function(d) {
                ...
                try {
                  var t = Ee(e)
                    ...
                    n = Ee(e)
                      .find('Key')
                      .text();
                  return !1 === d.events.trigger('file.uploadedToS3', [t, n, e], !0)
                    ? (d.edit.on(), !1)
                    : t;
                } catch (r) {
                  return T(p, e), !1;
      ...
      function T(e, t) {
        d.edit.on(),
          ...
          d.events.trigger('file.error', [{ code: e, message: n[e] }, t]);
      }
      function A() {
        d.edit.on(), i(!0);
      }
      function o(e) {
        if (void 0 !== e && 0 < e.length) {
          ...
          var t,
            n = e[0];
          if (
            (null === d.opts.fileUploadURL || d.opts.fileUploadURL == c) &&
            ...
            return (
              ...
              ((l = new FileReader()).onload = function() {
                for (
                  var e = l.result, t = atob(l.result.split(',')[1]), n = [], r = 0;
                  r < t.length;
                  r++
                )
                  n.push(t.charCodeAt(r));
                (e = window.URL.createObjectURL(new Blob([new Uint8Array(n)], { type: s.type }))),
          ...
          if (
            ...
            d.opts.fileAllowedTypes.indexOf(n.type.replace(/file\//g, '')) < 0
          )
            return T(h), !1;
          if (
            (d.drag_support.formdata && (t = d.drag_support.formdata ? new FormData() : null), t)
          ) {
            var r;
            if (!1 !== d.opts.fileUploadToS3)
              for (r in (t.append(
                'key',
                d.opts.fileUploadToS3.keyStart + new Date().getTime() + '-' + (n.name || 'untitled')
              ),
              t.append('success_action_status', '201'),
              t.append('X-Requested-With', 'xhr'),
              t.append('Content-Type', n.type),
              d.opts.fileUploadToS3.params))
                d.opts.fileUploadToS3.params.hasOwnProperty(r) &&
            ...
            d.opts.fileUploadToS3 &&
              (i = d.opts.fileUploadToS3.uploadURL
            ...
            (a.onload = function() {
              ...
              (a.onerror = E),
              (a.upload.onprogress = b),
              (a.onabort = A),
              g();
            var o = d.popups.get('file.insert');
            o &&
              o.off('abortUpload').on('abortUpload', function() {
      ...
      function C(e) {
        ...
        var t;
        d.opts.fileUpload ||
          d.opts.fileInsertButtons.splice(d.opts.fileInsertButtons.indexOf('fileUpload'), 1),
          (t =
            '<div class="fr-buttons">' + d.button.buildList(d.opts.fileInsertButtons) + '</div>');
        var n = '';
        d.opts.fileUpload &&
          (n =
        ...
        return (
          ...
          d.helpers.isIOS() &&
            d.events.$on(r, 'touchstart', '.fr-file-upload-layer input[type="file"]', function() {
          ...
          if (n && 'undefined' != typeof n.type) {
            if (n.type.indexOf('image') < 0) {
              ...
              d.markers.remove(),
                ...
                d.$el.find('.fr-marker').replaceWith(Ee.FE.MARKERS),
                d.popups.hideAll();
              var r = d.popups.get('file.insert');
              return (
                r || (r = C()),
                d.popups.setContainer('file.insert', d.$sc),
                d.popups.show('file.insert', e.originalEvent.pageX, e.originalEvent.pageY),
                g(),
                o(t.files),
                e.preventDefault(),
                e.stopPropagation(),
      ...
      return (
        ...
        (n[l] = 'No link in upload response.'),
        (n[f] = 'Error during file upload.'),
        (n[p] = 'Parsing response failed.'),
        (n[u] = 'File is too large.'),
        (n[h] = 'File file type is invalid.'),
        (n[7] = 'Files can be uploaded only to same domain in IE 8 and IE 9.'),
        {
          _init: function() {
            d.events.on('drop', t),
              ...
              d.events.on('link.beforeRemove', e),
              d.$wp && (S(), d.events.on('contentChanged', S)),
              C(!0);
          },
    ...
    Ee.FE.DefineIcon('insertFile', { NAME: 'file-o', FA5NAME: 'file' }),
    ...
    Ee.FE.DefineIcon('fileBack', { NAME: 'arrow-left' }),
          ...
          r.length
            ? n
                ...
                .scrollTop(
                  r.offset().top -
                    n.offset().top -
                    (n.parent().outerHeight() / 2 - r.outerHeight() / 2)
                )
            : n.parent().scrollTop(0);
        },
        refresh: function(e) {
          if (i.opts.fontFamilySelection) {
            var t = Ee(i.selection.element())
              .css('font-family')
              .replace(/(sans-serif|serif|monospace|cursive|fantasy)/gi, '')
              .replace(/"|'|/g, '')
              .split(',');
            e.find('> span').text(
              i.opts.fontFamily[s()] ||
                t[0] ||
                i.language.translate(i.opts.fontFamilyDefaultSelection)
            );
          }
        },
      };
    ...
    Ee.FE.DefineIcon('fontFamily', { NAME: 'font' }),
    Ee.extend(Ee.FE.DEFAULTS, {
    ...
    (Ee.FE.PLUGINS.fontSize = function(a) {
      return {
        ...
        refreshOnShow: function(e, t) {
          ...
          'pt' === a.opts.fontSizeUnit && (n = Math.round((72 * parseFloat(n, 10)) / 96) + 'pt'),
            t
              .find('.fr-command.fr-active')
              .removeClass('fr-active')
              .attr('aria-selected', !1),
          ...
          i.length
            ? r
                ...
                .scrollTop(
                  i.offset().top -
                    r.offset().top -
                    (r.parent().outerHeight() / 2 - i.outerHeight() / 2)
                )
            : r.parent().scrollTop(0);
        },
        refresh: function(e) {
          if (a.opts.fontSizeSelection) {
            var t = a.helpers.getPX(Ee(a.selection.element()).css('font-size'));
            'pt' === a.opts.fontSizeUnit && (t = Math.round((72 * parseFloat(t, 10)) / 96) + 'pt'),
              e.find('> span').text(t);
          }
        },
      };
    ...
    Ee.FE.DefineIcon('fontSize', { NAME: 'text-height' }),
    Ee.extend(Ee.FE.POPUP_TEMPLATES, {
    ...
    (Ee.FE.PLUGINS.forms = function(a) {
      ...
      function t(e) {
        Ee(this).data('mousedown') &&
          (e.stopPropagation(), Ee(this).removeData('mousedown'), l((o = this))),
          e.preventDefault();
      }
      function n() {
      ...
      function l(e) {
        ...
        t ||
          (t = (function() {
            var e = '';
            0 < a.opts.formEditButtons.length &&
              (e =
                '<div class="fr-buttons">' + a.button.buildList(a.opts.formEditButtons) + '</div>');
            var t = { buttons: e },
      ...
      function d() {
        ...
        if (t) {
          var n = Ee(t);
          n.is('button')
            ? e.find('input[type="text"][name="text"]').val(n.text())
            : e.find('input[type="text"][name="text"]').val(n.attr('placeholder'));
        }
      ...
      function f(e) {
        ...
        var t = '';
        1 <= a.opts.formUpdateButtons.length &&
          (t =
            '<div class="fr-buttons">' + a.button.buildList(a.opts.formUpdateButtons) + '</div>');
        var n = '',
          r = 0;
      ...
      return {
        _init: function() {
          a.events.$on(a.$el, a._mousedown, 'input, textarea, button', e),
            ...
            f(!0),
            a.events.$on(a.$el, 'submit', 'form', function(e) {
              return e.preventDefault(), !1;
            });
        },
    ...
    Ee.FE.DefineIcon('inputStyle', { NAME: 'magic' }),
    Ee.FE.RegisterCommand('inputStyle', {
      ...
      html: function() {
        ...
        for (var n in t)
          t.hasOwnProperty(n) &&
            (e +=
              '<li><a class="fr-command" tabIndex="-1" data-cmd="inputStyle" data-param1="' +
              n +
              '">' +
              this.language.translate(t[n]) +
              '</a></li>');
    ...
    Ee.FE.DefineIcon('inputEdit', { NAME: 'edit' }),
    ...
    Ee.FE.DefineIcon('inputBack', { NAME: 'arrow-left' }),
    ...
    (Ee.FE.PLUGINS.fullscreen = function(n) {
      ...
      function e() {
        ...
        (t = n.helpers.scrollTop()),
          ...
          n.helpers.isMobile() &&
            (n.$tb.data('parent', n.$tb.parent()),
            n.$tb.prependTo(n.$box),
      ...
      function s() {
        ...
        n.$box.toggleClass('fr-fullscreen'),
          ...
          n.opts.toolbarInline && n.toolbar.showInline(),
          n.events.trigger('charCounter.update'),
          n.opts.toolbarSticky &&
            n.opts.toolbarStickyOffset &&
            (n.opts.toolbarBottom
              ? n.$tb
                  .css('bottom', n.opts.toolbarStickyOffset)
                  .data('bottom', n.opts.toolbarStickyOffset)
              : n.$tb
                  .css('top', n.opts.toolbarStickyOffset)
                  .data('top', n.opts.toolbarStickyOffset));
        for (var e = n.$box.parent(); !e.is('body:first'); )
      ...
      function d(e) {
        ...
        e.toggleClass('fr-active', t).attr('aria-pressed', t),
          e
            .find('> *:not(.fr-sr-only)')
            .replaceWith(t ? n.icon.create('fullscreenCompress') : n.icon.create('fullscreen'));
      }
      return {
        _init: function() {
          if (!n.$wp) return !1;
    ...
    Ee.FE.DefineIcon('fullscreen', { NAME: 'expand' }),
    Ee.FE.DefineIcon('fullscreenCompress', { NAME: 'compress' }),
    Ee.extend(Ee.FE.DEFAULTS, {
      helpSets: [
        ...
        show: function() {
          if (!r) {
            var e = '<h4>' + o.language.translate('Shortcuts') + '</h4>',
              t = (function() {
                for (
                  var e = '<div class="fr-help-modal">', t = 0;
                  t < o.opts.helpSets.length;
                  t++
                ) {
                  ...
                  for (var i = 0; i < n.commands.length; i++) {
                    ...
                    (r += '<tr>'),
                      ...
                      (r +=
                        '<td>' +
                        a.val.replace('OSkey', o.helpers.isMac() ? '&#8984;' : 'Ctrl+') +
                        '</td>'),
                      (r += '</tr>');
                  }
                  e += r += '</tbody></table>';
            ...
            (r = n.$modal),
              n.$head,
              n.$body,
              o.events.$on(Ee(o.o_win), 'resize', function() {
                o.modals.resize(i);
              });
          }
    ...
    Ee.FroalaEditor.DefineIcon('help', { NAME: 'question' }),
    Ee.FE.RegisterShortcut(Ee.FE.KEYCODE.SLASH, 'help', null, '/'),
    Ee.FE.RegisterCommand('help', {
      title: 'Help',
      icon: 'help',
      undo: !1,
      focus: !1,
    ...
    (Ee.FE.PLUGINS.image = function(f) {
      ...
      function e() {
        for (
          var e, t, n = 'IMG' == f.el.tagName ? [f.el] : f.el.querySelectorAll('img'), r = 0;
          r < n.length;
          r++
        ) {
          var i = Ee(n[r]);
          !f.opts.htmlUntouched && f.opts.useClasses
            ? ((f.opts.imageDefaultAlign || f.opts.imageDefaultDisplay) &&
                (0 < (t = i).parents('.fr-img-caption').length &&
                  (t = t.parents('.fr-img-caption:first')),
                t.hasClass('fr-dii') ||
                  t.hasClass('fr-dib') ||
                  (t.addClass('fr-fi' + fe(t)[0]),
                  t.addClass('fr-di' + pe(t)[0]),
                  t.css('margin', ''),
                  t.css('float', ''),
                  t.css('display', ''),
                  t.css('z-index', ''),
            ...
            : f.opts.htmlUntouched ||
              ...
              ((f.opts.imageDefaultAlign || f.opts.imageDefaultDisplay) &&
                ...
                ce(
                  e,
                  e.hasClass('fr-dib') ? 'block' : e.hasClass('fr-dii') ? 'inline' : null,
                  e.hasClass('fr-fil') ? 'left' : e.hasClass('fr-fir') ? 'right' : fe(e)
                ),
                e.removeClass('fr-dib fr-dii fr-fir fr-fil'))),
            f.opts.iframe && i.on('load', f.size.syncIframe);
        }
      }
      function A(e) {
        void 0 === e && (e = !0);
        ...
        for (t = 0; t < n.length; t++)
          if (
            ...
            Ee(n[t]).toggleClass('fr-draggable', f.opts.imageMove),
            '' === n[t].getAttribute('class') && n[t].removeAttribute('class'),
            '' === n[t].getAttribute('style') && n[t].removeAttribute('style'),
            n[t].parentNode &&
              n[t].parentNode.parentNode &&
              f.node.hasClass(n[t].parentNode.parentNode, 'fr-img-caption'))
          ) {
            var i = n[t].parentNode.parentNode;
            f.browser.mozilla || i.setAttribute('contenteditable', !1),
        ...
        if (s)
          for (t = 0; t < s.length; t++)
            r.indexOf(s[t].getAttribute('src')) < 0 &&
              f.events.trigger('image.removed', [Ee(s[t])]);
        if (s && e) {
          var o = [];
      ...
      function C() {
          ...
          (l ||
            (function() {
              ...
              f.shared.$image_resizer
                ...
                : ((f.shared.$image_resizer = Ee('<div class="fr-image-resizer"></div>')),
                  (l = f.shared.$image_resizer),
                  f.events.$on(
                    l,
                    'mousedown',
                  ...
                  f.opts.imageResize &&
                    (l.append(o('nw') + o('ne') + o('sw') + o('se')),
                    (f.shared.$img_overlay = Ee('<div class="fr-image-overlay"></div>')),
                    (c = f.shared.$img_overlay),
              ...
              f.events.on(
                ...
                function() {
                  l
                    ...
                    .remove(),
                    (l = null),
                    f.opts.imageResize && (c.remove(), (c = null));
                },
                !0
              ),
                f.helpers.isMobile() ||
                  f.events.$on(Ee(f.o_win), 'resize', function() {
                    p && !p.hasClass('fr-uploading') ? oe(!0) : p && (C(), ue(), N(!1));
                  });
              if (f.opts.imageResize) {
                (e = l.get(0).ownerDocument),
                  f.events.$on(l, f._mousedown, '.fr-handler', R),
                  f.events.$on(Ee(e), f._mousemove, y),
                  f.events.$on(Ee(e.defaultView || e.parentWindow), f._mouseup, L),
                  f.events.$on(c, 'mouseleave', L);
                var r = 1,
                  i = null,
                  a = 0;
                f.events.on(
                  ...
                  function(e) {
                    if (p) {
                      var t = -1 != navigator.userAgent.indexOf('Mac OS X') ? e.metaKey : e.ctrlKey,
                        n = e.which;
                      (n !== i || 200 < e.timeStamp - a) && (r = 1),
                        (n == Ee.FE.KEYCODE.EQUALS ||
                          (f.browser.mozilla && n == Ee.FE.KEYCODE.FF_EQUALS)) &&
                        t &&
                        !e.altKey
                          ? (r = j.call(this, e, 1, 1, r))
                          : (n == Ee.FE.KEYCODE.HYPHEN ||
                              (f.browser.mozilla && n == Ee.FE.KEYCODE.FF_HYPHEN)) &&
                            t &&
                            !e.altKey
                            ? (r = j.call(this, e, 2, -1, r))
                            : f.keys.ctrlKey(e) ||
                              n != Ee.FE.KEYCODE.ENTER ||
                              (p.before('<br>'), I(p)),
                        (i = n),
        ...
        ve() && (r = r.find('.fr-img-wrap')),
          l
            .css('top', (f.opts.iframe ? r.offset().top : r.offset().top + t) - 1)
            .css('left', (f.opts.iframe ? r.offset().left : r.offset().left + n) - 1)
      ...
      function R(e) {
        ...
        if ('mousedown' == e.type) {
          ...
          i &&
            r.frameElement &&
            (t += f.helpers.getPX(Ee(r.frameElement).offset().left) + r.frameElement.clientLeft);
        }
        (d = Ee(this)).data('start-x', t),
          d.data('start-width', p.width()),
          d.data('start-height', p.height());
        var a = p.width();
      ...
      function y(e) {
        ...
        if (d && p) {
          ...
          if (
            ((d.hasClass('fr-hnw') || d.hasClass('fr-hsw')) && (r = 0 - r),
            ...
            (i = (((i + r) / Ee(a).outerWidth()) * 100).toFixed(2)),
              f.opts.imageRoundPercent && (i = Math.round(i)),
              S(i + '%'),
              (t = ve()
                ? (
                    (f.helpers.getPX(p.parents('.fr-img-caption').css('width')) /
                      Ee(a).outerWidth()) *
                    100
                  ).toFixed(2)
                : ((f.helpers.getPX(p.css('width')) / Ee(a).outerWidth()) * 100).toFixed(2)) ===
                i ||
                f.opts.imageRoundPercent ||
                S(t + '%'),
              p.css('height', '').removeAttr('height');
          } else
            i + r >= f.opts.imageMinWidth &&
              (S(i + r),
              (t = ve()
                ? f.helpers.getPX(p.parents('.fr-img-caption').css('width'))
                : f.helpers.getPX(p.css('width')))),
              t !== i + r && S(t),
              ((p.attr('style') || '').match(/(^height:)|(; *height:)/) || p.attr('height')) &&
                (p.css('height', (d.data('start-height') * p.width()) / d.data('start-width')),
                p.removeAttr('height'));
      ...
      function L(e) {
        ...
        if (d && p) {
          ...
          (d = null),
            ...
            a(),
            f.undo.saveStep(),
            f.events.trigger('image.resizeEnd', [ge()]);
        }
      }
      function _(e, t, n) {
        f.edit.on(),
          ...
          !p && n && Q(n),
          f.events.trigger('image.error', [{ code: e, message: i[e] }, t, n]);
      }
      function x(e) {
        if (e)
          return (
        ...
        (t.onload = function() {
          ...
          if (l) {
            ...
            e.on('load', D),
              ...
              f.events.disableBlur(),
              f.$el.blur(),
              f.events.trigger(n ? 'image.replaced' : 'image.inserted', [e, d]);
          } else
            (e = B(o, s, D)),
              A(!1),
              f.undo.saveStep(),
              f.events.disableBlur(),
              f.$el.blur(),
              f.events.trigger('image.inserted', [e, d]);
        }),
          (t.onerror = function() {
            _(r);
          }),
                ...
                try {
                  var t = Ee(e)
                    ...
                    n = Ee(e)
                      .find('Key')
                      .text();
                  return !1 === f.events.trigger('image.uploadedToS3', [t, n, e], !0)
                    ? (f.edit.on(), !1)
                    : t;
                } catch (r) {
                  return _(m, e), !1;
      ...
      function B(e, t, n) {
        ...
        ce(o, f.opts.imageDefaultDisplay, f.opts.imageDefaultAlign),
          o.on('load', n),
          o.on('error', n),
          f.edit.on(),
          f.events.focus(!0),
      ...
      function U(e, t) {
        if (void 0 !== e && 0 < e.length) {
          ...
          var n,
            r = e[0];
          if (
            (null === f.opts.imageUploadURL || f.opts.imageUploadURL == u) &&
              ...
              ((l = new FileReader()).onload = function() {
                ...
                if (l.result.indexOf('svg+xml') < 0) {
                  for (var t = atob(l.result.split(',')[1]), n = [], r = 0; r < t.length; r++)
                    n.push(t.charCodeAt(r));
                  (e = window.URL.createObjectURL(new Blob([new Uint8Array(n)], { type: o.type }))),
          ...
          if (
            (r.name ||
              (r.name =
                new Date().getTime() + '.' + (r.type || 'image/jpeg').replace(/image\//g, '')),
            r.size > f.opts.imageMaxSize)
          )
            return _(v), !1;
          if (f.opts.imageAllowedTypes.indexOf(r.type.replace(/image\//g, '')) < 0) return _(E), !1;
          if (
            (f.drag_support.formdata && (n = f.drag_support.formdata ? new FormData() : null), n)
          ) {
            var i;
            if (!1 !== f.opts.imageUploadToS3)
              ...
              f.opts.imageUploadToS3.params))
                f.opts.imageUploadToS3.params.hasOwnProperty(i) &&
                  n.append(i, f.opts.imageUploadToS3.params[i]);
            for (i in f.opts.imageUploadParams)
              f.opts.imageUploadParams.hasOwnProperty(i) &&
                n.append(i, f.opts.imageUploadParams[i]);
            n.append(f.opts.imageUploadParam, r, r.name);
            var a = f.opts.imageUploadURL;
            f.opts.imageUploadToS3 &&
              (a = f.opts.imageUploadToS3.uploadURL
                  ...
                  e.off('load'),
                    ...
                    e.off('abortUpload').on('abortUpload', function() {
                      4 != t.readyState &&
                        (t.abort(),
                        i
                          ? (i.attr('src', i.data('fr-old-src')), i.removeClass('fr-uploading'))
                          : e.remove(),
                        oe(!0));
                    }),
                    t.send(n);
      ...
      function H(e) {
        ...
        if (t && t.files && t.files.length) {
          ...
          if (
            ...
            0 <= f.opts.imageAllowedTypes.indexOf(n.type.replace(/image\//g, ''))
          ) {
            ...
            f.markers.remove(),
              ...
              0 === f.$el.find('.fr-marker').length && f.selection.setAtEnd(f.el),
              f.popups.hideAll();
            ...
            return (
              f.opts.iframe && ((a += f.$iframe.offset().top), (i += f.$iframe.offset().left)),
              f.popups.show('image.insert', i, a),
              N(),
              0 <= f.opts.imageAllowedTypes.indexOf(n.type.replace(/image\//g, ''))
                ? (oe(!0), U(t.files))
                : _(E),
      ...
      function W(e) {
        ...
        f.opts.imageUpload ||
          ...
          f.opts.imageInsertButtons.splice(f.opts.imageInsertButtons.indexOf('imageUpload'), 1);
        ...
        return (
          1 <= f.opts.imageInsertButtons.length && (n = f.popups.create('image.insert', c)),
          f.$wp &&
      ...
      function G(e) {
        ...
        var t = {
            buttons:
              '<div class="fr-buttons">' + f.button.buildList(f.opts.imageAltButtons) + '</div>',
            alt_layer:
      ...
      function q(e) {
        ...
        var t = {
            buttons:
              '<div class="fr-buttons">' + f.button.buildList(f.opts.imageSizeButtons) + '</div>',
            size_layer:
          ...
          e.get(0) == f.el
            ...
            : (e.get(0).parentNode && 'A' == e.get(0).parentNode.tagName
                ? (f.selection.setBefore(e.get(0).parentNode) ||
                    f.selection.setAfter(e.get(0).parentNode) ||
                    e.parent().after(Ee.FE.MARKERS),
                  Ee(e.get(0).parentNode).remove())
                : (f.selection.setBefore(e.get(0)) ||
                    f.selection.setAfter(e.get(0)) ||
                    e.after(Ee.FE.MARKERS),
                  e.remove()),
      ...
      function Z(e) {
        var t = e.which;
        if (p && (t == Ee.FE.KEYCODE.BACKSPACE || t == Ee.FE.KEYCODE.DELETE))
          return e.preventDefault(), e.stopPropagation(), Q(), !1;
        if (p && t == Ee.FE.KEYCODE.ESC) {
          var n = p;
          return (
            oe(!0), f.selection.setAfter(n.get(0)), f.selection.restore(), e.preventDefault(), !1
          );
        }
        if (p && (t == Ee.FE.KEYCODE.ARROW_LEFT || t == Ee.FE.KEYCODE.ARROW_RIGHT)) {
          ...
          return (
            oe(!0),
            t == Ee.FE.KEYCODE.ARROW_LEFT ? f.selection.setBefore(r) : f.selection.setAfter(r),
            f.selection.restore(),
            e.preventDefault(),
            !1
          );
        }
        return p && t === Ee.FE.KEYCODE.TAB
          ? (e.preventDefault(), e.stopPropagation(), oe(!0), !1)
          : p && t != Ee.FE.KEYCODE.F10 && !f.keys.isBrowserAction(e)
            ? (e.preventDefault(), e.stopPropagation(), !1)
            : void 0;
      }
      function J(e) {
        if (e && 'IMG' == e.tagName) {
          if (
            (f.node.hasClass(e, 'fr-uploading') || f.node.hasClass(e, 'fr-error')
              ? e.parentNode.removeChild(e)
              : f.node.hasClass(e, 'fr-draggable') && e.classList.remove('fr-draggable'),
            e.parentNode &&
              e.parentNode.parentNode &&
              f.node.hasClass(e.parentNode.parentNode, 'fr-img-caption'))
          ) {
          ...
          for (
            var r = e.querySelectorAll('img.fr-uploading, img.fr-error, img.fr-draggable'), i = 0;
            i < r.length;
            i++
          )
            J(r[i]);
      ...
      function te() {
        f.opts.imagePaste
          ? f.$el.find('img[data-fr-image-pasted]').each(function(e, r) {
              if (f.opts.imagePasteProcess) {
                var t = f.opts.imageDefaultWidth;
                t && 'auto' != t && (t += f.opts.imageResizeWithPercent ? '%' : 'px'),
                  Ee(r)
                    .css('width', t)
                    .removeClass('fr-dii fr-dib fr-fir fr-fil'),
                  ce(Ee(r), f.opts.imageDefaultDisplay, f.opts.imageDefaultAlign);
              }
              if (0 === r.src.indexOf('data:')) ee(r);
              else if (
                ...
                (n.crossOrigin = 'Anonymous'),
                  (n.onload = function() {
                    ...
                    (t.height = this.naturalHeight),
                      ...
                      (r.src = t.toDataURL('image/' + e));
                  }),
                  (n.src =
                    (0 === r.src.indexOf('blob:') ? '' : f.opts.imageCORSProxy + '/') + r.src);
              } else
                0 !== r.src.indexOf('http') || 0 === r.src.indexOf('https://mail.google.com/mail')
                  ? (f.selection.save(), Ee(r).remove(), f.selection.restore())
                  : Ee(r).removeAttr('data-fr-image-pasted');
            })
      ...
      function ne(e) {
        ...
        n && 'auto' != n && (n += f.opts.imageResizeWithPercent ? '%' : 'px'),
          f.undo.saveStep(),
          f.html.insert(
        ...
        r && ce(r, f.opts.imageDefaultDisplay, f.opts.imageDefaultAlign),
      ...
      function re(e) {
        if (e && e.clipboardData && e.clipboardData.items) {
          var t = null;
          if (
            (e.clipboardData.types && -1 != e.clipboardData.types.indexOf('text/rtf')) ||
            ...
            for (
              var n = 0;
              n < e.clipboardData.items.length && !(t = e.clipboardData.items[n].getAsFile());
              n++
            );
      ...
      function ae(e) {
        if (
          'false' ==
          Ee(this)
            .parents('[contenteditable]:not(.fr-element):not(.fr-img-caption):not(body):first')
          ...
          f.browser.msie
            ? (f.popups.areVisible() && f.events.disableBlur(),
              f.win.getSelection &&
                ...
                f.win.getSelection().addRange(f.doc.createRange())))
            : f.selection.clear(),
      ...
      (i[r] = 'Image cannot be loaded from the passed link.'),
        (i[h] = 'No link in upload response.'),
        (i[g] = 'Error during file upload.'),
        (i[m] = 'Parsing response failed.'),
        (i[v] = 'File is too large.'),
        (i[E] = 'Image file type is invalid.'),
          ...
          : 'inline' == t
            ...
            : 'block' == t &&
              ...
              'left' == n
                ...
                : 'right' == n && e.css({ marginRight: 0, textAlign: 'right' }));
      }
      function fe(e) {
        if ((void 0 === e && (e = me()), e)) {
      ...
      function pe(e) {
        ...
        return (
          e.css('float', 'none'),
          'block' == e.css('display')
            ? (e.css('float', ''), e.css('float') != t && e.css('float', t), 'block')
            : (e.css('float', ''), e.css('float') != t && e.css('float', t), 'inline')
        );
      }
      function ue() {
        ...
        e || (e = W()),
          f.popups.isVisible('image.insert') ||
            (w(), f.popups.refresh('image.insert'), f.popups.setContainer('image.insert', f.$sc));
        var t = me();
        ve() && (t = t.find('.fr-img-wrap'));
        var n = t.offset().left + t.outerWidth() / 2,
          r = t.offset().top + t.outerHeight();
      ...
      return {
        _init: function() {
          ...
          f.events.$on(
            f.$el,
            f._mousedown,
            'IMG' == f.el.tagName ? null : 'img:not([contenteditable="false"])',
            function(e) {
              if (
                'false' ==
                Ee(this)
                  .parents(
                    '[contenteditable]:not(.fr-element):not(.fr-img-caption):not(body):first'
                  )
                  .attr('contenteditable')
              )
                return !0;
            ...
            f.events.$on(
              ...
              function(e) {
                ...
                t &&
                  ((t = !1),
                  e.stopPropagation(),
                  f.browser.msie && (f.$el.attr('contenteditable', !0), f.events.enableBlur()));
              }
            ),
            f.events.on(
              'keyup',
            ...
            f.events.on('drop', H),
            f.events.on('element.beforeDrop', K),
            f.events.on('mousedown window.mousedown', le),
            f.events.on('window.touchmove', de),
            ...
            f.opts.imageAddNewLine &&
              f.events.on('image.inserted', function(e) {
                var t = e.get(0);
                for (
                  t.nextSibling && 'BR' === t.nextSibling.tagName && (t = t.nextSibling);
                  t && !f.node.isElement(t);

                )
                  t = f.node.isLastSibling(t) ? t.parentNode : null;
                f.node.isElement(t) &&
                  (f.opts.enter === Ee.FE.ENTER_BR
                    ? e.after('<br>')
                    : Ee(f.node.blockParent(e.get(0))).after(
                        '<' + f.html.defaultTag() + '><br></' + f.html.defaultTag() + '>'
                      ));
              }),
            'IMG' == f.el.tagName && f.$el.addClass('fr-view'),
            f.events.$on(
              f.$el,
              f.helpers.isMobile() && !f.helpers.isWindowsPhone() ? 'touchend' : 'click',
              'IMG' == f.el.tagName ? null : 'img:not([contenteditable="false"])',
              ae
            ),
            f.helpers.isMobile() &&
            ...
            f.$wp
              ? (f.events.on('window.keydown keydown', Z, !0),
                f.events.on(
                  'keyup',
                  function(e) {
                ...
                f.events.$on(f.$el, 'keydown', function() {
                  ...
                  e.nodeType === Node.TEXT_NODE && (e = e.parentNode),
                    f.node.hasClass(e, 'fr-inner') ||
                      (f.node.hasClass(e, 'fr-img-caption') ||
                        (e = Ee(e)
                          .parents('.fr-img-caption')
                          .get(0)),
                      f.node.hasClass(e, 'fr-img-caption') &&
                        (Ee(e).after(Ee.FE.INVISIBLE_SPACE + Ee.FE.MARKERS),
                        f.selection.restore()));
                }))
              : f.events.$on(f.$win, 'keydown', Z),
            f.events.on(
              'toolbar.esc',
              function() {
                if (p) {
            ...
            f.events.on(
              ...
              function(e) {
                if (
                  ...
                  !f.popups.get('image.edit').find(':focus').length
                ) {
                  var t = me();
                  ve()
                    ? (t.before(Ee.FE.START_MARKER),
                      t.after(Ee.FE.END_MARKER),
                      f.selection.restore(),
                      f.paste.saveCopiedText(t.get(0).outerHTML, t.text()))
                    : (he(), f.paste.saveCopiedText(p.get(0).outerHTML, p.attr('alt'))),
                    'copy' == e.type
                      ? setTimeout(function() {
                          I(p);
                        })
            ...
            f.browser.msie &&
              f.events.on('keydown', function(e) {
                ...
                var t = e.which;
                t == Ee.FE.KEYCODE.C && f.keys.ctrlKey(e)
                  ? f.events.trigger('window.copy')
                  : t == Ee.FE.KEYCODE.X && f.keys.ctrlKey(e) && f.events.trigger('window.cut');
              }),
            ...
            f.events.on('paste.before', re),
            f.events.on('paste.beforeCleanup', ie),
            f.events.on('paste.after', te),
            f.events.on('html.set', e),
            f.events.on('html.inserted', e),
            e(),
            f.events.on('destroy', function() {
              s = [];
            }),
            f.events.on('html.processGet', J),
            ...
            f.$wp && (A(), f.events.on('contentChanged', A)),
            f.events.$on(Ee(f.o_win), 'orientationchange.image', function() {
              setTimeout(function() {
                p && I(p);
              }, 100);
            }),
        ...
        showLayer: function(e) {
          ...
          if (p || f.opts.toolbarInline) {
            ...
            (t = a.offset().left + a.outerWidth() / 2),
              (n = a.offset().top + (f.opts.toolbarBottom ? 10 : a.outerHeight() - 10));
          }
          !p &&
            f.opts.toolbarInline &&
            ((n = r.offset().top - f.helpers.getPX(r.css('margin-top'))),
            r.hasClass('fr-above') && (n += r.outerHeight())),
            r.find('.fr-layer').removeClass('fr-active'),
            r.find('.fr-' + e + '-layer').addClass('fr-active'),
            f.popups.show('image.insert', t, n, p ? p.outerHeight() : 0),
        ...
        refreshUploadButton: function(e) {
          f.popups
            ...
            .hasClass('fr-active') && e.addClass('fr-active').attr('aria-pressed', !0);
        },
        ...
        insertByURL: function() {
          ...
          if (0 < e.val().length) {
            ...
            if (f.opts.imageUploadRemoteUrls && f.opts.imageCORSProxy && f.opts.imageUpload) {
              ...
              (n.onload = function() {
                200 == this.status
                  ? U([new Blob([this.response], { type: this.response.type || 'image/png' })], p)
                  : _(r);
              }),
                (n.onerror = function() {
                  k(t, !0, [], p);
                }),
                n.open('GET', f.opts.imageCORSProxy + '/' + t, !0),
                (n.responseType = 'blob'),
                n.send();
            } else k(t, !0, [], p);
            e.val(''), e.blur();
        ...
        refreshAlignOnShow: function(e, t) {
          p &&
            t
              .find('.fr-command[data-param1="' + fe() + '"]')
              .addClass('fr-active')
              .attr('aria-selected', !0);
        },
        display: function(e) {
        ...
        refreshDisplayOnShow: function(e, t) {
          p &&
            t
              .find('.fr-command[data-param1="' + pe() + '"]')
              .addClass('fr-active')
              .attr('aria-selected', !0);
        },
        replace: ue,
        back: function() {
          p
            ? (f.events.disableBlur(), Ee('.fr-popup input:focus').blur(), I(p))
            : (f.events.disableBlur(),
              f.selection.restore(),
              f.events.enableBlur(),
              f.popups.hide('image.insert'),
        ...
        setSize: function(e, t) {
          if (p) {
            ...
            p.removeAttr('width').removeAttr('height'),
              ...
              t.match(r) ? p.css('height', t) : p.css('height', ''),
              ve() &&
                (p
                  .parents('.fr-img-caption')
                  .removeAttr('width')
                ...
                e.match(r)
                  ...
                  : p.parents('.fr-img-caption').css('width', ''),
                t.match(r)
                  ? p.parents('.fr-img-caption').css('height', t)
                  : p.parents('.fr-img-caption').css('height', '')),
        ...
        toggleCaption: function() {
          ...
          if (p && !ve()) {
            ...
            e.wrap(
              ...
              p.after(
                '<span class="fr-inner"' +
                  (f.browser.mozilla ? '' : ' contenteditable="true"') +
                  '>' +
                  Ee.FE.START_MARKER +
    ...
    Ee.FE.DefineIcon('insertImage', { NAME: 'image' }),
    Ee.FE.RegisterShortcut(Ee.FE.KEYCODE.P, 'insertImage', null, 'P'),
    Ee.FE.RegisterCommand('insertImage', {
      title: 'Insert Image',
      undo: !1,
      focus: !0,
      refreshAfterCallback: !1,
    ...
    Ee.FE.DefineIcon('imageUpload', { NAME: 'upload' }),
    ...
    Ee.FE.DefineIcon('imageByURL', { NAME: 'link' }),
    ...
    Ee.FE.DefineIcon('imageDisplay', { NAME: 'star' }),
    ...
    Ee.FE.DefineIcon('image-align', { NAME: 'align-left' }),
    Ee.FE.DefineIcon('image-align-left', { NAME: 'align-left' }),
    Ee.FE.DefineIcon('image-align-right', { NAME: 'align-right' }),
    Ee.FE.DefineIcon('image-align-center', { NAME: 'align-justify' }),
    Ee.FE.DefineIcon('imageAlign', { NAME: 'align-justify' }),
    ...
    Ee.FE.DefineIcon('imageReplace', { NAME: 'exchange', FA5NAME: 'exchange-alt' }),
    ...
    Ee.FE.DefineIcon('imageRemove', { NAME: 'trash' }),
    ...
    Ee.FE.DefineIcon('imageBack', { NAME: 'arrow-left' }),
    ...
    Ee.FE.DefineIcon('imageStyle', { NAME: 'magic' }),
    ...
    Ee.FE.DefineIcon('imageAlt', { NAME: 'info' }),
    ...
    Ee.FE.DefineIcon('imageSize', { NAME: 'arrows-alt' }),
    ...
    Ee.FE.DefineIcon('imageCaption', { NAME: 'commenting', FA5NAME: 'comment-alt' }),
    ...
    (Ee.FE.PLUGINS.imageManager = function(s) {
      ...
      function y() {
        if (
          p < o.length &&
          (a.outerHeight() <= r.outerHeight() + s.opts.imageManagerScrollOffset ||
            r.scrollTop() + s.opts.imageManagerScrollOffset > a.outerHeight() - r.outerHeight())
        ) {
          f++;
          for (
            var e = s.opts.imageManagerPageSize * (f - 1);
            e < Math.min(o.length, s.opts.imageManagerPageSize * f);
            e++
          )
            t(o[e]);
        }
        ...
        N(!1),
          (a.onload = function() {
            ...
            if ((i.url && n.attr('data-url', i.url), i.tag))
              if (
                (d.find('.fr-modal-more.fr-not-available').removeClass('fr-not-available'),
                d.find('.fr-modal-tags').show(),
                0 <= i.tag.indexOf(','))
              ) {
                for (var e = i.tag.split(','), t = 0; t < e.length; t++)
                  (e[t] = e[t].trim()),
                    0 === c.find('a[title="' + e[t] + '"]').length &&
                      c.append('<a role="button" title="' + e[t] + '">' + e[t] + '</a>');
                n.attr('data-tag', e.join());
              } else
                0 === c.find('a[title="' + i.tag.trim() + '"]').length &&
                  c.append(
                    '<a role="button" title="' + i.tag.trim() + '">' + i.tag.trim() + '</a>'
                  ),
            ...
            o
              .append(n)
              .append(
                Ee(s.icon.create('imageManagerDelete'))
                  .addClass('fr-delete-img')
                  .attr('title', s.language.translate('Delete'))
              )
              .append(
                Ee(s.icon.create('imageManagerInsert'))
                  .addClass('fr-insert-img')
                  .attr('title', s.language.translate('Insert'))
              ),
          ...
          (a.onerror = function() {
            p++,
              o.remove(),
              x(_(parseInt(o.attr('class').match(/fr-image-(\d+)/)[1], 10) + 1)),
              D(e, i),
              p % s.opts.imageManagerPageSize == 0 && y();
          }),
          (a.src = i.thumb || i.url),
      ...
      function L() {
        var r, i;
        return (
          a.find('.fr-list-column').each(function(e, t) {
            var n = Ee(t);
            0 === e
              ? ((i = n.outerHeight()), (r = n))
              : n.outerHeight() < i && ((i = n.outerHeight()), (r = n));
          }),
          r
        );
      }
      function _(e) {
        ...
        for (var t = [], n = u - 1; e <= n; n--) {
          ...
          r.length &&
            (t.push(r),
            Ee('<div id="fr-image-hidden-container">').append(r),
            a.find('.fr-image-' + n).remove());
        }
        return t;
      }
      function x(e) {
      ...
      function I(e) {
        ...
        confirm(t) &&
          (s.opts.imageManagerDeleteURL
            ? !1 !== s.events.trigger('imageManager.beforeDeleteImage', [n]) &&
              (n.parent().addClass('fr-image-deleting'),
              Ee.ajax({
                method: s.opts.imageManagerDeleteMethod,
                url: s.opts.imageManagerDeleteURL,
                data: Ee.extend(
                  Ee.extend({ src: n.attr('src') }, w(n)),
                ...
                .done(function(e) {
                  ...
                  n.parent().remove(),
                    ...
                    l.find('#fr-modal-tags > a').each(function() {
                      0 === l.find('#fr-image-list [data-tag*="' + Ee(this).text() + '"]').length &&
                        Ee(this)
                          .removeClass('fr-selected-tag')
                          .hide();
                    }),
                    F(),
                    N(!0);
      ...
      function D(e, t) {
        10 <= e && e < 20
          ? i.hide()
          : 20 <= e && e < 30 && Ee('.fr-image-deleting').removeClass('fr-image-deleting'),
          s.events.trigger('imageManager.error', [{ code: e, message: n[e] }, t]);
      }
      function k() {
        var e = d.find('.fr-modal-head-line').outerHeight(),
          t = c.outerHeight();
        d.toggleClass('fr-show-tags'),
          d.hasClass('fr-show-tags')
            ? (d.css('height', e + t), c.find('a').css('opacity', 1))
            : (d.css('height', e), c.find('a').css('opacity', 0));
      }
      function F() {
          ...
          show: function() {
            ...
            l.data('current-image', s.image.get()),
              ...
              i ||
                ...
                (a = l.find('#fr-image-list')),
                (c = l.find('#fr-modal-tags')),
                (h = S()),
                R(),
                d.css('height', d.find('.fr-modal-head-line').outerHeight()),
                s.events.$on(Ee(s.o_win), 'resize', function() {
                  N(!!o);
                }),
                s.helpers.isMobile() &&
                  (s.events.bindClick(a, 'div.fr-image-container', function(e) {
                ...
                s.events.bindClick(a, '.fr-insert-img', O),
                s.events.bindClick(a, '.fr-delete-img', I),
                ...
                r.on('scroll', y),
                s.events.bindClick(l, '#fr-modal-more-' + s.sid, k),
                s.events.bindClick(c, 'a', M)),
              i.show(),
  ...
  Ee.FE.DEFAULTS.imageInsertButtons.push('imageManager'),
    ...
    Ee.FE.DefineIcon('imageManager', { NAME: 'folder' }),
    Ee.FE.DefineIcon('imageManagerInsert', { NAME: 'plus' }),
    Ee.FE.DefineIcon('imageManagerDelete', { NAME: 'trash' }),
    Ee.extend(Ee.FE.DEFAULTS, {
      inlineClasses: {
        'fr-class-code': 'Code',
    ...
    Ee.FE.DefineIcon('inlineClass', { NAME: 'tag' }),
    Ee.extend(Ee.FE.DEFAULTS, {
      inlineStyles: {
      ...
      return {
        apply: function(e) {
          if ('' !== i.selection.text())
            ...
            i.html.insert(
              '<span style="' + e + '">' + Ee.FE.INVISIBLE_SPACE + Ee.FE.MARKERS + '</span>'
            );
        },
      };
    }),
        ...
        for (var n in t) {
          if (t.hasOwnProperty(n))
            e +=
              ...
              (t[n] + (-1 === t[n].indexOf('display:block;') ? ' display:block;' : '')) +
    ...
    Ee.FE.DefineIcon('inlineStyle', { NAME: 'paint-brush' }),
    Ee.extend(Ee.FE.DEFAULTS, {
    ...
    (Ee.FE.PLUGINS.lineBreaker = function(p) {
      ...
      function s(e, t) {
        var n, r, i, a, o, s, l, d;
        if (null == e)
          (o = (a = t.parent()).offset().top),
            (n = (l = t.offset().top) - Math.min((l - o) / 2, p.opts.lineBreakerOffset)),
            (i = a.outerWidth()),
            (r = a.offset().left);
        else if (null == t)
          (s = (a = e.parent()).offset().top + a.outerHeight()) <
            (d = e.offset().top + e.outerHeight()) &&
            (s = (a = Ee(a).parent()).offset().top + a.outerHeight()),
        ...
        p.opts.iframe &&
          ((r += p.$iframe.offset().left - p.helpers.scrollLeft()),
          (n += p.$iframe.offset().top - p.helpers.scrollTop())),
          p.$box.append(u),
      ...
      function l(e) {
        if (e) {
          ...
          if (0 < t.parents(p.opts.lineBreakerTags.join(',')).length)
            return (
              (e = t.parents(p.opts.lineBreakerTags.join(',')).get(0)),
              0 !== p.$el.find(e).length && Ee(e).is(p.opts.lineBreakerTags.join(','))
                ? Ee(e)
                : null
            );
        }
      ...
      function a(e, t) {
        ...
        return n &&
          !Ee(n).closest('.fr-line-breaker').length &&
          !p.node.isElement(n) &&
          n != p.$wp.get(0) &&
          (function(e) {
      ...
      function d(e, t, n) {
        for (
          var r = null, i = 100;
          !r && e > p.$box.offset().left && e < p.$box.offset().left + p.$box.outerWidth() && 0 < i;

        )
          (r = a(e, t)) || (r = o(e, t, 5)),
            'left' == n
              ? (e -= p.opts.lineBreakerHorizontalOffset)
              : (e += p.opts.lineBreakerHorizontalOffset),
      ...
      function n(e) {
        ...
        ('HTML' == r.tagName ||
          'BODY' == r.tagName ||
          p.node.isElement(r) ||
          0 <= (r.getAttribute('class') || '').indexOf('fr-line-breaker'))
          ? ((n = o(e.pageX - p.win.pageXOffset, e.pageY - p.win.pageYOffset, 1)) ||
              (n = d(
                e.pageX - p.win.pageXOffset - p.opts.lineBreakerHorizontalOffset,
                e.pageY - p.win.pageYOffset,
                'left'
              )),
            n ||
              (n = d(
          ...
          t
            ? (function(e, t) {
                ...
                if (
                  Math.abs(a - t) <= p.opts.lineBreakerOffset ||
                  Math.abs(t - i) <= p.opts.lineBreakerOffset
                )
                  if (Math.abs(a - t) < Math.abs(t - i)) {
                    for (
                      var o = (r = e.get(0)).nextSibling;
                      o && o.nodeType == Node.TEXT_NODE && 0 === o.textContent.length;
            ...
            : p.core.sameInstance(u) && u.removeClass('fr-visible').removeData('instance');
      }
      function e(e) {
        return (
          !(u.hasClass('fr-visible') && !p.core.sameInstance(u)) &&
          (p.popups.areVisible() || p.el.querySelector('.fr-selected-cell')
            ? (u.removeClass('fr-visible'), !0)
            : void (
                !1 !== t ||
                p.edit.isDisabled() ||
                (i && clearTimeout(i), (i = setTimeout(n, 30, e)))
              ))
        );
      }
      function r() {
        i && clearTimeout(i),
          u && u.hasClass('fr-visible') && u.removeClass('fr-visible').removeData('instance');
      }
      function c() {
        (t = !0), r();
      }
      ...
      function h(e) {
        ...
        var n = u.data('tag1'),
          ...
          i = p.html.defaultTag();
        null == n
          ? i && 'TD' != r.parent().get(0).tagName && 0 === r.parents(i).length
            ? r.before('<' + i + '>' + Ee.FE.MARKERS + '<br></' + i + '>')
            : r.before(Ee.FE.MARKERS + '<br>')
          : i && 'TD' != n.parent().get(0).tagName && 0 === n.parents(i).length
            ? n.after('<' + i + '>' + Ee.FE.MARKERS + '<br></' + i + '>')
            : n.after(Ee.FE.MARKERS + '<br>'),
          t.selection.restore();
      }
      return {
        _init: function() {
          if (!p.$wp) return !1;
          p.shared.$line_breaker ||
            (p.shared.$line_breaker = Ee(
              '<div class="fr-line-breaker"><a class="fr-floating-btn" role="button" tabIndex="-1" title="' +
                p.language.translate('Break') +
    ...
    Ee.extend(Ee.FE.DEFAULTS, {
      lineHeights: { Default: '', Single: '1', 1.15: '1.15', 1.5: '1.5', Double: '2' },
    }),
    (Ee.FE.PLUGINS.lineHeight = function(i) {
      return {
        ...
        apply: function(e) {
          ...
          i.selection.save();
          for (var n = 0; n < t.length; n++)
            Ee(t[n]).css('line-height', e),
              '' === Ee(t[n]).attr('style') && Ee(t[n]).removeAttr('style');
    ...
    Ee.FE.DefineIcon('lineHeight', { NAME: 'arrows-v', FA5NAME: 'arrows-alt-v' }),
    Ee.extend(Ee.FE.POPUP_TEMPLATES, {
      'link.edit': '[_BUTTONS_]',
    ...
    (Ee.FE.PLUGINS.link = function(f) {
      function p() {
        ...
        if (!e && f.$wp) {
          ...
          return r && r == n && 'A' == r.tagName
            ? (f.browser.msie || f.helpers.isMobile()) &&
              (f.selection.info(n).atEnd || f.selection.info(n).atStart)
              ? null
              : n
            : null;
        }
        return 'A' == f.el.tagName
          ? f.el
        ...
        if (i) 'A' == i.get(0).parentNode.tagName && a.push(i.get(0).parentNode);
          ...
          if (o.getRangeAt && o.rangeCount) {
            ...
            for (var s = 0; s < o.rangeCount; ++s)
              if (
                ((t = (e = o.getRangeAt(s)).commonAncestorContainer) &&
                  1 != t.nodeType &&
                  (t = t.parentNode),
                ...
                for (var l = 0; l < n.length; ++l)
                  r.selectNodeContents(n[l]),
                    r.compareBoundaryPoints(e.END_TO_START, e) < 1 &&
                      -1 < r.compareBoundaryPoints(e.START_TO_END, e) &&
                      a.push(n[l]);
              }
          }
        } else if (f.doc.selection && 'Control' != f.doc.selection.type)
          if (
            'a' == (t = (e = f.doc.selection.createRange()).parentElement()).nodeName.toLowerCase()
          )
            a.push(t);
          else {
            (n = t.getElementsByTagName('a')), (r = f.doc.body.createTextRange());
            for (var d = 0; d < n.length; ++d)
              r.moveToElementText(n[d]),
      ...
      function h(i) {
        if (f.core.hasFocus()) {
          if ((o(), i && 'keyup' === i.type && (i.altKey || i.which == Ee.FE.KEYCODE.ALT)))
            return !0;
          setTimeout(function() {
              ...
              if (e && !t) {
                if (f.image) {
                  ...
                  if (1 == n.length && 'IMG' == n[0].tagName) {
                    ...
                    return (
                      0 === r.startOffset && 0 === r.endOffset
                        ? Ee(e).before(Ee.FE.MARKERS)
                        : Ee(e).after(Ee.FE.MARKERS),
                      f.selection.restore(),
                      !1
                    );
      ...
      function a(e) {
        ...
        t ||
          (t = (function() {
            var e = '';
            1 <= f.opts.linkEditButtons.length &&
              ('A' == f.el.tagName &&
                0 <= f.opts.linkEditButtons.indexOf('linkRemove') &&
                f.opts.linkEditButtons.splice(f.opts.linkEditButtons.indexOf('linkRemove'), 1),
              (e =
                '<div class="fr-buttons">' +
                f.button.buildList(f.opts.linkEditButtons) +
                '</div>'));
            var t = { buttons: e },
              n = f.popups.create('link.edit', t);
            f.$wp &&
              f.events.$on(f.$wp, 'scroll.link-edit', function() {
      ...
      function s(e) {
        ...
        var t = '';
        1 <= f.opts.linkInsertButtons.length &&
          (t =
            '<div class="fr-buttons">' + f.button.buildList(f.opts.linkInsertButtons) + '</div>');
        var n = '',
          r = 0;
        for (var i in ((n =
        ...
        f.opts.linkText &&
          (n +=
            ...
            f.language.translate('Text') +
            '" tabIndex="' +
            ++r +
            '"></div>'),
        f.opts.linkAttributes))
          if (f.opts.linkAttributes.hasOwnProperty(i)) {
            ...
            n +=
              ...
              f.language.translate(a) +
              '" tabIndex="' +
              ++r +
              '"></div>';
          }
        f.opts.linkAlwaysBlank ||
          (n +=
            ...
            f.id +
            '">' +
            f.language.translate('Open in new tab') +
            '</label></div>');
        var o = {
            buttons: t,
            input_layer: (n +=
        ...
        return (
          f.$wp &&
            f.events.$on(f.$wp, 'scroll.link-insert', function() {
              (f.image ? f.image.get() : null) && f.popups.isVisible('link.insert') && m(),
      ...
      function c(e, t, n) {
        ...
        r || 'A' == f.el.tagName
          ? 'A' == f.el.tagName && f.$el.focus()
          : (f.selection.restore(), f.popups.hide('link.insert'));
        var i = e;
        f.opts.linkConvertEmailAddress &&
          f.helpers.isEmail(e) &&
          !/^mailto:.*/i.test(e) &&
          (e = 'mailto:' + e);
        if (
          ('' === f.opts.linkAutoPrefix ||
            new RegExp('^(' + Ee.FE.LinkProtocols.join('|') + '):.', 'i').test(e) ||
            /^data:image.*/i.test(e) ||
            /^(https?:|ftps?:|file:|)\/\//i.test(e) ||
            /^([A-Za-z]:(\\){1,2}|[A-Za-z]:((\\){1,2}[^\\]+)+)(\\)?$/i.test(e) ||
            (['/', '{', '[', '#', '(', '.'].indexOf((e || '')[0]) < 0 &&
              (e = f.opts.linkAutoPrefix + f.helpers.sanitizeURL(e))),
          (e = f.helpers.sanitizeURL(e)),
          f.opts.linkAlwaysBlank && (n.target = '_blank'),
          f.opts.linkAlwaysNoFollow && (n.rel = 'nofollow'),
          f.helpers.isEmail(i) && ((n.target = null), (n.rel = null)),
          '_blank' == n.target
            ? (f.opts.linkNoOpener && (n.rel ? (n.rel += ' noopener') : (n.rel = 'noopener')),
              f.opts.linkNoReferrer && (n.rel ? (n.rel += ' noreferrer') : (n.rel = 'noreferrer')))
            : null == n.target &&
              (n.rel
                ? (n.rel = n.rel.replace(/noopener/, '').replace(/noreferrer/, ''))
                : (n.rel = null)),
          (t = t || ''),
          e === f.opts.linkAutoPrefix)
        )
          return (
            f.popups
              .get('link.insert')
        ...
        if (o) {
          if (((a = Ee(o)).attr('href', e), 0 < t.length && a.text() != t && !r)) {
            for (
              var s = a.get(0);
              1 === s.childNodes.length && s.childNodes[0].nodeType == Node.ELEMENT_NODE;
          ...
          r
            ? (r.wrap('<a href="' + e + '"></a>'),
              f.image.hasCaption() &&
                r.parent().append(r.parents('.fr-img-caption').find('.fr-inner')))
            : (f.format.remove('a'),
              f.selection.isCollapsed()
                ? ((t = 0 === t.length ? i : t),
                  ...
                  f.selection.restore())
                : 0 < t.length && t != f.selection.text().replace(/\n/g, '')
                  ? (f.selection.remove(),
                    f.html.insert(
                      '<a href="' +
                        e +
                        ...
                        for (
                          ...
                          if (n) {
                            for (
                              ...
                              (r = r.parentNode),
                                f.node.isBlock(r) ||
                                  ((i += f.node.closeTagString(r)),
                                  (a = f.node.openTagString(r) + a)),
                                r != n;

                            );
                            var o =
                              f.node.openTagString(t.get(0)) +
                              t.html() +
                              f.node.closeTagString(t.get(0));
          ...
          1 == l.length &&
            ...
            !r &&
            (Ee(l[0])
              .prepend(Ee.FE.START_MARKER)
              .append(Ee.FE.END_MARKER),
            f.selection.restore());
        }
        if (r) {
      ...
      function g() {
        ...
        if (e) {
          ...
          t || (t = s()),
            f.popups.isVisible('link.insert') ||
              (f.popups.refresh('link.insert'),
              f.selection.save(),
              f.helpers.isMobile() &&
                (f.events.disableBlur(), f.$el.blur(), f.events.enableBlur())),
      ...
      return {
        _init: function() {
          f.events.on('keyup', function(e) {
            ...
            f.events.$on(f.$el, 'click', 'a', function(e) {
        ...
        remove: function() {
          ...
          t && e
            ? (t.unwrap(), f.image.edit(t))
            : e &&
              (f.selection.save(), Ee(e).replaceWith(Ee(e).html()), f.selection.restore(), o());
        },
        showInsertPopup: function() {
        ...
        back: function() {
          f.image && f.image.get()
            ...
            : (f.events.disableBlur(),
              ...
              f.events.enableBlur(),
              p() && f.$wp
                ? (f.selection.restore(), o(), h())
                : 'A' == f.el.tagName
                  ? (f.$el.focus(), h())
                  : (f.popups.hide('link.insert'), f.toolbar.showInline()));
        },
        imageLink: m,
        applyStyle: function(e, t, n) {
    ...
    Ee.FE.DefineIcon('insertLink', { NAME: 'link' }),
    ...
    Ee.FE.DefineIcon('linkOpen', { NAME: 'external-link', FA5NAME: 'external-link-alt' }),
    ...
    Ee.FE.DefineIcon('linkEdit', { NAME: 'edit' }),
    ...
    Ee.FE.DefineIcon('linkRemove', { NAME: 'unlink' }),
    ...
    Ee.FE.DefineIcon('linkBack', { NAME: 'arrow-left' }),
    ...
    Ee.FE.DefineIcon('linkList', { NAME: 'search' }),
    ...
    Ee.FE.DefineIcon('imageLink', { NAME: 'link' }),
    Ee.FE.RegisterCommand('imageLink', {
      ...
      refresh: function(e) {
        var t;
        this.link.get()
          ? ((t = e.prev()).hasClass('fr-separator') && t.removeClass('fr-hidden'),
    ...
    Ee.FE.DefineIcon('linkStyle', { NAME: 'magic' }),
    ...
    Ee.extend(Ee.FE.DEFAULTS, { listAdvancedTypes: !0 }),
    (Ee.FE.PLUGINS.lists = function(f) {
      ...
      function i(e, t) {
        ...
        e.length &&
          (n =
            'rtl' == f.opts.direction || 'rtl' == Ee(e[0]).css('direction')
              ? 'margin-right'
              : 'margin-left');
        for (var a = 0; a < e.length; a++)
          if ('TD' != e[a].tagName && 'TH' != e[a].tagName && 'LI' != e[a].tagName) {
            ...
            r && e[a].tagName.toLowerCase() == r
              ? Ee(e[a]).replaceWith(
                  s + '<li' + f.node.attributes(e[a]) + '>' + Ee(e[a]).html() + '</li>' + l
                )
              : Ee(e[a]).wrap(s + '<li></li>' + l);
          }
        f.clean.lists();
      }
      function a(e) {
        ...
        for (t = 0; t < e.length; t++) {
          ...
          if ((i.before(u(a.tagName)), 'LI' == a.parentNode.tagName))
            ...
            o && (s += ' class="' + o + '"');
            var l =
              'rtl' == f.opts.direction || 'rtl' == i.css('direction')
                ? 'margin-right'
                : 'margin-left';
            f.helpers.getPX(Ee(a).css(l)) &&
              0 <= (Ee(a).attr('style') || '').indexOf(l + ':') &&
              (s += ' style="' + l + ':' + f.helpers.getPX(Ee(a).css(l)) + 'px;"'),
              f.html.defaultTag() &&
                0 === i.find(f.html.blockTagsQuery()).length &&
                i.wrapInner('<' + f.html.defaultTag() + s + '></' + f.html.defaultTag() + '>'),
              f.node.isEmpty(i.get(0), !0) ||
                0 !== i.find(f.html.blockTagsQuery()).length ||
                i.append('<br>'),
              i.append(p('LI')),
              i.prepend(u('LI'));
        ...
        for (t = 0; t < r.length; t++) {
          var d = Ee(r[t]),
            c = d.html();
          (c = (c = c.replace(/<span class="fr-close-([a-z]*)"><\/span>/g, '</$1>')).replace(
      ...
      function o(e) {
        ...
        for (var t = 0; t < e.length; t++) {
          ...
          if (n) {
            ...
            if (r) {
              for (
                var i = Ee('<li>').prependTo(Ee(r)), a = f.node.contents(e[t])[0];
                a && !f.node.isList(a);
      ...
      function e(e) {
        if ('indent' == e || 'outdent' == e) {
          for (var t = !1, n = f.selection.blocks(), r = [], i = 0; i < n.length; i++)
            'LI' == n[i].tagName
              ? ((t = !0), r.push(n[i]))
              : 'LI' == n[i].parentNode.tagName && ((t = !0), r.push(n[i].parentNode));
          t && ('indent' == e ? o(r) : s(r));
        }
      }
      return {
              ...
              function(e) {
                if (e.which == Ee.FE.KEYCODE.TAB) {
                  for (var t = f.selection.blocks(), n = [], r = 0; r < t.length; r++)
                    'LI' == t[r].tagName
                      ? n.push(t[r])
                      : 'LI' == t[r].parentNode.tagName && n.push(t[r].parentNode);
                  if (
                    1 < n.length ||
                    (n.length && (f.selection.info(n[0]).atStart || f.node.isEmpty(n[0])))
                  )
        ...
        format: function(e, t) {
          ...
          if (
            ...
            for (n = 0; n < r.length; n++)
              'LI' == r[n].tagName &&
                (Ee(r[n].parentNode).css('list-style-type', 'default' === t ? '' : t),
                0 === (Ee(r[n].parentNode).attr('style') || '').length &&
                  Ee(r[n].parentNode).removeAttr('style'));
          }
        },
        refresh: function(e, t) {
          ...
          if (n.get(0) != f.el) {
            var r = n.get(0);
            (r =
              'LI' != r.tagName && r.firstElementChild && 'LI' != r.firstElementChild.tagName
                ? n.parents('li').get(0)
                : 'LI' == r.tagName || r.firstElementChild
                  ? r.firstElementChild && 'LI' == r.firstElementChild.tagName
                    ? n.get(0).firstChild
                    : n.get(0)
                  : n.parents('li').get(0)) &&
    ...
    Ee.FE.DefineIcon('formatUL', { NAME: 'list-ul' }),
    Ee.FE.DefineIcon('formatOL', { NAME: 'list-ol' }),
    Ee.extend(Ee.FE.DEFAULTS, {
      paragraphFormat: {
        N: 'Normal',
        H1: 'Heading 1',
        ...
        apply: function(e) {
          ...
          for (var c = 0; c < d.length; c++)
            if (d[c].tagName != e && !p.node.isList(d[c])) {
              ...
              'LI' == d[c].tagName
                ? u(f, e)
                : 'LI' == d[c].parentNode.tagName && d[c]
                  ? ((o = f),
                    (s = e),
                    (l = p.html.defaultTag()),
                    (s && s.toLowerCase() != l) || (s = 'div class="fr-temp-div"'),
                    o.replaceWith(Ee('<' + s + '>').html(o.html())))
                  : 0 <= ['TD', 'TH'].indexOf(d[c].parentNode.tagName)
                    ? ((r = f),
                      (i = e),
                      (a = p.html.defaultTag()),
                      i ||
                        (i =
                          ...
                          (p.node.isEmpty(r.get(0), !0) ? ' data-empty="true"' : '')),
                      i.toLowerCase() == a
                        ? (p.node.isEmpty(r.get(0), !0) || r.append('<br/>'),
                          r.replaceWith(r.html()))
                        : r.replaceWith(Ee('<' + i + '>').html(r.html())))
                    : ((t = f),
                      (n = e) ||
                        (n =
                          'div class="fr-temp-div"' +
                          (p.node.isEmpty(t.get(0), !0) ? ' data-empty="true"' : '')),
                      t.replaceWith(
                        Ee('<' + n + ' ' + p.node.attributes(t.get(0)) + '>')
                          .html(t.html())
          ...
          if (t.hasOwnProperty(n)) {
            ...
            (r = r ? '<span class="fr-shortcut">' + r + '</span>' : ''),
              (e +=
                ...
                ('N' == n ? this.html.defaultTag() || 'DIV' : n) +
    ...
    Ee.FE.DefineIcon('paragraphFormat', { NAME: 'paragraph' }),
    Ee.extend(Ee.FE.DEFAULTS, {
      paragraphStyles: {
        'fr-text-gray': 'Gray',
    ...
    Ee.FE.DefineIcon('paragraphStyle', { NAME: 'magic' }),
    Ee.extend(Ee.FE.DEFAULTS, { html2pdf: window.html2pdf }),
      ...
      return {
        run: function() {
          !(function(e) {
            var t = s.$el.html(),
              n = null;
            s.shared.print_iframe
              ? (n = s.shared.print_iframe)
              : (((n = document.createElement('iframe')).name = 'fr-print'),
                ...
                (n.style.tabIndex = '-1'),
                s.events.on('shared.destroy', function() {
                  n.remove();
                }),
            ...
            i.document.open(),
              i.document.write(
                '<!DOCTYPE html><html ' +
                  (s.opts.documentReady ? 'style="margin: 0; padding: 0;"' : '') +
                  '><head><title>' +
                  document.title +
                  '</title>'
              ),
            ...
            Array.prototype.forEach.call(a, function(e) {
              ...
              (t.rel = e.rel),
                ...
                (t.type = 'text/css'),
                (t.media = 'all'),
                i.document.write(t.outerHTML);
            }),
              i.document.write(
                '</head><body style="height:auto;text-align: ' +
                  ('rtl' == s.opts.direction ? 'right' : 'left') +
                  '; direction: ' +
                  s.opts.direction +
                  '; ' +
                  (s.opts.documentReady ? ' padding: 2cm; width: 17cm; margin: 0;' : '') +
                  '"><div class="fr-view">'
              ),
              i.document.write(t),
              i.document.write('</div></body></html>'),
              i.document.close();
          })(function() {
            setTimeout(function() {
              s.events.disableBlur(),
    ...
    Ee.FE.DefineIcon('print', { NAME: 'print' }),
    ...
    Ee.FE.DefineIcon('getPDF', { NAME: 'file-pdf-o', FA5NAME: 'file-pdf' }),
    ...
    Ee.FE.DefineIcon('quickInsert', {
      PATH:
        '<path d="M22,16.75 L16.75,16.75 L16.75,22 L15.25,22.000 L15.25,16.75 L10,16.75 L10,15.25 L15.25,15.25 L15.25,10 L16.75,10 L16.75,15.25 L22,15.25 L22,16.75 Z"/>',
      template: 'svg',
    }),
    ...
    Ee.FE.RegisterQuickInsertButton('image', {
      ...
      callback: function() {
        ...
        e.shared.$qi_image_input ||
          ((e.shared.$qi_image_input = Ee(
            '<input accept="image/' +
              e.opts.imageAllowedTypes.join(', image/').toLowerCase() +
              '" name="quickInsertImage' +
              this.id +
              '" style="display: none;" type="file">'
          )),
          Ee('body:first').append(e.shared.$qi_image_input),
          e.events.$on(
            e.shared.$qi_image_input,
            'change',
            function() {
    ...
    Ee.FE.RegisterQuickInsertButton('embedly', {
      ...
      callback: function() {
        var e = prompt(
          this.language.translate('Paste the URL of any web content you want to insert.')
        );
    ...
    (Ee.FE.PLUGINS.quickInsert = function(o) {
      ...
      function t(e) {
        ...
        (t = e.offset().top - o.$box.offset().top),
          (n =
            ((o.$iframe && o.$iframe.offset().left) || 0) + e.offset().left < s.outerWidth()
              ? e.offset().left + s.outerWidth()
              : 0 - s.outerWidth()),
          o.opts.enter != Ee.FE.ENTER_BR
            ? (r = (s.outerHeight() - e.outerHeight()) / 2)
            : (Ee('<span>' + Ee.FE.INVISIBLE_SPACE + '</span>').insertAfter(e),
              (r = (s.outerHeight() - e.next().outerHeight()) / 2),
              e.next().remove()),
          o.opts.iframe && (t += o.$iframe.offset().top),
          s.hasClass('fr-on') && 0 <= t && l.css('top', t - r),
          0 <= t && t - Math.abs(r) <= o.$box.outerHeight() - e.outerHeight()
            ? (s.hasClass('fr-hidden') && (s.hasClass('fr-on') && a(), s.removeClass('fr-hidden')),
              s.css('top', t - r))
            : s.hasClass('fr-visible') && (s.addClass('fr-hidden'), d()),
          s.css('left', n);
      }
      function n(e) {
        s ||
          (function() {
            o.shared.$quick_insert ||
              (o.shared.$quick_insert = Ee(
                '<div class="fr-quick-insert"><a class="fr-floating-btn" role="button" tabIndex="-1" title="' +
                  o.language.translate('Quick Insert') +
                  '">' +
                  o.icon.create('quickInsert') +
                  '</a></div>'
              ));
      ...
      function r() {
        if (o.core.hasFocus()) {
          var e = o.selection.element();
          if (
            (o.opts.enter == Ee.FE.ENTER_BR || o.node.isBlock(e) || (e = o.node.blockParent(e)),
            o.opts.enter == Ee.FE.ENTER_BR && !o.node.isBlock(e))
          ) {
          ...
          ((o.opts.enter != Ee.FE.ENTER_BR &&
            o.node.isEmpty(e) &&
            0 <= o.opts.quickInsertTags.indexOf(e.tagName.toLowerCase())) ||
            (o.opts.enter == Ee.FE.ENTER_BR &&
              (('BR' == e.tagName &&
                (!e.previousSibling ||
                  'BR' == e.previousSibling.tagName ||
                  o.node.isBlock(e.previousSibling))) ||
                (o.node.isEmpty(e) &&
                  (!e.previousSibling ||
                    'BR' == e.previousSibling.tagName ||
                    o.node.isBlock(e.previousSibling)) &&
                  (!e.nextSibling ||
                    'BR' == e.nextSibling.tagName ||
                    o.node.isBlock(e.nextSibling))))))
            ? s && s.data('tag').is(Ee(e)) && s.hasClass('fr-on')
              ? d()
              : o.selection.isCollapsed() && n(Ee(e))
            : i();
        }
      }
      function i() {
      ...
      function a(e) {
        if ((e && e.preventDefault(), s.hasClass('fr-on') && !s.hasClass('fr-hidden'))) d();
          ...
          if (!o.shared.$qi_helper) {
            for (
              var t = o.opts.quickInsertButtons, n = '<div class="fr-qi-helper">', r = 0, i = 0;
              i < t.length;
              i++
            ) {
              ...
              a &&
                (!a.requiredPlugin ||
                  (Ee.FE.PLUGINS[a.requiredPlugin] &&
                    0 <= o.opts.pluginsEnabled.indexOf(a.requiredPlugin))) &&
                (n +=
                  '<a class="fr-btn fr-floating-btn" role="button" title="' +
                  o.language.translate(a.title) +
                  '" tabIndex="-1" data-cmd="' +
                  t[i] +
                  '" style="transition-delay: ' +
                  0.025 * r++ +
                  's;">' +
                  o.icon.create(a.icon) +
                  '</a>');
            }
            (n += '</div>'),
      ...
      function d() {
        ...
        e.length &&
          (e.find('a').removeClass('fr-size-1'),
          e.css('left', -9999),
          s.hasClass('fr-hidden') || s.removeClass('fr-on'));
      }
      return {
        _init: function() {
    ...
    Ee.FE.DefineIcon('quote', { NAME: 'quote-left' }),
    Ee.extend(Ee.FE.DEFAULTS, {
      saveInterval: 1e4,
      saveURL: null,
      saveParams: {},
    ...
    Ee.FE.DefineIcon('save', { NAME: 'floppy-o', FA5NAME: 'save' }),
        ...
        show: function() {
          if (!o) {
            var e = '<h4>' + s.language.translate('Special Characters') + '</h4>',
              t = (function() {
                for (
                  var e = '<div class="fr-special-characters-modal">', t = 0;
                  t < s.opts.specialCharactersSets.length;
                  t++
                ) {
                  for (
                    var n = s.opts.specialCharactersSets[t],
                      r = n.list,
                      i =
                        '<div class="fr-special-characters-list"><p class="fr-special-characters-title">' +
                    ...
                    var o = r[a];
                    i +=
                      '<span class="fr-command fr-special-character" tabIndex="-1" role="button" value="' +
                      o['char'] +
                      '" title="' +
                      o.desc +
                      '">' +
            ...
            (o = n.$modal),
              ...
              s.events.$on(
                ...
                function(e) {
                  ...
                  if (
                    !(n.length || t != Ee.FE.KEYCODE.F10 || s.keys.ctrlKey(e) || e.shiftKey) &&
                    e.altKey
                  )
                    return d(l.find('span.fr-special-character:first'), e), !1;
                  if (
                    t == Ee.FE.KEYCODE.TAB ||
                    t == Ee.FE.KEYCODE.ARROW_LEFT ||
                    t == Ee.FE.KEYCODE.ARROW_RIGHT
                  ) {
                    var r = null,
                      i = null,
                      a = !1;
                    return (
                      t == Ee.FE.KEYCODE.ARROW_LEFT || t == Ee.FE.KEYCODE.ARROW_RIGHT
                        ? ((i = t == Ee.FE.KEYCODE.ARROW_RIGHT), (a = !0))
                        : (i = !e.shiftKey),
                      n.length
                        ? (a &&
                            (r = i
                              ? n.nextAll('span.fr-special-character:first')
                              : n.prevAll('span.fr-special-character:first')),
                          (r && r.length) ||
                            (r = i
                              ? n
                                  .parent()
                                  .next()
                                  .find('span.fr-special-character:first')
                              : n
                                  .parent()
                                  .prev()
                                  .find('span.fr-special-character:' + (a ? 'last' : 'first')))
                              .length ||
                            (r = l.find('span.fr-special-character:' + (i ? 'first' : 'last'))))
                        : (r = l.find('span.fr-special-character:' + (i ? 'first' : 'last'))),
                      d(r, e),
                      !1
                    );
    ...
    Ee.FroalaEditor.DefineIcon('specialCharacters', { template: 'text', NAME: '&#937;' }),
    ...
    (Ee.FE.PLUGINS.table = function(T) {
        ...
        if (e) {
          ...
          if ((t || (t = p()), t)) {
            ...
            T.popups.show('table.edit', r, i, n.bottom - n.top),
              T.edit.isDisabled() &&
                (1 < Q().length && T.toolbar.disable(),
                T.$el.removeClass('fr-no-selection'),
                T.edit.on(),
                T.button.bulkRefresh(),
                T.selection.setAtEnd(T.$el.find('.fr-selected-cell:last').get(0)),
                T.selection.restore());
          }
        }
      }
      function d() {
        ...
        if (i) {
          ...
          a ||
            (a = (function() {
              var e = '';
              0 < T.opts.tableColorsButtons.length &&
                (e =
                  '<div class="fr-buttons fr-table-colors-buttons">' +
                  T.button.buildList(T.opts.tableColorsButtons) +
                  '</div>');
              var t = '';
              T.opts.colorsHEXInput &&
                (t =
                  ...
                  T.id +
                  '" type="text" placeholder="' +
                  T.language.translate('HEX Color') +
                  ...
                  T.language.translate('OK') +
                  '</button></div></div>');
              var n = {
                  buttons: e,
                  colors: (function() {
                    for (
                      var e = '<div class="fr-table-colors">', t = 0;
                      t < T.opts.tableColors.length;
                      t++
                    )
                      0 !== t && t % T.opts.tableColorsStep == 0 && (e += '<br>'),
                        'REMOVE' != T.opts.tableColors[t]
                          ? (e +=
                              '<span class="fr-command" style="background: ' +
                              T.opts.tableColors[t] +
                              ';" tabIndex="-1" role="button" data-cmd="tableCellBackgroundColor" data-param1="' +
                              T.opts.tableColors[t] +
                              '"><span class="fr-sr-only">' +
                              T.language.translate('Color') +
                              ' ' +
                              T.opts.tableColors[t] +
                              '&nbsp;&nbsp;&nbsp;</span></span>')
                          : (e +=
                              '<span class="fr-command" data-cmd="tableCellBackgroundColor" tabIndex="-1" role="button" data-param1="REMOVE" title="' +
                              T.language.translate('Clear Formatting') +
                              '">' +
                              T.icon.create('tableColorRemove') +
                              '<span class="fr-sr-only">' +
                              T.language.translate('Clear Formatting') +
                              '</span></span>');
                    return (e += '</div>');
              ...
              return (
                T.events.$on(T.$wp, 'scroll.table-colors', function() {
      ...
      function c(e) {
        if (e)
          return (
            T.popups.onHide('table.insert', function() {
              T.popups
                .get('table.insert')
                .find('.fr-table-size .fr-select-table-size > span[data-row="1"][data-col="1"]')
                .trigger('mouseenter');
            }),
            !0
          );
        var t = '';
        0 < T.opts.tableInsertButtons.length &&
          (t =
            '<div class="fr-buttons">' + T.button.buildList(T.opts.tableInsertButtons) + '</div>');
        var n,
          r = {
            buttons: t,
        ...
        return (
          ...
          (n = i),
          T.events.$on(n, 'focus', '[tabIndex]', function(e) {
            var t = Ee(e.currentTarget);
            f(t);
          }),
          T.events.on(
            ...
            function(e) {
              ...
              var n,
                r = e.which;
              if (
                Ee.FE.KEYCODE.ARROW_UP == r ||
                Ee.FE.KEYCODE.ARROW_DOWN == r ||
                Ee.FE.KEYCODE.ARROW_LEFT == r ||
                Ee.FE.KEYCODE.ARROW_RIGHT == r
              ) {
                if (t.is('span.fr-table-cell')) {
                  ...
                  Ee.FE.KEYCODE.ARROW_UP == r
                    ? (l = Math.max(0, l - 1))
                    : Ee.FE.KEYCODE.ARROW_DOWN == r
                      ? (l = Math.min(T.opts.tableInsertMaxSize - 1, l + 1))
                      : Ee.FE.KEYCODE.ARROW_LEFT == r
                        ? (s = Math.max(0, s - 1))
                        : Ee.FE.KEYCODE.ARROW_RIGHT == r &&
                          (s = Math.min(T.opts.tableInsertMaxSize - 1, s + 1));
                  var d = l * o + s,
                    c = Ee(i.get(d));
      ...
      function f(e) {
        ...
        for (var i = 1; i <= T.opts.tableInsertMaxSize; i++)
          for (var a = 0; a <= T.opts.tableInsertMaxSize; a++) {
            ...
            i <= t && a <= n
              ? o.addClass('hover')
              : i <= t + 1 || (i <= 2 && !T.helpers.isMobile())
                ? o.css('display', 'inline-block')
                : 2 < i && !T.helpers.isMobile() && o.css('display', 'none');
          }
      ...
      function p(e) {
        ...
        if (0 < T.opts.tableEditButtons.length) {
          var t = {
              buttons:
                '<div class="fr-buttons">' + T.button.buildList(T.opts.tableEditButtons) + '</div>',
            },
            n = T.popups.create('table.edit', t);
          return (
            T.events.$on(T.$wp, 'scroll.table-edit', function() {
      ...
      function g(e) {
        ...
        if (0 < t.length) {
          ...
          for (n = 0; n < a[r].length; n++) {
            if (
              ('below' == e && r < a.length - 1 && a[r][n] == a[r + 1][n]) ||
              ('above' == e && 0 < r && a[r][n] == a[r - 1][n])
            ) {
              if (0 === n || (0 < n && a[r][n] != a[r][n - 1])) {
                var l = Ee(a[r][n]);
                l.attr('rowspan', parseInt(l.attr('rowspan'), 10) + 1);
              }
            } else s += '<td style="' + Ee(a[r][n]).attr('style') + '" ><br></td>';
          }
          (s += '</tr>'),
            (i =
              0 < T.$el.find('th.fr-selected-cell').length && 'below' == e
                ? Ee(t.find('tbody').not(t.find('table tbody')))
                : Ee(
                    t
                      .find('tr')
                      .not(t.find('table tr'))
            ...
            'below' == e
              ? 'TBODY' == i.prop('tagName')
                ? i.prepend(s)
                : i.after(s)
              : 'above' == e && (i.before(s), T.popups.isVisible('table.edit') && u());
        }
      }
      function m(e, t, n) {
        var r,
        ...
        if (e < (t = Math.min(t, d[0].length - 1)))
          for (i = e; i <= t; i++)
            if (
              !(e < i && d[0][i] == d[0][i - 1]) &&
              1 < (o = Math.min(parseInt(d[0][i].getAttribute('colspan'), 10) || 1, t - e + 1)) &&
              d[0][i] == d[0][i + 1]
            )
              for (l = o - 1, r = 1; r < d.length; r++)
                if (d[r][i] != d[r - 1][i]) {
                  for (a = i; a < i + o; a++)
                    if (
                      1 < (s = parseInt(d[r][a].getAttribute('colspan'), 10) || 1) &&
                      d[r][a] == d[r][a + 1]
                    )
                      a += l = Math.min(l, s - 1);
      ...
      function v(e, t, n) {
        ...
        if (e < (t = Math.min(t, d.length - 1)))
          for (r = e; r <= t; r++)
            if (
              !(e < r && d[r][0] == d[r - 1][0]) &&
              1 < (o = Math.min(parseInt(d[r][0].getAttribute('rowspan'), 10) || 1, t - e + 1)) &&
              d[r][0] == d[r + 1][0]
            )
              for (l = o - 1, i = 1; i < d[0].length; i++)
                if (d[r][i] != d[r][i - 1]) {
                  for (a = r; a < r + o; a++)
                    if (
                      1 < (s = parseInt(d[a][i].getAttribute('rowspan'), 10) || 1) &&
                      d[a][i] == d[a + 1][i]
                    )
                      a += l = Math.min(l, s - 1);
                    else if (!(l = Math.max(0, l - 1))) break;
      ...
      function E(e, t, n, r, i, a, o) {
        ...
        for (s = r; s <= i; s++)
          for (l = a; l <= o; l++)
            (r < s && e[s][l] == e[s - 1][l]) ||
              (a < l && e[s][l] == e[s][l - 1]) ||
              (1 < (d = parseInt(e[s][l].getAttribute(n), 10) || 1) &&
                (1 < d - t ? e[s][l].setAttribute(n, d - t) : e[s][l].removeAttribute(n)));
      }
      ...
      function t(e) {
        ...
        'REMOVE' != e
          ? t.css('background-color', T.helpers.HEXtoRGB(e))
            ...
            e
              ...
              .each(function(s, e) {
                ...
                t.find('> th, > td').each(function(e, t) {
                  for (
                    var n = Ee(t),
                      r = parseInt(n.attr('colspan'), 10) || 1,
                      i = parseInt(n.attr('rowspan'), 10) || 1,
                      a = s;
                    a < s + i;
                    a++
                  )
      ...
      function R(e, t) {
        for (var n = 0; n < t.length; n++)
          for (var r = 0; r < t[n].length; r++) if (t[n][r] == e) return { row: n, col: r };
      }
      function y(e, t, n) {
      ...
      function L() {
        T.el.querySelector('.fr-cell-fixed') &&
          T.el.querySelector('.fr-cell-fixed').classList.remove('fr-cell-fixed'),
          T.el.querySelector('.fr-cell-handler') &&
            T.el.querySelector('.fr-cell-handler').classList.remove('fr-cell-handler');
      }
      function _() {
      ...
      function O(t, n) {
        if (Ee(t).is(n)) _(), Ee(t).addClass('fr-selected-cell');
        else {
          x(), T.edit.off();
          var r = S(),
            i = R(t, r),
            ...
            o = (function e(t, n, r, i, a) {
              var o,
                ...
                u = i;
              for (o = c; o <= f; o++)
                (1 < (parseInt(Ee(a[o][p]).attr('rowspan'), 10) || 1) ||
                  1 < (parseInt(Ee(a[o][p]).attr('colspan'), 10) || 1)) &&
                  ((d = y((l = R(a[o][p], a)).row, l.col, a)),
                  (c = Math.min(l.row, c)),
                  (f = Math.max(d.row, f)),
                  (p = Math.min(l.col, p)),
                  (u = Math.max(d.col, u))),
                  (1 < (parseInt(Ee(a[o][u]).attr('rowspan'), 10) || 1) ||
                    1 < (parseInt(Ee(a[o][u]).attr('colspan'), 10) || 1)) &&
                    ((d = y((l = R(a[o][u], a)).row, l.col, a)),
                    (c = Math.min(l.row, c)),
                    (f = Math.max(d.row, f)),
                    (p = Math.min(l.col, p)),
                    (u = Math.max(d.col, u)));
              for (s = p; s <= u; s++)
                (1 < (parseInt(Ee(a[c][s]).attr('rowspan'), 10) || 1) ||
                  1 < (parseInt(Ee(a[c][s]).attr('colspan'), 10) || 1)) &&
                  ((d = y((l = R(a[c][s], a)).row, l.col, a)),
                  (c = Math.min(l.row, c)),
                  (f = Math.max(d.row, f)),
                  (p = Math.min(l.col, p)),
                  (u = Math.max(d.col, u))),
                  (1 < (parseInt(Ee(a[f][s]).attr('rowspan'), 10) || 1) ||
                    1 < (parseInt(Ee(a[f][s]).attr('colspan'), 10) || 1)) &&
                    ((d = y((l = R(a[f][s], a)).row, l.col, a)),
                    (c = Math.min(l.row, c)),
                    (f = Math.max(d.row, f)),
                    (p = Math.min(l.col, p)),
                    (u = Math.max(d.col, u)));
              return c == t && f == n && p == r && u == i
                ? { min_i: t, max_i: n, min_j: r, max_j: i }
                : e(c, f, p, u, a);
            })(
              Math.min(i.row, a.row),
              Math.max(i.row, a.row),
              Math.min(i.col, a.col),
              Math.max(i.col, a.col),
              r
            );
        ...
        return (
          'TD' == e.target.tagName || 'TH' == e.target.tagName
            ...
            : 0 < n.closest('td').length
              ? (t = n.closest('td').get(0))
              : 0 < n.closest('th').length && (t = n.closest('th').get(0)),
      ...
      function e(e) {
        ...
        if ((0 < Q().length && !t && D(), !T.edit.isDisabled() || T.popups.isVisible('table.edit')))
          if (1 != e.which || (1 == e.which && T.helpers.isMac() && e.ctrlKey))
            ...
            e.shiftKey && 0 < T.$el.find(n + '.fr-selected-cell').length
              ? Ee(T.$el.find(n + '.fr-selected-cell').closest('table')).is(Ee(t).closest('table'))
                ? O(r, t)
                : x()
              : ((T.keys.ctrlKey(e) || e.shiftKey) &&
                  (1 < Q().length ||
                    (0 === Ee(t).find(T.selection.element()).length &&
                      !Ee(t).is(T.selection.element()))) &&
                  x(),
                (r = t),
                0 < T.opts.tableEditButtons.length && O(r, r));
          }
      }
      function n(e) {
        ...
        if (
          (i ||
            T.$tb.is(e.target) ||
            T.$tb.is(Ee(e.target).closest(T.$tb.get(0))) ||
            (0 < Q().length && T.toolbar.enable(), _()),
          !(1 != e.which || (1 == e.which && T.helpers.isMac() && e.ctrlKey)))
        ) {
          if (((a = !1), i))
            (i = !1),
              I(e) || 1 != Q().length
                ? 0 < Q().length && (T.selection.isCollapsed() ? u() : _())
                : _();
          if (b) {
              ...
              (function() {
                ...
                if (e !== t) {
                  ...
                  if ((T.undo.canDo() || T.undo.saveStep(), null !== n && null !== r)) {
                    ...
                    ('rtl' == T.opts.direction && 0 === r) || ('rtl' != T.opts.direction && 0 !== r)
                      ? ((g = ((a + t - e) / a) * v),
                        i.css(
                          'margin-right',
                          'calc(100% - ' +
                            ...
                            '% - ' +
                            Math.round(E).toFixed(4) +
                            '%)'
                        ))
                      : (('rtl' == T.opts.direction && 0 !== r) ||
                          ('rtl' != T.opts.direction && 0 === r)) &&
                        ((g = ((a - t + e) / a) * v),
                        i.css(
                          'margin-left',
                  ...
                  T.selection.restore(),
                    T.undo.saveStep(),
                    T.events.trigger('table.resized', [i.get(0)]);
                }
                A.removeData('origin'),
      ...
      function F(e, t, n, r) {
        for (
          ...
          'TD' != a.tagName &&
          'TH' != a.tagName &&
          ('up' == r ? (i = a.previousElementSibling) : 'down' == r && (i = a.nextElementSibling),
          !i);
        ...
        'TD' == a.tagName || 'TH' == a.tagName
          ...
          : i && ('up' == r && T.selection.setAtEnd(i), 'down' == r && T.selection.setAtStart(i));
      }
      function M(e, t, n) {
      ...
      function U(e, t) {
        ...
        if (
          (t &&
            ...
            (0 < n.closest('td').length
              ? (t = n.closest('td'))
              : 0 < n.closest('th').length && (t = n.closest('th'))),
          !t || ('TD' != t.tagName && 'TH' != t.tagName))
        )
          A &&
            n.get(0) != A.get(0) &&
            n.parent().get(0) != A.get(0) &&
            T.core.sameInstance(A) &&
            B();
        else {
          ...
          var a = n.offset().left - 1,
            o = a + n.outerWidth();
          if (
            Math.abs(e.pageX - a) <= T.opts.tableResizerOffset ||
            Math.abs(o - e.pageX) <= T.opts.tableResizerOffset
          ) {
            var s,
              l,
              d,
              ...
              g = r.offset().top,
              m = r.outerHeight() - 1;
            'rtl' != T.opts.direction
              ? e.pageX - a <= T.opts.tableResizerOffset
                ? ((d = a),
                  0 < u.col
                    ? ((c = a - Y(u.col - 1, p) + T.opts.tableResizingLimit),
                      (f = a + Y(u.col, p) - T.opts.tableResizingLimit),
                      (s = u.col - 1),
                      (l = u.col))
                    : ((s = null),
                      (l = 0),
                      (c = r.offset().left - 1 - parseInt(r.css('margin-left'), 10)),
                      (f =
                        r.offset().left - 1 + r.width() - p[0].length * T.opts.tableResizingLimit)))
                : o - e.pageX <= T.opts.tableResizerOffset &&
                  ((d = o),
                  h.col < p[h.row].length && p[h.row][h.col + 1]
                    ? ((c = o - Y(h.col, p) + T.opts.tableResizingLimit),
                      (f = o + Y(h.col + 1, p) - T.opts.tableResizingLimit),
                      (s = h.col),
                      (l = h.col + 1))
                    : ((s = h.col),
                      (l = null),
                      (c = r.offset().left - 1 + p[0].length * T.opts.tableResizingLimit),
                      (f = i.offset().left - 1 + i.width() + parseFloat(i.css('padding-left')))))
              : o - e.pageX <= T.opts.tableResizerOffset
                ? ((d = o),
                  0 < u.col
                    ? ((c = o - Y(u.col, p) + T.opts.tableResizingLimit),
                      (f = o + Y(u.col - 1, p) - T.opts.tableResizingLimit),
                      (s = u.col),
                      (l = u.col - 1))
                    : ((s = null),
                      (l = 0),
                      (c = r.offset().left + p[0].length * T.opts.tableResizingLimit),
                      (f = i.offset().left - 1 + i.width() + parseFloat(i.css('padding-left')))))
                : e.pageX - a <= T.opts.tableResizerOffset &&
                  ((d = a),
                  h.col < p[h.row].length && p[h.row][h.col + 1]
                    ? ((c = a - Y(h.col + 1, p) + T.opts.tableResizingLimit),
                      (f = a + Y(h.col, p) - T.opts.tableResizingLimit),
                      (s = h.col + 1),
                      (l = h.col))
                    : ((s = h.col),
                      (l = null),
                      (c = i.offset().left + parseFloat(i.css('padding-left'))),
                      (f =
                        r.offset().left -
                        1 +
                        r.width() -
                        p[0].length * T.opts.tableResizingLimit))),
              A ||
                (T.shared.$table_resizer ||
                  (T.shared.$table_resizer = Ee('<div class="fr-table-resizer"><div></div></div>')),
                (A = T.shared.$table_resizer),
            ...
            T.opts.iframe &&
              ((v += T.$iframe.offset().left),
              (E += T.$iframe.offset().top),
              (c += T.$iframe.offset().left),
              (f += T.$iframe.offset().left)),
              A.data('max-left', c),
              A.data('max-right', f),
      ...
      function K(e, t) {
        ...
        var n,
          ...
          o = 0;
        T.opts.iframe &&
          ((a += T.$iframe.offset().left - T.helpers.scrollLeft()),
          (o += T.$iframe.offset().top - T.helpers.scrollTop())),
          r.find('th, td').each(function() {
            var e = Ee(this);
            return e.offset().left <= i && i < e.offset().left + e.outerWidth() / 2
              ? ((n = parseInt(s.find('a').css('width'), 10)),
                s.css('top', o + e.offset().top - T.$box.offset().top - n - 5),
                s.css('left', a + e.offset().left - T.$box.offset().left - n / 2),
                s.data('selected-cell', e),
                s.data('position', 'before'),
                s.addClass('fr-visible'),
                !1)
              : e.offset().left + e.outerWidth() / 2 <= i && i < e.offset().left + e.outerWidth()
                ? ((n = parseInt(s.find('a').css('width'), 10)),
                  s.css('top', o + e.offset().top - T.$box.offset().top - n - 5),
                  s.css(
                    'left',
                    a + e.offset().left - T.$box.offset().left + e.outerWidth() - n / 2
                  ),
                  s.data('selected-cell', e),
                  s.data('position', 'after'),
                  s.addClass('fr-visible'),
                  !1)
                : void 0;
          });
      ...
      function H(e, t) {
        ...
        T.opts.iframe &&
          ...
          r.find('tr').each(function() {
            var e = Ee(this);
            return e.offset().top <= i && i < e.offset().top + e.outerHeight() / 2
              ? ((n = parseInt(s.find('a').css('width'), 10)),
                s.css('top', o + e.offset().top - T.$box.offset().top - n / 2),
                s.css('left', a + e.offset().left - T.$box.offset().left - n - 5),
                s.data('selected-cell', e.find('td:first')),
                s.data('position', 'above'),
                s.addClass('fr-visible'),
                !1)
              : e.offset().top + e.outerHeight() / 2 <= i && i < e.offset().top + e.outerHeight()
                ? ((n = parseInt(s.find('a').css('width'), 10)),
                  s.css('top', o + e.offset().top - T.$box.offset().top + e.outerHeight() - n / 2),
                  s.css('left', a + e.offset().left - T.$box.offset().left - n - 5),
                  s.data('selected-cell', e.find('td:first')),
                  s.data('position', 'below'),
                  s.addClass('fr-visible'),
                  !1)
                : void 0;
          });
      ...
      function W(e) {
        ...
        T.opts.tableResizer &&
          (!T.popups.areVisible() || (T.popups.areVisible() && T.popups.isVisible('table.edit'))) &&
          U(e, t),
          !T.opts.tableInsertHelper ||
            T.popups.areVisible() ||
            (T.$tb.hasClass('fr-inline') && T.$tb.is(':visible')) ||
            (function(e, t) {
              if (0 === Q().length) {
                var n, r, i;
                if (t && ('HTML' == t.tagName || 'BODY' == t.tagName || T.node.isElement(t)))
                  for (n = 1; n <= T.opts.tableInsertHelperOffset; n++) {
                    if (
                      ((r = T.doc.elementFromPoint(
                        e.pageX - T.win.pageXOffset,
                        e.pageY - T.win.pageYOffset + n
                      )),
                      Ee(r).hasClass('fr-tooltip'))
                    )
                      return;
                    if (
                      r &&
                      ('TH' == r.tagName || 'TD' == r.tagName || 'TABLE' == r.tagName) &&
                      (Ee(r).parents('.fr-wrapper').length || T.opts.iframe)
                    )
                      return K(e, Ee(r).closest('table'));
                    if (
                      ((i = T.doc.elementFromPoint(
                        e.pageX - T.win.pageXOffset + n,
                        e.pageY - T.win.pageYOffset
                      )),
                      Ee(i).hasClass('fr-tooltip'))
                    )
                      return;
                    if (
                      i &&
                      ('TH' == i.tagName || 'TD' == i.tagName || 'TABLE' == i.tagName) &&
                      (Ee(i).parents('.fr-wrapper').length || T.opts.iframe)
                    )
                      return H(e, Ee(i).closest('table'));
                  }
      ...
      function V(e) {
        if ((1 < Q().length && a && x(), !1 === a && !1 === i && !1 === b))
          o && clearTimeout(o),
            (T.edit.isDisabled() && !T.popups.isVisible('table.edit')) ||
              (o = setTimeout(W, 30, e));
        else if (b) {
          ...
          var n = A.data('max-left'),
            r = A.data('max-right');
          n <= t && t <= r
            ? A.css('left', t - T.opts.tableResizerOffset - T.$wp.offset().left)
            : t < n && parseFloat(A.css('left'), 10) > n - T.opts.tableResizerOffset
              ? A.css('left', n - T.opts.tableResizerOffset - T.$wp.offset().left)
              : r < t &&
                parseFloat(A.css('left'), 10) < r - T.opts.tableResizerOffset &&
                A.css('left', r - T.opts.tableResizerOffset - T.$wp.offset().left);
        } else a && P();
      }
      function X(e) {
        T.node.isEmpty(e.get(0))
          ? e.prepend(Ee.FE.MARKERS)
          : e.prepend(Ee.FE.START_MARKER).append(Ee.FE.END_MARKER);
      }
      function q() {
        T.shared.$ti_helper ||
          ((T.shared.$ti_helper = Ee(
      ...
      return {
        _init: function() {
          ...
          if (!T.helpers.isMobile()) {
            (b = i = a = !1),
              ...
              T.popups.onShow('image.edit', function() {
                _(), (i = a = !1);
              }),
              ...
              T.events.on('contentChanged', function() {
                0 < Q().length &&
                  (u(),
                  T.$el.find('img').on('load.selected-cells', function() {
              ...
              T.events.$on(Ee(T.o_win), 'keydown', function() {
                a &&
                  i &&
                  ((i = a = !1),
                  T.$el.removeClass('fr-no-selection'),
                  ...
                  ? !1 ===
                      (function(e) {
                        ...
                        if (0 < t.length) {
                          ...
                          1 == t.length
                            ? (r = n = t[0])
                            : ((n = T.el.querySelector('.fr-cell-fixed')),
                              (r = T.el.querySelector('.fr-cell-handler')));
                          var o = R(r, i);
                          ...
                          } else if (Ee.FE.KEYCODE.ARROW_UP == a && 0 < o.row)
                  ...
                  : (function(e) {
                      ...
                      if (n.length && ('TD' == (n = n[0]).tagName || 'TH' == n.tagName)) {
                        ...
                        if (
                          r &&
                          'TABLE' == r.tagName &&
                          (Ee.FE.KEYCODE.ARROW_LEFT == t ||
                            Ee.FE.KEYCODE.ARROW_UP == t ||
                            Ee.FE.KEYCODE.ARROW_RIGHT == t ||
                            Ee.FE.KEYCODE.ARROW_DOWN == t) &&
                          (0 < Q().length && D(),
                          T.browser.webkit &&
                            (Ee.FE.KEYCODE.ARROW_UP == t || Ee.FE.KEYCODE.ARROW_DOWN == t))
                        ) {
                            ...
                            ((Ee.FE.KEYCODE.ARROW_UP == t &&
                              ((i.previousSibling && 'BR' !== i.previousSibling.tagName) ||
                                (i.previousSibling &&
                                  ...
                                  i.previousSibling.previousSibling))) ||
                              (Ee.FE.KEYCODE.ARROW_DOWN == t &&
                                ((i.nextSibling && 'BR' !== i.nextSibling.tagName) ||
                                  (i.nextSibling &&
                                    'BR' === i.nextSibling.tagName &&
                          ...
                          Ee.FE.KEYCODE.ARROW_UP == t
                            ? M(o, r, a)
                            : Ee.FE.KEYCODE.ARROW_DOWN == t && $(o, r, a),
                            T.selection.restore();
                        }
                      }
                    })(e);
              ...
              T.events.on(
                ...
                function(e) {
                      ...
                      if (e.which == Ee.FE.KEYCODE.TAB) {
                        ...
                        if (0 < Q().length) t = T.$el.find('.fr-selected-cell:last');
                          ...
                          'TD' == n.tagName || 'TH' == n.tagName
                            ? (t = Ee(n))
                            : n != T.el &&
                              (0 < Ee(n).parentsUntil(T.$el, 'td').length
                                ? (t = Ee(n).parents('td:first'))
                                : 0 < Ee(n).parentsUntil(T.$el, 'th').length &&
                                  (t = Ee(n).parents('th:first')));
                        }
                        if (t)
                          return (
                            e.preventDefault(),
                            !!(
                              0 === T.selection.get().focusOffset &&
                              0 < Ee(T.selection.element()).parentsUntil(T.$el, 'ol, ul').length &&
                              (0 <
                                Ee(T.selection.element())
                                  .closest('li')
                                  .prev().length ||
                                (Ee(T.selection.element()).is('li') &&
                                  0 < Ee(T.selection.element()).prev().length))
                            ) ||
                              (D(),
                              e.shiftKey
                                ? 0 < t.prev().length
                                  ...
                                  : 0 < t.closest('tr').length && 0 < t.closest('tr').prev().length
                                    ...
                                    : 0 < t.closest('tbody').length &&
                                      0 < t.closest('table').find('thead tr').length &&
                                      X(t.closest('table').find('thead tr th:last'))
                                : 0 < t.next().length
                                  ? X(t.next())
                                  : 0 < t.closest('tr').length && 0 < t.closest('tr').next().length
                                    ...
                                    : 0 < t.closest('thead').length &&
                                      0 < t.closest('table').find('tbody tr').length
                                      ? X(t.closest('table').find('tbody tr td:first'))
                                      : (t.addClass('fr-selected-cell'),
                                        g('below'),
                                        _(),
                                        X(
                                          t
                  ...
                  var t = Q();
                  if (0 < t.length) {
                    if (0 < t.length && T.keys.ctrlKey(e) && e.which == Ee.FE.KEYCODE.A)
                      return (
                        _(),
                    ...
                    if (e.which == Ee.FE.KEYCODE.ESC && T.popups.isVisible('table.edit'))
                      return (
                        _(),
                        T.popups.hide('table.edit'),
                        e.preventDefault(),
                    ...
                    if (
                      1 < t.length &&
                      (e.which == Ee.FE.KEYCODE.BACKSPACE || e.which == Ee.FE.KEYCODE.DELETE)
                    ) {
                      T.undo.saveStep();
                      for (var n = 0; n < t.length; n++)
                    ...
                    if (1 < t.length && e.which != Ee.FE.KEYCODE.F10 && !T.keys.isBrowserAction(e))
                    ...
                    (function(e) {
                      if (e.altKey && e.which == Ee.FE.KEYCODE.SPACE) {
                        ...
                        if (
                          ('TD' == n.tagName || 'TH' == n.tagName
                            ? (t = n)
                            : 0 < Ee(n).closest('td').length
                              ? (t = Ee(n)
                                  .closest('td')
                                  .get(0))
                              : 0 < Ee(n).closest('th').length &&
                                (t = Ee(n)
                                  .closest('th')
                                  .get(0)),
                          t)
            ...
            T.events.on('html.beforeGet', function() {
              ...
              T.events.on('html.afterGet', function() {
                for (var e = 0; e < t.length; e++)
                  t[e].className =
                    (t[e].className ? t[e].className.trim() + ' ' : '') + 'fr-selected-cell';
                t = [];
              }),
              c(!0),
              p(!0);
        ...
        insert: function(e, t) {
          var n,
            ...
            i =
              '<table ' +
              (T.opts.tableDefaultWidth
                ? 'style="width: ' + T.opts.tableDefaultWidth + ';" '
                : '') +
          ...
          for (n = 0; n < e; n++) {
            for (i += '<tr>', r = 0; r < t; r++)
              (i +=
                '<td' +
                (T.opts.tableDefaultWidth ? ' style="width: ' + a.toFixed(4) + '%;"' : '') +
                '>'),
          ...
          if (0 < e.length) {
            ...
            if (0 === a.min_i && a.max_i == i.length - 1) h();
              ...
              C(0, i.length - 1, 0, i[0].length - 1, e),
                0 < a.min_i
                  ? T.selection.setAtEnd(i[a.min_i - 1][0])
                  : T.selection.setAtEnd(i[0][0]),
                T.selection.restore(),
                T.popups.hide('table.edit');
            }
          }
        ...
        insertColumn: function(l) {
          ...
          if (0 < e.length) {
            ...
            e.find('th, td').each(function() {
              ...
              e
                ...
                .each(function(e) {
                  for (var t, n = Ee(this), r = 0, i = 0; r - 1 < d; ) {
                    ...
                    t == c[e][r]
                      ? ((r += parseInt(Ee(t).attr('colspan'), 10) || 1), i++)
                      : ((r += parseInt(Ee(c[e][r]).attr('colspan'), 10) || 1),
                        'after' == l && (t = 0 === i ? -1 : n.find('> th, > td').get(i - 1)));
                  }
                  var a,
                    o = Ee(t);
                  if (
                    ('after' == l && d < r - 1) ||
                    ('before' == l && 0 < d && c[e][d] == c[e][d - 1])
                  ) {
              ...
              e.find('th, td').each(function() {
                (n = Ee(this)).data('old-width') &&
                  (n.css('width', ((n.data('old-width') * p) / f).toFixed(4) + '%'),
            ...
            if (0 === a.min_j && a.max_j == i[0].length - 1) h();
              ...
              for (t = 0; t < i.length; t++)
                for (n = 0; n < i[0].length; n++)
                  (r = Ee(i[t][n])).hasClass('fr-selected-cell') ||
                    (r.data('old-width', (r.outerWidth() / e.outerWidth()) * 100),
                    (n < a.min_j || n > a.max_j) && (o += (r.outerWidth() / e.outerWidth()) * 100));
                  ...
                  if (0 === t || i[t][n] != i[t - 1][n])
                    if (((r = Ee(i[t][n])), 1 < (parseInt(r.attr('colspan'), 10) || 1))) {
                      ...
                      1 == s ? r.removeAttr('colspan') : r.attr('colspan', s),
                        r.css(
                          'width',
                          ((100 * (r.data('old-width') - Y(n, i))) / o).toFixed(4) + '%'
                        ),
                      ...
                      r.remove(),
                        0 === l.find('> th, > td').length &&
                          (0 === l.prev().length ||
                            0 === l.next().length ||
                            l.prev().find('> th[rowspan], > td[rowspan]').length <
                              l.prev().find('> th, > td').length) &&
                          l.remove();
                    }
              C(0, i.length - 1, 0, i[0].length - 1, e),
                0 < a.min_j
                  ? T.selection.setAtEnd(i[a.min_i][a.min_j - 1])
                  : T.selection.setAtEnd(i[a.min_i][0]),
                T.selection.restore(),
                T.popups.hide('table.edit'),
                e.find('th, td').each(function() {
                  (r = Ee(this)).data('old-width') &&
                    (r.css('width', ((100 * r.data('old-width')) / o).toFixed(4) + '%'),
                    r.removeData('old-width'));
                });
            }
          }
        ...
        mergeCells: function() {
          if (
            1 < Q().length &&
            (0 === T.$el.find('th.fr-selected-cell').length ||
              0 === T.$el.find('td.fr-selected-cell').length)
          ) {
            L();
            var e,
              t,
            ...
            for (
              i.css('width', Math.min(100, (l / o.outerWidth()) * 100).toFixed(4) + '%'),
                n.min_j < n.max_j && i.attr('colspan', n.max_j - n.min_j + 1),
                n.min_i < n.max_i && i.attr('rowspan', n.max_i - n.min_i + 1),
                e = 1;
              e < r.length;
              e++
            )
              '<br>' != (t = Ee(r[e])).html() && '' !== t.html() && (s += '<br>' + t.html()),
                t.remove();
            i.html(s),
        ...
        splitCellHorizontally: function() {
          if (1 == Q().length) {
            ...
            if (1 < r) {
              ...
              for (
                var l = a.row + s, d = 0 === a.col ? a.col : a.col - 1;
                0 <= d && (i[l][d] == i[l][d - 1] || (0 < l && i[l][d] == i[l - 1][d]));
    ...
    Ee.FE.DefineIcon('insertTable', { NAME: 'table' }),
    ...
    Ee.FE.DefineIcon('tableHeader', { NAME: 'header', FA5NAME: 'heading' }),
    ...
    Ee.FE.DefineIcon('tableRows', { NAME: 'bars' }),
    ...
    Ee.FE.DefineIcon('tableColumns', { NAME: 'bars fa-rotate-90' }),
    ...
    Ee.FE.DefineIcon('tableCells', { NAME: 'square-o', FA5NAME: 'square' }),
    ...
    Ee.FE.DefineIcon('tableRemove', { NAME: 'trash' }),
    ...
    Ee.FE.DefineIcon('tableStyle', { NAME: 'paint-brush' }),
    ...
    Ee.FE.DefineIcon('tableCellBackground', { NAME: 'tint' }),
    ...
    Ee.FE.DefineIcon('tableBack', { NAME: 'arrow-left' }),
    ...
    Ee.FE.DefineIcon('tableCellVerticalAlign', { NAME: 'arrows-v', FA5NAME: 'arrows-alt-v' }),
    ...
    Ee.FE.DefineIcon('tableCellHorizontalAlign', { NAME: 'align-left' }),
    Ee.FE.DefineIcon('align-left', { NAME: 'align-left' }),
    Ee.FE.DefineIcon('align-right', { NAME: 'align-right' }),
    Ee.FE.DefineIcon('align-center', { NAME: 'align-center' }),
    Ee.FE.DefineIcon('align-justify', { NAME: 'align-justify' }),
    Ee.FE.RegisterCommand('tableCellHorizontalAlign', {
      ...
      refresh: function(e) {
        ...
        t.length &&
          e
            .find('> *:first')
            .replaceWith(this.icon.create('align-' + this.helpers.getAlignment(Ee(t[0]))));
      },
      refreshOnShow: function(e, t) {
        t.find(
          '.fr-command[data-param1="' +
            this.helpers.getAlignment(this.$el.find('.fr-selected-cell:first')) +
            '"]'
        )
          .addClass('fr-active')
          .attr('aria-selected', !0);
    ...
    Ee.FE.DefineIcon('tableCellStyle', { NAME: 'magic' }),
    ...
    Ee.FE.DefineIcon('tableColorRemove', { NAME: 'eraser' }),
    (Ee.FE.URLRegEx =
      '(^| |\\u00A0)(' +
      Ee.FE.LinkRegEx +
    ...
    (Ee.FE.PLUGINS.url = function(a) {
      ...
      function t(e, t, n) {
        ...
        return (
          /^((http|https|ftp|ftps|mailto|tel|sms|notes|data)\:)/i.test(i) || (i = '//' + i),
          (t || '') +
            '<a' +
            (a.opts.linkAlwaysBlank ? ' target="_blank"' : '') +
            (o ? ' rel="' + o + '"' : '') +
      ...
      function l(e) {
        return (
          a.opts.linkAlwaysNoFollow && (o = 'nofollow'),
          a.opts.linkAlwaysBlank &&
            (a.opts.linkNoOpener && (o ? (o += ' noopener') : (o = 'noopener')),
            a.opts.linkNoReferrer && (o ? (o += ' noreferrer') : (o = 'noreferrer'))),
          e.replace(s(), t)
        );
      }
      function d(e) {
      ...
      function n() {
        ...
        if (
          (function e(t) {
            return (
              !!t &&
              ('A' === t.tagName || (!(!t.parentNode || t.parentNode == a.el) && e(t.parentNode)))
            );
          })(n)
        )
          return !1;
        if (s().test(d(n.textContent))) {
          ...
          r.removeAttr('data-fr-linked'),
            n.parentNode.removeChild(n),
            a.events.trigger('url.linked', [r.get(0)]);
        } else if (
          n.textContent.split(' ').length <= 2 &&
          n.previousSibling &&
          'A' === n.previousSibling.tagName
        ) {
            ...
            a.events.on(
              ...
              function(e) {
                ...
                !a.selection.isCollapsed() ||
                  (t != Ee.FE.KEYCODE.ENTER && t != Ee.FE.KEYCODE.SPACE) ||
                  n();
              },
              !0
            ),
            a.events.on('paste.beforeCleanup', function(e) {
              if (a.helpers.isURL(e)) {
                var t = null;
                return (
                  a.opts.linkAlwaysBlank &&
                    (a.opts.linkNoOpener && (t ? (t += ' noopener') : (t = 'noopener')),
                    a.opts.linkNoReferrer && (t ? (t += ' noreferrer') : (t = 'noreferrer'))),
                  '<a' +
                    (a.opts.linkAlwaysBlank ? ' target="_blank"' : '') +
                    (t ? ' rel="' + t + '"' : '') +
                    ' href="' +
    ...
    (Ee.FE.PLUGINS.video = function(p) {
      var s,
        c,
        f,
        u,
            ...
            (e = (function() {
              ...
              if (0 < p.opts.videoEditButtons.length) {
                p.opts.videoResponsive &&
                  (-1 < p.opts.videoEditButtons.indexOf('videoSize') &&
                    p.opts.videoEditButtons.splice(p.opts.videoEditButtons.indexOf('videoSize'), 1),
                  -1 < p.opts.videoEditButtons.indexOf('videoDisplay') &&
                    p.opts.videoEditButtons.splice(
                      p.opts.videoEditButtons.indexOf('videoDisplay'),
                      1
                    ),
                  -1 < p.opts.videoEditButtons.indexOf('videoAlign') &&
                    p.opts.videoEditButtons.splice(
                      p.opts.videoEditButtons.indexOf('videoAlign'),
                      1
                    )),
                  (e += '<div class="fr-buttons">'),
                  (e += p.button.buildList(p.opts.videoEditButtons));
                var t = { buttons: (e += '</div>') },
                  n = p.popups.create('video.edit', t);
                return (
                  p.events.$on(p.$wp, 'scroll.video-edit', function() {
      ...
      function o(e) {
        ...
        var t = '';
        p.opts.videoUpload ||
          -1 === p.opts.videoInsertButtons.indexOf('videoUpload') ||
          p.opts.videoInsertButtons.splice(p.opts.videoInsertButtons.indexOf('videoUpload'), 1);
        ...
        0 <= o &&
          ...
          (i =
            ...
            p.id +
            '" type="text" placeholder="' +
            p.language.translate('Paste in a video URL') +
        ...
        0 <= s &&
          ...
          (l =
            ...
            p.id +
            '" type="text" placeholder="' +
            p.language.translate('Embedded Code') +
        ...
        0 <= a &&
          ...
          (d =
            ...
            p.opts.videoAllowedTypes.join(', video/').toLowerCase() +
      ...
      function b(e) {
        ...
        u && (V(), (t = !0)),
          p.html.insert(
            '<span contenteditable="false" draggable="true" class="fr-jiv fr-video">' +
              e +
              '</span>',
            !1,
            p.opts.videoSplitHTML
          ),
          p.popups.hide('video.insert');
        var n = p.$el.find('.fr-jiv');
        n.removeClass('fr-jiv'),
          n.toggleClass('fr-rv', p.opts.videoResponsive),
          q(n, p.opts.videoDefaultDisplay, p.opts.videoDefaultAlign),
          n.toggleClass('fr-draggable', p.opts.videoMove),
          p.events.trigger(t ? 'video.replaced' : 'video.inserted', [n]);
      }
      function T() {
        var e = Ee(this);
        p.popups.hide('video.insert'),
        ...
        C('Loading video'),
          (function() {
            ...
            if (d) {
              ...
              e.find('video').on('canplay', T),
                e.find('video').attr('src', s),
                p.edit.on(),
                F(),
                p.undo.saveStep(),
                p.$el.blur(),
                p.events.trigger(r ? 'video.replaced' : 'video.inserted', [e, c]);
            } else
              (e = (function(e, t, n) {
                var r,
                  i = '';
                ...
                a && 'auto' != a && (a += 'px');
                var o = Ee(
                  '<span contenteditable="false" draggable="true" class="fr-video fr-dv' +
                    p.opts.videoDefaultDisplay[0] +
                    ('center' != p.opts.videoDefaultAlign
                      ? ' fr-fv' + p.opts.videoDefaultAlign[0]
                      : '') +
                    '"><video src="' +
                    e +
                    '" ' +
                    ...
                    (a ? ' style="width: ' + a + ';" ' : '') +
                    ' controls>' +
                    p.language.translate('Your browser does not support HTML5 video.') +
                    '</video></span>'
                );
                o.toggleClass('fr-draggable', p.opts.videoMove),
                  ...
                  p.selection.restore(),
                  p.undo.saveStep(),
                  p.opts.videoSplitHTML ? p.markers.split() : p.markers.insert(),
                  p.html.wrap();
                var s = p.$el.find('.fr-marker');
                return (
                  p.node.isLastSibling(s) &&
                    s.parent().hasClass('fr-deletable') &&
                    s.insertAfter(s.parent()),
                  s.replaceWith(o),
                  p.selection.clear(),
                  o.find('video').get(0).readyState > o.find('video').get(0).HAVE_FUTURE_DATA ||
                  p.helpers.isIOS()
                    ? n.call(o.find('video').get(0))
                    : o.find('video').on('canplaythrough load', n),
                  o
                );
              })(s, l, T)),
                F(),
                p.undo.saveStep(),
                p.events.trigger('video.inserted', [e, c]);
          })();
      }
      function C(e) {
      ...
      function S(e) {
        ...
        if (
          ...
          t.find('.fr-buttons').show(),
          e || p.$el.find('video.fr-error').length)
        ) {
          if (
            (p.events.focus(),
            p.$el.find('video.fr-error').length &&
              (p.$el
                .find('video.fr-error')
                .parent()
                .remove(),
                ...
                try {
                  var t = Ee(e)
                    ...
                    n = Ee(e)
                      .find('Key')
                      .text();
                  return !1 === p.events.trigger('video.uploadedToS3', [t, n, e], !0)
                    ? (p.edit.on(), !1)
                    : t;
                } catch (r) {
                  return H(g, e), !1;
      ...
      function O(e) {
        ...
        if ('mousedown' == e.type) {
          ...
          a &&
            i.frameElement &&
            ((t += p.helpers.getPX(Ee(i.frameElement).offset().left) + i.frameElement.clientLeft),
            (n =
              e.clientY +
              p.helpers.getPX(Ee(i.frameElement).offset().top) +
              i.frameElement.clientTop));
        }
      ...
      function I(e) {
        ...
        if (c) {
          ...
          var a = t - r,
            ...
            l = s.width(),
            d = s.height();
          (c.hasClass('fr-hnw') || c.hasClass('fr-hsw')) && (a = 0 - a),
      ...
      function F() {
        ...
        for (e = 0; e < t.length; e++)
          n.push(t[e].getAttribute('src')),
            Ee(t[e]).toggleClass('fr-draggable', p.opts.videoMove),
        ...
        if (r)
          for (e = 0; e < r.length; e++)
            n.indexOf(r[e].getAttribute('src')) < 0 &&
              p.events.trigger('video.removed', [Ee(r[e])]);
        r = t;
      }
      function M() {
        f ||
          (function() {
            var e;
            if (
              (p.shared.$video_resizer
                ? ((f = p.shared.$video_resizer),
                  (s = p.shared.$vid_overlay),
                  p.events.on(
                    'destroy',
                    function() {
                ...
                : ((p.shared.$video_resizer = Ee('<div class="fr-video-resizer"></div>')),
                  (f = p.shared.$video_resizer),
                  p.events.$on(
                    f,
                    'mousedown',
                  ...
                  p.opts.videoResize &&
                    (f.append(t('nw') + t('ne') + t('sw') + t('se')),
                    (p.shared.$vid_overlay = Ee('<div class="fr-video-overlay"></div>')),
                    (s = p.shared.$vid_overlay),
              ...
              p.events.on(
                ...
                function() {
                  f
                    ...
                    .remove(),
                    (f = null),
                    p.opts.videoResize && (s.remove(), (s = null));
                },
                !0
              ),
              p.helpers.isMobile() ||
                p.events.$on(Ee(p.o_win), 'resize.video', function() {
                  B(!0);
                }),
              p.opts.videoResize)
            ) {
              (e = f.get(0).ownerDocument),
                p.events.$on(f, p._mousedown, '.fr-handler', O),
                p.events.$on(Ee(e), p._mousemove, I),
                p.events.$on(Ee(e.defaultView || e.parentWindow), p._mouseup, D),
                p.events.$on(s, 'mouseleave', D);
              var r = 1,
                i = null,
                a = 0;
              p.events.on('keydown', function(e) {
                if (u) {
                  ...
                  (n !== i || 200 < e.timeStamp - a) && (r = 1),
                    (n == Ee.FE.KEYCODE.EQUALS ||
                      (p.browser.mozilla && n == Ee.FE.KEYCODE.FF_EQUALS)) &&
                    t &&
                    !e.altKey
                      ? (r = k.call(this, e, 1, 1, r))
                      : (n == Ee.FE.KEYCODE.HYPHEN ||
                          (p.browser.mozilla && n == Ee.FE.KEYCODE.FF_HYPHEN)) &&
                        t &&
                        !e.altKey &&
                        (r = k.call(this, e, 2, -1, r)),
                    (i = n),
                    (a = e.timeStamp);
                }
              }),
        ...
        f.css(
          'top',
          (p.opts.iframe ? e.offset().top - 1 : e.offset().top - p.$wp.offset().top - 1) +
            p.$wp.scrollTop()
        )
          .css(
            'left',
            (p.opts.iframe ? e.offset().left - 1 : e.offset().left - p.$wp.offset().left - 1) +
              p.$wp.scrollLeft()
          )
      ...
      function $(e) {
        ...
        p.toolbar.disable(),
          p.helpers.isMobile() && (p.events.disableBlur(), p.$el.blur(), p.events.enableBlur()),
          p.$el.find('.fr-video.fr-active').removeClass('fr-active'),
          ...
          p.events.trigger('image.hideResizer');
      }
      function B(e) {
        u &&
          (p.shared.vid_exit_flag || !0 === e) &&
          (f.removeClass('fr-active'),
          p.toolbar.enable(),
          u.removeClass('fr-active'),
          (u = null),
          P());
      }
      function e() {
        ...
        if (t && t.files && t.files.length) {
          ...
          if (n && n.type && -1 !== n.type.indexOf('video')) {
            ...
            p.markers.remove(),
              ...
              p.$el.find('.fr-marker').replaceWith(Ee.FE.MARKERS),
              p.popups.hideAll();
            var r = p.popups.get('video.insert');
            return (
              r || (r = o()),
              p.popups.setContainer('video.insert', p.$sc),
              p.popups.show('video.insert', e.originalEvent.pageX, e.originalEvent.pageY),
              C(),
              0 <= p.opts.videoAllowedTypes.indexOf(n.type.replace(/video\//g, ''))
                ? K(t.files)
                : H(v),
              e.preventDefault(),
              e.stopPropagation(),
      ...
      function K(e) {
        if (void 0 !== e && 0 < e.length) {
          ...
          var t,
            n = e[0];
          if (
            (null === p.opts.videoUploadURL || p.opts.videoUploadURL == l) &&
            !p.opts.videoUploadToS3
          )
            return (
              (function(r) {
          ...
          if (
            (p.drag_support.formdata && (t = p.drag_support.formdata ? new FormData() : null), t)
          ) {
            var r;
            if (!1 !== p.opts.videoUploadToS3)
              for (r in (t.append(
                'key',
                p.opts.videoUploadToS3.keyStart +
                  new Date().getTime() +
                  '-' +
                  (n.name || 'untitled')
              ),
              ...
              t.append('X-Requested-With', 'xhr'),
              t.append('Content-Type', n.type),
              p.opts.videoUploadToS3.params))
                p.opts.videoUploadToS3.params.hasOwnProperty(r) &&
                  t.append(r, p.opts.videoUploadToS3.params[r]);
            for (r in p.opts.videoUploadParams)
              p.opts.videoUploadParams.hasOwnProperty(r) &&
                t.append(r, p.opts.videoUploadParams[r]);
            t.append(p.opts.videoUploadParam, n);
            var i = p.opts.videoUploadURL;
            p.opts.videoUploadToS3 &&
              (i = p.opts.videoUploadToS3.uploadURL
                ? p.opts.videoUploadToS3.uploadURL
                : 'https://' +
                  p.opts.videoUploadToS3.region +
                  '.amazonaws.com/' +
                  p.opts.videoUploadToS3.bucket);
            var a = p.core.getXHR(i, p.opts.videoUploadMethod);
            (a.onload = function() {
              _.call(a, u);
            }),
              (a.onerror = x),
              (a.upload.onprogress = N),
              (a.onabort = w),
              C(),
      ...
      function H(e, t) {
        p.edit.on(),
          ...
          y(p.language.translate('Something went wrong. Please try again.')),
          p.events.trigger('video.error', [{ code: e, message: i[e] }, t]);
      }
      function W() {
        if (u) {
      ...
      function z(e) {
        ...
        var t = {
            buttons:
              '<div class="fr-buttons">' + p.button.buildList(p.opts.videoSizeButtons) + '</div>',
            size_layer:
              ...
              p.language.translate('Update') +
              '</button></div></div>',
          },
          n = p.popups.create('video.size', t);
        return (
          p.events.$on(p.$wp, 'scroll', function() {
      ...
      function V() {
        if (u && !1 !== p.events.trigger('video.beforeRemove', [u])) {
          ...
          p.popups.hideAll(),
            B(!0),
            p.selection.setBefore(e.get(0)) || p.selection.setAfter(e.get(0)),
            e.remove(),
            p.selection.restore(),
            p.html.fillEmptyBlocks();
        }
      }
      function X() {
        S();
      ...
      function q(e, t, n) {
        !p.opts.htmlUntouched && p.opts.useClasses
      ...
      function j() {
        p.$el
          ...
          p.$el
            ...
            .filter(function() {
              if (
                (p.browser.safari && this.getAttribute('src') && this.setAttribute('src', this.src),
                0 < Ee(this).parents('span.fr-video').length)
              )
                return !1;
              for (var e = Ee(this).attr('src'), t = 0; t < Ee.FE.VIDEO_PROVIDERS.length; t++) {
                ...
                if (
                  n.test_regex.test(e) &&
                  new RegExp(p.opts.videoAllowedProviders.join('|')).test(n.provider)
                )
                  return !0;
              }
              return !1;
            ...
            .map(function() {
              return 0 === Ee(this).parents('object').length
                ? this
                : Ee(this)
                    .parents('object')
                    .get(0);
        ...
        for (var e, t, n = p.$el.find('span.fr-video, video'), r = 0; r < n.length; r++) {
          ...
          !p.opts.htmlUntouched && p.opts.useClasses
            ? ((t = i).hasClass('fr-dvi') ||
                t.hasClass('fr-dvb') ||
                (t.addClass('fr-fv' + Y(t)[0]), t.addClass('fr-dv' + G(t)[0])),
              p.opts.videoTextNear || i.removeClass('fr-dvi').addClass('fr-dvb'))
            : p.opts.htmlUntouched ||
              p.opts.useClasses ||
              (q(
                (e = i),
                e.hasClass('fr-dvb') ? 'block' : e.hasClass('fr-dvi') ? 'inline' : null,
                e.hasClass('fr-fvl') ? 'left' : e.hasClass('fr-fvr') ? 'right' : Y(e)
              ),
              e.removeClass('fr-dvb fr-dvi fr-fvr fr-fvl'));
        }
        n.toggleClass('fr-draggable', p.opts.videoMove);
      }
      function Q() {
      ...
      return (
        (i[1] = 'Video cannot be loaded from the passed link.'),
        (i[d] = 'No link in upload response.'),
        (i[h] = 'Error during file upload.'),
        (i[g] = 'Parsing response failed.'),
        (i[m] = 'File is too large.'),
        (i[v] = 'Video file type is invalid.'),
        (i[7] = 'Files can be uploaded only to same domain in IE 8 and IE 9.'),
        (p.shared.vid_exit_flag = !1),
        {
          _init: function() {
            p.opts.videoResponsive && (p.opts.videoResize = !1),
              p.events.on('drop', U, !0),
              p.events.on('mousedown window.mousedown', e),
              p.events.on('window.touchmove', P),
              p.events.on('mouseup window.mouseup', B),
              ...
              p.helpers.isMobile() &&
                (p.events.$on(p.$el, 'touchstart', 'span.fr-video', function() {
                  n = !1;
                }),
                p.events.$on(p.$el, 'touchmove', function() {
                  n = !0;
                })),
              p.events.on('html.set', j),
              j(),
              p.events.$on(p.$el, 'mousedown', 'span.fr-video', function(e) {
                e.stopPropagation(),
                  (p.browser.msie || p.browser.edge) && (e.target.dragDrop(), $.call(this, e));
              }),
              ...
              p.events.on(
                ...
                function(e) {
                  var t = e.which;
                  return !u || (t != Ee.FE.KEYCODE.BACKSPACE && t != Ee.FE.KEYCODE.DELETE)
                    ? u && t == Ee.FE.KEYCODE.ESC
                      ? (B(!0), e.preventDefault(), !1)
                      : u && t != Ee.FE.KEYCODE.F10 && !p.keys.isBrowserAction(e)
                        ? (e.preventDefault(), !1)
                        : void 0
                    : (e.preventDefault(), V(), p.undo.saveStep(), !1);
                },
                !0
              ),
              p.events.on(
              ...
              p.events.on('keydown', function() {
                p.$el.find('span.fr-video:empty').remove();
              }),
              p.$wp && (F(), p.events.on('contentChanged', F)),
              o(!0),
              z(!0);
          },
          showInsertPopup: function() {
            ...
            if ((t || (t = o()), S(), !t.hasClass('fr-active')))
              if (
                (p.popups.refresh('video.insert'),
                p.popups.setContainer('video.insert', p.$tb),
                e.is(':visible'))
              ) {
                var n = e.offset().left + e.outerWidth() / 2,
          ...
          showLayer: function(e) {
            ...
            if (!u && !p.opts.toolbarInline) {
              ...
              (t = i.offset().left + i.outerWidth() / 2),
                (n = i.offset().top + (p.opts.toolbarBottom ? 10 : i.outerHeight() - 10));
            }
            p.opts.toolbarInline &&
              ((n = r.offset().top - p.helpers.getPX(r.css('margin-top'))),
              r.hasClass('fr-above') && (n += r.outerHeight())),
              r.find('.fr-layer').removeClass('fr-active'),
              r.find('.fr-' + e + '-layer').addClass('fr-active'),
              p.popups.show('video.insert', t, n, 0),
              p.accessibility.focusPopup(r);
          },
          refreshByURLButton: function(e) {
            p.popups
              .get('video.insert')
          ...
          insertByURL: function(e) {
            ...
            if ((/^http/.test(e) || (e = 'https://' + e), p.helpers.isURL(e)))
              for (var n = 0; n < Ee.FE.VIDEO_PROVIDERS.length; n++) {
                ...
                if (
                  r.test_regex.test(e) &&
                  new RegExp(p.opts.videoAllowedProviders.join('|')).test(r.provider)
                ) {
            ...
            t
              ? b(t)
              : (y(p.language.translate('Something went wrong. Please try again.')),
                p.events.trigger('video.linkError', [e]));
          },
            ...
            void 0 === e &&
              (e =
                p.popups
                  ...
                  .val() || ''),
              0 !== e.length && Ee.FE.VIDEO_EMBED_REGEX.test(e)
                ? b(e)
                : (y(p.language.translate('Something went wrong. Please try again.')),
                  p.events.trigger('video.codeError', [e]));
          },
          insert: b,
          align: function(e) {
          ...
          showSizePopup: function() {
            ...
            e || (e = z()),
              S(),
              p.popups.refresh('video.size'),
              p.popups.setContainer('video.size', p.$sc);
            var t = u.find('iframe, embed, video'),
          ...
          replace: function() {
            var e = p.popups.get('video.insert');
            e || (e = o()),
              p.popups.isVisible('video.insert') ||
                (S(),
                p.popups.refresh('video.insert'),
                p.popups.setContainer('video.insert', p.$sc));
          ...
          back: function() {
            u
              ? (p.events.disableBlur(), u.trigger('click'))
              : (p.events.disableBlur(),
                p.selection.restore(),
                p.events.enableBlur(),
                p.popups.hide('video.insert'),
    ...
    Ee.FE.DefineIcon('insertVideo', { NAME: 'video-camera', FA5NAME: 'camera' }),
    Ee.FE.DefineIcon('videoByURL', { NAME: 'link' }),
    ...
    Ee.FE.DefineIcon('videoEmbed', { NAME: 'code' }),
    ...
    Ee.FE.DefineIcon('videoUpload', { NAME: 'upload' }),
    ...
    Ee.FE.DefineIcon('videoDisplay', { NAME: 'star' }),
    ...
    Ee.FE.DefineIcon('video-align', { NAME: 'align-left' }),
    Ee.FE.DefineIcon('video-align-left', { NAME: 'align-left' }),
    Ee.FE.DefineIcon('video-align-right', { NAME: 'align-right' }),
    Ee.FE.DefineIcon('video-align-center', { NAME: 'align-justify' }),
    Ee.FE.DefineIcon('videoAlign', { NAME: 'align-center' }),
    ...
    Ee.FE.DefineIcon('videoReplace', { NAME: 'exchange', FA5NAME: 'exchange-alt' }),
    ...
    Ee.FE.DefineIcon('videoRemove', { NAME: 'trash' }),
    ...
    Ee.FE.DefineIcon('videoSize', { NAME: 'arrows-alt' }),
    ...
    Ee.FE.DefineIcon('videoBack', { NAME: 'arrow-left' }),
    ...
    (Ee.FE.PLUGINS.wordPaste = function(T) {
      ...
      function t(e) {
        ...
        e || (T.opts.wordAllowedStyleProps = []),
          ...
          (r = (function(e, t) {
            ...
            c(i, function(e) {
              if (e.nodeType == Node.TEXT_NODE && /\n|\u00a0|\r/.test(e.data)) {
                if (!/\S| /.test(e.data) && !/[\u00a0]+/.test(e.data))
                  return e.data == Ee.FE.UNICODE_NBSP
                    ? ((e.data = '\u200b'), !0)
                    : 1 == e.data.length && 10 == e.data.charCodeAt(0)
                      ? ((e.data = ' '), !0)
                      : (A(e), !1);
                    ...
                    (function(e, t) {
                      ...
                      if ('IMG' == e.tagName) {
                        ...
                        (n = h[e.getAttribute('v:shapes')]) ||
                          ((n = e.getAttribute('v:shapes')),
                          e.parentNode &&
                            e.parentNode.parentNode &&
                            0 <= e.parentNode.parentNode.innerHTML.indexOf('msEquation') &&
                            (n = null));
                          ...
                          : Ee(e.parentNode)
                              .before(
                                '<img data-fr-image-pasted="true" src="' +
                                  s +
                                  '" style="' +
                                  e.parentNode.getAttribute('style') +
                                  '">'
                              )
                              .remove();
                      }
            ...
            for (
              var a = i.querySelectorAll('ul > ul, ul > ol, ol > ul, ol > ol'), o = a.length - 1;
              0 <= o;
              o--
            )
              a[o].previousElementSibling &&
                'LI' === a[o].previousElementSibling.tagName &&
                a[o].previousElementSibling.appendChild(a[o]);
            c(i, function(t) {
              ...
              if (t.nodeType == Node.ELEMENT_NODE) {
                    ...
                    i = (function e(t, n, r) {
                      ...
                      for (; t; ) {
                        if (!C(t)) {
                          if (
                            t.outerHTML &&
                            0 < t.outerHTML.indexOf('mso-bookmark') &&
                        ...
                        if ((r = r || h) < h)
                          (f = e(t, n, h)), (u += f.el.outerHTML), (t = f.currentNode);
                        else {
                          if (h < r) break;
                          t.firstElementChild &&
                            ...
                            d === undefined || d === l
                              ? ((c = E(t, n)), (u += '<li>' + c + '</li>'))
                              : ((f = e(t, n, h)), (u += f.el.outerHTML), (t = f.currentNode));
                          var g = t && t.nextElementSibling;
                          g && (s = g.previousElementSibling),
                      ...
                      return { el: v, currentNode: t };
                    })(t, s).el,
                    a = null;
                  return (
                    (a = r ? r.nextSibling : n.firstChild)
                      ? n.insertBefore(i, a)
                      : n.appendChild(i),
                    !1
                  );
                ...
                return (
                  'FONT' === t.tagName && s['.' + t.getAttribute('class')] && (t = v(t, 'span')),
                  p(t, s)
                );
              }
              if (t.nodeType == Node.COMMENT_NODE) {
                if (-1 < t.data.indexOf('[if !supportLineBreakNewLine]'))
                  for (var o = t.nextSibling; o; )
                    (o = t.nextSibling) && A(o),
                      o.data && -1 < o.data.indexOf('[endif]') && (o = null);
                return A(t), !1;
              }
              return !0;
            }),
                  ...
                  !(function(e) {
                    ...
                    for (var r = {}, i = 0; i < n.length; i++) {
                      var a = n[i],
                        o = a.split(':');
                      2 == o.length &&
                        (('text-align' == o[0] && 'SPAN' == e.tagName) || (r[o[0]] = o[1]));
                    }
                    var s = '';
                    for (var l in r)
            ...
            return (
              (T.opts.htmlAllowedStyleProps = T.opts.wordAllowedStyleProps),
            ...
            (n = n.nextSibling),
              ...
              !n.parentNode
                ? r.previousSibling ||
                  ...
                  n.parentNode ||
                  (i
                    ? (n = i.nextSibling ? i.nextSibling.nextSibling : null)
                    : e.firstChild && (n = e.firstChild.nextSibling))
                : (n = i ? i.nextSibling : e.firstChild);
          }
      }
      function C(e) {
        if (
          !e.getAttribute('style') ||
          !/mso-list:[\s]*l/gi.test(e.getAttribute('style').replace(/\n/gi, ''))
        )
          return !1;
        try {
          if (!e.querySelector('[style="mso-list:Ignore"]'))
            return !!(e.outerHTML && 0 <= e.outerHTML.indexOf('\x3c!--[if !supportLists]--\x3e'));
        } catch (t) {
          return !1;
        }
        return !0;
      ...
      function E(e, a) {
        ...
        if (-1 != ['H1', 'H2', 'H3', 'H4', 'H5', 'H6'].indexOf(e.tagName)) {
          ...
          t.setAttribute('style', e.getAttribute('style')),
        ...
        c(o, function(e) {
          if (
            ...
            (T.browser.msie || T.browser.safari || T.browser.edge)
          )
            try {
          ...
          return (
            e.nodeType == Node.ELEMENT_NODE &&
              ...
              e.setAttribute(
                ...
                ['line-height', 'font-family', 'font-size'].forEach(function(e) {
          ...
          if (1 < (a = a.split('shplid')).length) {
            ...
            if (
              (-1 != l[0].indexOf('pngblip')
                ? (d = 'image/png')
                : -1 != l[0].indexOf('jpegblip') && (d = 'image/jpeg'),
              !d)
            )
              continue;
            var c,
      ...
      function p(e, t) {
        ...
        e.firstElementChild &&
          ('I' == e.firstElementChild.tagName
            ? v(e.firstElementChild, 'em')
            : 'B' == e.firstElementChild.tagName && v(e.firstElementChild, 'strong'));
        ...
        if (-1 != ['P', 'H1', 'H2', 'H3', 'H4', 'H5', 'H6', 'PRE'].indexOf(n)) {
          ...
          if (
            f &&
            (t && t[n.toLowerCase() + '.' + f] && y(e, t[n.toLowerCase() + '.' + f]),
            -1 != f.toLowerCase().indexOf('mso'))
          ) {
            var p = R(f);
            (p = p.replace(/[0-9a-z-_]*mso[0-9a-z-_]*/gi, ''))
          ...
          ('TR' == n &&
            (function(e, t) {
              ...
              for (var n = e.firstElementChild, r = 0, i = !1, a = null; n; ) {
                n.firstElementChild &&
                  -1 != n.firstElementChild.tagName.indexOf('W:') &&
                  (n.innerHTML = n.firstElementChild.innerHTML),
                  (a = n.getAttribute('width')) || i || (i = !0),
                  (r += parseInt(a, 10)),
                  (!n.firstChild || (n.firstChild && n.firstChild.data == Ee.FE.UNICODE_NBSP)) &&
                    (n.firstChild && A(n.firstChild), (n.innerHTML = '<br>'));
              ...
              for (n = e.firstElementChild; n; )
                (a = n.getAttribute('width')),
                  i
                    ...
                    : n.setAttribute('width', (100 * parseInt(a, 10)) / r + '%'),
                  (n = n.nextElementSibling);
            })(e, t),
          'A' != n ||
            ...
            !e.innerHTML ||
            (e.outerHTML = e.innerHTML),
          'A' == n && e.getAttribute('href') && e.querySelector('img'))
        ) {
          var g = e.querySelectorAll('span');
          for (i = 0; i < g.length; i++) g[i].innerText || (g[i].outerHTML = g[i].innerHTML);
        }
        if (
          (('TD' != n && 'TH' != n) || e.innerHTML || (e.innerHTML = '<br>'),
          'TABLE' == n && (e.style.width = e.style.width || '100%'),
          ...
          var m = R(e.getAttribute('style'));
          (m = m.replace(/[0-9a-z-_]*mso[0-9a-z-_]*:.+?(;{1,1}|$)/gi, ''))
                ...
                ? (function() {
                    if (!a) {
                      ...
                      (a = n.$modal),
                        ...
                        T.events.bindClick(r, 'button.fr-remove-word', function() {
