...
!(function(n) {
  ...
  c.extend(c.FE.POPUP_TEMPLATES, {
    ...
    (c.FE.PLUGINS.embedly = function(r) {
      function t() {
        r.events.on('html.processGet', i),
          ...
          r.win.embedly &&
            (r.win.embedly('on', 'card.rendered', function(e) {
              n(e);
            }),
            r.win.embedly('on', 'card.resize', function(e) {
              n(e);
            })),
          l(!0);
      }
      ...
      function d(e) {
        (s = c(this)),
          (function() {
            o ||
              (function() {
                r.shared.$embedly_resizer
                  ? ((o = r.shared.$embedly_resizer),
                    r.shared.$embedly_overlay,
                    r.events.on(
                      'destroy',
                      function() {
                  ...
                  : ((r.shared.$embedly_resizer = c('<div class="fr-embedly-resizer"></div>')),
                    (o = r.shared.$embedly_resizer),
                    r.events.$on(
                      o,
                      'mousedown',
            ...
            (r.$wp || r.$sc).append(o),
              ...
              o
                .css(
                  'top',
                  (r.opts.iframe
                    ? s.offset().top - 1 + r.$iframe.position().top
                    : s.offset().top - r.$wp.offset().top - 1) + r.$wp.scrollTop()
                )
                .css(
                  'left',
                  (r.opts.iframe
                    ? s.offset().left - 1
                    : s.offset().left - r.$wp.offset().left - 1) + r.$wp.scrollLeft()
                )
              ...
              (e = (function() {
                ...
                if (0 < r.opts.embedlyEditButtons.length) {
                  (e += '<div class="fr-buttons">'),
                    (e += r.button.buildList(r.opts.embedlyEditButtons));
                  var t = { buttons: (e += '</div>') },
                    n = r.popups.create('embedly.edit', t);
                  return (
                    r.events.$on(r.$wp, 'scroll.emebdly-edit', function() {
                      s &&
                        r.popups.isVisible('embedly.edit') &&
                        (r.events.disableBlur(), d.call(s.get(0)));
                    }),
                    n
                  );
                }
      ...
      function i(e) {
        if (e && r.node.hasClass(e, 'fr-embedly'))
          ...
          for (var t = e.querySelectorAll('.fr-embedly'), n = 0; n < t.length; n++) i(t[n]);
      }
      function l(e) {
        if (e) return r.popups.onRefresh('embedly.insert', a), !0;
        var t = '';
        0 < r.opts.embedlyInsertButtons.length &&
          ((t += '<div class="fr-buttons">'),
          (t += r.button.buildList(r.opts.embedlyInsertButtons)),
          (t += '</div>'));
        var n = {
          buttons: t,
          url_layer:
      ...
      function e(e) {
        if (e.length) {
          var t =
            ...
            (r.opts.embedlyKey ? " data-card-key='" + r.opts.embedlyKey + "'" : '') +
            '></a>';
          r.html.insert(
      ...
      function f() {
        if (s && !1 !== r.events.trigger('embedly.beforeRemove', [s])) {
          ...
          r.popups.hideAll(),
            u(!0),
            r.selection.setBefore(e.get(0)) || r.selection.setAfter(e.get(0)),
            e.remove(),
            r.selection.restore(),
            r.html.fillEmptyBlocks(),
            r.undo.saveStep(),
            r.events.trigger('video.removed', [e]);
        }
      }
      function u(e) {
        s &&
          (r.shared.embedly_exit_flag || !0 === e) &&
      ...
      return (
        (r.shared.embedly_exit_flag = !1),
        {
          _init: function() {
            if (!r.$wp) return !1;
            if ('undefined' != typeof embedly) t();
            else if (r.shared.embedlyLoaded) r.shared.embedlyCallbacks.push(t);
            else {
              (r.shared.embedlyLoaded = !0),
                (r.shared.embedlyCallbacks = []),
                r.shared.embedlyCallbacks.push(t);
              var e = r.doc.createElement('script');
              (e.type = 'text/javascript'),
                (e.src = r.opts.embedlyScriptPath),
                (e.innerText = ''),
                (e.onload = function() {
                  if (r.shared.embedlyCallbacks)
                    for (var e = 0; e < r.shared.embedlyCallbacks.length; e++)
                      r.shared.embedlyCallbacks[e]();
                }),
          ...
          showInsertPopup: function() {
            ...
            if ((t || (t = l()), !t.hasClass('fr-active')))
              if (
                (r.popups.refresh('embedly.insert'),
                r.popups.setContainer('embedly.insert', r.$tb),
                e.is(':visible'))
              ) {
          ...
          back: function() {
            s
              ? (r.events.disableBlur(), s.trigger('click'))
              : (r.events.disableBlur(),
                r.selection.restore(),
                r.events.enableBlur(),
                r.popups.hide('embedly.insert'),
                r.toolbar.showInline());
          },
        }
      );
    }),
    c.FE.DefineIcon('embedly', { NAME: 'share-alt' }),
    c.FE.RegisterCommand('embedly', {
      undo: !0,
      focus: !0,
      title: 'Embed URL',
      popup: !0,
    ...
    c.FE.RegisterCommand('embedlyInsert', {
      undo: !0,
      focus: !0,
      callback: function() {
        this.embedly.insert();
    ...
    c.FE.DefineIcon('embedlyRemove', { NAME: 'trash' }),
    c.FE.RegisterCommand('embedlyRemove', {
      title: 'Remove',
      undo: !1,
      callback: function() {
        this.embedly.remove();
    ...
    c.FE.DefineIcon('embedlyBack', { NAME: 'arrow-left' }),
    c.FE.RegisterCommand('embedlyBack', {
      title: 'Back',
      undo: !1,
      focus: !1,
      back: !0,
