...
!(function(e) {
  'function' == typeof define && define.amd
    ...
    : 'object' == typeof module && module.exports
      ? (module.exports = function(o, r) {
          return (
            r === undefined &&
              (r = 'undefined' != typeof window ? require('jquery') : require('jquery')(o)),
            e(r)
          );
        })
      : e(window.jQuery);
  ...
  (C.FE.PLUGINS.colors = function(E) {
      ...
      for (
        var r = 'text' == o ? E.opts.colorsText : E.opts.colorsBackground,
          e =
            ...
            o +
            '-color' +
            (E.opts.colorsDefaultTab == o ||
            ('text' != E.opts.colorsDefaultTab &&
    ...
    function t(o) {
      'REMOVE' != o
        ? E.format.applyStyle('background-color', E.helpers.HEXtoRGB(o))
        : E.format.removeStyle('background-color'),
        r();
    }
    function a(o) {
      'REMOVE' != o
        ? E.format.applyStyle('color', E.helpers.HEXtoRGB(o))
        : E.format.removeStyle('color'),
        r();
    }
    return {
          ...
          (r ||
            (r = (function() {
              ...
              E.opts.toolbarInline &&
                0 < E.opts.colorsButtons.length &&
                (r += E.button.buildList(E.opts.colorsButtons)),
                (r += ((o = '<div class="fr-colors-tabs fr-group">'),
                (o +=
              ...
              !(function(o) {
                ...
                for (
                  a.find('.fr-selected-color').remove(),
                    ...
                    a.not('[data-param1="REMOVE"]').attr('aria-selected', !1);
                  t.get(0) != E.el;
                  ...
                  if ('transparent' != t.css(r) && 'rgba(0, 0, 0, 0)' != t.css(r)) {
                    var s = e.find(
                      '.fr-' +
                        ...
                        E.helpers.RGBToHex(t.css(r)) +
                        '"]'
                    );
                    s.append('<span class="fr-selected-color" aria-hidden="true">\uf00c</span>'),
                      s.addClass('fr-active-item').attr('aria-selected', !0);
                    break;
                  }
                  t = t.parent();
                }
    ...
    C.FE.RegisterCommand('colorChangeSet', {
      ...
      callback: function(o, r) {
        var e = this.popups
          .get('colors.picker')
          .find('.fr-command[data-cmd="' + o + '"][data-param1="' + r + '"]');
