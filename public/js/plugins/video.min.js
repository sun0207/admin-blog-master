...
!(function(i) {
  ...
  Q.extend(Q.FE.POPUP_TEMPLATES, {
    ...
    (Q.FE.PLUGINS.video = function(p) {
              ...
              if (0 < p.opts.videoEditButtons.length) {
                ...
                return (
                  p.events.$on(p.$wp, 'scroll.video-edit', function() {
                    u && p.popups.isVisible('video.edit') && (p.events.disableBlur(), R(u));
                  }),
                  i
                );
              }
      ...
      function n(e) {
        if (e) return p.popups.onRefresh('video.insert', b), p.popups.onHide('image.insert', W), !0;
        var t = '';
        p.opts.videoUpload ||
        ...
        return (
          (function(o) {
            p.events.$on(
              ...
              function() {
                return Q(this).addClass('fr-drop'), !1;
              },
              !0
            ),
              p.events.$on(
                ...
                '.fr-video-upload-layer',
                function() {
                  return Q(this).removeClass('fr-drop'), !1;
                },
                !0
              ),
              p.events.$on(
                ...
                '.fr-video-upload-layer',
                function(e) {
                  e.preventDefault(), e.stopPropagation(), Q(this).removeClass('fr-drop');
      ...
      function y(e) {
        ...
        i.removeClass('fr-jiv'),
          i.toggleClass('fr-rv', p.opts.videoResponsive),
          q(i, p.opts.videoDefaultDisplay, p.opts.videoDefaultAlign),
          i.toggleClass('fr-draggable', p.opts.videoMove),
          p.events.trigger(t ? 'video.replaced' : 'video.inserted', [i]);
      }
      function w() {
        var e = Q(this);
        p.popups.hide('video.insert'),
      ...
      function E(a, e, d, l, f) {
        p.edit.off(), x('Loading video'), e && (a = p.helpers.sanitizeURL(a));
        C('Loading video'),
          (function() {
            var e, t;
            if (l) {
              ...
              e.find('video').on('canplay', w),
                ...
                p.undo.saveStep(),
                p.$el.blur(),
                p.events.trigger(o ? 'video.replaced' : 'video.inserted', [e, f]);
            } else
              (e = (function(e, t, i) {
                var o,
                  r = '';
                ...
                return (
                  p.node.isLastSibling(a) &&
                    a.parent().hasClass('fr-deletable') &&
                    a.insertAfter(a.parent()),
                  a.replaceWith(n),
                  p.selection.clear(),
                  n.find('video').get(0).readyState > n.find('video').get(0).HAVE_FUTURE_DATA ||
                  p.helpers.isIOS()
                    ? i.call(n.find('video').get(0))
                    : n.find('video').on('canplaythrough load', i),
                  n
                );
              })(a, d, w)),
                O(),
                p.undo.saveStep(),
                p.events.trigger('video.inserted', [e, f]);
          })();
      }
      function C(e) {
        ...
        void 0 === e && x(p.language.translate('Uploading'), 0);
      }
      function A(e) {
        var t = p.popups.get('video.insert');
        if (
          ...
          if (
            ...
            var i = u;
            P(!0), p.selection.setAfter(i.find('video').get(0)), p.selection.restore();
          }
          p.popups.hide('video.insert');
        }
      }
      function x(e, t) {
        ...
        if (i) {
          ...
          o.find('h3').text(e + (t ? ' ' + t + '%' : '')),
            ...
            t
              ? (o.find('div').removeClass('fr-indeterminate'),
                o.find('div > span').css('width', t + '%'))
              : o.find('div').addClass('fr-indeterminate');
        }
      }
      function _(e) {
        C();
                ...
                try {
                  var t = Q(e)
                    ...
                    i = Q(e)
                      .find('Key')
                      .text();
                  return !1 === p.events.trigger('video.uploadedToS3', [t, i, e], !0)
                    ? (p.edit.on(), !1)
                    : t;
                } catch (o) {
                  return V(h, e), !1;
      ...
      function D() {
        V(h, this.response || this.responseText || this.responseXML);
      }
      function U(e) {
        if (e.lengthComputable) {
          var t = ((e.loaded / e.total) * 100) | 0;
          x(p.language.translate('Uploading'), t);
        }
      }
      function B() {
        p.edit.on(), A(!0);
      ...
      function I(e) {
        ...
        if ('mousedown' == e.type) {
          ...
          s &&
            r.frameElement &&
            ((t += p.helpers.getPX(Q(r.frameElement).offset().left) + r.frameElement.clientLeft),
            (i =
              e.clientY +
              p.helpers.getPX(Q(r.frameElement).offset().top) +
              r.frameElement.clientTop));
        }
        p.undo.canDo() || p.undo.saveStep(),
          (f = Q(this)).data('start-x', t),
          f.data('start-y', i),
          a.show(),
          p.popups.hideAll(),
          T();
      ...
      function $(e) {
        ...
        if (f) {
          ...
          var s = t - o,
            ...
            d = a.width(),
            l = a.height();
          (f.hasClass('fr-hnw') || f.hasClass('fr-hsw')) && (s = 0 - s),
      ...
      function k(e) {
        if (!p.core.sameInstance(v)) return !0;
        f && u && (e && e.stopPropagation(), (f = null), a.hide(), L(), s(), p.undo.saveStep());
      }
      function t(e) {
      ...
      function O() {
        ...
        for (e = 0; e < t.length; e++)
          i.push(t[e].getAttribute('src')),
            Q(t[e]).toggleClass('fr-draggable', p.opts.videoMove),
            '' === t[e].getAttribute('class') && t[e].removeAttribute('class'),
            '' === t[e].getAttribute('style') && t[e].removeAttribute('style');
        if (o)
          for (e = 0; e < o.length; e++)
            i.indexOf(o[e].getAttribute('src')) < 0 && p.events.trigger('video.removed', [Q(o[e])]);
        o = t;
      }
      function L() {
        v ||
            ...
            if (
              (p.shared.$video_resizer
                ? ((v = p.shared.$video_resizer),
                  (a = p.shared.$vid_overlay),
                  p.events.on(
                    'destroy',
                    function() {
                      v.removeClass('fr-active').appendTo(Q('body:first'));
                    },
                    !0
                  ))
                : ((p.shared.$video_resizer = Q('<div class="fr-video-resizer"></div>')),
                  (v = p.shared.$video_resizer),
                  p.events.$on(
                    v,
                    'mousedown',
                  ...
                  p.opts.videoResize &&
                    (v.append(t('nw') + t('ne') + t('sw') + t('se')),
                    (p.shared.$vid_overlay = Q('<div class="fr-video-overlay"></div>')),
                    (a = p.shared.$vid_overlay),
              ...
              p.events.on(
                ...
                function() {
                  v
                    ...
                    .remove(),
                    (v = null),
                    p.opts.videoResize && (a.remove(), (a = null));
                },
                !0
              ),
              p.helpers.isMobile() ||
                p.events.$on(Q(p.o_win), 'resize.video', function() {
                  P(!0);
                }),
              p.opts.videoResize)
            ) {
              (e = v.get(0).ownerDocument),
                p.events.$on(v, p._mousedown, '.fr-handler', I),
                p.events.$on(Q(e), p._mousemove, $),
                p.events.$on(Q(e.defaultView || e.parentWindow), p._mouseup, k),
                p.events.$on(a, 'mouseleave', k);
              var o = 1,
                r = null,
                s = 0;
              p.events.on('keydown', function(e) {
                if (u) {
                  var t = -1 != navigator.userAgent.indexOf('Mac OS X') ? e.metaKey : e.ctrlKey,
                    i = e.which;
                  (i !== r || 200 < e.timeStamp - s) && (o = 1),
                    (i == Q.FE.KEYCODE.EQUALS ||
                      (p.browser.mozilla && i == Q.FE.KEYCODE.FF_EQUALS)) &&
                    t &&
                    !e.altKey
                      ? (o = F.call(this, e, 1, 1, o))
                      : (i == Q.FE.KEYCODE.HYPHEN ||
                          (p.browser.mozilla && i == Q.FE.KEYCODE.FF_HYPHEN)) &&
                        t &&
                        !e.altKey &&
                        (o = F.call(this, e, 2, -1, o)),
                    (r = i),
                    (s = e.timeStamp);
                }
              }),
      ...
      function z(e) {
        ...
        for (var t = 0; t < Q.FE.INSTANCES.length; t++)
          Q.FE.INSTANCES[t] != p && Q.FE.INSTANCES[t].events.trigger('video.hideResizer');
        p.toolbar.disable(),
          p.helpers.isMobile() && (p.events.disableBlur(), p.$el.blur(), p.events.enableBlur()),
          p.$el.find('.fr-video.fr-active').removeClass('fr-active'),
          (u = Q(this)).addClass('fr-active'),
        ...
        if (t && t.files && t.files.length) {
          ...
          if (i && i.type && -1 !== i.type.indexOf('video')) {
            ...
            p.markers.remove(),
              ...
              p.$el.find('.fr-marker').replaceWith(Q.FE.MARKERS),
              p.popups.hideAll();
            ...
            return (
              ...
              C(),
              0 <= p.opts.videoAllowedTypes.indexOf(i.type.replace(/video\//g, ''))
                ? N(t.files)
                : V(m),
              e.preventDefault(),
              e.stopPropagation(),
      ...
      function N(e) {
        if (void 0 !== e && 0 < e.length) {
          ...
          var t,
            i = e[0];
          if (
            (null === p.opts.videoUploadURL || p.opts.videoUploadURL == d) &&
            !p.opts.videoUploadToS3
          )
            return (
              (function(o) {
                u && u.find('iframe') && u.find('iframe').length && j();
                ...
                (r.onload = function() {
                  ...
                  E(
                    window.URL.createObjectURL(new Blob([new Uint8Array(t)], { type: o.type })),
                    !1,
                    null,
                    u
                  );
          ...
          if (i.size > p.opts.videoMaxSize) return V(g), !1;
          if (p.opts.videoAllowedTypes.indexOf(i.type.replace(/video\//g, '')) < 0) return V(m), !1;
          if (
            ...
            if (!1 !== p.opts.videoUploadToS3)
              ...
              t.append('Content-Type', i.type),
              p.opts.videoUploadToS3.params))
                p.opts.videoUploadToS3.params.hasOwnProperty(o) &&
                  t.append(o, p.opts.videoUploadToS3.params[o]);
            for (o in p.opts.videoUploadParams)
              p.opts.videoUploadParams.hasOwnProperty(o) &&
                t.append(o, p.opts.videoUploadParams[o]);
            t.append(p.opts.videoUploadParam, i);
            var r = p.opts.videoUploadURL;
            p.opts.videoUploadToS3 &&
              (r = p.opts.videoUploadToS3.uploadURL
            ...
            n &&
              n.off('abortUpload').on('abortUpload', function() {
      ...
      function V(e, t) {
        p.edit.on(),
          ...
          _(p.language.translate('Something went wrong. Please try again.')),
          p.events.trigger('video.error', [{ code: e, message: r[e] }, t]);
      }
      function Y() {
        if (u) {
      ...
      function H(e) {
        if (e) return p.popups.onRefresh('video.size', Y), !0;
        var t = {
            buttons:
        ...
        return (
          p.events.$on(p.$wp, 'scroll', function() {
            u && p.popups.isVisible('video.size') && (p.events.disableBlur(), R(u));
          }),
          i
        );
      }
      ...
      function q(e, t, i) {
        !p.opts.htmlUntouched && p.opts.useClasses
          ? (e.removeClass('fr-fvl fr-fvr fr-dvb fr-dvi'),
            e.addClass('fr-fv' + i[0] + ' fr-dv' + t[0]))
          : 'inline' == t
      ...
      function G() {
        p.$el
          .find('video')
          .filter(function() {
            return 0 === Q(this).parents('span.fr-video').length;
          })
          ...
          p.$el
            ...
            .filter(function() {
              if (
                ...
                0 < Q(this).parents('span.fr-video').length)
              )
                return !1;
              for (var e = Q(this).attr('src'), t = 0; t < Q.FE.VIDEO_PROVIDERS.length; t++) {
                var i = Q.FE.VIDEO_PROVIDERS[t];
                if (
                  i.test_regex.test(e) &&
                  new RegExp(p.opts.videoAllowedProviders.join('|')).test(i.provider)
                )
                  return !0;
              }
              return !1;
            ...
            .map(function() {
              return 0 === Q(this).parents('object').length
                ? this
                : Q(this)
                    .parents('object')
                    .get(0);
            ...
            .wrap('<span class="fr-video" contenteditable="false"></span>');
        for (var e, t, i = p.$el.find('span.fr-video, video'), o = 0; o < i.length; o++) {
          var r = Q(i[o]);
          !p.opts.htmlUntouched && p.opts.useClasses
            ? ((t = r).hasClass('fr-dvi') ||
                t.hasClass('fr-dvb') ||
                (t.addClass('fr-fv' + X(t)[0]), t.addClass('fr-dv' + K(t)[0])),
              p.opts.videoTextNear || r.removeClass('fr-dvi').addClass('fr-dvb'))
            : p.opts.htmlUntouched ||
              p.opts.useClasses ||
              (q(
                (e = r),
                e.hasClass('fr-dvb') ? 'block' : e.hasClass('fr-dvi') ? 'inline' : null,
                e.hasClass('fr-fvl') ? 'left' : e.hasClass('fr-fvr') ? 'right' : X(e)
              ),
      ...
      return (
        ...
        (r[l] = 'No link in upload response.'),
        ...
        (p.shared.vid_exit_flag = !1),
        {
          _init: function() {
            p.opts.videoResponsive && (p.opts.videoResize = !1),
              p.events.on('drop', M, !0),
              p.events.on('mousedown window.mousedown', e),
              p.events.on('window.touchmove', T),
              p.events.on('mouseup window.mouseup', P),
              ...
              p.events.on('html.set', G),
              G(),
              p.events.$on(p.$el, 'mousedown', 'span.fr-video', function(e) {
                e.stopPropagation(),
                  (p.browser.msie || p.browser.edge) && (e.target.dragDrop(), z.call(this, e));
              }),
              ...
              p.events.on(
                ...
                function(e) {
                  var t = e.which;
                  return !u || (t != Q.FE.KEYCODE.BACKSPACE && t != Q.FE.KEYCODE.DELETE)
                    ? u && t == Q.FE.KEYCODE.ESC
                      ? (P(!0), e.preventDefault(), !1)
                      : u && t != Q.FE.KEYCODE.F10 && !p.keys.isBrowserAction(e)
                        ? (e.preventDefault(), !1)
                        : void 0
                    : (e.preventDefault(), j(), p.undo.saveStep(), !1);
                },
                !0
              ),
              p.events.on(
              ...
              p.$wp && (O(), p.events.on('contentChanged', O)),
              n(!0),
              H(!0);
          },
            ...
            if ((t || (t = n()), A(), !t.hasClass('fr-active')))
              if (
                ...
                var i = e.offset().left + e.outerWidth() / 2,
                  o = e.offset().top + (p.opts.toolbarBottom ? 10 : e.outerHeight() - 10);
                p.popups.show('video.insert', i, o, e.outerHeight());
          ...
          showLayer: function(e) {
            ...
            if (!u && !p.opts.toolbarInline) {
              ...
              (t = r.offset().left + r.outerWidth() / 2),
                (i = r.offset().top + (p.opts.toolbarBottom ? 10 : r.outerHeight() - 10));
            }
            p.opts.toolbarInline &&
              ((i = o.offset().top - p.helpers.getPX(o.css('margin-top'))),
              o.hasClass('fr-above') && (i += o.outerHeight())),
              o.find('.fr-layer').removeClass('fr-active'),
              o.find('.fr-' + e + '-layer').addClass('fr-active'),
              p.popups.show('video.insert', t, i, 0),
              p.accessibility.focusPopup(o);
          },
          ...
          insertByURL: function(e) {
            ...
            if ((/^http/.test(e) || (e = 'https://' + e), p.helpers.isURL(e)))
              for (var i = 0; i < Q.FE.VIDEO_PROVIDERS.length; i++) {
                var o = Q.FE.VIDEO_PROVIDERS[i];
                if (
                  o.test_regex.test(e) &&
                  new RegExp(p.opts.videoAllowedProviders.join('|')).test(o.provider)
                ) {
            ...
            void 0 === e &&
              (e =
                p.popups
                  ...
                  .val() || ''),
              0 !== e.length && Q.FE.VIDEO_EMBED_REGEX.test(e)
                ? y(e)
                : (_(p.language.translate('Something went wrong. Please try again.')),
          ...
          refreshAlign: function(e) {
            if (!u) return !1;
            e.find('> *:first').replaceWith(p.icon.create('video-align-' + X()));
          },
          refreshAlignOnShow: function(e, t) {
            u &&
              t
                .find('.fr-command[data-param1="' + X() + '"]')
                .addClass('fr-active')
          ...
          showSizePopup: function() {
            ...
            p.popups.show('video.size', i, o, t.height());
          },
          replace: function() {
            var e = p.popups.get('video.insert');
            e || (e = n()),
            ...
            p.popups.show('video.insert', t, i, u.outerHeight());
          },
          back: function() {
            u
    ...
    Q.FE.RegisterCommand('insertVideo', {
      title: 'Insert Video',
      undo: !1,
      focus: !0,
    ...
    Q.FE.DefineIcon('insertVideo', { NAME: 'video-camera', FA5NAME: 'camera' }),
    Q.FE.DefineIcon('videoByURL', { NAME: 'link' }),
    Q.FE.RegisterCommand('videoByURL', {
      title: 'By URL',
      undo: !1,
      focus: !1,
      toggle: !0,
    ...
    Q.FE.DefineIcon('videoEmbed', { NAME: 'code' }),
    Q.FE.RegisterCommand('videoEmbed', {
      title: 'Embedded Code',
      undo: !1,
      focus: !1,
      toggle: !0,
    ...
    Q.FE.DefineIcon('videoUpload', { NAME: 'upload' }),
    Q.FE.RegisterCommand('videoUpload', {
      title: 'Upload Video',
      undo: !1,
      focus: !1,
      toggle: !0,
    ...
    Q.FE.RegisterCommand('videoInsertByURL', {
      undo: !0,
      focus: !0,
      callback: function() {
    ...
    Q.FE.RegisterCommand('videoInsertEmbed', {
      undo: !0,
      focus: !0,
      callback: function() {
    ...
    Q.FE.DefineIcon('videoDisplay', { NAME: 'star' }),
    Q.FE.RegisterCommand('videoDisplay', {
      title: 'Display',
      type: 'dropdown',
    ...
    Q.FE.DefineIcon('video-align', { NAME: 'align-left' }),
    Q.FE.DefineIcon('video-align-left', { NAME: 'align-left' }),
    Q.FE.DefineIcon('video-align-right', { NAME: 'align-right' }),
    Q.FE.DefineIcon('video-align-center', { NAME: 'align-justify' }),
    Q.FE.DefineIcon('videoAlign', { NAME: 'align-center' }),
    Q.FE.RegisterCommand('videoAlign', {
      type: 'dropdown',
      title: 'Align',
      options: { left: 'Align Left', center: 'None', right: 'Align Right' },
      html: function() {
        var e = '<ul class="fr-dropdown-list" role="presentation">',
          t = Q.FE.COMMANDS.videoAlign.options;
        for (var i in t)
          t.hasOwnProperty(i) &&
            (e +=
              ...
              i +
              '" title="' +
              this.language.translate(t[i]) +
              '">' +
              this.icon.create('video-align-' + i) +
    ...
    Q.FE.DefineIcon('videoReplace', { NAME: 'exchange', FA5NAME: 'exchange-alt' }),
    Q.FE.RegisterCommand('videoReplace', {
      title: 'Replace',
      undo: !1,
      focus: !1,
      popup: !0,
    ...
    Q.FE.DefineIcon('videoRemove', { NAME: 'trash' }),
    Q.FE.RegisterCommand('videoRemove', {
      title: 'Remove',
      callback: function() {
        this.video.remove();
      },
    }),
    Q.FE.DefineIcon('videoSize', { NAME: 'arrows-alt' }),
    Q.FE.RegisterCommand('videoSize', {
      undo: !1,
      focus: !1,
      popup: !0,
      title: 'Change Size',
    ...
    Q.FE.DefineIcon('videoBack', { NAME: 'arrow-left' }),
    Q.FE.RegisterCommand('videoBack', {
      title: 'Back',
      undo: !1,
      focus: !1,
      back: !0,
    ...
    Q.FE.RegisterCommand('videoDismissError', {
      title: 'OK',
      undo: !1,
      callback: function() {
    ...
    Q.FE.RegisterCommand('videoSetSize', {
      undo: !0,
      focus: !1,
      title: 'Update',
      refreshAfterCallback: !1,
