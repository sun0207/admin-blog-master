...
!(function(l) {
  ...
  n.extend(n.FE.DEFAULTS, {
        ...
        show: function() {
          if (!o) {
              ...
              t = (function() {
                for (
                  ...
                  var l = s.opts.helpSets[t],
                    o = '<table>';
                  (o += '<thead><tr><th>' + s.language.translate(l.title) + '</th></tr></thead>'),
                    (o += '<tbody>');
                  for (var a = 0; a < l.commands.length; a++) {
                    var n = l.commands[a];
                    (o += '<tr>'),
                      (o += '<td>' + s.language.translate(n.desc) + '</td>'),
                      (o +=
                        '<td>' +
                        n.val.replace('OSkey', s.helpers.isMac() ? '&#8984;' : 'Ctrl+') +
                        '</td>'),
                      (o += '</tr>');
                  }
                  e += o += '</tbody></table>';
            ...
            (o = l.$modal),
              l.$head,
              l.$body,
              s.events.$on(n(s.o_win), 'resize', function() {
                s.modals.resize(a);
              });
          }
    ...
    n.FroalaEditor.DefineIcon('help', { NAME: 'question' }),
    n.FE.RegisterShortcut(n.FE.KEYCODE.SLASH, 'help', null, '/'),
    n.FE.RegisterCommand('help', {
      title: 'Help',
      icon: 'help',
      undo: !1,
      focus: !1,
