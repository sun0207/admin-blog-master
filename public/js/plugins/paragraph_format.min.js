  ...
  'function' == typeof define && define.amd
    ...
    : 'object' == typeof module && module.exports
      ? (module.exports = function(a, e) {
          return (
            e === undefined &&
              (e = 'undefined' != typeof window ? require('jquery') : require('jquery')(a)),
            t(e)
          );
        })
      : t(window.jQuery);
      ...
      return {
              ...
              'LI' == s[d].tagName
                ...
                : 'LI' == s[d].parentNode.tagName && s[d]
                  ? ((i = m),
                    (p = a),
                    (l = h.html.defaultTag()),
                    (p && p.toLowerCase() != l) || (p = 'div class="fr-temp-div"'),
                    i.replaceWith(g('<' + p + '>').html(i.html())))
                    ...
                    ? ((r = m),
                      ...
                      n ||
                        (n =
                          ...
                          (h.node.isEmpty(r.get(0), !0) ? ' data-empty="true"' : '')),
                      n.toLowerCase() == o
                        ? (h.node.isEmpty(r.get(0), !0) || r.append('<br/>'),
                          r.replaceWith(r.html()))
                        : r.replaceWith(g('<' + n + '>').html(r.html())))
                    : ((e = m),
                      (t = a) ||
                        (t =
                          'div class="fr-temp-div"' +
                          (h.node.isEmpty(e.get(0), !0) ? ' data-empty="true"' : '')),
                      e.replaceWith(
        ...
        refreshOnShow: function(a, e) {
          ...
          if (t.length) {
            ...
            e.find('.fr-command[data-param1="N"]')
              .addClass('fr-active')
              .attr('aria-selected', !0);
        },
        refresh: function(a) {
