...
!(function(o) {
  ...
  l.extend(l.FE.POPUP_TEMPLATES, {
    ...
    (l.FE.PLUGINS.forms = function(s) {
      ...
      function e(t) {
        l(this).data('mousedown') &&
          (t.stopPropagation(), l(this).removeData('mousedown'), a((r = this))),
          t.preventDefault();
      }
      function o() {
      ...
      function a(t) {
        ...
        e ||
          (e = (function() {
            var t = '';
            0 < s.opts.formEditButtons.length &&
              (t =
                '<div class="fr-buttons">' + s.button.buildList(s.opts.formEditButtons) + '</div>');
            var e = { buttons: t },
              o = s.popups.create('forms.edit', e);
            return (
              s.$wp &&
                s.events.$on(s.$wp, 'scroll.link-edit', function() {
      ...
      function p() {
        ...
        if (e) {
          var o = l(e);
          o.is('button')
            ? t.find('input[type="text"][name="text"]').val(o.text())
            : t.find('input[type="text"][name="text"]').val(o.attr('placeholder'));
        }
      ...
      function d(t) {
        ...
        var e = '';
        1 <= s.opts.formUpdateButtons.length &&
          (e =
            '<div class="fr-buttons">' + s.button.buildList(s.opts.formUpdateButtons) + '</div>');
        var o = '',
          n = 0;
        (o = '<div class="fr-forms-text-layer fr-layer fr-active">'),
          (o +=
      ...
      return {
        _init: function() {
          s.events.$on(s.$el, s._mousedown, 'input, textarea, button', t),
            s.events.$on(s.$el, s._mouseup, 'input, textarea, button', e),
            s.events.$on(s.$el, 'touchmove', 'input, textarea, button', n),
            s.events.$on(s.$el, s._mouseup, o),
            s.events.$on(s.$win, s._mouseup, o),
            d(!0),
        ...
        updateInput: function() {
          ...
          if (e) {
            ...
            n.length && (o.is('button') ? o.text(n) : o.attr('placeholder', n)),
              s.popups.hide('forms.update'),
              a(e);
          }
        },
        getInput: i,
        ...
        showUpdatePopup: function() {
          ...
          if (t) {
            ...
            o || (o = d()),
              s.popups.isVisible('forms.update') || s.popups.refresh('forms.update'),
              s.popups.setContainer('forms.update', s.$sc);
    ...
    l.FE.DefineIcon('inputStyle', { NAME: 'magic' }),
    ...
    l.FE.DefineIcon('inputEdit', { NAME: 'edit' }),
    ...
    l.FE.DefineIcon('inputBack', { NAME: 'arrow-left' }),
