  ...
  (c.FE.PLUGINS.fullscreen = function(o) {
    ...
    function e() {
      ...
      (t = o.helpers.scrollTop()),
        ...
        o.helpers.isMobile() &&
          (o.$tb.data('parent', o.$tb.parent()),
          o.$tb.prependTo(o.$box),
        ...
        (o.opts.zIndex = 2147483641),
        (o.opts.heightMax = null),
        o.size.refresh(),
        o.opts.toolbarInline && o.toolbar.showInline();
      for (var e = o.$box.parent(); !e.is('body:first'); )
        e.addClass('fr-fullscreen-wrapper'), (e = e.parent());
      o.opts.toolbarContainer && o.$box.prepend(o.$tb),
        o.events.trigger('charCounter.update'),
        o.events.trigger('codeView.update'),
        o.$win.trigger('scroll');
    }
    function l() {
      if (o.helpers.isIOS() && o.core.hasFocus()) return o.$el.blur(), setTimeout(f, 250), !1;
      o.$box.toggleClass('fr-fullscreen'),
        ...
        o.opts.toolbarSticky &&
          ...
          (o.opts.toolbarBottom
            ? o.$tb
                .css('bottom', o.opts.toolbarStickyOffset)
                .data('bottom', o.opts.toolbarStickyOffset)
            : o.$tb.css('top', o.opts.toolbarStickyOffset).data('top', o.opts.toolbarStickyOffset));
      for (var e = o.$box.parent(); !e.is('body:first'); )
        e.removeClass('fr-fullscreen-wrapper'), (e = e.parent());
      o.opts.toolbarContainer && c(o.opts.toolbarContainer).append(o.$tb),
        c(o.o_win).trigger('scroll'),
        o.events.trigger('codeView.update');
    }
    function f() {
    ...
    function a(e) {
      ...
      e.toggleClass('fr-active', t).attr('aria-pressed', t),
        e
          .find('> *:not(.fr-sr-only)')
          .replaceWith(t ? o.icon.create('fullscreenCompress') : o.icon.create('fullscreen'));
    }
    return {
      _init: function() {
        if (!o.$wp) return !1;
