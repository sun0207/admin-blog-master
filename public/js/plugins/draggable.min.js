...
!(function(n) {
  ...
  v.extend(v.FE.DEFAULTS, { dragInline: !0 }),
    (v.FE.PLUGINS.draggable = function(f) {
      ...
      function d(e, t, n) {
        f.opts.iframe && ((e += f.$iframe.offset().top), (t += f.$iframe.offset().left)),
      ...
      function t(e) {
        (e.originalEvent.dataTransfer.dropEffect = 'move'),
          f.opts.dragInline
            ...
            : (e.preventDefault(),
              (function(e) {
                var t = f.doc.elementFromPoint(
                  e.originalEvent.pageX - f.win.pageXOffset,
                  e.originalEvent.pageY - f.win.pageYOffset
                );
                if (!g(t)) {
                  for (
                    var n = 0, r = t;
                    !g(r) && r == t && 0 < e.originalEvent.pageY - f.win.pageYOffset - n;

                  )
                    n++,
                      (r = f.doc.elementFromPoint(
                        e.originalEvent.pageX - f.win.pageXOffset,
                        e.originalEvent.pageY - f.win.pageYOffset - n
                      ));
                  ...
                  for (
                    ...
                    !g(o) &&
                    o == t &&
                    e.originalEvent.pageY - f.win.pageYOffset + a < v(f.doc).height();

                  )
                    a++,
                      (o = f.doc.elementFromPoint(
                        e.originalEvent.pageX - f.win.pageXOffset,
                        e.originalEvent.pageY - f.win.pageYOffset + a
                      ));
                  (!g(o) || (p && 0 === f.$el.find(o).length && o != p.get(0))) && (o = null),
                    (t = null == o && r ? r : o && null == r ? o : o && r ? (n < a ? r : o) : null);
                }
                ...
                if (
                  ...
                  var i;
                  p ||
                    (v.FE.$draggable_helper ||
                      (v.FE.$draggable_helper = v('<div class="fr-drag-helper"></div>')),
                  ...
                  i || 0 !== l.next().length
                    ? (i || (l = l.next()),
                      ('before' == p.data('fr-position') && l.is(p.data('fr-tag'))) ||
                        ...
                        d(
                          l.offset().top - s / 2 - f.$box.offset().top,
                          l.offset().left - f.win.pageXOffset - f.$box.offset().left,
                          l.width()
                        ),
                    ...
                    : ('after' == p.data('fr-position') && l.is(p.data('fr-tag'))) ||
                      ...
                      d(
                        l.offset().top + v(t).height() + s / 2 - f.$box.offset().top,
                        l.offset().left - f.win.pageXOffset - f.$box.offset().left,
                        l.width()
                      ),
      ...
      function r(e) {
        ...
        p && p.hasClass('fr-visible') && f.$box.find(p).length
          ? a(e)
          : t.length && (e.preventDefault(), e.stopPropagation()),
          p && f.$box.find(p).length && p.removeClass('fr-visible'),
      ...
      function a(e) {
        ...
        if (t.length) {
          ...
          if (
            (t.removeClass('fr-dragging'),
            !1 === (t = f.events.chainTrigger('element.beforeDrop', t)))
          )
            return !1;
          var a = t;
          if (
            (t.parent().is('A') && 1 == t.parent().get(0).childNodes.length && (a = t.parent()),
            f.core.isEmpty())
          )
            f.events.focus();
          ...
          if ((n == f || f.undo.canDo() || f.undo.saveStep(), f.core.isEmpty())) f.$el.html(a);
            ...
            0 === a.find(o).length
              ? v(o).replaceWith(a)
              : 0 === t.find(o).length && v(o).replaceWith(t),
              t.after(v.FE.MARKERS),
              f.selection.restore();
          }
          return (
            f.popups.hideAll(),
            f.selection.save(),
            f.$el
              .find(f.html.emptyBlockTagsQuery())
              .not('TD, TH, LI, .fr-inner')
              .not(f.opts.htmlAllowedEmptyTags.join(','))
              .remove(),
            f.html.wrap(),
      ...
      function o(e) {
        if (e && 'DIV' == e.tagName && f.node.hasClass(e, 'fr-drag-helper'))
