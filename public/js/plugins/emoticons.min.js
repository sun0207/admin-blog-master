  ...
  'function' == typeof define && define.amd
    ...
    : 'object' == typeof module && module.exports
      ? (module.exports = function(e, o) {
          return (
            o === undefined &&
              (o = 'undefined' != typeof window ? require('jquery') : require('jquery')(e)),
            t(o)
          );
        })
      : t(window.jQuery);
})(function(g) {
  g.extend(g.FE.POPUP_TEMPLATES, { emoticons: '[_BUTTONS_][_EMOTICONS_]' }),
    ...
    (g.FE.PLUGINS.emoticons = function(E) {
      ...
      return {
        _init: function() {
          var e = function() {
            for (
              var e = E.el.querySelectorAll('.fr-emoticon:not(.fr-deletable)'), o = 0;
              o < e.length;
              o++
            )
              e[o].className += ' fr-deletable';
          };
          e(),
            E.events.on('html.set', e),
            E.events.on('keydown', function(e) {
              if (E.keys.isCharacter(e.which) && E.selection.inEditor()) {
                var o = E.selection.ranges(0),
                  t = n();
                E.node.hasClass(t, 'fr-emoticon-img') &&
                  t &&
                  (0 === o.startOffset && E.selection.element() === t
                    ? g(t).before(g.FE.MARKERS + g.FE.INVISIBLE_SPACE)
                    : g(t).after(g.FE.INVISIBLE_SPACE + g.FE.MARKERS),
                  E.selection.restore());
              }
            }),
            E.events.on('keyup', function(e) {
              for (var o = E.el.querySelectorAll('.fr-emoticon'), t = 0; t < o.length; t++)
                'undefined' != typeof o[t].textContent &&
                  0 === o[t].textContent.replace(/\u200B/gi, '').length &&
                  g(o[t]).remove();
              if (!(e.which >= g.FE.KEYCODE.ARROW_LEFT && e.which <= g.FE.KEYCODE.ARROW_DOWN)) {
                var s = n();
                E.node.hasClass(s, 'fr-emoticon-img') &&
                  (g(s).append(g.FE.MARKERS), E.selection.restore());
              }
            });
        },
        insert: function(e, o) {
          ...
          t
            ? (0 === s.startOffset && E.selection.element() === t
                ? g(t).before(g.FE.MARKERS + g.FE.INVISIBLE_SPACE)
                : 0 < s.startOffset &&
                  E.selection.element() === t &&
                  s.commonAncestorContainer.parentNode.classList.contains('fr-emoticon') &&
                  g(t).after(g.FE.INVISIBLE_SPACE + g.FE.MARKERS),
              E.selection.restore(),
              E.html.insert(
            ...
            (o ||
              (o = (function() {
                ...
                E.opts.toolbarInline &&
                  0 < E.opts.emoticonsButtons.length &&
                  (e =
                    '<div class="fr-buttons fr-emoticons-buttons">' +
                    E.button.buildList(E.opts.emoticonsButtons) +
                    '</div>');
                var h,
                  o = {
                    buttons: e,
                    emoticons: (function() {
                      for (
                        var e = '<div style="text-align: center">', o = 0;
                        o < E.opts.emoticonsSet.length;
                        o++
                      )
                        0 !== o && o % E.opts.emoticonsStep == 0 && (e += '<br>'),
                          (e +=
                            '<span class="fr-command fr-emoticon" tabIndex="-1" data-cmd="insertEmoticon" title="' +
                            E.language.translate(E.opts.emoticonsSet[o].desc) +
                            '" role="button" data-param1="' +
                            E.opts.emoticonsSet[o].code +
                            '">' +
                            (E.opts.emoticonsUseImage
                              ? '<img src="https://cdnjs.cloudflare.com/ajax/libs/emojione/2.0.1/assets/svg/' +
                                E.opts.emoticonsSet[o].code +
                                '.svg"/>'
                              : '&#x' + E.opts.emoticonsSet[o].code + ';') +
                  ...
                  E.events.on(
                    ...
                    function(e) {
                      ...
                      if (g.FE.KEYCODE.TAB == c) {
                        if (
                          (o.is('span.fr-emoticon') && e.shiftKey) ||
                          (o.is('a') && !e.shiftKey)
                        ) {
                        ...
                        if (!1 !== t) {
                          ...
                          o.is('span.fr-emoticon') && (a = a.not('span.fr-emoticon:not(:focus)')),
                            (s = a.index(o)),
                            (s = e.shiftKey
                              ? (((s - 1) % a.length) + a.length) % a.length
                              : (s + 1) % a.length),
                            (n = a.get(s)),
                        ...
                        g.FE.KEYCODE.ARROW_UP == c ||
                        g.FE.KEYCODE.ARROW_DOWN == c ||
                        g.FE.KEYCODE.ARROW_LEFT == c ||
                        g.FE.KEYCODE.ARROW_RIGHT == c
                      ) {
                        if (o.is('span.fr-emoticon')) {
                          ...
                          g.FE.KEYCODE.ARROW_UP == c
                            ...
                            : g.FE.KEYCODE.ARROW_DOWN == c
                              ...
                              : g.FE.KEYCODE.ARROW_LEFT == c
                                ? (u = (((u - 1) % p) + p) % p)
                                : g.FE.KEYCODE.ARROW_RIGHT == c && (u = (u + 1) % p),
                            (n = g(f.get(u))),
                            E.events.disableBlur(),
                            n.focus(),
                            (t = !1);
                        ...
                        g.FE.KEYCODE.ENTER == c &&
                          (o.is('a') ? o[0].click() : E.button.exec(o), (t = !1));
    ...
    g.FE.DefineIcon('emoticons', { NAME: 'smile-o', FA5NAME: 'smile' }),
      ...
      callback: function(e, o) {
        this.emoticons.insert(
          ...
          this.opts.emoticonsUseImage
            ? 'https://cdnjs.cloudflare.com/ajax/libs/emojione/2.0.1/assets/svg/' + o + '.svg'
            : null
        ),
          this.emoticons.hideEmoticonsPopup();
      },
    }),
    g.FE.DefineIcon('emoticonsBack', { NAME: 'arrow-left' }),
