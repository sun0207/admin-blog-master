...
!(function(t) {
  'function' == typeof define && define.amd
    ...
    : 'object' == typeof module && module.exports
      ? (module.exports = function(e, a) {
          return (
            a === undefined &&
              (a = 'undefined' != typeof window ? require('jquery') : require('jquery')(e)),
            t(a)
          );
        })
      : t(window.jQuery);
  ...
  if (
    ...
    (O.FE.PLUGINS.imageManager = function(o) {
      ...
      function I() {
        if (
          m < s.length &&
          (n.outerHeight() <= r.outerHeight() + o.opts.imageManagerScrollOffset ||
            r.scrollTop() + o.opts.imageManagerScrollOffset > n.outerHeight() - r.outerHeight())
        ) {
          f++;
          for (
            var e = o.opts.imageManagerPageSize * (f - 1);
            e < Math.min(s.length, o.opts.imageManagerPageSize * f);
            e++
          )
            a(s[e]);
        }
        ...
        T(!1),
          (n.onload = function() {
            ...
            if ((i.url && t.attr('data-url', i.url), i.tag))
              if (
                ...
                for (var e = i.tag.split(','), a = 0; a < e.length; a++)
                  (e[a] = e[a].trim()),
                    0 === d.find('a[title="' + e[a] + '"]').length &&
                      d.append('<a role="button" title="' + e[a] + '">' + e[a] + '</a>');
                t.attr('data-tag', e.join());
              } else
                0 === d.find('a[title="' + i.tag.trim() + '"]').length &&
                  d.append(
            ...
            s
              .append(t)
              .append(
                O(o.icon.create('imageManagerDelete'))
                  .addClass('fr-delete-img')
                  .attr('title', o.language.translate('Delete'))
              )
              .append(
                O(o.icon.create('imageManagerInsert'))
              ...
              t.on('load', function() {
                s.removeClass('fr-empty'),
                  ...
                  T(!1),
                  m % o.opts.imageManagerPageSize == 0 && I();
              }),
      ...
      function P() {
        ...
        return (
          n.find('.fr-list-column').each(function(e, a) {
            ...
            0 === e
              ? ((i = t.outerHeight()), (r = t))
              : t.outerHeight() < i && ((i = t.outerHeight()), (r = t));
          }),
          r
        );
      }
      ...
      function R(e) {
        ...
        confirm(a) &&
          (o.opts.imageManagerDeleteURL
            ? !1 !== o.events.trigger('imageManager.beforeDeleteImage', [t]) &&
              (t.parent().addClass('fr-image-deleting'),
              O.ajax({
                method: o.opts.imageManagerDeleteMethod,
                url: o.opts.imageManagerDeleteURL,
                data: O.extend(
                  O.extend({ src: t.attr('src') }, q(t)),
                  o.opts.imageManagerDeleteParams
                ),
                ...
                .done(function(e) {
                  ...
                  t.parent().remove(),
                    ...
                    g.find('#fr-modal-tags > a').each(function() {
                      0 === g.find('#fr-image-list [data-tag*="' + O(this).text() + '"]').length &&
                        O(this)
      ...
      function U(e, a) {
        10 <= e && e < 20
          ? i.hide()
          : 20 <= e && e < 30 && O('.fr-image-deleting').removeClass('fr-image-deleting'),
          o.events.trigger('imageManager.error', [{ code: e, message: t[e] }, a]);
      }
      function F() {
        var e = l.find('.fr-modal-head-line').outerHeight(),
          a = d.outerHeight();
        l.toggleClass('fr-show-tags'),
          l.hasClass('fr-show-tags')
            ? (l.css('height', e + a), d.find('a').css('opacity', 1))
            : (l.css('height', e), d.find('a').css('opacity', 0));
      }
      function H() {
      ...
      function j(e) {
        ...
        a.toggleClass('fr-selected-tag'),
          o.opts.imageManagerToggleTags && a.siblings('a').removeClass('fr-selected-tag'),
          H();
      }
      function k(e, a) {
          ...
          show: function() {
            if (!g) {
              var e,
                a =
                  ...
                  '"></i><h4 data-text="true">' +
                  o.language.translate('Manage Images') +
                  '</h4></div>';
              (a += '<div class="fr-modal-tags" id="fr-modal-tags"></div>'),
                (e = o.opts.imageManagerPreloader
                  ? '<img class="fr-preloader" id="fr-preloader" alt="' +
                    o.language.translate('Loading') +
                    '.." src="' +
                    o.opts.imageManagerPreloader +
                    '" style="display: none;">'
            ...
            g.data('current-image', o.image.get()),
              ...
              i ||
                ...
                r.on('scroll', I),
                o.events.bindClick(g, '#fr-modal-more-' + o.sid, F),
                o.events.bindClick(d, 'a', j)),
              i.show(),
              n.find('.fr-list-column').empty(),
              o.opts.imageManagerLoadURL
                ? O.ajax({
  ...
  O.FE.DEFAULTS.imageInsertButtons.push('imageManager'),
    O.FE.RegisterCommand('imageManager', {
      title: 'Browse',
      undo: !1,
      focus: !1,
      modal: !0,
    ...
    O.FE.DefineIcon('imageManager', { NAME: 'folder' }),
    O.FE.DefineIcon('imageManagerInsert', { NAME: 'plus' }),
    O.FE.DefineIcon('imageManagerDelete', { NAME: 'trash' });
});
