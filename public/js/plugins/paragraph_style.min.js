    ...
    (i.FE.PLUGINS.paragraphStyle = function(o) {
      return {
        ...
        apply: function(e, a, t) {
          void 0 === a && (a = o.opts.paragraphStyles),
            void 0 === t && (t = o.opts.paragraphMultipleStyles);
          var r = '';
          t || ((r = Object.keys(a)).splice(r.indexOf(e), 1), (r = r.join(' '))),
            o.selection.save(),
            o.html.wrap(!0, !0, !0, !0),
            o.selection.restore();
          ...
          for (var s = i(n[0]).hasClass(e), l = 0; l < n.length; l++)
            i(n[l])
              .removeClass(r)
              .toggleClass(e, !s),
              i(n[l]).hasClass('fr-temp-div') && i(n[l]).removeClass('fr-temp-div'),
              '' === i(n[l]).attr('class') && i(n[l]).removeAttr('class');
          ...
          if (t.length) {
            ...
            a.find('.fr-command').each(function() {
              var e = i(this).data('param1'),
                a = r.hasClass(e);
              i(this)
                .toggleClass('fr-active', a)
                .attr('aria-selected', a);
            });
          }
        },
      };
