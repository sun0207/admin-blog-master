  ...
  'function' == typeof define && define.amd
    ...
    : 'object' == typeof module && module.exports
      ? (module.exports = function(n, e) {
          return (
            e === undefined &&
              (e = 'undefined' != typeof window ? require('jquery') : require('jquery')(n)),
            i(e)
          );
        })
      : i(window.jQuery);
      ...
      return {
        ...
        refreshOnShow: function(n, e) {
          e.find('.fr-command').each(function() {
            var n = s(this).data('param1'),
              e = i.format.is('span', { class: n });
            s(this)
              .toggleClass('fr-active', e)
