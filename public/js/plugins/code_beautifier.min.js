  ...
  e.FE.PLUGINS.codeBeautifier = function() {
    ...
    function k(i, e) {
      ...
      'string' == typeof r && (r = parseInt(r, 10)),
        e.indent_with_tabs && ((s = '\t'), (r = 1)),
        (l = l.replace(/\\r/, '\r').replace(/\\n/, '\n'));
      var h,
        c = /^\s+$/,
        u = -1,
        p = 0;
      ...
      for (
        ...
        if ('/' === h && '*' === f()) {
          ...
          P || '{' === L || k.trim(), k.singleSpace(), y.push(x()), k.newLine();
        else if ('@' === h) {
          k.preserveSingleSpace(), y.push(h);
          var B = (void 0, (S = u), (A = T(': ,;{}()[]/=\'"')), (u = S - 1), d(), A);
          B.match(/[ :]$/) && (d(), (B = T(': ').replace(/\s$/, '')), y.push(B), k.singleSpace()),
            (B = B.replace(/\s$/, '')) in t && ((v += 1), B in n && (D = !0));
        } else
          '#' === h && '{' === f()
    ...
    (e = X),
      ...
      (e.isIdentifierStart = function(e) {
        return e < 65
          ? 36 === e || 64 === e
          : e < 91 || (e < 97 ? 95 === e : e < 123 || (170 <= e && n.test(String.fromCharCode(e))));
      }),
      (e.isIdentifierChar = function(e) {
        return e < 48
          ...
          : e < 58 ||
              (!(e < 65) &&
                (e < 91 ||
                  (e < 97 ? 95 === e : e < 123 || (170 <= e && i.test(String.fromCharCode(e))))));
      });
    var L = {
    ...
    function r(i, e) {
      ...
      function E(e, t) {
        ...
        return (
          e &&
            ...
            !_.just_added_newline() && e.line_indent_level > n && (n = e.line_indent_level)),
          {
            mode: t,
            parent: e,
      ...
      for (
        p = {
          TK_START_EXPR: function() {
            ...
            var e = L.Expression;
            if ('[' === a.text) {
              if ('TK_WORD' === o || ')' === c.last_text)
                return (
                  'TK_RESERVED' === o &&
                    F(c.last_text, s.line_starters) &&
                    (_.space_before_token = !0),
                  v(e),
                  R(),
                  b(),
                  void (d.space_in_paren && (_.space_before_token = !0))
                );
              (e = L.ArrayLiteral),
                S(c.mode) &&
                  (('[' !== c.last_text && (',' !== c.last_text || (']' !== l && '}' !== l))) ||
                    d.keep_array_indentation ||
                    K());
            } else
              'TK_RESERVED' === o && 'for' === c.last_text
                ? (e = L.ForInitializer)
                : 'TK_RESERVED' === o && F(c.last_text, ['if', 'while']) && (e = L.Conditional);
            ';' === c.last_text || 'TK_START_BLOCK' === o
              ...
              : 'TK_END_EXPR' === o ||
                ...
                : ('TK_RESERVED' === o && '(' === a.text) || 'TK_WORD' === o || 'TK_OPERATOR' === o
                  ? ('TK_RESERVED' === o &&
                      ('function' === c.last_word || 'typeof' === c.last_word)) ||
                    ('*' === c.last_text && 'function' === l)
                    ? d.space_after_anon_function && (_.space_before_token = !0)
                    : 'TK_RESERVED' !== o ||
                      (!F(c.last_text, s.line_starters) && 'catch' !== c.last_text) ||
                      (d.space_before_conditional && (_.space_before_token = !0))
                  : (_.space_before_token = !0);
            '(' === a.text &&
              'TK_RESERVED' === o &&
              'await' === c.last_word &&
          ...
          TK_END_EXPR: function() {
            ...
            d.space_in_paren &&
              ('TK_START_EXPR' !== o || d.space_in_empty_paren
                ? (_.space_before_token = !0)
                : (_.trim(), (_.space_before_token = !1)));
            ']' === a.text && d.keep_array_indentation ? (R(), k()) : (k(), R());
            _.remove_redundant_indentation(u),
              c.do_while &&
                u.mode === L.Conditional &&
                ((u.mode = L.Expression), (c.do_block = !1), (c.do_while = !1));
          },
          TK_START_BLOCK: function() {
            var e = D(1),
              t = D(2);
            t &&
            ((':' === t.text && F(e.type, ['TK_STRING', 'TK_WORD', 'TK_RESERVED'])) ||
              (F(e.text, ['get', 'set']) && F(t.type, ['TK_WORD', 'TK_RESERVED'])))
              ? F(l, ['class', 'interface'])
                ? v(L.BlockStatement)
                : v(L.ObjectLiteral)
              : v(L.BlockStatement);
            ...
            'expand' === d.brace_style || ('none' === d.brace_style && a.wanted_newline)
              ? 'TK_OPERATOR' !== o &&
                (n ||
                  'TK_EQUALS' === o ||
                  ('TK_RESERVED' === o && N(c.last_text) && 'else' !== c.last_text))
                ? (_.space_before_token = !0)
                : K(!1, !0)
          ...
          TK_END_BLOCK: function() {
            ...
            'expand' === d.brace_style
              ? e || K()
              : e ||
                (S(c.mode) && d.keep_array_indentation
                  ? ((d.keep_array_indentation = !1), K(), (d.keep_array_indentation = !0))
                  : K());
            k(), R();
          },
          TK_WORD: C,
          ...
          TK_OPERATOR: function() {
            ...
            if (':' === a.text && c.in_case)
              return (c.case_body = !0), b(), R(), K(), void (c.in_case = !1);
            ...
            F(a.text, ['--', '++', '!', '~']) ||
            (F(a.text, ['-', '+']) &&
              (F(o, ['TK_START_BLOCK', 'TK_START_EXPR', 'TK_EQUALS', 'TK_OPERATOR']) ||
                F(c.last_text, s.line_starters) ||
                ',' === c.last_text))
              ? ((t = e = !1),
                  ...
                  : 'TK_END_EXPR' === o
                    ...
                    : 'TK_OPERATOR' === o &&
                      ((e =
                        F(a.text, ['--', '-', '++', '+']) &&
                        F(c.last_text, ['--', '-', '++', '+'])),
                      F(a.text, ['+', '-']) && F(c.last_text, ['--', '++']) && (t = !0)),
                (c.mode !== L.BlockStatement && c.mode !== L.Statement) ||
                  ('{' !== c.last_text && ';' !== c.last_text) ||
                  K())
              : ':' === a.text
                ? 0 === c.ternary_depth
                  ? (e = !1)
          ...
          TK_COMMA: function() {
            if (c.declaration_statement)
              return (
                A(c.parent.mode) && (c.declaration_assignment = !1),
                R(),
                void (c.declaration_assignment
                  ? K((c.declaration_assignment = !1), !0)
                  : ((_.space_before_token = !0), d.comma_first && w()))
              );
            R(),
              c.mode === L.ObjectLiteral ||
              (c.mode === L.Statement && c.parent.mode === L.ObjectLiteral)
                ? (c.mode === L.Statement && k(), K())
                : ((_.space_before_token = !0), d.comma_first && w());
          },
          TK_BLOCK_COMMENT: function() {
            if (_.raw)
              return (
                ...
                void (
                  a.directives &&
                  'end' === a.directives.preserve &&
                  (d.test_output_raw || (_.raw = !1))
                )
              );
            if (a.directives)
              return (
                K(!1, !0), R(), 'start' === a.directives.preserve && (_.raw = !0), void K(!1, !0)
              );
            if (!X.newline.test(a.text) && !a.wanted_newline)
              return (_.space_before_token = !0), R(), void (_.space_before_token = !0);
            var e,
              t = (function(e) {
                e = e.replace(/\x0d/g, '');
                var t = [],
          ...
          TK_DOT: function() {
            ...
            'TK_RESERVED' === o && N(c.last_text)
              ? (_.space_before_token = !0)
              : w(')' === c.last_text && d.break_chained_methods);
            R();
          },
          TK_UNKNOWN: function() {
          ...
          (e = e || {}).braces_on_own_line !== undefined &&
            (d.brace_style = e.braces_on_own_line ? 'expand' : 'collapse'),
          d.brace_style = e.brace_style
            ? e.brace_style
            : d.brace_style
              ? d.brace_style
              : 'collapse',
      ...
      function x(e) {
        ...
        if (d.keep_array_indentation && S(c.mode)) for (n = 0; n < t; n += 1) K(0 < n);
          ...
          (d.max_preserve_newlines && t > d.max_preserve_newlines && (t = d.max_preserve_newlines),
          d.preserve_newlines && 1 < e.newlines)
        ) {
          K();
      ...
      function w(e) {
        if (((e = e !== undefined && e), !_.just_added_newline()))
          if ((d.preserve_newlines && a.wanted_newline) || e) K(!1, !0);
            ...
            _.current_line.get_character_count() + a.text.length + (_.space_before_token ? 1 : 0) >=
      ...
      function m() {
        _.just_added_newline() &&
          (d.keep_array_indentation && S(c.mode) && a.wanted_newline
            ? (_.current_line.push(a.whitespace_before), (_.space_before_token = !1))
            : _.set_indent(c.indentation_level) && (c.line_indent_level = c.indentation_level));
      }
      function R(e) {
        _.raw
          ? _.add_raw_token(a)
          : (d.comma_first &&
              'TK_COMMA' === o &&
              _.just_added_newline() &&
              ',' === _.previous_line.last() &&
              (_.previous_line.pop(), m(), _.add_token(','), (_.space_before_token = !0)),
            (e = e || a.text),
            m(),
            _.add_token(e));
      }
      ...
      function k() {
        0 < t.length &&
          ((u = c), (c = t.pop()), u.mode === L.Statement && _.remove_redundant_indentation(u));
      }
      function y() {
        return (
          c.parent.mode === L.ObjectLiteral &&
          c.mode === L.Statement &&
          ((':' === c.last_text && 0 === c.ternary_depth) ||
            ('TK_RESERVED' === o && F(c.last_text, ['get', 'set'])))
        );
      }
      function O() {
        return (
      ...
      function C() {
        ('TK_RESERVED' === a.type &&
          ...
          F(a.text, ['set', 'get']) &&
          (a.type = 'TK_WORD'),
        'TK_RESERVED' === a.type && c.mode === L.ObjectLiteral) &&
          (':' == D(1).text && (a.type = 'TK_WORD'));
        if (
          (O() ||
            !a.wanted_newline ||
            A(c.mode) ||
            ...
            (!d.preserve_newlines &&
              'TK_RESERVED' === o &&
              F(c.last_text, ['var', 'let', 'const', 'set', 'get'])) ||
            K(),
          c.do_block && !c.do_while)
        ) {
          if ('TK_RESERVED' === a.type && 'while' === a.text)
            return (
              (_.space_before_token = !0), R(), (_.space_before_token = !0), void (c.do_while = !0)
            );
          K(), (c.do_block = !1);
        }
        if (c.if_block)
        ...
        if (
          'TK_RESERVED' === a.type &&
          ('case' === a.text || ('default' === a.text && c.in_case_statement))
        )
          return (
            K(),
            (c.case_body || d.jslint_happy) &&
              (0 < c.indentation_level &&
                (!c.parent || c.indentation_level > c.parent.indentation_level) &&
                (c.indentation_level -= 1),
              (c.case_body = !1)),
            R(),
            (c.in_case = !0),
        ...
        if (
          ('TK_RESERVED' === a.type &&
            'function' === a.text &&
            ((F(c.last_text, ['}', ';']) ||
              (_.just_added_newline() && !F(c.last_text, ['[', '{', ':', '=', ',']))) &&
              (_.just_added_blankline() || a.comments_before.length || (K(), K(!0))),
            'TK_RESERVED' === o || 'TK_WORD' === o
              ? 'TK_RESERVED' === o &&
                F(c.last_text, ['get', 'set', 'new', 'return', 'export', 'async'])
                ? (_.space_before_token = !0)
          ...
          ('TK_COMMA' !== o && 'TK_START_EXPR' !== o && 'TK_EQUALS' !== o && 'TK_OPERATOR' !== o) ||
            y() ||
            w(),
        ...
        'TK_END_BLOCK' === o
          ? 'TK_RESERVED' === a.type && F(a.text, ['else', 'catch', 'finally'])
            ? 'expand' === d.brace_style ||
              ...
              ('none' === d.brace_style && a.wanted_newline)
              ? (n = 'NEWLINE')
        ...
        'TK_RESERVED' === a.type &&
          F(a.text, s.line_starters) &&
          ')' !== c.last_text &&
          (n = 'else' === c.last_text || 'export' === c.last_text ? 'SPACE' : 'NEWLINE'),
        'TK_RESERVED' === a.type && F(a.text, ['else', 'catch', 'finally']))
          ? 'TK_END_BLOCK' !== o ||
            'expand' === d.brace_style ||
            'end-expand' === d.brace_style ||
          ...
          : 'NEWLINE' === n
            ? 'TK_RESERVED' === o && N(c.last_text)
              ...
              : 'TK_END_EXPR' !== o
                ? ('TK_START_EXPR' === o &&
                    'TK_RESERVED' === a.type &&
                    F(a.text, ['var', 'let', 'const'])) ||
                  ':' === c.last_text ||
                  ('TK_RESERVED' === a.type && 'if' === a.text && 'else' === c.last_text
                    ? (_.space_before_token = !0)
                    : K())
                : 'TK_RESERVED' === a.type &&
                  F(a.text, s.line_starters) &&
        ...
        R(),
          (c.last_word = a.text),
          'TK_RESERVED' === a.type && 'do' === a.text && (c.do_block = !0),
          'TK_RESERVED' === a.type && 'if' === a.text && (c.if_block = !0);
      }
      (o = 'TK_START_BLOCK'),
        (l = ''),
      ...
      (this.baseIndentString = n),
        ...
        (this.trim = function(e) {
          for (
            ...
            e && 1 < i.length && this.current_line.is_empty();

          )
            i.pop(), (this.current_line = i[i.length - 1]), this.current_line.trim();
      ...
      function _() {
        ...
        if ((n.length && (C = n.join('')), k.test(i))) {
          var r = !0,
            ...
            _ = k;
          for (
            '0' === i && V < P && /[Xxo]/.test(v.charAt(V))
              ? ((s = r = !1), (i += v.charAt(V)), (V += 1), (_ = /[o]/.test(v.charAt(V)) ? y : O))
              : ((i = ''), (V -= 1));
            V < P && _.test(v.charAt(V));
            ...
            (i += v.charAt(V)),
              ...
              s &&
                ...
                /[Ee]/.test(v.charAt(V)) &&
                ((i += v.charAt(V)),
                (V += 1) < P && /[+-]/.test(v.charAt(V)) && ((i += v.charAt(V)), (V += 1)),
                (r = s = !1));
          return [i, 'TK_WORD'];
        }
        if (X.isIdentifierStart(v.charCodeAt(V - 1))) {
          ...
          return 'TK_DOT' === t.type ||
            ('TK_RESERVED' === t.type && F(t.text, ['set', 'get'])) ||
            !F(i, j)
            ? [i, 'TK_WORD']
            : 'in' === i
              ? [i, 'TK_OPERATOR']
        ...
        if (
          ...
          (('/' === i ||
            ...
            (('TK_RESERVED' === t.type &&
              F(t.text, ['return', 'case', 'throw', 'else', 'do', 'typeof', 'yield'])) ||
              ('TK_END_EXPR' === t.type &&
                ')' === t.text &&
                t.parent &&
                'TK_RESERVED' === t.parent.type &&
                F(t.parent.text, ['if', 'while', 'for'])) ||
              F(t.type, [
                'TK_COMMENT',
                'TK_START_EXPR',
                'TK_START_BLOCK',
          ...
          if (((e = i), '/' === h))
            for (
              var p = !1;
              V < P && (c || p || v.charAt(V) !== h) && !X.newline.test(v.charAt(V));
            ...
            if (T && 0 === T.index) {
              ...
              return (
                (f = f.slice(0, m)), (V += m - 1), [(f = f.replace(X.lineBreak, '\n')), 'TK_STRING']
              );
            }
          } else
            for (
              ;
              V < P && (c || (v.charAt(V) !== h && ('`' === h || !X.newline.test(v.charAt(V)))));

            )
              (c || '`' === h) && X.newline.test(v.charAt(V))
                ? ('\r' === v.charAt(V) && '\n' === v.charAt(V + 1) && (V += 1), (e += '\n'))
                : (e += v.charAt(V)),
                c
                  ? (('x' !== v.charAt(V) && 'u' !== v.charAt(V)) || (u = !0), (c = !1))
                  : (c = '\\' === v.charAt(V)),
                (V += 1);
          if (
            (u &&
        ...
        if ('#' === i) {
          ...
          if (V < P && k.test(v.charAt(V))) {
            ...
            return (
              '#' === i ||
                ('[' === v.charAt(V) && ']' === v.charAt(V + 1)
                  ? ((R += '[]'), (V += 2))
                  : '{' === v.charAt(V) && '}' === v.charAt(V + 1) && ((R += '{}'), (V += 2))),
              [R, 'TK_WORD']
            );
          }
        }
        if ('<' === i && ('?' === v.charAt(V) || '%' === v.charAt(V))) {
          ...
          if (b)
            return (
              (i = b[0]), (V += i.length - 1), [(i = i.replace(X.lineBreak, '\n')), 'TK_STRING']
            );
        }
        if ('<' === i && '\x3c!--' === v.substring(V - 1, V + 3)) {
          for (V += 3, i = '\x3c!--'; !X.newline.test(v.charAt(V)) && V < P; )
            (i += v.charAt(V)), V++;
          return (L = !0), [i, 'TK_COMMENT'];
        }
        if ('-' === i && L && '--\x3e' === v.substring(V - 1, V + 2))
          return (L = !1), (V += 2), ['--\x3e', 'TK_COMMENT'];
          ...
          ((t = t || {}).wrap_line_length !== undefined &&
            ...
            w =
              t.wrap_attributes_indent_size === undefined
                ? r
                : parseInt(t.wrap_attributes_indent_size, 10) || r,
            h = t.end_with_newline !== undefined && t.end_with_newline,
            c = Array.isArray(t.extra_liners)
            ...
            (n = new function() {
              return (
                ...
                (this.traverse_whitespace = function() {
                  ...
                  if (
                    ...
                    for (this.newlines = 0; this.Utils.in_array(e, this.Utils.whitespace); )
                      o && '\n' == e && this.newlines <= l && (this.newlines += 1),
                        this.pos++,
                        (e = this.input.charAt(this.pos));
                    return !0;
                  }
                ...
                (this.get_contents_to = function(e) {
                  ...
                  return (
                    this.pos < r && ((t = this.input.substring(this.pos, r)), (this.pos = r)), t
                  );
                }),
                ...
                (this.get_tag = function(e) {
                  ...
                  do {
                    ...
                    if (
                      ...
                      if (
                        (("'" != i && '"' != i) || ((i += this.get_unformatted(i)), (_ = !0)),
                        '=' == i && (_ = !1),
                        r.length && '=' != r[r.length - 1] && '>' != i && _)
                      ) {
                          ...
                          : 'script' == f &&
                            ...
                            : 'style' == f &&
                              ...
                              : '!' == f.charAt(0)
                                ...
                                : e ||
                                  ('/' == f.charAt(0)
                                    ? (this.retrieve_tag(f.substring(1)), (this.tag_type = 'END'))
                                    : (this.record_tag(f),
                                      'html' != f.toLowerCase() && (this.indent_content = !0),
                                      (this.tag_type = 'START')),
                ...
                (this.get_comment = function(e) {
                  ...
                  for (
                    ...
                    ((t += r)[t.length - 1] != n[n.length - 1] || -1 == t.indexOf(n));
                ...
                (this.printer = function(e, t, n, i, r) {
                  ...
                  for (var s = (this.line_char_count = 0); s < this.indent_size; s++)
                  ...
                  (this.print_newline = function(e, t) {
                    (this.line_char_count = 0),
                      t &&
                        t.length &&
                        (e || '\n' != t[t.length - 1]) &&
                        ('\n' != t[t.length - 1] && (t[t.length - 1] = _(t[t.length - 1])),
                        t.push('\n'));
                  }),
            ...
            case 'TK_TAG_END':
              if ('TK_CONTENT' == n.last_token && '' === n.last_text) {
                var p = n.token_text.match(/\w+/)[0],
                  d = null;
                n.output.length &&
                  (d = n.output[n.output.length - 1].match(/(?:<|{{#)\/?\s*(\w+)/)),
            ...
            case 'TK_SCRIPT':
              if ('' !== n.token_text) {
                ...
                var K,
                  m = n.token_text,
                  R = 1;
                'TK_SCRIPT' == n.token_type ? (K = y) : 'TK_STYLE' == n.token_type && (K = k),
                  'keep' == t.indent_scripts
                    ? (R = 0)
                    : 'separate' == t.indent_scripts && (R = -n.indent_level);
