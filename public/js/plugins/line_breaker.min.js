    ...
    (v.FE.PLUGINS.lineBreaker = function(d) {
      ...
      function s(e, t) {
        ...
        if (null == e)
          (i = (o = t.parent()).offset().top),
            (n = (f = t.offset().top) - Math.min((f - i) / 2, d.opts.lineBreakerOffset)),
            (a = o.outerWidth()),
            (r = o.offset().left);
        else if (null == t)
          (s = (o = e.parent()).offset().top + o.outerHeight()) <
            (l = e.offset().top + e.outerHeight()) &&
            (s = (o = v(o).parent()).offset().top + o.outerHeight()),
        ...
        d.opts.iframe &&
          ((r += d.$iframe.offset().left - d.helpers.scrollLeft()),
          (n += d.$iframe.offset().top - d.helpers.scrollTop())),
          d.$box.append(g),
      ...
      function f(e) {
        if (e) {
          ...
          if (0 < t.parents(d.opts.lineBreakerTags.join(',')).length)
            return (
              (e = t.parents(d.opts.lineBreakerTags.join(',')).get(0)),
              0 !== d.$el.find(e).length && v(e).is(d.opts.lineBreakerTags.join(',')) ? v(e) : null
            );
        }
        return null;
      }
      ...
      function i(e, t, n) {
        for (var r = n, a = null; r <= d.opts.lineBreakerOffset && !a; )
      ...
      function l(e, t, n) {
        for (
          var r = null, a = 100;
          !r && e > d.$box.offset().left && e < d.$box.offset().left + d.$box.outerWidth() && 0 < a;

        )
          (r = o(e, t)) || (r = i(e, t, 5)),
            'left' == n
              ? (e -= d.opts.lineBreakerHorizontalOffset)
              : (e += d.opts.lineBreakerHorizontalOffset),
            (a -= d.opts.lineBreakerHorizontalOffset);
        return r;
      }
      function n(e) {
        var t = (a = null),
        ...
        ('HTML' == r.tagName ||
          ...
          ? ((n = i(e.pageX - d.win.pageXOffset, e.pageY - d.win.pageYOffset, 1)) ||
              (n = l(
                e.pageX - d.win.pageXOffset - d.opts.lineBreakerHorizontalOffset,
                e.pageY - d.win.pageYOffset,
                'left'
              )),
            n ||
              (n = l(
          ...
          t
            ? (function(e, t) {
                ...
                if (
                  Math.abs(o - t) <= d.opts.lineBreakerOffset ||
      ...
      function e(e) {
        return (
          ...
          (d.popups.areVisible() || d.el.querySelector('.fr-selected-cell')
            ? (g.removeClass('fr-visible'), !0)
            : void (
                !1 !== t ||
                d.edit.isDisabled() ||
                (a && clearTimeout(a), (a = setTimeout(n, 30, e)))
              ))
        );
      }
      function r() {
        a && clearTimeout(a),
          g && g.hasClass('fr-visible') && g.removeClass('fr-visible').removeData('instance');
      }
      function p() {
        (t = !0), r();
      }
