  ...
  'function' == typeof define && define.amd
    ...
    : 'object' == typeof module && module.exports
      ? (module.exports = function(E, c) {
          return (
            c === undefined &&
              (c = 'undefined' != typeof window ? require('jquery') : require('jquery')(E)),
            T(c)
          );
        })
      : T(window.jQuery);
  ...
  s.extend(s.FE.DEFAULTS, {
    ...
    (s.FE.PLUGINS.specialCharacters = function(a) {
      ...
      return {
        ...
        show: function() {
          if (!I) {
            var E = '<h4>' + a.language.translate('Special Characters') + '</h4>',
              c = (function() {
                for (
                  var E = '<div class="fr-special-characters-modal">', c = 0;
                  c < a.opts.specialCharactersSets.length;
                  c++
                ) {
                  for (
                    var T = a.opts.specialCharactersSets[c],
                      R = T.list,
                      L =
                        '<div class="fr-special-characters-list"><p class="fr-special-characters-title">' +
                        a.language.translate(T.title) +
                        '</p>',
                      A = 0;
                    A < R.length;
                    A++
            ...
            (I = T.$modal),
              ...
              a.events.$on(
                ...
                function(E) {
                  ...
                  if (
                    !(T.length || c != s.FE.KEYCODE.F10 || a.keys.ctrlKey(E) || E.shiftKey) &&
                    E.altKey
                  )
                    return r(e.find('span.fr-special-character:first'), E), !1;
                  if (
                    c == s.FE.KEYCODE.TAB ||
                    c == s.FE.KEYCODE.ARROW_LEFT ||
                    c == s.FE.KEYCODE.ARROW_RIGHT
                  ) {
                    var R = null,
                      L = null,
                      A = !1;
                    return (
                      c == s.FE.KEYCODE.ARROW_LEFT || c == s.FE.KEYCODE.ARROW_RIGHT
                        ? ((L = c == s.FE.KEYCODE.ARROW_RIGHT), (A = !0))
                        : (L = !E.shiftKey),
                      T.length
                        ? (A &&
                            (R = L
                              ? T.nextAll('span.fr-special-character:first')
                              : T.prevAll('span.fr-special-character:first')),
                          (R && R.length) ||
                            (R = L
                              ? T.parent()
                                  .next()
                              ...
                              .length ||
                            (R = e.find('span.fr-special-character:' + (L ? 'first' : 'last'))))
                        : (R = e.find('span.fr-special-character:' + (L ? 'first' : 'last'))),
                      r(R, E),
                      !1
                    );
        ...
        insert: function(E) {
          a.specialCharacters.hide(),
            a.undo.saveStep(),
            a.html.insert(E.attr('value'), !0),
            a.undo.saveStep();
        },
      };
    }),
    s.FroalaEditor.DefineIcon('specialCharacters', { template: 'text', NAME: '&#937;' }),
