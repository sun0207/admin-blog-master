...
!(function(n) {
  ...
  m.extend(m.FE.POPUP_TEMPLATES, {
    ...
    (m.FE.PLUGINS.link = function(d) {
      function c() {
        ...
        if (!e && d.$wp) {
          ...
          return i && i == n && 'A' == i.tagName
            ? (d.browser.msie || d.helpers.isMobile()) &&
              (d.selection.info(n).atEnd || d.selection.info(n).atStart)
              ? null
              : n
            : null;
        }
        return 'A' == d.el.tagName
          ? d.el
        ...
        if (r) 'A' == r.get(0).parentNode.tagName && l.push(r.get(0).parentNode);
          ...
          if (a.getRangeAt && a.rangeCount) {
            ...
            for (var s = 0; s < a.rangeCount; ++s)
              if (
                ((t = (e = a.getRangeAt(s)).commonAncestorContainer) &&
                  1 != t.nodeType &&
                  (t = t.parentNode),
          ...
          if (
            'a' == (t = (e = d.doc.selection.createRange()).parentElement()).nodeName.toLowerCase()
          )
            l.push(t);
          else {
      ...
      function k(r) {
        if (d.core.hasFocus()) {
          if ((a(), r && 'keyup' === r.type && (r.altKey || r.which == m.FE.KEYCODE.ALT)))
            return !0;
          setTimeout(function() {
                  ...
                  if (1 == n.length && 'IMG' == n[0].tagName) {
                    ...
                    return (
                      0 === i.startOffset && 0 === i.endOffset
                        ? m(e).before(m.FE.MARKERS)
                        : m(e).after(m.FE.MARKERS),
                      d.selection.restore(),
                      !1
                    );
                  }
      ...
      function l(e) {
        ...
        t ||
          (t = (function() {
            ...
            1 <= d.opts.linkEditButtons.length &&
              ('A' == d.el.tagName &&
                0 <= d.opts.linkEditButtons.indexOf('linkRemove') &&
                d.opts.linkEditButtons.splice(d.opts.linkEditButtons.indexOf('linkRemove'), 1),
              (e =
                '<div class="fr-buttons">' +
                d.button.buildList(d.opts.linkEditButtons) +
                '</div>'));
            var t = { buttons: e },
        ...
        var n = m(e);
        d.popups.isVisible('link.edit') || d.popups.refresh('link.edit'),
          d.popups.setContainer('link.edit', d.$sc);
      ...
      function p() {
        ...
        if (t) {
          ...
          for (a.prop('checked', !1), n = 0; n < a.length; n++)
            (i = m(a[n])), r.attr(i.attr('name')) == i.data('checked') && i.prop('checked', !0);
          ...
          e.find('input.fr-link-attr[type="text"]').val(''),
            ...
            e.find('input.fr-link-attr[type="text"][name="text"]').val(d.selection.text());
      ...
      function s(e) {
        ...
        var t = '';
        1 <= d.opts.linkInsertButtons.length &&
          (t =
            '<div class="fr-buttons">' + d.button.buildList(d.opts.linkInsertButtons) + '</div>');
        var n = '',
          i = 0;
        for (var r in ((n =
        ...
        return (
          d.$wp &&
            d.events.$on(d.$wp, 'scroll.link-insert', function() {
              (d.image ? d.image.get() : null) && d.popups.isVisible('link.insert') && h(),
                d.popups.isVisible('link.insert') && g();
            }),
          s
        );
      }
      function f(e, t, n) {
        if ((void 0 === n && (n = {}), !1 === d.events.trigger('link.beforeInsert', [e, t, n])))
          return !1;
        var i = d.image ? d.image.get() : null;
        i || 'A' == d.el.tagName
          ? 'A' == d.el.tagName && d.$el.focus()
          : (d.selection.restore(), d.popups.hide('link.insert'));
        var r = e;
        d.opts.linkConvertEmailAddress &&
          d.helpers.isEmail(e) &&
          !/^mailto:.*/i.test(e) &&
          (e = 'mailto:' + e);
        if (
          ('' === d.opts.linkAutoPrefix ||
            ...
            (['/', '{', '[', '#', '(', '.'].indexOf((e || '')[0]) < 0 &&
              (e = d.opts.linkAutoPrefix + d.helpers.sanitizeURL(e))),
          ...
          '_blank' == n.target
            ? (d.opts.linkNoOpener && (n.rel ? (n.rel += ' noopener') : (n.rel = 'noopener')),
              d.opts.linkNoReferrer && (n.rel ? (n.rel += ' noreferrer') : (n.rel = 'noreferrer')))
            : null == n.target &&
              (n.rel
        ...
        if (a) {
          ...
          i || l.prepend(m.FE.START_MARKER).append(m.FE.END_MARKER),
            l.attr(n),
            i || d.selection.restore();
        } else {
          i
            ? (i.wrap('<a href="' + e + '"></a>'),
              d.image.hasCaption() &&
                i.parent().append(i.parents('.fr-img-caption').find('.fr-inner')))
            : (d.format.remove('a'),
                        ...
                        for (
                          ...
                          if (n) {
                            for (
                              ...
                              (i = i.parentNode),
                                d.node.isBlock(i) ||
                                  ((r += d.node.closeTagString(i)),
                                  (l = d.node.openTagString(i) + l)),
                                i != n;

                            );
                            var a =
                              d.node.openTagString(t.get(0)) +
                              t.html() +
                              d.node.closeTagString(t.get(0));
          ...
          for (var o = u(), p = 0; p < o.length; p++)
            (l = m(o[p])).attr(n), l.removeAttr('_moz_dirty');
          1 == o.length &&
            d.$wp &&
            !i &&
            (m(o[0])
              .prepend(m.FE.START_MARKER)
              .append(m.FE.END_MARKER),
            d.selection.restore());
        }
        if (i) {
      ...
      function g() {
        ...
        if (e) {
          ...
          t || (t = s()),
            d.popups.isVisible('link.insert') ||
              (d.popups.refresh('link.insert'),
              d.selection.save(),
              d.helpers.isMobile() &&
                (d.events.disableBlur(), d.$el.blur(), d.events.enableBlur())),
      ...
      function h() {
        ...
        if (e) {
          var t = d.popups.get('link.insert');
          d.image.hasCaption() && (e = e.find('.fr-img-wrap')),
            t || (t = s()),
            p(),
            d.popups.setContainer('link.insert', d.$sc);
      ...
      return {
        _init: function() {
          d.events.on('keyup', function(e) {
            ...
            d.events.on(
              'toolbar.esc',
              function() {
                if (d.popups.isVisible('link.edit'))
                  return d.events.disableBlur(), d.events.focus(), !1;
              },
              !0
            );
        },
        remove: function() {
          ...
          t && e
            ? (t.unwrap(), d.image.edit(t))
            : e && (d.selection.save(), m(e).replaceWith(m(e).html()), d.selection.restore(), a());
        },
        showInsertPopup: function() {
          ...
          if ((t || (t = s()), !t.hasClass('fr-active')))
            if (
              (d.popups.refresh('link.insert'),
              d.popups.setContainer('link.insert', d.$tb || d.$sc),
              e.is(':visible'))
            ) {
              var n = e.offset().left + e.outerWidth() / 2,
        ...
        usePredefined: function(e) {
          ...
          for (n = 0; n < a.length; n++)
            (t = m(a[n])).prop('checked', t.data('checked') == i[t.attr('name')]);
        ...
        back: function() {
          d.image && d.image.get()
            ...
            : (d.events.disableBlur(),
              ...
              d.events.enableBlur(),
              c() && d.$wp
                ? (d.selection.restore(), a(), k())
                : 'A' == d.el.tagName
                  ? (d.$el.focus(), k())
                  : (d.popups.hide('link.insert'), d.toolbar.showInline()));
        },
        imageLink: h,
