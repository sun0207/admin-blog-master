  ...
  'function' == typeof define && define.amd
    ...
    : 'object' == typeof module && module.exports
      ? (module.exports = function(e, r) {
          return (
            r === undefined &&
              (r = 'undefined' != typeof window ? require('jquery') : require('jquery')(e)),
            a(r)
          );
        })
      : a(window.jQuery);
  ...
  c.extend(c.FE.DEFAULTS, {
    ...
    (c.FE.PLUGINS.entities = function(t) {
      ...
      function o(e) {
        ...
        for (var r = t.node.contents(e), a = 0; a < r.length; a++)
          r[a].nodeType == Node.TEXT_NODE ? i(r[a]) : o(r[a]);
