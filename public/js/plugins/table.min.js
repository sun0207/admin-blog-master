  ...
  Z.extend(Z.FE.POPUP_TEMPLATES, {
    ...
    (Z.FE.PLUGINS.table = function(w) {
        ...
        if (e) {
          ...
          if ((t || (t = p()), t)) {
            ...
            w.popups.show('table.edit', a, s, l.bottom - l.top),
              w.edit.isDisabled() &&
                (1 < J().length && w.toolbar.disable(),
                w.$el.removeClass('fr-no-selection'),
                w.edit.on(),
                w.button.bulkRefresh(),
                w.selection.setAtEnd(w.$el.find('.fr-selected-cell:last').get(0)),
                w.selection.restore());
          }
        }
      }
      function f() {
        ...
        if (s) {
          ...
          n ||
            (n = (function() {
              var e = '';
              0 < w.opts.tableColorsButtons.length &&
                (e =
                  '<div class="fr-buttons fr-table-colors-buttons">' +
                  w.button.buildList(w.opts.tableColorsButtons) +
                  '</div>');
              var t = '';
      ...
      function c(e) {
        ...
        var t = '';
        0 < w.opts.tableInsertButtons.length &&
          (t =
            '<div class="fr-buttons">' + w.button.buildList(w.opts.tableInsertButtons) + '</div>');
        var l,
          a = {
            buttons: t,
                  ...
                  Z.FE.KEYCODE.ARROW_UP == a
                    ...
                    : Z.FE.KEYCODE.ARROW_DOWN == a
                      ...
                      : Z.FE.KEYCODE.ARROW_LEFT == a
                        ? (o = Math.max(0, o - 1))
                        : Z.FE.KEYCODE.ARROW_RIGHT == a &&
                          (o = Math.min(w.opts.tableInsertMaxSize - 1, o + 1));
                  var f = i * r + o,
                    c = Z(s.get(f));
      ...
      function d(e) {
        var t = e.data('row'),
          l = e.data('col'),
          a = e.parent();
        a.siblings('.fr-table-size-info').html(t + ' &times; ' + l),
          a.find('> span').removeClass('hover fr-active-item');
        for (var s = 1; s <= w.opts.tableInsertMaxSize; s++)
          for (var n = 0; n <= w.opts.tableInsertMaxSize; n++) {
            ...
            s <= t && n <= l
              ? r.addClass('hover')
              : s <= t + 1 || (s <= 2 && !w.helpers.isMobile())
                ? r.css('display', 'inline-block')
                : 2 < s && !w.helpers.isMobile() && r.css('display', 'none');
          }
      ...
      function p(e) {
        ...
        if (0 < w.opts.tableEditButtons.length) {
          var t = {
              buttons:
                '<div class="fr-buttons">' + w.button.buildList(w.opts.tableEditButtons) + '</div>',
            },
      ...
      function u() {
        if (0 < J().length) {
          var e = Q();
          w.selection.setBefore(e.get(0)) || w.selection.setAfter(e.get(0)),
            w.selection.restore(),
      ...
      function b(e) {
        ...
        if (0 < t.length) {
          ...
          for (l = 0; l < n[a].length; l++) {
            if (
              ('below' == e && a < n.length - 1 && n[a][l] == n[a + 1][l]) ||
              ('above' == e && 0 < a && n[a][l] == n[a - 1][l])
            ) {
          ...
          (o += '</tr>'),
            (s =
              0 < w.$el.find('th.fr-selected-cell').length && 'below' == e
                ? Z(t.find('tbody').not(t.find('table tbody')))
                : Z(
                    t
                      .find('tr')
                      .not(t.find('table tr'))
            ...
            'below' == e
              ? 'TBODY' == s.prop('tagName')
                ? s.prepend(o)
                : s.after(o)
              : 'above' == e && (s.before(o), w.popups.isVisible('table.edit') && h());
        }
      }
      function g(e, t, l) {
        var a,
        ...
        if (e < (t = Math.min(t, f[0].length - 1)))
          for (s = e; s <= t; s++)
            if (
              !(e < s && f[0][s] == f[0][s - 1]) &&
              1 < (r = Math.min(parseInt(f[0][s].getAttribute('colspan'), 10) || 1, t - e + 1)) &&
              f[0][s] == f[0][s + 1]
            )
              for (i = r - 1, a = 1; a < f.length; a++)
                if (f[a][s] != f[a - 1][s]) {
                  for (n = s; n < s + r; n++)
                    if (
                      1 < (o = parseInt(f[a][n].getAttribute('colspan'), 10) || 1) &&
                      f[a][n] == f[a][n + 1]
                    )
                      n += i = Math.min(i, o - 1);
      ...
      function m(e, t, l) {
        ...
        if (e < (t = Math.min(t, f.length - 1)))
          for (a = e; a <= t; a++)
            if (
              !(e < a && f[a][0] == f[a - 1][0]) &&
              1 < (r = Math.min(parseInt(f[a][0].getAttribute('rowspan'), 10) || 1, t - e + 1)) &&
              f[a][0] == f[a + 1][0]
            )
              for (i = r - 1, s = 1; s < f[0].length; s++)
                if (f[a][s] != f[a][s - 1]) {
                  for (n = a; n < a + r; n++)
                    if (
                      1 < (o = parseInt(f[n][s].getAttribute('rowspan'), 10) || 1) &&
                      f[n][s] == f[n + 1][s]
                    )
                      n += i = Math.min(i, o - 1);
                    else if (!(i = Math.max(0, i - 1))) break;
      ...
      function v(e, t, l, a, s, n, r) {
        ...
        for (o = a; o <= s; o++)
          for (i = n; i <= r; i++)
            (a < o && e[o][i] == e[o - 1][i]) ||
              (n < i && e[o][i] == e[o][i - 1]) ||
              (1 < (f = parseInt(e[o][i].getAttribute(l), 10) || 1) &&
                (1 < f - t ? e[o][i].setAttribute(l, f - t) : e[o][i].removeAttribute(l)));
      }
      ...
      function t(e) {
        ...
        'REMOVE' != e
          ? t.css('background-color', w.helpers.HEXtoRGB(e))
            ...
            e
              ...
              .each(function(o, e) {
                ...
                t.find('> th, > td').each(function(e, t) {
                  for (
                    var l = Z(t),
                      a = parseInt(l.attr('colspan'), 10) || 1,
                      s = parseInt(l.attr('rowspan'), 10) || 1,
                      n = o;
                    n < o + s;
                    n++
                  )
                    for (var r = i; r < i + a; r++)
                      f[n] || (f[n] = []), f[n][r] ? i++ : (f[n][r] = t);
                  i += a;
                });
              }),
          f
      ...
      function A(e, t) {
        for (var l = 0; l < t.length; l++)
          for (var a = 0; a < t[l].length; a++) if (t[l][a] == e) return { row: l, col: a };
      }
      function F(e, t, l) {
      ...
      function x() {
        w.el.querySelector('.fr-cell-fixed') &&
          w.el.querySelector('.fr-cell-fixed').classList.remove('fr-cell-fixed'),
          w.el.querySelector('.fr-cell-handler') &&
            w.el.querySelector('.fr-cell-handler').classList.remove('fr-cell-handler');
      }
      function D() {
          ...
          var a = O(),
            ...
            r = (function e(t, l, a, s, n) {
              var r,
                ...
                h = s;
              for (r = c; r <= d; r++)
                (1 < (parseInt(Z(n[r][p]).attr('rowspan'), 10) || 1) ||
                  1 < (parseInt(Z(n[r][p]).attr('colspan'), 10) || 1)) &&
                  ((f = F((i = A(n[r][p], n)).row, i.col, n)),
                  (c = Math.min(i.row, c)),
                  (d = Math.max(f.row, d)),
                  (p = Math.min(i.col, p)),
                  (h = Math.max(f.col, h))),
                  (1 < (parseInt(Z(n[r][h]).attr('rowspan'), 10) || 1) ||
                    1 < (parseInt(Z(n[r][h]).attr('colspan'), 10) || 1)) &&
                    ((f = F((i = A(n[r][h], n)).row, i.col, n)),
                    (c = Math.min(i.row, c)),
                    (d = Math.max(f.row, d)),
                    (p = Math.min(i.col, p)),
                    (h = Math.max(f.col, h)));
              for (o = p; o <= h; o++)
                (1 < (parseInt(Z(n[c][o]).attr('rowspan'), 10) || 1) ||
                  1 < (parseInt(Z(n[c][o]).attr('colspan'), 10) || 1)) &&
                  ((f = F((i = A(n[c][o], n)).row, i.col, n)),
                  (c = Math.min(i.row, c)),
                  (d = Math.max(f.row, d)),
                  (p = Math.min(i.col, p)),
                  (h = Math.max(f.col, h))),
                  (1 < (parseInt(Z(n[d][o]).attr('rowspan'), 10) || 1) ||
                    1 < (parseInt(Z(n[d][o]).attr('colspan'), 10) || 1)) &&
                    ((f = F((i = A(n[d][o], n)).row, i.col, n)),
                    (c = Math.min(i.row, c)),
                    (d = Math.max(f.row, d)),
                    (p = Math.min(i.col, p)),
                    (h = Math.max(f.col, h)));
              return c == t && d == l && p == a && h == s
                ? { min_i: t, max_i: l, min_j: a, max_j: s }
                : e(c, d, p, h, n);
            })(
              Math.min(s.row, n.row),
              Math.max(s.row, n.row),
              Math.min(s.col, n.col),
              Math.max(s.col, n.col),
              a
            );
      ...
      function I(e) {
        ...
        return (
          'TD' == e.target.tagName || 'TH' == e.target.tagName
            ? (t = e.target)
            : 0 < l.closest('td').length
              ? (t = l.closest('td').get(0))
              : 0 < l.closest('th').length && (t = l.closest('th').get(0)),
      ...
      function e(e) {
        ...
        if ((0 < J().length && !t && S(), !w.edit.isDisabled() || w.popups.isVisible('table.edit')))
          if (1 != e.which || (1 == e.which && w.helpers.isMac() && e.ctrlKey))
            (3 == e.which || (1 == e.which && w.helpers.isMac() && e.ctrlKey)) && t && S();
          else if (((n = !0), t)) {
            0 < J().length && !e.shiftKey && S(),
              e.stopPropagation(),
            ...
            e.shiftKey && 0 < w.$el.find(l + '.fr-selected-cell').length
              ? Z(w.$el.find(l + '.fr-selected-cell').closest('table')).is(Z(t).closest('table'))
                ? _(a, t)
                : y()
              : ((w.keys.ctrlKey(e) || e.shiftKey) &&
                  (1 < J().length ||
                    (0 === Z(t).find(w.selection.element()).length &&
                      !Z(t).is(w.selection.element()))) &&
                  y(),
                (a = t),
                0 < w.opts.tableEditButtons.length && _(a, a));
          }
      }
      function l(e) {
        ...
        if (
          (s ||
            w.$tb.is(e.target) ||
            w.$tb.is(Z(e.target).closest(w.$tb.get(0))) ||
            (0 < J().length && w.toolbar.enable(), D()),
          !(1 != e.which || (1 == e.which && w.helpers.isMac() && e.ctrlKey)))
        ) {
          if (((n = !1), s))
            (s = !1),
              I(e) || 1 != J().length
                ? 0 < J().length && (w.selection.isCollapsed() ? h() : D())
                : D();
          if (E) {
            ...
            w.opts.iframe && (t -= w.$iframe.offset().left),
              ...
              (function() {
                ...
                if (e !== t) {
                      ...
                      ? ((b = ((n + t - e) / n) * m),
                        s.css(
                          ...
                          'calc(100% - ' +
                            ...
                            '% - ' +
                            Math.round(v).toFixed(4) +
                            '%)'
                        ))
                      : (('rtl' == w.opts.direction && 0 !== a) ||
                          ('rtl' != w.opts.direction && 0 === a)) &&
                        ((b = ((n - t + e) / n) * m),
                        s.css(
                          'margin-left',
                  ...
                  w.selection.restore(),
                    w.undo.saveStep(),
                    w.events.trigger('table.resized', [s.get(0)]);
                }
                C.removeData('origin'),
                  C.removeData('release-position'),
                  C.removeData('first'),
                  C.removeData('second'),
                  C.removeData('table');
              })(),
      ...
      function T(e) {
        if (!0 === s && 0 < w.opts.tableEditButtons.length) {
          if (
            ...
            if ('TD' == e.currentTarget.tagName && 0 === w.$el.find('th.fr-selected-cell').length)
              return void _(a, e.currentTarget);
            if ('TH' == e.currentTarget.tagName && 0 === w.$el.find('td.fr-selected-cell').length)
              return void _(a, e.currentTarget);
          }
          y();
        }
      ...
      function N(e, t, l, a) {
        for (
          ...
          'TD' != n.tagName &&
          'TH' != n.tagName &&
          ('up' == a ? (s = n.previousElementSibling) : 'down' == a && (s = n.nextElementSibling),
          !s);
      ...
      function W() {
        C &&
          (C.find('div').css('opacity', 0),
          C.css('top', 0),
          C.css('left', 0),
          C.css('height', 0),
          C.find('div').css('height', 0),
          C.hide());
      }
      function k() {
      ...
      function K(e, t) {
        ...
        if (
          (t &&
            ...
            (0 < l.closest('td').length
              ? (t = l.closest('td'))
              : 0 < l.closest('th').length && (t = l.closest('th'))),
          !t || ('TD' != t.tagName && 'TH' != t.tagName))
        )
          C &&
            l.get(0) != C.get(0) &&
            l.parent().get(0) != C.get(0) &&
            w.core.sameInstance(C) &&
            W();
        else {
          ...
          var n = l.offset().left - 1,
            r = n + l.outerWidth();
          if (
            Math.abs(e.pageX - n) <= w.opts.tableResizerOffset ||
            Math.abs(r - e.pageX) <= w.opts.tableResizerOffset
          ) {
            var o,
              i,
              f,
            ...
            'rtl' != w.opts.direction
              ? e.pageX - n <= w.opts.tableResizerOffset
                ? ((f = n),
                  0 < h.col
                    ? ((c = n - j(h.col - 1, p) + w.opts.tableResizingLimit),
                      (d = n + j(h.col, p) - w.opts.tableResizingLimit),
                      (o = h.col - 1),
                      (i = h.col))
                    : ((o = null),
                      (i = 0),
                      (c = a.offset().left - 1 - parseInt(a.css('margin-left'), 10)),
                      (d =
                        a.offset().left - 1 + a.width() - p[0].length * w.opts.tableResizingLimit)))
                : r - e.pageX <= w.opts.tableResizerOffset &&
                  ((f = r),
                  u.col < p[u.row].length && p[u.row][u.col + 1]
                    ? ((c = r - j(u.col, p) + w.opts.tableResizingLimit),
                      (d = r + j(u.col + 1, p) - w.opts.tableResizingLimit),
                      (o = u.col),
                      (i = u.col + 1))
                    : ((o = u.col),
                      (i = null),
                      (c = a.offset().left - 1 + p[0].length * w.opts.tableResizingLimit),
                      (d = s.offset().left - 1 + s.width() + parseFloat(s.css('padding-left')))))
              : r - e.pageX <= w.opts.tableResizerOffset
                ? ((f = r),
                  0 < h.col
                    ? ((c = r - j(h.col, p) + w.opts.tableResizingLimit),
                      (d = r + j(h.col - 1, p) - w.opts.tableResizingLimit),
                      (o = h.col),
                      (i = h.col - 1))
                    : ((o = null),
                      (i = 0),
                      (c = a.offset().left + p[0].length * w.opts.tableResizingLimit),
                      (d = s.offset().left - 1 + s.width() + parseFloat(s.css('padding-left')))))
                : e.pageX - n <= w.opts.tableResizerOffset &&
                  ((f = n),
                  u.col < p[u.row].length && p[u.row][u.col + 1]
                    ? ((c = n - j(u.col + 1, p) + w.opts.tableResizingLimit),
                      (d = n + j(u.col, p) - w.opts.tableResizingLimit),
                      (o = u.col + 1),
                      (i = u.col))
                    : ((o = u.col),
                      (i = null),
                      (c = s.offset().left + parseFloat(s.css('padding-left'))),
                      (d =
                        a.offset().left -
                        1 +
                        a.width() -
                        p[0].length * w.opts.tableResizingLimit))),
              C ||
                (w.shared.$table_resizer ||
                  (w.shared.$table_resizer = Z('<div class="fr-table-resizer"><div></div></div>')),
                ...
                w.events.$on(C, 'mousedown', function(e) {
                  return (
                    ...
                    1 == e.which
                      ? (w.selection.save(),
                        (E = !0),
                        C.addClass('fr-moving'),
                        y(),
                        w.edit.off(),
                        C.find('div').css('opacity', 1),
                        !1)
                      : void 0)
                  );
                }),
                ...
                w.events.on(
                  'destroy',
                  function() {
                    w.$el.find('.fr-selected-cell').removeClass('fr-selected-cell'),
                      C.hide().appendTo(Z('body:first'));
                  },
                  !0
                )),
              C.data('table', a),
            ...
            w.opts.iframe &&
              ((m += w.$iframe.offset().left),
              (v += w.$iframe.offset().top),
              (c += w.$iframe.offset().left),
              (d += w.$iframe.offset().left)),
              C.data('max-left', c),
              C.data('max-right', d),
      ...
      function L(e, t) {
        ...
        var l,
          ...
          r = 0;
        w.opts.iframe &&
          ((n += w.$iframe.offset().left - w.helpers.scrollLeft()),
          (r += w.$iframe.offset().top - w.helpers.scrollTop())),
            ...
            return e.offset().left <= s && s < e.offset().left + e.outerWidth() / 2
              ...
              : e.offset().left + e.outerWidth() / 2 <= s && s < e.offset().left + e.outerWidth()
                ? ((l = parseInt(o.find('a').css('width'), 10)),
                  ...
                  o.css(
                    'left',
                    n + e.offset().left - w.$box.offset().left + e.outerWidth() - l / 2
                  ),
                  o.data('selected-cell', e),
      ...
      function Y(e) {
        ...
        w.opts.tableResizer &&
          (!w.popups.areVisible() || (w.popups.areVisible() && w.popups.isVisible('table.edit'))) &&
          K(e, t),
              ...
              if (0 === J().length) {
                ...
                if (t && ('HTML' == t.tagName || 'BODY' == t.tagName || w.node.isElement(t)))
                  for (l = 1; l <= w.opts.tableInsertHelperOffset; l++) {
                    if (
                      ((a = w.doc.elementFromPoint(
                        e.pageX - w.win.pageXOffset,
                        e.pageY - w.win.pageYOffset + l
                      )),
                      Z(a).hasClass('fr-tooltip'))
                    )
                      return;
                    if (
                      a &&
                      ('TH' == a.tagName || 'TD' == a.tagName || 'TABLE' == a.tagName) &&
                      (Z(a).parents('.fr-wrapper').length || w.opts.iframe)
                    )
                      return L(e, Z(a).closest('table'));
                    if (
                      ((s = w.doc.elementFromPoint(
                        e.pageX - w.win.pageXOffset + l,
                        e.pageY - w.win.pageYOffset
                      )),
                      Z(s).hasClass('fr-tooltip'))
                    )
                      return;
                    if (
                      s &&
                      ('TH' == s.tagName || 'TD' == s.tagName || 'TABLE' == s.tagName) &&
                      (Z(s).parents('.fr-wrapper').length || w.opts.iframe)
                    )
      ...
      function X(e) {
        if ((1 < J().length && n && y(), !1 === n && !1 === s && !1 === E))
          r && clearTimeout(r),
            (w.edit.isDisabled() && !w.popups.isVisible('table.edit')) ||
              (r = setTimeout(Y, 30, e));
        else if (E) {
          ...
          l <= t && t <= a
            ...
            : t < l && parseFloat(C.css('left'), 10) > l - w.opts.tableResizerOffset
              ...
              : a < t &&
                parseFloat(C.css('left'), 10) < a - w.opts.tableResizerOffset &&
                C.css('left', a - w.opts.tableResizerOffset - w.$wp.offset().left);
        } else n && k();
      }
      function U(e) {
        w.node.isEmpty(e.get(0))
          ? e.prepend(Z.FE.MARKERS)
          : e.prepend(Z.FE.START_MARKER).append(Z.FE.END_MARKER);
      }
      function q() {
        w.shared.$ti_helper ||
      ...
      return {
            ...
            (E = s = n = !1),
                ...
                e.shiftKey
                  ? !1 ===
                      (function(e) {
                        ...
                        if (0 < t.length) {
                          ...
                          1 == t.length
                            ? (a = l = t[0])
                            : ((l = w.el.querySelector('.fr-cell-fixed')),
                              (a = w.el.querySelector('.fr-cell-handler')));
                          var r = A(a, s);
                          ...
                          } else if (Z.FE.KEYCODE.ARROW_UP == n && 0 < r.row)
                            return _(l, s[r.row - 1][r.col]), !1;
                        }
                      })(e) &&
                    setTimeout(function() {
                      h();
                  ...
                  : (function(e) {
                      ...
                      if (l.length && ('TD' == (l = l[0]).tagName || 'TH' == l.tagName)) {
                        for (var a = l; a && 'TABLE' != a.tagName && a.parentNode != w.el; )
                          a = a.parentNode;
                        if (
                          a &&
                          'TABLE' == a.tagName &&
                          (Z.FE.KEYCODE.ARROW_LEFT == t ||
                            Z.FE.KEYCODE.ARROW_UP == t ||
                            Z.FE.KEYCODE.ARROW_RIGHT == t ||
                            Z.FE.KEYCODE.ARROW_DOWN == t) &&
                          (0 < J().length && S(),
                          w.browser.webkit &&
                            (Z.FE.KEYCODE.ARROW_UP == t || Z.FE.KEYCODE.ARROW_DOWN == t))
                        ) {
                          var s = w.selection.ranges(0).startContainer;
                          if (
                            s.nodeType == Node.TEXT_NODE &&
                            ((Z.FE.KEYCODE.ARROW_UP == t &&
                              ((s.previousSibling && 'BR' !== s.previousSibling.tagName) ||
                                (s.previousSibling &&
                                  'BR' === s.previousSibling.tagName &&
                                  s.previousSibling.previousSibling))) ||
                              (Z.FE.KEYCODE.ARROW_DOWN == t &&
                                ((s.nextSibling && 'BR' !== s.nextSibling.tagName) ||
                                  (s.nextSibling &&
                                    'BR' === s.nextSibling.tagName &&
                          ...
                          Z.FE.KEYCODE.ARROW_UP == t
                            ? B(r, a, n)
                            : Z.FE.KEYCODE.ARROW_DOWN == t && z(r, a, n),
                            w.selection.restore();
                        }
                      }
                    })(e);
              ...
              w.events.on(
                ...
                function(e) {
                      ...
                      if (e.which == Z.FE.KEYCODE.TAB) {
                        ...
                        if (0 < J().length) t = w.$el.find('.fr-selected-cell:last');
                          ...
                          'TD' == l.tagName || 'TH' == l.tagName
                            ? (t = Z(l))
                            : l != w.el &&
                              (0 < Z(l).parentsUntil(w.$el, 'td').length
                                ? (t = Z(l).parents('td:first'))
                                : 0 < Z(l).parentsUntil(w.$el, 'th').length &&
                                  (t = Z(l).parents('th:first')));
                        }
                        if (t)
                          return (
                            e.preventDefault(),
                            !!(
                              ...
                              (0 <
                                Z(w.selection.element())
                                  .closest('li')
                                  .prev().length ||
                                (Z(w.selection.element()).is('li') &&
                                  0 < Z(w.selection.element()).prev().length))
                            ) ||
                              (S(),
                              e.shiftKey
                                ? 0 < t.prev().length
                                  ...
                                  : 0 < t.closest('tr').length && 0 < t.closest('tr').prev().length
                                    ...
                                    : 0 < t.closest('tbody').length &&
                                      ...
                                      U(t.closest('table').find('thead tr th:last'))
                                : 0 < t.next().length
                                  ? U(t.next())
                  ...
                  var t = J();
                  if (0 < t.length) {
                    if (0 < t.length && w.keys.ctrlKey(e) && e.which == Z.FE.KEYCODE.A)
                      return (
                        D(),
                        w.popups.isVisible('table.edit') && w.popups.hide('table.edit'),
                        (t = []),
                        !0
                      );
                    if (e.which == Z.FE.KEYCODE.ESC && w.popups.isVisible('table.edit'))
                      return (
                        D(),
                        w.popups.hide('table.edit'),
                        e.preventDefault(),
                    ...
                    if (
                      1 < t.length &&
                      (e.which == Z.FE.KEYCODE.BACKSPACE || e.which == Z.FE.KEYCODE.DELETE)
                    ) {
                      w.undo.saveStep();
                      for (var l = 0; l < t.length; l++)
                        Z(t[l]).html('<br>'), l == t.length - 1 && Z(t[l]).prepend(Z.FE.MARKERS);
                      return w.selection.restore(), w.undo.saveStep(), !(t = []);
                    }
                    if (1 < t.length && e.which != Z.FE.KEYCODE.F10 && !w.keys.isBrowserAction(e))
                    ...
                    (function(e) {
                      if (e.altKey && e.which == Z.FE.KEYCODE.SPACE) {
                        ...
                        if (
                          ('TD' == l.tagName || 'TH' == l.tagName
                            ? (t = l)
                            : 0 < Z(l).closest('td').length
                              ? (t = Z(l)
                                  .closest('td')
                                  .get(0))
                              : 0 < Z(l).closest('th').length &&
                                (t = Z(l)
                                  .closest('th')
                                  .get(0)),
                          t)
        ...
        insert: function(e, t) {
          var l,
            ...
            s =
              '<table ' +
              (w.opts.tableDefaultWidth
                ? 'style="width: ' + w.opts.tableDefaultWidth + ';" '
                : '') +
          ...
          for (l = 0; l < e; l++) {
            for (s += '<tr>', a = 0; a < t; a++)
              (s +=
                '<td' +
                (w.opts.tableDefaultWidth ? ' style="width: ' + n.toFixed(4) + '%;"' : '') +
                '>'),
                0 === l && 0 === a && (s += Z.FE.MARKERS),
                (s += '<br></td>');
            s += '</tr>';
          }
          ...
          if (0 < e.length) {
            ...
            if (0 === n.min_i && n.max_i == s.length - 1) u();
              ...
              R(0, s.length - 1, 0, s[0].length - 1, e),
                0 < n.min_i
                  ? w.selection.setAtEnd(s[n.min_i - 1][0])
                  : w.selection.setAtEnd(s[0][0]),
                w.selection.restore(),
                w.popups.hide('table.edit');
            }
          }
        ...
        insertColumn: function(i) {
          ...
          if (0 < e.length) {
            ...
            e.find('th, td').each(function() {
              ...
              e
                ...
                .each(function(e) {
                  for (var t, l = Z(this), a = 0, s = 0; a - 1 < f; ) {
                    ...
                    t == c[e][a]
                      ? ((a += parseInt(Z(t).attr('colspan'), 10) || 1), s++)
                      : ((a += parseInt(Z(c[e][a]).attr('colspan'), 10) || 1),
                        'after' == i && (t = 0 === s ? -1 : l.find('> th, > td').get(s - 1)));
                  }
                  var n,
                    r = Z(t);
                  if (
                    ('after' == i && f < a - 1) ||
                    ('before' == i && 0 < f && c[e][f] == c[e][f - 1])
                  ) {
                    if (0 === e || (0 < e && c[e][f] != c[e - 1][f])) {
                      var o = parseInt(r.attr('colspan'), 10) + 1;
                      r.attr('colspan', o),
                        r.css('width', ((r.data('old-width') * p) / d + p).toFixed(4) + '%'),
              ...
              e.find('th, td').each(function() {
                (l = Z(this)).data('old-width') &&
                  (l.css('width', ((l.data('old-width') * p) / d).toFixed(4) + '%'),
            ...
            if (0 === n.min_j && n.max_j == s[0].length - 1) u();
              ...
              for (t = 0; t < s.length; t++)
                for (l = 0; l < s[0].length; l++)
                  (a = Z(s[t][l])).hasClass('fr-selected-cell') ||
                    (a.data('old-width', (a.outerWidth() / e.outerWidth()) * 100),
                    (l < n.min_j || l > n.max_j) && (r += (a.outerWidth() / e.outerWidth()) * 100));
                ...
                for (t = 0; t < s.length; t++)
                  if (0 === t || s[t][l] != s[t - 1][l])
                    if (((a = Z(s[t][l])), 1 < (parseInt(a.attr('colspan'), 10) || 1))) {
                      ...
                      1 == o ? a.removeAttr('colspan') : a.attr('colspan', o),
                        a.css(
                          'width',
                          ((100 * (a.data('old-width') - j(l, s))) / r).toFixed(4) + '%'
                        ),
                      ...
                      a.remove(),
                        0 === i.find('> th, > td').length &&
                          (0 === i.prev().length ||
                            0 === i.next().length ||
                            i.prev().find('> th[rowspan], > td[rowspan]').length <
                              i.prev().find('> th, > td').length) &&
                          i.remove();
                    }
              R(0, s.length - 1, 0, s[0].length - 1, e),
                0 < n.min_j
                  ? w.selection.setAtEnd(s[n.min_i][n.min_j - 1])
                  : w.selection.setAtEnd(s[n.min_i][0]),
                w.selection.restore(),
                w.popups.hide('table.edit'),
                e.find('th, td').each(function() {
                  (a = Z(this)).data('old-width') &&
                    (a.css('width', ((100 * a.data('old-width')) / r).toFixed(4) + '%'),
                    a.removeData('old-width'));
                });
            }
          }
        ...
        mergeCells: function() {
          if (
            1 < J().length &&
            (0 === w.$el.find('th.fr-selected-cell').length ||
              0 === w.$el.find('td.fr-selected-cell').length)
          ) {
            x();
            var e,
              t,
            ...
            for (
              s.css('width', Math.min(100, (i / r.outerWidth()) * 100).toFixed(4) + '%'),
                l.min_j < l.max_j && s.attr('colspan', l.max_j - l.min_j + 1),
                l.min_i < l.max_i && s.attr('rowspan', l.max_i - l.min_i + 1),
                e = 1;
              e < a.length;
              e++
            )
              '<br>' != (t = Z(a[e])).html() && '' !== t.html() && (o += '<br>' + t.html()),
                t.remove();
            s.html(o),
              w.selection.setAtEnd(s.get(0)),
              w.selection.restore(),
              w.toolbar.enable(),
              m(l.min_i, l.max_i, r);
        ...
        splitCellVertically: function() {
          if (1 == J().length) {
            ...
            if (1 < t) {
              ...
              1 < o ? e.attr('colspan', o) : e.removeAttr('colspan'),
                1 < t - o ? s.attr('colspan', t - o) : s.removeAttr('colspan'),
                e.css('width', a.toFixed(4) + '%'),
                s.css('width', i.toFixed(4) + '%');
            } else {
              var f;
        ...
        splitCellHorizontally: function() {
          if (1 == J().length) {
            ...
            if (1 < a) {
              var o = Math.ceil(a / 2);
              1 < o ? e.attr('rowspan', o) : e.removeAttr('rowspan'),
                1 < a - o ? r.attr('rowspan', a - o) : r.removeAttr('rowspan');
              for (
                var i = n.row + o, f = 0 === n.col ? n.col : n.col - 1;
                0 <= f && (s[i][f] == s[i][f - 1] || (0 < i && s[i][f] == s[i - 1][f]));
    ...
    Z.FE.RegisterCommand('tableCellHorizontalAlign', {
      ...
      refresh: function(e) {
        ...
        t.length &&
          e
            .find('> *:first')
            .replaceWith(this.icon.create('align-' + this.helpers.getAlignment(Z(t[0]))));
      },
      refreshOnShow: function(e, t) {
        t.find(
          '.fr-command[data-param1="' +
