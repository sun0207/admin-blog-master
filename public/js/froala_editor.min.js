...
!(function(n) {
      ...
      var t = w.proxy(function() {
          'TEXTAREA' != e && (this._original_html = this._original_html || this.$oel.html()),
            ...
            this.opts.iframe
              ...
              : ((this.$el = w('<div></div>')),
                (this.el = this.$el.get(0)),
                (this.$wp = w('<div></div>').append(this.$el)),
                this.$box.html(this.$wp)),
    ...
    (s.prototype.destroy = function() {
      ...
      if (
        ...
        for (var t in this.shared)
          this.shared.hasOwnProperty(t) && (this.shared[t], (w.FE.SHARED[this.sid][t] = null));
      ...
      this.$oel.parents('form').off('.' + this.id),
        ...
        this.core.destroy(e),
        w.FE.INSTANCES.splice(w.FE.INSTANCES.indexOf(this), 1);
    }),
      ...
      if ('string' == typeof o) {
        ...
        return (
          this.each(function() {
            var e,
              t,
              n = w(this).data('froala.editor');
            if (!n)
              return console.warn(
                'Editor should be initialized before calling the ' + o + ' method.'
              );
            if (
              (0 < o.indexOf('.') && n[o.split('.')[0]]
                ? (n[o.split('.')[0]] && (e = n[o.split('.')[0]]), (t = o.split('.')[1]))
                : ((e = n), (t = o.split('.')[0])),
              !e[t])
            )
  ...
  (w.FE.LinkRegExCommon = '[a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_.]{1,}'),
    (w.FE.LinkRegExEnd =
      "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;/~+#-\\'*-_{}]*)|())"),
    (w.FE.LinkRegExTLD =
      '((' + w.FE.LinkRegExCommon + ')(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))'),
    (w.FE.LinkRegExHTTP = '((ftp|http|https):\\/\\/' + w.FE.LinkRegExCommon + ')'),
    (w.FE.LinkRegExAuth =
      '((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@' + w.FE.LinkRegExCommon + ')'),
        ...
        isURL: function(e) {
          return (
            ...
            ((e = String(e)
              ...
              .replace(/"/g, '%22')
              .replace(/ /g, '%20')),
            new RegExp('^' + w.FE.LinkRegExHTTP + w.FE.LinkRegExEnd + '$', 'gi').test(e))
          );
        },
    ...
    (w.FE.MODULES.events = function(l) {
      ...
      function u(e, t, n) {
        if (!l.edit.isDisabled() || n) {
          ...
          return (
            !1 !== (o = l.$oel.triggerHandler('froalaEditor.' + e, w.merge([l], t || []))) && o
          );
        }
      }
      function g() {
      ...
      return {
        _init: function() {
          (l.shared.$_events = l.shared.$_events || []),
            ...
            d('mousedown', function() {
              for (var e = 0; e < w.FE.INSTANCES.length; e++)
                w.FE.INSTANCES[e] != l &&
                  w.FE.INSTANCES[e].popups &&
                  w.FE.INSTANCES[e].popups.areVisible() &&
                  w.FE.INSTANCES[e].$el.find('.fr-marker').remove();
            }),
        ...
        chainTrigger: function(e, t, n) {
          if (!l.edit.isDisabled() || n) {
            ...
            return (
              void 0 !== (o = l.$oel.triggerHandler('froalaEditor.' + e, w.merge([l], [t]))) &&
                (t = o),
              t
            );
          }
    ...
    (w.FE.MODULES.node = function(a) {
      ...
      function l(e) {
        return (
          !!e &&
          (e.nodeType == Node.ELEMENT_NODE && 0 <= w.FE.BLOCK_TAGS.indexOf(e.tagName.toLowerCase()))
        );
      }
      function d(e) {
        var t = {},
      ...
      return {
        ...
        isEmpty: function(e, t) {
          ...
          for (var r = !1, o = 0; o < n.length; o++) {
            ...
            if (
              ...
              if (
                'BR' != i.tagName &&
                0 < (i.textContent || '').replace(/\u200B/gi, '').replace(/\n/g, '').length
              )
                return !1;
              if (r) return !1;
              'BR' == i.tagName && (r = !0);
          ...
          return !(
            e.querySelectorAll(w.FE.VOID_ELEMENTS.join(',')).length -
              e.querySelectorAll('br').length ||
            e.querySelector(
              a.opts.htmlAllowedEmptyTags.join(':not(.fr-marker),') + ':not(.fr-marker)'
            ) ||
        ...
        deepestParent: function(e, t, n) {
          if (
            ...
            0 <= t.indexOf(e.parentNode) ||
              (e.parentNode && a.node.hasClass(e.parentNode, 'fr-inner')) ||
              (e.parentNode && 0 <= w.FE.SIMPLE_ENTER_TAGS.indexOf(e.parentNode.tagName) && n))
          )
            return null;
          for (
            ;
            ...
            (w.FE.SIMPLE_ENTER_TAGS.indexOf(e.parentNode.tagName) < 0 || !n) &&
        ...
        isFirstSibling: function e(t, n) {
          void 0 === n && (n = !0);
          for (var r = t.previousSibling; r && n && a.node.hasClass(r, 'fr-marker'); )
            r = r.previousSibling;
          return !r || (r.nodeType == Node.TEXT_NODE && '' === r.textContent && e(r));
        },
        isLastSibling: function e(t, n) {
          void 0 === n && (n = !0);
          for (var r = t.nextSibling; r && n && a.node.hasClass(r, 'fr-marker'); )
            r = r.nextSibling;
          return !r || (r.nodeType == Node.TEXT_NODE && '' === r.textContent && e(r));
        },
        isList: function(e) {
        ...
        isVoid: function(e) {
          return (
            ...
            0 <= w.FE.VOID_ELEMENTS.indexOf((e.tagName || '').toLowerCase())
          );
        },
        hasFocus: function(e) {
          return (
        ...
        try {
          ...
          if ((n.insertNode(o), (o = d.$el.find('span.fr-marker').get(0)))) {
            for (
              ...
              w(i).remove(), (i = d.$el.find('span.fr-marker').get(0).nextSibling);
        ...
        place: function(e, t, n) {
          ...
          try {
            ...
            if (
              ...
              for (
                i = (r = d.$el.find('span.fr-marker[data-type="true"][data-id="' + n + '"]').get(0))
                  .nextSibling;
                i && i.nodeType === Node.TEXT_NODE && 0 === i.textContent.length;

              )
                w(i).remove(), (i = r.nextSibling);
            if (!0 === t && !e.collapsed) {
              for (; !d.node.isElement(r.parentNode) && !i; )
                w(r.parentNode).after(r), (i = r.nextSibling);
              if (
                i &&
            ...
            if (!1 === t && !e.collapsed) {
              ...
              ((r.parentNode && 0 <= ['TD', 'TH'].indexOf(r.parentNode.tagName)) ||
                ...
                !r.previousSibling &&
                w(r.parentNode.previousSibling).append(r);
            }
          ...
          if ((t || ((t = d.node.blockParent(e)) && 'LI' != t.tagName && (t = null)), t))
            if (d.node.isBlock(t) && d.node.isEmpty(t))
              ...
              d.node.isEmpty(t.parentNode)
                ? w(t).replaceWith('<span class="fr-marker"></span>')
                : w(t).append('<span class="fr-marker"></span>');
            else if (d.cursor.isAtStart(e, t))
              w(t).before('<span class="fr-marker"></span>'), w(e).remove();
            else if (d.cursor.isAtEnd(e, t))
              w(t).after('<span class="fr-marker"></span>'), w(e).remove();
            else {
              for (
                var n = e, r = '', o = '';
                (n = n.parentNode),
    ...
    (w.FE.MODULES.selection = function(S) {
      function s() {
        ...
        return (
          S.win.getSelection
            ? (e = S.win.getSelection())
            : S.doc.getSelection
              ? (e = S.doc.getSelection())
              : S.doc.selection && (e = S.doc.selection.createRange().text),
          e.toString()
        );
      }
      function T() {
        return S.win.getSelection
          ? S.win.getSelection()
          : S.doc.getSelection
            ? S.doc.getSelection()
          ...
          for (t = 0; t < n.length; t++)
            if (n[t].startContainer !== S.doc || S.browser.msie) {
              ...
              if (
                ((void 0 !== i && i) ||
                  !o ||
                  (w('.fr-marker').remove(), S.selection.setAtEnd(S.el)),
                S.el.normalize(),
                S.browser.safari && !o)
              )
                try {
      ...
      function C() {
        ...
        for (e = 0; e < t.length; e++) {
          ...
          if (0 < a.length) {
            ...
            try {
              for (
                var l, d = !1, c = o.nextSibling;
                c && c.nodeType == Node.TEXT_NODE && 0 === c.textContent.length;

              )
                (c = (l = c).nextSibling), w(l).remove();
              for (
                var f, p, u = a.nextSibling;
                u && u.nodeType == Node.TEXT_NODE && 0 === u.textContent.length;

              )
                (u = (l = u).nextSibling), w(l).remove();
              if (o.nextSibling == a || a.nextSibling == o) {
                for (
                  var g = o.nextSibling == a ? o : a, h = g == o ? a : o, m = g.previousSibling;
                  m && m.nodeType == Node.TEXT_NODE && 0 === m.length;

                )
                  (m = (l = m).previousSibling), w(l).remove();
                if (m && m.nodeType == Node.TEXT_NODE)
                  for (; m && m.previousSibling && m.previousSibling.nodeType == Node.TEXT_NODE; )
                    (m.previousSibling.textContent = m.previousSibling.textContent + m.textContent),
                      (m = m.previousSibling),
                      w(m.nextSibling).remove();
                for (var E = h.nextSibling; E && E.nodeType == Node.TEXT_NODE && 0 === E.length; )
                  (E = (l = E).nextSibling), w(l).remove();
                if (E && E.nodeType == Node.TEXT_NODE)
                  for (; E && E.nextSibling && E.nextSibling.nodeType == Node.TEXT_NODE; )
                    (E.nextSibling.textContent = E.textContent + E.nextSibling.textContent),
                      (E = E.nextSibling),
                      w(E.previousSibling).remove();
                if (
                  (m && (S.node.isVoid(m) || S.node.isBlock(m)) && (m = null),
                  E && (S.node.isVoid(E) || S.node.isBlock(E)) && (E = null),
                  m && E && m.nodeType == Node.TEXT_NODE && E.nodeType == Node.TEXT_NODE)
                ) {
                  ...
                  !m && E && E.nodeType == Node.TEXT_NODE
                    ? (w(o).remove(),
                      w(a).remove(),
                      S.opts.htmlUntouched || S.spaces.normalize(E),
                      (s = w(S.doc.createTextNode('\u200b'))),
                      w(E).before(s),
                      i.setStart(E, 0),
                      i.setEnd(E, 0),
                      (d = !0))
              ...
              if (!d)
                (S.browser.chrome || S.browser.edge) && o.nextSibling == a
                  ? ((f = A(a, i, !0) || i.setStartAfter(a)),
                    (p = A(o, i, !1) || i.setEndBefore(o)))
      ...
      function o(e) {
        ...
        if (S.win.getSelection) {
          ...
          S.doc.selection &&
            ...
            ((n = (t = S.doc.selection.createRange()).duplicate()).moveToElementText(e),
      ...
      function $(e, t) {
        ...
        for (var r = S.node.contents(e), o = 0; o < r.length; o++)
          r[o].nodeType != Node.ELEMENT_NODE
            ? w(r[o]).remove()
            : ($(r[o], 0 === o), 0 === o && (t = !1));
        e.nodeType == Node.TEXT_NODE
          ? w(e).replaceWith('<span data-first="true" data-text="true"></span>')
          : t && w(e).attr('data-first', !0);
      }
      function O() {
      ...
      function r(e, t) {
        ...
        for (
          var n = e.firstChild;
          n && (S.node.isBlock(n) || (t && !S.node.isVoid(n) && n.nodeType == Node.ELEMENT_NODE));
      ...
      function i(e, t) {
        ...
        for (
          r.setAttribute('id', 'fr-sel-markers'), r.innerHTML = w.FE.MARKERS;
          e.parentNode &&
          S.opts.htmlAllowedEmptyTags &&
          0 <= S.opts.htmlAllowedEmptyTags.indexOf(e.tagName.toLowerCase());
      ...
      return {
          ...
          try {
            if (e.rangeCount) {
              ...
              if (r.nodeType == Node.ELEMENT_NODE) {
                ...
                w(r.childNodes[n.endOffset]).text() === s()
                  ...
                  !o &&
                    0 < r.childNodes.length &&
                    w(r.childNodes[r.childNodes.length - 1]).text() === s() &&
        ...
        isFull: function() {
          ...
          for (e = 0; e < t.length; e++)
            t[e].nextSibling &&
              (t[e].innerHTML =
                '<span class="fr-mk">' + w.FE.INVISIBLE_SPACE + '</span>' + t[e].innerHTML);
          var n = !1,
            r = o(S.el);
          for (
            r.atStart && r.atEnd && (n = !0), t = S.el.querySelectorAll('.fr-mk'), e = 0;
            e < t.length;
            e++
          )
        ...
        remove: function() {
          ...
          for (t = 0; t < o.length; t++)
            for (
              ...
              !(
                n(i) ||
                S.node.isBlock(i.parentNode) ||
                S.$el.is(i.parentNode) ||
                S.node.hasClass(i.parentNode, 'fr-inner')
              );

            )
              w(i.parentNode).before(i);
          ...
          for (t = 0; t < a.length; t++) {
            for (
              ...
              !(
                r(s) ||
                S.node.isBlock(s.parentNode) ||
                S.$el.is(s.parentNode) ||
                S.node.hasClass(s.parentNode, 'fr-inner')
              );

            )
              w(s.parentNode).after(s);
            s.parentNode &&
              S.node.isBlock(s.parentNode) &&
              S.node.isEmpty(s.parentNode) &&
              !S.$el.is(s.parentNode) &&
              !S.node.hasClass(s.parentNode, 'fr-inner') &&
              S.opts.keepFormatOnDelete &&
              w(s.parentNode).after(s);
          }
          if (
            (function() {
            ...
            if (l.length)
              S.$el.find('.fr-marker').remove(),
                l.append(w.FE.INVISIBLE_SPACE + w.FE.MARKERS).removeAttr('data-first'),
              ...
              for (
                S.$el
                  ...
                  .filter(function() {
                    return (
                      0 < w(this).find('[data-del-cell]').length &&
                      w(this).find('[data-del-cell]').length == w(this).find('td, th').length
                    );
                  })
                  .remove(),
                ...
                var d = o[t],
                  c = d.nextSibling,
                  f = S.$el
                    .find('.fr-marker[data-type="false"][data-id="' + w(d).data('id') + '"]')
                    .get(0);
                if (f) {
                  if (d && (!c || c != f)) {
                    ...
                    if (
                      ...
                      u && 0 <= ['UL', 'OL'].indexOf(u.tagName) && (h = !(u = null)),
                      w(d).after(f),
                      p != u)
                    )
                      if (null != p || g)
                        if (null != u || h || 0 !== w(p).parentsUntil(S.$el, 'table').length)
                          p &&
                            u &&
                            0 === w(p).parentsUntil(S.$el, 'table').length &&
                            0 === w(u).parentsUntil(S.$el, 'table').length &&
                            0 === w(p).find(u).length &&
                            0 === w(u).find(p).length &&
                            (w(p).append(w(u).html()), w(u).remove());
                        else {
          ...
          S.$el.find('li:empty').remove(),
            S.opts.keepFormatOnDelete || S.html.fillEmptyBlocks(),
            S.html.cleanEmptyTags(!0),
            S.opts.htmlUntouched ||
              (S.clean.lists(), S.$el.find('li:empty').append('<br>'), S.spaces.normalize());
          ...
          void 0 !== v &&
            ...
            S.node.isElement(v.parentNode) &&
            S.node.isElement(b.parentNode) &&
            S.$el.append('<br>'),
            C();
        },
        blocks: function() {
          ...
          if (p() && n.rangeCount) {
            ...
            for (e = 0; e < r.length; e++) {
              ...
              (S.node.isBlock(a) || S.node.hasClass(a, 'fr-inner')) &&
                t.indexOf(a) < 0 &&
                t.push(a),
        ...
        setBefore: function(e, t) {
          ...
          return n
            ? (S.node.isBlock(n)
                ? i(n)
                : 'BR' == n.tagName
                  ? w(n).before(w.FE.MARKERS)
                  : w(n).after(w.FE.MARKERS),
              !0)
            : !!t && (S.node.isBlock(e) ? r(e) : w(e).before(w.FE.MARKERS), !0);
        },
        setAfter: function(e, t) {
          ...
          for (
            ...
            n = n.nextSibling;
          return n
            ? (S.node.isBlock(n) ? r(n) : w(n).before(w.FE.MARKERS), !0)
            : !!t && (S.node.isBlock(e) ? i(e) : w(e).after(w.FE.MARKERS), !0);
        },
        rangeElement: f,
      };
    }),
    ...
    (w.FE.MODULES.clean = function(f) {
        ...
        return i
          ...
          .replace(/\[FROALA\.EDITOR\.NOSCRIPT ([\d]*)\]/gi, function(e, t) {
            return 0 <= f.opts.htmlRemoveTags.indexOf('noscript')
              ? ''
              : a[parseInt(t, 10)].replace(/\&lt;/g, '<').replace(/\&gt;/g, '>');
          })
      ...
      function v(e) {
        for (var t = f.node.contents(e), n = 0; n < t.length; n++)
          t[n].nodeType != Node.TEXT_NODE && v(t[n]);
        !(function(e) {
          ...
          if (
            ...
            e.nodeType == Node.ELEMENT_NODE &&
              (e.getAttribute('data-fr-src') &&
                ...
                e.setAttribute(
                  'data-fr-src',
                  f.helpers.sanitizeURL(E(e.getAttribute('data-fr-src')))
                ),
              e.getAttribute('href') &&
                e.setAttribute('href', f.helpers.sanitizeURL(E(e.getAttribute('href')))),
              e.getAttribute('src') &&
                e.setAttribute('src', f.helpers.sanitizeURL(E(e.getAttribute('src')))),
              e.getAttribute('data') &&
                e.setAttribute('data', f.helpers.sanitizeURL(E(e.getAttribute('data')))),
      ...
      return {
        _init: function() {
          f.opts.fullPage &&
            w.merge(f.opts.htmlAllowedTags, [
              'head',
              'title',
              'style',
              'link',
          ...
          !(function() {
            for (var e = f.el.querySelectorAll('tr'), t = 0; t < e.length; t++) {
              ...
              if (!1 !== r && 0 !== n.length) {
                ...
                var a = i;
                'THEAD' != a.tagName &&
                  ((a = f.doc.createElement('THEAD')), i.insertBefore(a, i.firstChild)),
                  a.appendChild(e[t]);
              }
            }
          })();
            ...
            (function() {
              for (var e = f.el.querySelectorAll('ul, ol'), t = 0; t < e.length; t++)
                for (var n = f.node.contents(e[t]), r = null, o = n.length - 1; 0 <= o; o--)
                  'LI' != n[o].tagName && 'UL' != n[o].tagName && 'OL' != n[o].tagName
                    ? (r || (r = w('<li>')).insertBefore(n[o]), r.prepend(n[o]))
                    : (r = null);
            })(),
            (function() {
              var e, t, n;
        ...
        if (!l.html.isPreformatted(i)) {
          t &&
            ...
            (r && 'BR' !== r.tagName && !l.node.isBlock(r)) ||
              !(l.node.isBlock(i) || (l.node.isLink(i) && !i.nextSibling) || l.node.isElement(i)) ||
              (o = o.replace(/[\f\n\r\t\v ]{1,}$/g, '')),
            (n && 'BR' !== n.tagName && !l.node.isBlock(n)) ||
              !(
                l.node.isBlock(i) ||
                (l.node.isLink(i) && !i.previousSibling) ||
                l.node.isElement(i)
              ) ||
              (o = o.replace(/^[\f\n\r\t\v ]{1,}/g, '')),
          ...
          (!r ||
            ...
            (l.node.isVoid(n) || (a = a.replace(/ $/, w.FE.UNICODE_NBSP))),
            !n ||
              l.node.isVoid(n) ||
              l.node.isBlock(n) ||
    ...
    (w.FE.MODULES.html = function(F) {
      function c() {
        return F.opts.enter == w.FE.ENTER_P
          ? 'p'
          : F.opts.enter == w.FE.ENTER_DIV
            ? 'div'
            : F.opts.enter == w.FE.ENTER_BR
              ? null
              : void 0;
      }
      function s(e, t) {
        ...
        if (e) {
          ...
          for (t = 0; t < o.length; t++) {
            ...
            if (i) {
              var a = i.nextSibling,
                s = i.previousSibling;
              i && r.indexOf(i) < 0 && F.node.isBlock(i) && r.push(i),
                s && F.node.isBlock(s) && r.indexOf(s) < 0 && r.push(s),
                a && F.node.isBlock(a) && r.indexOf(a) < 0 && r.push(a);
            }
          }
        } else r = F.el.querySelectorAll(p());
        var l = p();
        for (
          l += ',' + w.FE.VOID_ELEMENTS.join(','),
            l += ', .fr-inner',
            l += ',' + F.opts.htmlAllowedEmptyTags.join(':not(.fr-marker),') + ':not(.fr-marker)',
            t = r.length - 1;
          0 <= t;
          t--
        )
      ...
      function e(e) {
        ...
        (r = w.merge(r, F.opts.htmlAllowedEmptyTags)),
          (r = void 0 === e ? w.merge(r, w.FE.BLOCK_TAGS) : w.merge(r, w.FE.NO_DELETE_TAGS)),
          (t = F.el.querySelectorAll('*:empty:not(' + r.join('):not(') + '):not(.fr-marker)'));
        do {
          n = !1;
          for (var o = 0; o < t.length; o++)
            (0 !== t[o].attributes.length && void 0 === t[o].getAttribute('href')) ||
      ...
      function a(e, t) {
        ...
        if ((t && (n = 'div'), n)) {
          for (
            var r = F.doc.createDocumentFragment(), o = null, i = !1, a = e.firstChild, s = !1;
            a;
            ...
            if (
              ...
              (F.node.isBlock(a) ||
                (0 <= F.opts.htmlDoNotWrapTags.indexOf(a.tagName.toLowerCase()) &&
                  !F.node.hasClass(a, 'fr-marker')))
            )
              ...
              null == o
                ? ((o = F.doc.createElement(n)),
                  (s = !0),
                  t && (o.setAttribute('class', 'fr-temp-div'), o.setAttribute('data-empty', !0)),
                  o.appendChild(a.cloneNode(!0)),
                  r.appendChild(o))
                : !1 === i &&
                  (o.appendChild(F.doc.createElement('br')),
                  t && (o.setAttribute('class', 'fr-temp-div'), o.setAttribute('data-empty', !0))),
                (o = null);
            else {
              var d = a.textContent;
              ...
              (d.replace(/(^ *)|( *$)/g, '').length && d.indexOf('\n') < 0)
                ? (null == o &&
                  ...
                  i ||
                    F.node.hasClass(a, 'fr-marker') ||
                    (a.nodeType == Node.TEXT_NODE && 0 === d.replace(/ /g, '').length) ||
                    (i = !0))
                : (s = !0);
            }
            a = l;
      ...
      function n(e) {
        if ((void 0 === e && (e = F.el), e && 0 <= ['SCRIPT', 'STYLE', 'PRE'].indexOf(e.tagName)))
          return !1;
        for (
          ...
          if (!s(n.parentNode, !0)) {
            ...
            if (r) {
              var i = n.previousSibling,
                a = n.nextSibling;
              i && a && ' ' == o
                ? (o = F.node.isBlock(i) && F.node.isBlock(a) ? '' : ' ')
                : (i || (o = o.replace(/^ */, '')), a || (o = o.replace(/ *$/, '')));
            }
            n.textContent = o;
          }
        }
      ...
      function d(e) {
        ...
        if (
          t &&
          (F.node.isBlock(t) || F.node.isElement(t)) &&
          ...
          n &&
            ...
            ((F.el == t && !r && F.opts.enter == w.FE.ENTER_BR && F.browser.msie) ||
          ...
          !t ||
            ...
            e.previousSibling ||
            e.nextSibling ||
            !F.node.isDeletable(e.parentNode) ||
            d(e.parentNode);
      }
      function u() {
        ...
        F.node.isEmpty(F.el) &&
          (null != c()
            ? F.el.querySelector(p()) ||
              F.el.querySelector(
                F.opts.htmlDoNotWrapTags.join(':not(.fr-marker),') + ':not(.fr-marker)'
              ) ||
              (F.core.hasFocus()
                ? (F.$el.html('<' + c() + '>' + w.FE.MARKERS + '<br/></' + c() + '>'),
                  F.selection.restore())
                : F.$el.html('<' + c() + '><br/></' + c() + '>'))
            : F.el.querySelector('*:not(.fr-marker):not(br)') ||
              (F.core.hasFocus()
                ? (F.$el.html(w.FE.MARKERS + '<br/>'), F.selection.restore())
                : F.$el.html('<br/>')));
      }
      function g(e, t) {
      ...
      function v(e) {
        ...
        var n,
          ...
          o = t
            ...
            : 0;
        if (
          (F.el.textContent.match(/\u200B/g) || []).length -
            F.el.querySelectorAll('.fr-marker').length ==
          o
        )
          return !1;
        do {
      ...
      return {
        ...
        fillEmptyBlocks: function(e) {
          ...
          for (var n = 0; n < t.length; n++) {
            ...
            'false' === r.getAttribute('contenteditable') ||
              r.querySelector(
                F.opts.htmlAllowedEmptyTags.join(':not(.fr-marker),') + ':not(.fr-marker)'
              ) ||
              F.node.isVoid(r) ||
              ('TABLE' != r.tagName &&
                'TBODY' != r.tagName &&
        ...
        get: function(e, t) {
          ...
          if (!F.opts.useClasses && !t) {
            ...
            for (r = 0; r < F.doc.styleSheets.length; r++) {
              var c,
                f = 0;
              try {
                (c = F.doc.styleSheets[r].cssRules),
                  F.doc.styleSheets[r].ownerNode &&
                    'STYLE' == F.doc.styleSheets[r].ownerNode.nodeType &&
                    (f = 1);
              } catch (w) {}
              if (c)
                  ...
                  if (c[p].selectorText && 0 < c[p].style.cssText.length) {
                    ...
                    for (o = 0; o < g.length; o++) {
                      !g[o].getAttribute('fr-original-style') && g[o].getAttribute('style')
                        ? (g[o].setAttribute('fr-original-style', g[o].getAttribute('style')),
                          i.push(g[o]))
                        : g[o].getAttribute('fr-original-style') ||
                          (g[o].setAttribute('fr-original-style', ''), i.push(g[o])),
                        a[g[o]] || (a[g[o]] = {});
                      for (
                        var m = 1e3 * f + D(c[p].selectorText),
                          E = c[p].style.cssText.split(';'),
                          v = 0;
                        v < E.length;
                        v++
                      ) {
                        ...
                        if (
                          ...
                          (a[g[o]][b] ||
                            ((a[g[o]][b] = 0) <=
                              (g[o].getAttribute('fr-original-style') || '').indexOf(b + ':') &&
                              (a[g[o]][b] = 1e4)),
                          m >= a[g[o]][b] && ((a[g[o]][b] = m), E[v].trim().length))
                        ) {
            ...
            for (r = 0; r < i.length; r++)
              if (
                (i[r].getAttribute('class') &&
                  (i[r].setAttribute('fr-original-class', i[r].getAttribute('class')),
          ...
          if (F.node.isEmpty(F.el))
            F.opts.fullPage &&
              ((n = k(F.iframe_document)),
              (n +=
                '<html' +
                F.node.attributes(F.$html.get(0)) +
                '>' +
                F.$html.find('head').get(0).outerHTML +
                '<body></body></html>'));
          ...
          if (!F.opts.useClasses && !t)
            for (r = 0; r < i.length; r++)
              i[r].getAttribute('fr-original-class') &&
                (i[r].setAttribute('class', i[r].getAttribute('fr-original-class')),
                ...
                void 0 !== i[r].getAttribute('fr-original-style')
                  ? (0 !== i[r].getAttribute('fr-original-style').length
                      ? i[r].setAttribute('style', i[r].getAttribute('fr-original-style'))
          ...
          var e,
            ...
            n = function(e, t) {
              for (
                ;
                t &&
                (t.nodeType == Node.TEXT_NODE || !F.node.isBlock(t)) &&
                !F.node.isElement(t) &&
                !F.node.hasClass(t, 'fr-inner');

              )
                t &&
                  t.nodeType != Node.TEXT_NODE &&
                  w(e).wrapInner(F.node.openTagString(t) + F.node.closeTagString(t)),
                  (t = t.parentNode);
          ...
          if ('undefined' != typeof F.win.getSelection) {
            F.browser.mozilla &&
              ...
              1 < F.$el.find('.fr-marker[data-type="false"]').length &&
                (F.$el.find('.fr-marker[data-type="false"][data-id="0"]').remove(),
                F.$el.find('.fr-marker[data-type="false"]:last').attr('data-id', '0'),
                F.$el
                  .find('.fr-marker')
                  .not('[data-id="0"]')
                  .remove()),
            ...
            'undefined' != typeof F.doc.selection &&
              'Text' == F.doc.selection.type &&
              (r = F.doc.selection.createRange().htmlText);
          return r;
        },
        insert: function(e, t, n) {
          ...
          if (
            ...
            e.indexOf('class="fr-marker"') < 0 &&
              ((o = r),
              ((i = F.doc.createElement('div')).innerHTML = o),
              F.selection.setAtEnd(i, !0),
              (r = i.innerHTML)),
            ...
            if (a) {
              F.node.isLastSibling(a) &&
                w(a)
                  .parent()
                  .hasClass('fr-deletable') &&
                w(a).insertAfter(w(a).parent());
                ...
                if (
                  (s &&
                    ...
                    (r = (function(e) {
                      ...
                      t.innerHTML = e;
                      for (
                        var n = t.querySelectorAll(':scope > ' + F.html.defaultTag()),
                          r = n.length - 1;
                        0 <= r;
                        r--
                      ) {
                        var o = n[r];
                        F.node.isBlock(o.previousSibling) ||
                          (o.previousSibling &&
                            !F.node.isEmpty(o) &&
                            w('<br>').insertAfter(o.previousSibling),
                          (o.outerHTML = o.innerHTML));
                      }
                      return t.innerHTML;
                    })(r)),
        ...
        unwrap: function() {
          F.$el.find('div.fr-temp-div').each(function() {
            this.previousSibling &&
              ...
              w(this).before('<br>'),
              w(this).attr('data-empty') ||
              !this.nextSibling ||
              (F.node.isBlock(this.nextSibling) && !w(this.nextSibling).hasClass('fr-temp-div'))
                ? w(this).replaceWith(w(this).html())
                : w(this).replaceWith(w(this).html() + '<br>');
          }),
            F.$el
              .find('.fr-temp-div')
    ...
    (w.FE.MODULES.language = function(e) {
      ...
      return {
        _init: function() {
          w.FE.LANGUAGE && (t = w.FE.LANGUAGE[e.opts.language]),
    ...
    (w.FE.MODULES.placeholder = function(f) {
      function e() {
        f.$placeholder ||
          ((f.$placeholder = w('<span class="fr-placeholder"></span>')),
      ...
      return {
        ...
        injectStyle: function(e) {
          if (d.opts.iframe) {
            ...
            for (
              var t = w('<style data-fr-style="true">' + e + '</style>').appendTo(d.$head)[0].sheet,
                n = 0;
              n < c.length;
              n++
            )
              for (
                var r = t.insertRule(c[n].selector + '{}', t.cssRules.length), o = 0;
                o < c[n].style.length;
                o++
              ) {
                var i = c[n].style[o],
                  a = c[n].style[i];
                d.browser.safari && 'content' === i && (a = '"' + a + '"'),
                  (t.cssRules[r].style[i] = a);
              }
      ...
      return {
        _startEnter: function(e) {
          ...
          if (h.node.isEmpty(n, !0) && r) {
            ...
            for (
              d =
                l.parentNode && 'LI' == l.parentNode.tagName
                  ? s + '<li>' + w.FE.MARKERS + '<br>' + a
                  : i
                    ? s + '<' + i + '>' + w.FE.MARKERS + '<br></' + i + '>' + a
                    : s + w.FE.MARKERS + '<br>' + a;
            ...
            for (var f = '<br>', p = e.parentNode; p && 'LI' != p.tagName; )
              (f = h.node.openTagString(p) + f + h.node.closeTagString(p)), (p = p.parentNode);
            w(n).before('<li>' + f + '</li>'), w(e).remove();
          } else if (o) {
            t = E(n);
            for (var u = w.FE.MARKERS + '<br>', g = e.parentNode; g && 'LI' != g.tagName; )
              (u = h.node.openTagString(g) + u + h.node.closeTagString(g)), (g = g.parentNode);
            t.parentNode && 'LI' == t.parentNode.tagName
              ? w(t.parentNode).after('<li>' + u + '</li>')
              : i
                ? w(t).after('<' + i + '>' + u + '</' + i + '>')
                : w(t).after(u),
              w(n).remove();
        ...
        _middleEnter: function(e) {
          for (var t = m(e), n = '', r = e, o = '', i = ''; r != t; ) {
            var a =
              'A' == (r = r.parentNode).tagName && h.cursor.isAtEnd(e, r) ? 'fr-to-remove' : '';
            (o =
          ...
          (n = i + n + o + w.FE.MARKERS + (h.opts.keepFormatOnDelete ? w.FE.INVISIBLE_SPACE : '')),
            w(e).replaceWith('<span id="fr-break"></span>');
        ...
        _endEnter: function(e) {
          for (var t = m(e), n = w.FE.MARKERS, r = '', o = e, i = !1; o != t; ) {
            var a =
              'A' == (o = o.parentNode).tagName && h.cursor.isAtEnd(e, o) ? 'fr-to-remove' : '';
            i || o == t || h.node.isBlock(o) || ((i = !0), (r += w.FE.INVISIBLE_SPACE)),
              (r =
                h.node.openTagString(
                  w(o)
                    .clone()
          ...
          if (n) {
            ...
            r.length && 'BR' == r[r.length - 1].tagName && w(r[r.length - 1]).remove(),
              w(t)
                ...
                .each(function() {
                  this.parentNode == t &&
                    w(this).replaceWith(w(this).html() + (h.node.isEmpty(this) ? '' : '<br>'));
                });
            for (var o, i = h.node.contents(t)[0]; i && !h.node.isList(i); )
              (o = i.nextSibling), w(n).append(i), (i = o);
            for (n = t.previousSibling; i; ) (o = i.nextSibling), w(n).append(i), (i = o);
            1 < (r = h.node.contents(n)).length &&
              'BR' === r[r.length - 1].tagName &&
              w(r[r.length - 1]).remove(),
              w(t).remove();
          } else {
            var a = E(t);
            if ((w(e).replaceWith(w.FE.MARKERS), a.parentNode && 'LI' == a.parentNode.tagName)) {
              ...
              l && 0 === w(t).find(h.html.blockTagsQuery()).length
                ? w(a).before('<' + l + '>' + w(t).html() + '</' + l + '>')
                : w(a).before(w(t).html());
            }
        ...
        _del: function(e) {
          ...
          if (r) {
            ...
            for (var o, i = e, a = h.node.contents(r)[0]; a && !h.node.isList(a); )
              (o = a.nextSibling), w(i).after(a), (i = a), (a = o);
            ...
            if (((s = s.nextSibling), h.node.isBlock(s)))
              w.FE.NO_DELETE_TAGS.indexOf(s.tagName) < 0 &&
                (w(e).replaceWith(w.FE.MARKERS),
                (t = h.node.contents(n)).length &&
                  'BR' == t[t.length - 1].tagName &&
                  w(t[t.length - 1]).remove(),
                w(n).append(w(s).html()),
                w(s).remove());
            else
              for (
                (t = h.node.contents(n)).length &&
                  ...
                  w(t[t.length - 1]).remove(),
                  w(e).replaceWith(w.FE.MARKERS);
                s && !h.node.isBlock(s) && 'BR' != s.tagName;

              )
                w(n).append(w(s)), (s = s.nextSibling);
          }
        },
      };
    }),
          ...
          (e != u.$wp.get(0) &&
            ...
            0 === e.nextSibling.textContent.replace(/\u200b/g, '').length
              ...
              : !(
                ...
                (e.parentNode == t || h(e.parentNode, t))))
        );
      }
      function s(e) {
        return (
          0 < w(e).parentsUntil(u.$el, 'LI').length && 0 === w(e).parentsUntil('LI', 'TABLE').length
        );
      }
      function d(e, t) {
        var n = new RegExp(
      ...
      function c(e) {
        ...
        if (((n = n.previousSibling), !u.node.isBlock(n) && u.node.isEditable(n))) {
          ...
          if (n.nodeType == Node.TEXT_NODE) {
            ...
            if (r.length && '\n' === r[r.length - 1])
              return (
                (n.textContent = r.substring(0, o - 2)),
            ...
            if (u.opts.tabSpaces && r.length >= u.opts.tabSpaces)
              0 ===
                r
                  ...
                  .replace(/ /g, '')
                  .replace(new RegExp(w.FE.UNICODE_NBSP, 'g'), '').length &&
                (o = r.length - u.opts.tabSpaces + 1);
            (n.textContent = r.substring(0, o - d(r))),
              u.opts.htmlUntouched &&
                ...
                (n.textContent =
                  n.textContent.substring(0, n.textContent.length - 1) + w.FE.UNICODE_NBSP);
            ...
            if (0 === n.textContent.length)
              if (i && u.opts.keepFormatOnDelete) w(n).after(w.FE.INVISIBLE_SPACE + w.FE.MARKERS);
                ...
                for (
                  ...
                  w.FE.NO_DELETE_TAGS.indexOf(n.parentNode.tagName) < 0;
            ...
            u.node.isDeletable(n)
              ...
              : e.nextSibling &&
                ...
                : !1 !== u.events.trigger('node.remove', [w(n)]) &&
                  (w(n).after(w.FE.MARKERS), w(n).remove());
        } else if (
          w.FE.NO_DELETE_TAGS.indexOf(n.tagName) < 0 &&
          ...
          if (u.node.isDeletable(n)) w(e).replaceWith(w.FE.MARKERS), w(n).remove();
            ...
            w(n).remove(), w(e).replaceWith(w.FE.MARKERS);
          else {
            for (
              u.node.isList(n) &&
                (n = w(n)
      ...
      function l(e) {
        ...
        if (null !== n) {
          ...
          if (
            ...
            (u.node.isEditable(n) || u.node.isDeletable(n)) &&
            i &&
            w.FE.NO_DELETE_TAGS.indexOf(i.tagName) < 0
          )
            if (u.node.isDeletable(i)) w(i).remove(), w(e).replaceWith(w.FE.MARKERS);
              ...
              if (u.node.isList(i))
                if (u.node.isEmpty(n, !0))
                  w(n).remove(),
                    w(i)
                      .find('li:first')
                      .prepend(w.FE.MARKERS);
                else {
                  var a = w(i).find('li:first');
                  'BLOCKQUOTE' == n.tagName &&
                    (o = u.node.contents(n)).length &&
                    u.node.isBlock(o[o.length - 1]) &&
                    (n = o[o.length - 1]),
                      ...
                      a
                        ...
                        .each(function() {
                          this.parentNode == a.get(0) &&
                            w(this).replaceWith(
                              w(this).html() + (u.node.isEmpty(this) ? '' : '<br>')
                            );
                        }),
                ...
                if (
                  ((o = u.node.contents(i)).length && 'BR' == o[0].tagName && w(o[0]).remove(),
              ...
              for (
                w(e).replaceWith(w.FE.MARKERS);
                i && 'BR' !== i.tagName && !u.node.isBlock(i) && u.node.isEditable(i);
      ...
      function n(e) {
        ...
        if ('BR' == (n = n.nextSibling).tagName && u.node.isEditable(n))
          if (n.nextSibling) {
            if (u.node.isBlock(n.nextSibling) && u.node.isEditable(n.nextSibling)) {
              if (!(w.FE.NO_DELETE_TAGS.indexOf(n.nextSibling.tagName) < 0))
                return void w(n).remove();
              ...
              u.node.deepestParent(n) &&
                ((!u.node.isEmpty(u.node.blockParent(n)) ||
                  (u.node.blockParent(n).nextSibling &&
                    w.FE.NO_DELETE_TAGS.indexOf(u.node.blockParent(n).nextSibling.tagName)) < 0) &&
                  w(n).remove(),
                l(e));
            return;
          }
        if (!u.node.isBlock(n) && u.node.isEditable(n)) {
          ...
          if (u.node.isDeletable(n)) w(e).replaceWith(w.FE.MARKERS), w(n).remove();
            ...
            ((t = u.node.contents(n)) && t.length && 'BR' == t[0].tagName && w(t[0]).remove(),
      ...
      function p(e, t, n) {
            ...
            h(e, o)
              ? ((r = u.html.defaultTag()),
                t
                  ...
                  : r
                    ? w(o).after('<' + r + '>' + w.FE.MARKERS + '<br></' + r + '>')
                    : w(o).after(w.FE.MARKERS + '<br>'),
                w(e).remove())
              : m(e, t, n),
            !1
          );
        if (null == o)
          ...
          (a =
            ...
            a +
            d +
            (e.parentNode == o && u.node.isBlock(o) ? '' : w.FE.INVISIBLE_SPACE) +
            w.FE.MARKERS),
            u.node.isBlock(o) &&
              !w(o)
                .find('*:last')
            ...
            w(e).remove(),
            (o.nextSibling && !u.node.isBlock(o.nextSibling)) ||
              u.node.isBlock(o) ||
              w(o).after('<br>'),
            (s = (s =
              !t && u.node.isBlock(o)
                ? u.node.openTagString(o) + w(o).html() + f
                : u.node.openTagString(o) + w(o).html() + u.node.closeTagString(o)).replace(
              /<span id="fr-break"><\/span>/g,
              a
            )),
            w(o).replaceWith(s);
      ...
      function m(e, t, n) {
        ...
        if (null == r)
          u.html.defaultTag() && e.parentNode === u.el
            ...
            : ((e.nextSibling && !u.node.isBlock(e.nextSibling)) || w(e).after('<br>'),
              w(e).replaceWith('<br>' + w.FE.MARKERS));
        else {
          var o = e,
            i = '';
          ...
          do {
            ...
            if (
              ...
              'BLOCKQUOTE' == r.tagName &&
                ...
                0 < w(l).find(e).length &&
                w(l).after(e),
              'BLOCKQUOTE' != r.tagName || (!h(e, o) && !g(e, o)))
            )
          ...
          if ('BLOCKQUOTE' == r.tagName)
            if (
              (e.previousSibling &&
                ...
                e.nextSibling &&
                'BR' == e.nextSibling.tagName &&
                (w(e.nextSibling).after(e),
                e.nextSibling && 'BR' == e.nextSibling.tagName && w(e.nextSibling).remove()),
              t)
            )
        ...
        enter: function(t) {
          ...
          for (var r = n.parentNode; r && !u.node.isElement(r); ) {
            if ('false' === r.getAttribute('contenteditable'))
              return w(n).replaceWith(w.FE.MARKERS), u.selection.restore(), !1;
                      ...
                      if (i && 'BLOCKQUOTE' == i.tagName)
                        if (g(t, i)) {
                          if (!n)
                            return (
                              (o = u.html.defaultTag())
                                ? w(i).before('<' + o + '>' + w.FE.MARKERS + '<br></' + o + '>')
                                : w(i).before(w.FE.MARKERS + '<br>'),
                              w(t).remove(),
                              !1
                            );
                        } else h(t, i) ? p(t, n, !0) : m(t, n, !0);
                      if (null == i)
                        (o = u.html.defaultTag()) && u.node.isElement(t.parentNode)
                          ? w(t).replaceWith('<' + o + '>' + w.FE.MARKERS + '<br></' + o + '>')
                          : w(t).replaceWith('<br>' + w.FE.MARKERS);
                      else {
                        if (u.node.isBlock(i))
                          if (('PRE' == i.tagName && (n = !0), n))
                            w(t).remove(), w(i).prepend('<br>' + w.FE.MARKERS);
                          else {
                            if (u.node.isEmpty(i, !0)) return p(t, n, r);
                            if (u.opts.keepFormatOnDelete) {
                              for (
                                var a = t, s = w.FE.INVISIBLE_SPACE;
                                a != i && !u.node.isElement(a);
        ...
        backspace: function() {
          ...
          for (var n = t.parentNode; n && !u.node.isElement(n); ) {
            if ('false' === n.getAttribute('contenteditable'))
              return w(t).replaceWith(w.FE.MARKERS), u.selection.restore(), !1;
          ...
          if (r) {
            ...
            o &&
              ...
              (1 == o.length
                ? w(r).remove()
                : (r.textContent = r.textContent.substr(0, o.length - d(o))));
          }
          return (
            i(t)
              ? s(t) &&
                ...
                ? s(t) &&
                  ...
                  : (function(e) {
                      for (
                        ...
                        w.FE.SIMPLE_ENTER_TAGS.indexOf(n.parentElement.tagName) < 0;

                      )
                        n = n.parentElement;
                      if (n && 'BLOCKQUOTE' == n.tagName) {
                        var o = u.node.deepestParent(e, [
                          w(e)
                            .parentsUntil(u.$el, 'BLOCKQUOTE')
                            .get(0),
                        ]);
                        ...
                        if (u.node.isBlock(n) && u.node.isEditable(n))
                          if (a && w.FE.NO_DELETE_TAGS.indexOf(a.tagName) < 0) {
                            if (u.node.isDeletable(a))
                              w(a).remove(), w(e).replaceWith(w.FE.MARKERS);
                            else if (u.node.isEditable(a))
                              if (u.node.isBlock(a))
                                if (u.node.isEmpty(a) && !u.node.isList(a))
                                  w(a).remove(),
                                    w(e).after(
                                      u.opts.keepFormatOnDelete ? w.FE.INVISIBLE_SPACE : ''
                                    );
                                else {
                                  if (
                                    (u.node.isList(a) &&
                                      (a = w(a)
                                        .find('li:last')
                                        .get(0)),
                                    (i = u.node.contents(a)).length &&
                                      'BR' == i[i.length - 1].tagName &&
                                      w(i[i.length - 1]).remove(),
                                    'BLOCKQUOTE' == a.tagName && 'BLOCKQUOTE' != n.tagName)
                                  )
                                    for (
                                      i = u.node.contents(a);
                                      i.length && u.node.isBlock(i[i.length - 1]);
                                  ...
                                  if (u.node.isEmpty(n)) w(e).remove(), u.selection.setAtEnd(a, !0);
                                    ...
                                    u.node.isBlock(s[s.length - 1])
                                      ? w(s[s.length - 1]).append(r.innerHTML)
                                      : w(a).append(r.innerHTML);
                                  }
                                ...
                                w(e).replaceWith(w.FE.MARKERS),
                                  'BLOCKQUOTE' == n.tagName && a.nodeType == Node.ELEMENT_NODE
                                    ? w(a).remove()
                                    : (w(a).after(u.node.isEmpty(n) ? '' : w(n).html()),
                                      w(n).remove(),
                                      'BR' == a.tagName && w(a).remove());
                          } else
                            a ||
                              (n &&
                                'BLOCKQUOTE' === n.tagName &&
    ...
    (w.FE.MODULES.keys = function(l) {
      ...
      function t() {
        l.selection.isFull() &&
          setTimeout(function() {
            ...
            e
              ? l.$el.html('<' + e + '>' + w.FE.MARKERS + '<br/></' + e + '>')
              : l.$el.html(w.FE.MARKERS + '<br/>'),
              l.selection.restore(),
      ...
      function a(e) {
        ...
        if (
          ((!(g(e) || (e.shiftKey && (33 === n || 34 === n || 35 === n || 36 === n))) &&
            l.selection.isFull() &&
        ...
        n == w.FE.KEYCODE.ENTER
          ? e.shiftKey
            ...
            : ((o = e),
              l.opts.multiLine
                ? (l.helpers.isIOS() || (o.preventDefault(), o.stopPropagation()),
                      ...
                      if (!l.helpers.isMobile() && t && 'A' == t.tagName) {
                        ...
                        if (n) {
                          ...
                          !n.nextSibling && n.parentNode && 'A' == n.parentNode.tagName
                            ? (n.parentNode.insertAdjacentHTML('afterend', '&nbsp;' + w.FE.MARKERS),
                              n.parentNode.removeChild(n))
                            : (r &&
                              r.nodeType == Node.TEXT_NODE &&
        ...
        l.opts.height || l.opts.heightMax
          ...
          : ((e = l.position.getBoundingRect().top),
            ...
            (e += l.opts.toolbarStickyOffset) > l.o_win.innerHeight - 20 &&
              w(l.o_win).scrollTop(e + l.helpers.scrollTop() - l.o_win.innerHeight + 20),
            (e = l.position.getBoundingRect().top),
            l.opts.toolbarBottom || (e -= l.opts.toolbarStickyOffset),
            l.opts.iframe && ((e += l.$iframe.offset().top), (e -= l.helpers.scrollTop())),
            e < l.$tb.height() + 20 &&
              w(l.o_win).scrollTop(e + l.helpers.scrollTop() - l.$tb.height() - 20));
      }
      function p() {
        var e,
      ...
      function u(e) {
        ...
        if (c) return !1;
        if (
          (e && l.helpers.isIOS() && e.which == w.FE.KEYCODE.ENTER && l.doc.execCommand('undo'),
          !l.selection.isCollapsed())
        )
          return !0;
        ...
        if (
          e &&
          !l.helpers.isIOS() &&
          (e.which == w.FE.KEYCODE.ENTER ||
            e.which == w.FE.KEYCODE.BACKSPACE ||
      ...
      function E(e) {
        ...
        if (
          ...
          (37 <= t && t <= 40) ||
          (!m(t) &&
            t != w.FE.KEYCODE.DELETE &&
            t != w.FE.KEYCODE.BACKSPACE &&
            t != w.FE.KEYCODE.ENTER &&
            t != w.FE.KEYCODE.IME)
        )
          return !0;
        ...
        return (
          ...
          (0 === t.length ||
            void (l.$el.outerHeight() - e.offsetY <= 10
              ? b(t[t.length - 1]) &&
                (n
                  ? l.$el.append('<' + n + '>' + w.FE.MARKERS + '<br></' + n + '>')
                  : l.$el.append(w.FE.MARKERS + '<br>'),
                l.selection.restore(),
                s())
              : e.offsetY <= 10 &&
                b(t[0]) &&
                (n
                  ? l.$el.prepend('<' + n + '>' + w.FE.MARKERS + '<br></' + n + '>')
                  : l.$el.prepend(w.FE.MARKERS + '<br>'),
                l.selection.restore(),
                s())))
        );
      }
      ...
      function r(r) {
        r &&
          ...
          (f.events.$on(
            ...
            'keydown',
            function(e) {
              if (!w(e.target).is('a.fr-command, button.fr-command, .fr-group span.fr-command'))
                return !0;
            ...
            (c = f.popups.get(d)),
            {
              _tiKeydown: function(e) {
                ...
                if (w.FE.KEYCODE.TAB == n) {
                  ...
                  if (0 <= a && a < i.length)
                    return t.events.disableBlur(), w(i[a]).focus(), e.stopPropagation(), !1;
                  ...
                  ? r != w.FE.KEYCODE.ARROW_LEFT || n || e.shiftKey || e.altKey
                    ? r != w.FE.KEYCODE.ARROW_UP || n || e.shiftKey || e.altKey
                      ? r != w.FE.KEYCODE.ARROW_DOWN || n || e.shiftKey || e.altKey
                        ? (r != w.FE.KEYCODE.ENTER && r != w.FE.KEYCODE.SPACE) ||
                          n ||
                          e.shiftKey ||
                          e.altKey
    ...
    (w.FE.MODULES.format = function(h) {
      ...
      function m(e, t, n) {
        if (e) {
          ...
          if (e) {
            ...
            for (
              var r = w(l(t, n)).insertBefore(e), o = e;
              o &&
              !w(o).is('.fr-marker') &&
              0 === w(o).find('.fr-marker').length &&
              'UL' != o.tagName &&
              'OL' != o.tagName;
            ...
            if (o)
              ...
              for (var a = r.get(0).parentNode; a && !a.nextSibling && !h.node.isElement(a); )
                a = a.parentNode;
              if (a) {
                var s = a.nextSibling;
                s &&
      ...
      function n(e, t) {
        ...
        if ((void 0 === t && (t = {}), t.style && delete t.style, h.selection.isCollapsed())) {
          h.markers.insert(),
            h.$el
              .find('.fr-marker')
              .replaceWith(l(e, t) + w.FE.INVISIBLE_SPACE + w.FE.MARKERS + ('</' + e + '>')),
            h.selection.restore();
        } else {
          var r;
          h.selection.save(),
          ...
          do {
            for (r = h.$el.find(f(e, t) + ' > ' + f(e, t)), n = 0; n < r.length; n++)
          ...
          for (n = 0; n < o.length; n++) {
            var i = w(o[n]);
            !0 === i.data('type')
              ? p(i.get(0).nextSibling, f(e, t)) && i.next().prepend(i)
              : p(i.get(0).previousSibling, f(e, t)) && i.prev().append(i);
          }
          h.selection.restore();
        }
      }
      function E(e, t, n, r) {
        ...
        if (e.parents(t).length || void 0 === t) {
          ...
          for (
            ;
            !h.node.isBlock(s.parent().get(0)) &&
            (void 0 === t || (void 0 !== t && !p(s.get(0), f(t, n))));

          )
            (i += h.node.closeTagString(s.get(0))),
          ...
          var d = s
            ...
            .replace(
              /<span id="mark"><\/span>/,
              i + h.node.closeTagString(s.get(0)) + a + l + i + h.node.openTagString(s.get(0)) + a
            );
          return (
            s.replaceWith(h.node.openTagString(s.get(0)) + d + h.node.closeTagString(s.get(0))), !0
          );
        }
        return !1;
      }
      function r(t, n) {
        ...
        !(function e(t, n, r, o) {
                ...
                for (var l = w(s).find(r || '*:not(br)'), d = l.length - 1; 0 <= d; d--) {
                  ...
                  h.node.isBlock(c) || h.node.isVoid(c) || (void 0 !== r && !p(c, f(r, o)))
                    ? h.node.isBlock(c) &&
                      void 0 === r &&
                      'TABLE' != s.tagName &&
                      h.node.clearAttributes(c)
                    : h.node.hasClass(c, 'fr-clone') || (c.outerHTML = c.innerHTML);
                }
                (void 0 === r && s.nodeType == Node.ELEMENT_NODE && !h.node.isVoid(s)) ||
                p(s, f(r, o))
                  ? h.node.isBlock(s)
                    ? void 0 === r &&
          ...
          r &&
            h.$el
              .find('.fr-marker')
              .before(w.FE.INVISIBLE_SPACE)
              .after(w.FE.INVISIBLE_SPACE),
      ...
      function t(e, t) {
        ...
        if (h.selection.isCollapsed()) {
              ...
              (d['style*'] = e + ':'),
                ...
                t
                  ? ((s = w(
                    ...
                    r.replaceWith(s))
                  : r.replaceWith(w.FE.INVISIBLE_SPACE + w.FE.MARKERS);
            }
            h.html.cleanEmptyTags();
          } else
            h.node.isEmpty(l.get(0)) && l.is('span')
              ? (r.replaceWith(w.FE.MARKERS), l.css(e, t))
              : ((s = w(
                  '<span style="' +
                    e +
                    ': ' +
          ...
          if (
            (h.selection.save(),
            null == t || ('color' == e && 0 < h.$el.find('.fr-marker').parents('u, a').length))
          ) {
            ...
            for (n = 0; n < c.length; n++)
              if (!0 === (r = w(c[n])).data('type'))
                for (
                  ;
                  h.node.isFirstSibling(r.get(0)) &&
                  !r.parent().is(h.$el) &&
                  !h.node.isElement(r.parent().get(0)) &&
                  !h.node.isBlock(r.parent().get(0));
          ...
          for (
            t && (p.style = e + ': ' + t + ';'),
              ...
              (t || '').match(/\dem$/) &&
                h.$el.find('span.fr-unprocessed').removeClass('fr-unprocessed');
            0 < h.$el.find('span.fr-unprocessed').length;

          ) {
            if (
              ((s = h.$el.find('span.fr-unprocessed:first').removeClass('fr-unprocessed'))
                .parent()
                .get(0)
                .normalize(),
        ...
        !(function() {
          ...
          for (e = 0; e < t.length; e++) {
            ...
            n.get(0).previousSibling == r.get(0) &&
              h.node.openTagString(n.get(0)) == h.node.openTagString(r.get(0)) &&
          ...
          h.$el.find('span[style] span[style]').each(function() {
            if (
              ...
              0 <= e.attr('style').indexOf('background-color') &&
                (w(this).attr('style', w(this).attr('style') + ';' + e.attr('style')),
                E(w(this), 'span[style]', {}, !1));
            }
          }),
            h.el.normalize(),
            h.selection.restore();
      ...
      function o(e, t) {
        ...
        for (
          ...
          i && i.nodeType == Node.ELEMENT_NODE && i != h.el && !p(i, f(e, t));
    ...
    (w.FE.MODULES.commands = function(a) {
      function o(e) {
        return (
          a.html.defaultTag() &&
            (e = '<' + a.html.defaultTag() + '>' + e + '</' + a.html.defaultTag() + '>'),
          e
        );
      }
      var i = {
        ...
        insertHR: function() {
          ...
          n.prev().is('hr')
            ...
            : n.next().is('hr')
              ...
              : a.selection.setAfter(n.get(0), !1) || a.selection.setBefore(n.get(0), !1),
      ...
      function t(e, t) {
        if (!1 !== a.events.trigger('commands.before', w.merge([e], t || []))) {
          var n = (w.FE.COMMANDS[e] && w.FE.COMMANDS[e].callback) || i[e],
            ...
            o = !1;
          w.FE.COMMANDS[e] &&
            ('undefined' != typeof w.FE.COMMANDS[e].focus && (r = w.FE.COMMANDS[e].focus),
            'undefined' != typeof w.FE.COMMANDS[e].accessibilityFocus &&
              (o = w.FE.COMMANDS[e].accessibilityFocus)),
            ((!a.core.hasFocus() && r && !a.popups.areVisible()) ||
              (!a.core.hasFocus() && o && a.accessibility.hasFocus())) &&
              a.events.focus(!0),
            w.FE.COMMANDS[e] &&
              !1 !== w.FE.COMMANDS[e].undo &&
              (a.$el.find('.fr-marker').length && (a.events.disableBlur(), a.selection.restore()),
              a.undo.saveStep()),
                  ...
                  if (t.previousSibling)
                    return (
                      a.node.isBlock(t.previousSibling)
                        ...
                        : w(t).before(w.FE.MARKERS),
                      a.selection.restore(),
                      !1
                    );
                } else if (
                  (e.which == w.FE.KEYCODE.ARROW_RIGHT || e.which == w.FE.KEYCODE.ARROW_DOWN) &&
                  t.nextSibling
                )
                  return (
                    a.node.isBlock(t.nextSibling)
                      ? a.selection.setAtStart(t.nextSibling)
                      : w(t).after(w.FE.MARKERS),
                    a.selection.restore(),
                    !1
                  );
            }),
    ...
    (w.FE.MODULES.data = function(p) {
        ...
        v = h(function(e) {
          ...
          for (
            var t = '',
              n = h('charCodeAt'),
              r = h('fromCharCode'),
              o = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789'.indexOf(e[0]),
              i = 1;
            i < e.length - 2;
            i++
          ) {
      ...
      return {
        _init: function() {
          ...
          e = p.opts.key || e || [''];
          var t = v(
            h('ziRA1E3B9pA5B-11D-11xg1A3ZB5D1D4B-11ED2EG2pdeoC1clIH4wB-22yQD5uF4YE3E3A9==')
          );
          'string' == typeof e && (e = [e]);
          for (var n, r, o, i = !(p.ul = !0), a = 0, s = 0; s < e.length; s++) {
            var l = ((r = e[s]),
              3 === (o = (v(r) || '').split('|')).length ? o : [null, null, v(r) || '']),
              d = l[2];
            if (
              d === v(h(v('mcVRDoB1BGILD7YFe1BTXBA7B6=='))) ||
              0 <= d.indexOf(g, d.length - g.length) ||
              y(g)
            ) {
              if (
                !(
                  (null === (n = l[1]) || new Date(n) < new Date(v('fA4B3E3C1I3H2C6C6C3E4=='))) &&
                  0 < (g || '').length
                ) ||
                y(g)
              ) {
    ...
    (w.FE.MODULES.paste = function(C) {
      ...
      function n(e, t) {
        try {
          C.win.localStorage.setItem('fr-copied-html', e),
            C.win.localStorage.setItem('fr-copied-text', t);
        } catch (n) {}
      }
      function e(e) {
      ...
      function t(e) {
        ...
        if (i) return !1;
        if (
          (e.originalEvent && (e = e.originalEvent), !1 === C.events.trigger('paste.before', [e]))
        )
          return e.preventDefault(), !1;
        if ((C.$win.scrollTop(), e && e.clipboardData && e.clipboardData.getData)) {
          ...
          if (
            ...
            /text\/html/.test(t) && !C.browser.safari
            ...
            C.selection.save(),
              ...
              o
                ...
                : ((o = w(
                  ...
                  C.browser.webkit || C.browser.mozilla
                    ? (o.css('top', C.$sc.scrollTop()), C.$el.after(o))
                    : C.browser.edge && C.opts.iframe
                      ? C.$el.append(o)
                      : C.$box.after(o),
      ...
      function s() {
        ...
        t && 'string' == typeof t && (A = t),
          (!e || (e && !1 !== C.events.trigger('paste.wordPaste', [A]))) && l(A, e);
      }
      function $(e) {
        for (var t = '', n = 0; n++ < e; ) t += '&nbsp;';
        return t;
      ...
      function l(r, e, t) {
          ...
          (r = O(
            (r = (function(e) {
              ...
              (e = (e = e.replace(/<lilevel([^1])([^>]*)>/gi, '<li data-indent="true"$2>')).replace(
                ...
                (e = (e = (e = C.clean.html(
                  e,
                  C.opts.pasteDeniedTags,
                  C.opts.pasteDeniedAttrs
        ...
        if (('string' == typeof u && (r = u), '' !== r)) {
          ...
          0 <= (g.innerHTML = r).indexOf('<body>')
            ? (C.html.cleanBlankSpaces(g), C.spaces.normalize(g, !0))
            : C.spaces.normalize(g);
          ...
          if ((b && w(b).parentsUntil(C.el, 'ul, ol').length && (S = !0), S)) {
            var T = g.children;
            1 == T.length &&
              0 <= ['OL', 'UL'].indexOf(T[0].tagName) &&
              (T[0].outerHTML = T[0].innerHTML);
          }
          if (!d) {
          ...
          if (C.opts.enter == w.FE.ENTER_BR)
            for (n = (o = g.querySelectorAll('p, div')).length - 1; 0 <= n; n--)
              0 === (i = o[n]).attributes.length &&
                (i.outerHTML = i.innerHTML + (i.nextSibling && !C.node.isEmpty(i) ? '<br>' : ''));
          else if (C.opts.enter == w.FE.ENTER_DIV)
            for (n = (o = g.getElementsByTagName('p')).length - 1; 0 <= n; n--)
              0 === (i = o[n]).attributes.length &&
                (i.outerHTML = '<div>' + i.innerHTML + '</div>');
          else
            C.opts.enter == w.FE.ENTER_P &&
              1 == g.childNodes.length &&
              'P' == g.childNodes[0].tagName &&
              0 === g.childNodes[0].attributes.length &&
              (g.childNodes[0].outerHTML = g.childNodes[0].innerHTML);
          (r = g.innerHTML),
            c &&
              (r = (function(e) {
                var t,
                ...
                var r = n.querySelectorAll(
                  '*:empty:not(td):not(th):not(tr):not(iframe):not(svg):not(' +
                    w.FE.VOID_ELEMENTS.join('):not(') +
                    '):not(' +
                    C.opts.htmlAllowedEmptyTags.join('):not(') +
                    ')'
                );
                for (; r.length; ) {
      ...
      function O(e) {
        ...
        for (
          ...
          var o = r[r.length - 1];
          if (C.html.defaultTag() && 'div' != C.html.defaultTag())
            o.querySelector(C.html.blockTagsQuery())
              ? (o.outerHTML = o.innerHTML)
              : (o.outerHTML =
                  '<' + C.html.defaultTag() + '>' + o.innerHTML + '</' + C.html.defaultTag() + '>');
          else {
      ...
      function f() {
        C.el.removeEventListener('copy', e),
          C.el.removeEventListener('cut', e),
          C.el.removeEventListener('paste', t);
      }
      return {
        _init: function() {
    ...
    (w.FE.MODULES.shortcuts = function(s) {
      var r = null;
      var l = !1;
      function e(e) {
        ...
        if (n && w.FE.SHORTCUTS_MAP[r]) {
          ...
          if (o && 0 <= s.opts.shortcutsEnabled.indexOf(o)) {
            var i,
              a = w.FE.SHORTCUTS_MAP[r].val;
            if (
              (o && !a
                ? (i = s.$tb.find('.fr-command[data-cmd="' + o + '"]'))
                : o &&
                  a &&
                  (i = s.$tb.find('.fr-command[data-cmd="' + o + '"][data-param1="' + a + '"]')),
              i.length)
            )
              return (
                e.preventDefault(),
            ...
            if (o && (s.commands[o] || (w.FE.COMMANDS[o] && w.FE.COMMANDS[o].callback)))
              return (
                e.preventDefault(),
                e.stopPropagation(),
                'keydown' == e.type && ((s.commands[o] || w.FE.COMMANDS[o].callback)(), (l = !0)),
                !1
              );
          }
        }
          ...
          if (!r)
            for (var t in ((r = {}), w.FE.SHORTCUTS_MAP))
              w.FE.SHORTCUTS_MAP.hasOwnProperty(t) &&
                0 <= s.opts.shortcutsEnabled.indexOf(w.FE.SHORTCUTS_MAP[t].cmd) &&
                (r[w.FE.SHORTCUTS_MAP[t].cmd + '.' + (w.FE.SHORTCUTS_MAP[t].val || '')] = {
    ...
    (w.FE.MODULES.icon = function(o) {
      return {
        ...
        getTemplate: function(e) {
          ...
          return void 0 !== t
            ? (n = t.template || w.FE.ICON_DEFAULT_TEMPLATE || o.opts.iconsTemplate)
            : n;
        },
      };
    }),
    ...
    (w.FE.MODULES.tooltip = function(o) {
      ...
      function i(e, t) {
        ...
        o.$tooltip ||
          (o.opts.tooltips &&
            ...
            (o.shared.$tooltip
              ...
              : ((o.shared.$tooltip = w('<div class="fr-tooltip"></div>')),
                (o.$tooltip = o.shared.$tooltip),
                o.opts.theme && o.$tooltip.addClass(o.opts.theme + '-theme'),
                w(o.o_doc)
                  .find('body:first')
                  .append(o.$tooltip)),
            o.events.on(
        ...
        n < 0 && (n = 0),
          n + o.$tooltip.outerWidth() > w(o.o_win).width() &&
            (n = w(o.o_win).width() - o.$tooltip.outerWidth()),
          void 0 === t && (t = o.opts.toolbarBottom),
          e.offset().top - w(window).scrollTop() + e.outerHeight() + 10 >= w(window).height() &&
            (t = !0);
        ...
        bind: function(e, t, n) {
          o.opts.tooltips &&
            ...
            (o.events.$on(
              ...
              t,
              function(e) {
                o.node.hasClass(e.currentTarget, 'fr-disabled') ||
                  o.edit.isDisabled() ||
                  i(w(e.currentTarget), n);
              },
              !0
            ),
            o.events.$on(
    ...
    (w.FE.MODULES.button = function(u) {
      ...
      (u.opts.toolbarInline || u.opts.toolbarContainer) &&
        (u.shared.buttons || (u.shared.buttons = []), (a = u.shared.buttons));
      var s = [];
      function l(e, t, n) {
      ...
      function t(e) {
        ...
        if (
          ...
          for (var n = 0; n < w.FE.INSTANCES.length; n++)
            w.FE.INSTANCES[n] != t &&
              w.FE.INSTANCES[n].popups &&
              w.FE.INSTANCES[n].popups.areVisible() &&
              w.FE.INSTANCES[n].$el.find('.fr-marker').remove();
          t.popups.hideAll();
        }
        u.node.hasClass(e.get(0), 'fr-dropdown')
          ? (function(e) {
              ...
              if (
                ...
                t
                  ...
                  w.FE.COMMANDS[i] &&
                    w.FE.COMMANDS[i].refreshOnShow &&
                    w.FE.COMMANDS[i].refreshOnShow.apply(o, [e, t]),
                  t.css(
                    'left',
                    e.offset().left -
                ...
                t.removeClass('test-height'),
                  ...
                  t.offset().top + e.outerHeight() + a < w(u.o_doc).height()
          ...
          : (r(e),
            w.FE.COMMANDS[e.data('cmd')] &&
              !1 !== w.FE.COMMANDS[e.data('cmd')].refreshAfterCallback &&
      ...
      function g(e, t, n) {
        ...
        if ('options' !== t.type)
          if (r) {
            ...
            o =
              ...
              'px">' +
              u.language.translate(i || t.title) +
              '</span>';
          } else
            (o = u.icon.create(t.icon || e)),
              (o +=
        ...
        return (
          t.hasOptions &&
            ...
            ((t.type = 'options'),
            (t.hasOptions = !1),
            (f = '<div class="fr-btn-wrap">' + f + g(e + 'Options', t, n) + '</div>')),
          f
        );
      }
      function e(o) {
      ...
      return {
        ...
        bindCommands: function(t, e) {
          ...
          var n = t.get(0).ownerDocument,
            ...
            o = function(e) {
              (!e ||
                (e.type == u._mouseup && e.target != w('html').get(0)) ||
                ('keydown' == e.type &&
                  ((u.keys.isCharacter(e.which) && !u.keys.ctrlKey(e)) ||
                    e.which == w.FE.KEYCODE.ESC))) &&
                c(t);
            };
          u.events.$on(w(r), u._mouseup + ' resize keydown', o, !0),
            ...
            u.node.hasClass(t.get(0), 'fr-popup')
              ? w.merge(s, t.find('.fr-btn').toArray())
              : w.merge(a, t.find('.fr-btn').toArray()),
        ...
        refresh: function(e) {
          ...
          u.node.hasClass(e.get(0), 'fr-dropdown')
            ...
            w.FE.COMMANDS[r] && w.FE.COMMANDS[r].refresh
              ? w.FE.COMMANDS[r].refresh.apply(n, [e, t])
    ...
    (w.FE.MODULES.modals = function(l) {
      ...
      return {
        ...
        create: function(n, e, t) {
          if (
            (l.shared.$overlay ||
              (l.shared.$overlay = w('<div class="fr-overlay">').appendTo('body:first')),
            (s = l.shared.$overlay),
              ...
              l.events.$on(
                ...
                function(e) {
                  ...
                  return t == w.FE.KEYCODE.ESC
                    ...
                    : !(
                        !w(e.target).is('input[type=text], textarea') &&
                        t != w.FE.KEYCODE.ARROW_UP &&
                        t != w.FE.KEYCODE.ARROW_DOWN &&
      ...
      function o(e, t) {
        ...
        return o
          ? ((n = w(
            ...
            n)
          : ((n = w('<div class="fr-popup fr-empty"></div>')),
            (r = w('body:first')).append(n),
            n.data('container', r),
            (f[e] = n));
      }
      function E(r) {
        ...
        return {
          ...
          _editorKeydown: function(e) {
            var t = o.data('instance') || c;
            t.keys.ctrlKey(e) ||
              e.which == w.FE.KEYCODE.ALT ||
              e.which == w.FE.KEYCODE.ESC ||
              (u(r) && o.find('.fr-back:visible').length
                ? t.button.exec(o.find('.fr-back:visible:first'))
                : e.which != w.FE.KEYCODE.ALT && t.popups.hide(r));
          },
          _preventFocus: function(e) {
            ...
            'mouseup' == e.type || w(n).is(':focus') || t.events.disableBlur(),
              'mouseup' != e.type ||
                w(n).hasClass('fr-command') ||
                0 < w(n).parents('.fr-command').length ||
                w(n).hasClass('fr-dropdown-content') ||
                c.button.hideActiveDropdowns(o),
              (c.browser.safari || c.browser.mozilla) &&
                'mousedown' == e.type &&
                w(n).is('input[type=file]') &&
                t.events.disableBlur();
          ...
          _editorMouseup: function() {
            o.is(':visible') &&
              i() &&
              0 <
                o.find('input:focus, textarea:focus, button:focus, select:focus').filter(':visible')
                  .length &&
              c.events.disableBlur();
          },
          ...
          _doPlaceholder: function() {
            0 === w(this).next().length &&
              ...
              w(this).toggleClass('fr-not-empty', '' !== w(this).val());
          },
      ...
      return (
        (c.shared.exit_flag = !1),
        {
          ...
          show: function(e, t, n, r) {
            if (
              (u(e) ||
                (g() && 0 < c.$el.find('.fr-marker').length
                  ? (c.events.disableBlur(), c.selection.restore())
                  : g() || (c.events.disableBlur(), c.events.focus(), c.events.enableBlur())),
              h([e]),
              !f[e])
            )
              return !1;
      ...
      function o() {
        ...
        if ((0 === e.top && 0 === e.left && 0 === e.width) || 0 === e.height) {
          ...
          n.css('display', 'none'),
            ...
            (e.width = 0),
            (e.height = o),
            (e.top = r.top - (v.opts.iframe ? 0 : v.helpers.scrollTop())),
            (e.right = 1),
            (e.bottom = 1),
            (e.ok = !0),
      ...
      function i(e, t, n, r) {
        ...
        !o ||
          ...
          'BODY' != o.get(0).tagName
            ? (e && (e += o.get(0).scrollLeft), t && (t += o.get(0).scrollTop))
          ...
          v.opts.iframe &&
            ...
            v.$tb &&
            o.get(0) != v.$tb.get(0) &&
            (e && (e += v.$iframe.offset().left), t && (t += v.$iframe.offset().top));
        var i,
          a,
          s,
          l,
        ...
        if (e) {
          ...
          c || ((c = n.find('.fr-arrow')), n.data('fr-arrow', c)),
            c.data('margin-left') || c.data('margin-left', v.helpers.getPX(c.css('margin-left'))),
          ...
          n.css(
            ...
            (function(e, t, n) {
              ...
              if (!v.helpers.isMobile() && v.$tb && e.parent().get(0) != v.$tb.get(0)) {
                ...
                o + t + r > v.$sc.offset().top + a && 0 < e.parent().offset().top + i && 0 < i
                  ? i > v.$wp.scrollTop() && ((t = i), e.addClass('fr-above'))
      ...
      function n(e) {
        ...
        if (v.core.hasFocus() || 0 < v.$tb.find('input:visible:focus').length) {
          var a = v.helpers.scrollTop(),
            s = Math.min(
              Math.max(a - v.$tb.parent().offset().top, 0),
              v.$tb.parent().outerHeight() - n.outerHeight()
            );
          s != r &&
            s != o &&
            ...
            n.data(
              ...
              setTimeout(function() {
                var e = v.helpers.scrollTop(),
                  t = Math.min(
                    Math.max(e - v.$tb.parent().offset().top, 0),
                    v.$tb.parent().outerHeight() - n.outerHeight()
                  );
                0 < t &&
                  'BODY' == v.$tb.parent().get(0).tagName &&
                  (t += v.$tb.parent().position().top),
                  t != r &&
            ...
            t ||
              (n.css('top', '0'),
              n.width(v.$tb.parent().width()),
              n.addClass('fr-sticky-on'),
              v.$box.addClass('fr-sticky-box'));
        } else
          clearTimeout(w(e).css('sticky-timeout')),
            n.css('top', '0'),
            n.css('position', ''),
            n.width(''),
            n.data('sticky-top', 0),
      ...
      function t(e) {
        if (e.offsetWidth) {
          var t,
            ...
            s = w(
              'body' == v.opts.scrollableContainer ? v.o_win : v.opts.scrollableContainer
            ).outerHeight(),
            l = 0,
            d = 0;
          'body' !== v.opts.scrollableContainer &&
            ((l = v.$sc.offset().top), (d = w(v.o_win).outerHeight() - l - s));
          ...
          var p = r.data('sticky-parent'),
            ...
            g = p.outerHeight();
          if (
            (r.data('sticky-offset') || void 0 !== i
              ? v.$box.find('.fr-sticky-dummy').css('height', o + 'px')
              : (r.data('sticky-offset', !0),
                r.after('<div class="fr-sticky-dummy" style="height: ' + o + 'px;"></div>')),
            !a)
          ) {
          ...
          var m =
              ...
              u < c + t &&
              c + t <= u + g - o &&
              (v.helpers.isInViewPort(v.$sc.get(0)) || 'body' == v.opts.scrollableContainer),
          ...
          m || E
            ? (r.css('width', p.get(0).getBoundingClientRect().width + 'px'),
              f ||
                ...
                r.css('top') &&
                  ('auto' != r.data('top')
                    ? r.css('top', v.helpers.getPX(r.data('top')) + l)
                    : r.data('top', 'auto')),
                r.css('bottom') &&
                  ('auto' != r.data('bottom')
                    ? r.css('bottom', v.helpers.getPX(r.data('bottom')) + d)
                    : r.css('bottom', 'auto'))))
      ...
      return {
        _init: function() {
          !(function() {
            if (((v._stickyElements = []), v.helpers.isIOS())) {
              var t = function() {
                if (
                  (v.helpers.requestAnimationFrame()(t),
                  !1 !== v.events.trigger('position.refresh'))
                )
              ...
              'body' !== v.opts.scrollableContainer &&
                v.events.$on(w(v.opts.scrollableContainer), 'scroll', e, !0),
        ...
        addSticky: function(e) {
          e.addClass('fr-sticky'),
            ...
            v._stickyElements.push(e.get(0));
        },
        refresh: e,
        at: i,
        getBoundingRect: o,
      ...
      return {
        ...
        outdent: function(e) {
          ...
          for (var t = o.selection.blocks(), n = 0; n < t.length; n++) {
            var r =
              'rtl' == o.opts.direction || 'rtl' == w(t[n]).css('direction')
                ? 'margin-right'
                : 'margin-left';
    ...
    (w.FE.MODULES.toolbar = function(o) {
      ...
      function e() {
        ...
        o.$tb.find('.fr-separator').remove(),
          o.$tb.find('> .fr-command, > div.fr-btn-wrap').addClass('fr-hidden');
        for (var t = 0; t < e.length; t++)
          if ('|' == e[t] || '-' == e[t]) o.$tb.append(o.button.buildList([e[t]]));
            ...
            o.node.hasClass(n.next().get(0), 'fr-dropdown-menu') && (r = n.next()),
              o.node.hasClass(n.next().get(0), 'fr-options') && (n = n.parent()),
      ...
      function t(e, t) {
        setTimeout(function() {
          if (
            ...
            o.core.hasFocus() &&
            !o.popups.areVisible() &&
            (o.opts.toolbarVisibleWithoutSelection ||
              (!o.selection.isCollapsed() && !o.keys.isIME()) ||
              t)
          ) {
            if ((o.$tb.data('instance', o), !1 === o.events.trigger('toolbar.show', [e])))
              return !1;
            o.$tb.show(),
              o.opts.toolbarContainer || o.position.forSelection(o.$tb),
              1 < o.opts.zIndex
                ? o.$tb.css('z-index', o.opts.zIndex + 1)
                : o.$tb.css('z-index', null);
          }
        }, 0);
      }
      function n(e) {
        return (
          ...
          (!(!e || 'keydown' !== e.type || !o.keys.ctrlKey(e)) ||
            (!!o.button
              .getButtons('.fr-dropdown.fr-active')
              .next()
              .find(o.o_doc.activeElement).length ||
              void (!1 !== o.events.trigger('toolbar.hide') && o.$tb.hide())))
        );
      }
      (r[w.FE.XS] =
        o.opts.toolbarButtonsXS ||
        o.opts.toolbarButtons ||
        w.FE.TOOLBAR_BUTTONS_XS ||
        w.FE.TOOLBAR_BUTTONS ||
        []),
        (r[w.FE.SM] =
          o.opts.toolbarButtonsSM ||
          o.opts.toolbarButtons ||
          w.FE.TOOLBAR_BUTTONS_SM ||
          w.FE.TOOLBAR_BUTTONS ||
          []),
        (r[w.FE.MD] =
          o.opts.toolbarButtonsMD ||
          o.opts.toolbarButtons ||
          w.FE.TOOLBAR_BUTTONS_MD ||
          w.FE.TOOLBAR_BUTTONS ||
          []),
      ...
      function l(e) {
        clearTimeout(s),
          (e && e.which == w.FE.KEYCODE.ESC) || (s = setTimeout(t, o.opts.typingTimer));
      }
      function d() {
        o.events.on('window.mousedown', n),
          ...
          o.helpers.isMobile()
            ? o.helpers.isIOS() ||
              (o.events.on('window.touchend', t), o.browser.mozilla && setInterval(t, 200))
            : o.events.on('window.keyup', l),
          ...
          o.helpers.isMobile() &&
            (o.events.$on(o.$doc, 'selectionchange', l),
            o.events.$on(o.$doc, 'orientationchange', t));
      }
      function c() {
        o.$tb
          .html('')
      ...
      function p() {
        o.opts.theme && o.$tb.addClass(o.opts.theme + '-theme'),
          ...
          'auto' != o.opts.direction &&
            o.$tb.removeClass('fr-ltr fr-rtl').addClass('fr-' + o.opts.direction),
          o.helpers.isMobile() ? o.$tb.addClass('fr-mobile') : o.$tb.addClass('fr-desktop'),
          o.opts.toolbarContainer
            ? (o.opts.toolbarInline && (d(), n()),
              o.opts.toolbarBottom ? o.$tb.addClass('fr-bottom') : o.$tb.addClass('fr-top'))
            : o.opts.toolbarInline
              ? (o.$sc.append(o.$tb),
                o.$tb.data('container', o.$sc),
                o.$tb.addClass('fr-inline'),
                o.$tb.prepend('<span class="fr-arrow"></span>'),
                d(),
                (o.opts.toolbarBottom = !1))
              : (o.opts.toolbarBottom && !o.helpers.isIOS()
                  ? (o.$box.append(o.$tb),
                    o.$tb.addClass('fr-bottom'),
                    o.$box.addClass('fr-bottom'))
                  : ((o.opts.toolbarBottom = !1),
                    o.$box.prepend(o.$tb),
                    o.$tb.addClass('fr-top'),
                    o.$box.addClass('fr-top')),
                o.$tb.addClass('fr-basic'),
                o.opts.toolbarSticky &&
                  (o.opts.toolbarStickyOffset &&
                    (o.opts.toolbarBottom
                      ? o.$tb.css('bottom', o.opts.toolbarStickyOffset)
                      : o.$tb.css('top', o.opts.toolbarStickyOffset)),
                  o.position.addSticky(o.$tb))),
          (function() {
            var e = w.merge([], a());
          ...
          o.events.$on(
            ...
            function(e) {
              var t = e.originalEvent
                ...
                : null;
              if (t && 'INPUT' != t.tagName && !o.edit.isDisabled())
        ...
        _init: function() {
          ...
          o.opts.toolbarContainer
            ? (o.shared.$tb
                ...
                : ((o.shared.$tb = w('<div class="fr-toolbar"></div>')),
                  (o.$tb = o.shared.$tb),
                  w(o.opts.toolbarContainer).append(o.$tb),
                  p(),
            ...
            : o.opts.toolbarInline
              ? (o.$box.addClass('fr-inline'),
                o.shared.$tb
                  ? ((o.$tb = o.shared.$tb), d())
                  : ((o.shared.$tb = w('<div class="fr-toolbar"></div>')),
                    (o.$tb = o.shared.$tb),
                    p()))
              : (o.$box.addClass('fr-basic'),
                (o.$tb = w('<div class="fr-toolbar"></div>')),
                p(),
                o.$tb.data('instance', o)),
            o.events.on('destroy', f, !0),
            o.events.on(
              o.opts.toolbarInline || o.opts.toolbarContainer ? 'shared.destroy' : 'destroy',
              c,
              !0
            );
        },
