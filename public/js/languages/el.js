  ...
  $.FE.LANGUAGE['el'] = {
    translation: {
      ...
      'Your browser does not support HTML5 video.':
        'Ο περιηγητής σας δεν υποστηρίζει βίντεο τύπου HTML5.',
      ...
      'The pasted content is coming from a Microsoft Word document. Do you want to keep the format or clean it up?':
        'Το περιεχόμενο που επικολλήσατε προέρχεται από ένα έγγραφο του Microsoft Word. Θέλετε να διατηρήσετε το έγγραφο ή να το καταργήσετε;',
      Keep: 'Διατήρηση',
      Clean: 'Κατάργηση',
