  ...
  $.FE.LANGUAGE['fr'] = {
    translation: {
      ...
      'Your browser does not support HTML5 video.':
        'Votre navigateur ne supporte pas les vid\u00e9os en format HTML5.',
      ...
      'Smiling face with open mouth and smiling eyes':
        'Visage souriant avec la bouche ouverte et les yeux en souriant',
      'Smiling face with open mouth and cold sweat':
        'Visage souriant avec la bouche ouverte et la sueur froide',
      'Smiling face with open mouth and tightly-closed eyes':
        'Visage souriant avec la bouche ouverte et les yeux herm\u00e9tiquement clos',
      ...
      'Face with stuck out tongue and winking eye':
        'Visage avec sortait de la langue et des yeux clignotante',
      'Face with stuck out tongue and tightly-closed eyes':
        'Visage avec sortait de la langue et les yeux ferm\u00e9s herm\u00e9tiquement',
      ...
      'The pasted content is coming from a Microsoft Word document. Do you want to keep the format or clean it up?':
        "Le contenu coll\u00e9 provient d'un document Microsoft Word. Voulez-vous conserver le format ou le nettoyer?",
      Keep: 'Conserver',
      Clean: 'Nettoyer',
