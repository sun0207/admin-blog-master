  ...
  $.FE.LANGUAGE['id'] = {
    translation: {
      ...
      'Smiling face with open mouth and smiling eyes':
        'Tersenyum wajah dengan mulut terbuka dan tersenyum mata',
      'Smiling face with open mouth and cold sweat':
        'Tersenyum wajah dengan mulut terbuka dan keringat dingin',
      'Smiling face with open mouth and tightly-closed eyes':
        'Tersenyum wajah dengan mulut terbuka dan mata tertutup rapat',
      ...
      'Face with stuck out tongue and winking eye':
        'Muka dengan menjulurkan lidah dan mengedip mata',
      'Face with stuck out tongue and tightly-closed eyes':
        'Wajah dengan lidah terjebak dan mata erat-tertutup',
      ...
      'The pasted content is coming from a Microsoft Word document. Do you want to keep the format or clean it up?':
        'Konten yang disisipkan berasal dari dokumen kata microsoft. apakah Anda ingin menyimpan format atau membersihkannya?',
      Keep: 'Menjaga',
      Clean: 'Bersih',
